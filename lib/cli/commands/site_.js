...
exports.init = function (cli) {
  ...
  function getPublishingUser(context, _) {
    ...
    log.help('The publishing username cannot be inferred for a shared subscription.');
    log.help('You may need to define your credentials in the portal.');
    log.help('Please provide a username for git remote.');
