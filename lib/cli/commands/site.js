...
/*   659 */       return getChannel().path(options.subscription).path("services/webspaces/").query("properties", "publishingUsers").GET(__cb(_, __frame, 5, 36, function ___(__0, __1) {
/*   655 */         publishingUsers = clean(__1);
/*   661 */         log.verbose("PublishingUsers", publishingUsers);
/*   662 */         return _(null, publishingUsers);
                  }));
                });
              };
/*   669 */   var writers = {
/*   670 */     Site: {
/*   671 */       xml: function(site) {
/*   672 */         return function(req) {
/*   673 */           req.write("<Site xmlns=\"http://schemas.microsoft.com/windowsazure\">");
/*   674 */           req.write("<HostNames>");
/*   675 */           req.write("<string xmlns=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\">");
/*   676 */           req.write((site.name + ".antdf0.antares-test.windows-int.net"));
/*   677 */           req.write("</string>");
/*   679 */           if (site.hostname) {
/*   680 */             req.write("<string xmlns=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\">");
/*   681 */             req.write(site.hostname);
/*   682 */             req.write("</string>");
                      }
                    ;
/*   684 */           req.write("</HostNames>");
/*   685 */           req.write("<Name>");
/*   686 */           req.write(site.name);
/*   687 */           req.write("</Name>");
/*   688 */           req.write("</Site>");
/*   690 */           req.end();
                    };
...
/*   696 */   function clean(source) {
/*   697 */     if ((typeof (source) === "string")) {
/*   698 */       return source;
                }
              ;
/*   701 */     var target = {
                };
/*   702 */     var hasString = false;
/*   703 */     var hasNonString = false;
/*   704 */     var stringValue = "";
/*   706 */     for (var prop in source) {
/*   707 */       if ((prop == "@")) {
/*   708 */         continue;
                  }
/*   709 */        else {
/*   710 */         if ((((prop === "#") || (prop === "string")) || (prop.substring((prop.length - 7)) === ":string"))) {
/*   711 */           hasString = true;
/*   712 */           stringValue = source[prop];
                    }
/*   713 */          else {
/*   714 */           hasNonString = true;
                    }
                  ;
/*   716 */         target[prop] = clean(source[prop]);
                  }
                ;
                };
/*   719 */     if ((hasString && !hasNonString)) {
/*   720 */       return stringValue;
                }
              ;
/*   722 */     return target;
              };
/*   725 */   function logEachData(title, data) {
/*   726 */     var cleaned = clean(data);
/*   727 */     for (var property in cleaned) {
/*   728 */       log.data(((title + " ") + property), cleaned[property]);
                };
              };
/*   732 */   function logError(message, err) {
/*   733 */     if ((arguments.length == 1)) {
/*   734 */       err = message;
/*   735 */       message = undefined;
                }
/*   736 */      else {
/*   737 */       log.error(message);
                }
              ;
/*   740 */     if (err) {
/*   741 */       if (err.message) {
/*   743 */         log.verbose("stack", err.stack);
/*   744 */         log.json("silly", err);
                  }
/*   746 */        else if (err.Message) {
/*   748 */         log.json("verbose", clean(err));
                  }
/*   750 */        else {
...
/*   756 */   function isArray(testObject) {
/*   757 */     return (((testObject && !(testObject.propertyIsEnumerable("length"))) && (typeof testObject === "object")) && (typeof testObject.length === "number"));
              };
/*   760 */   function toArray(testObject) {
/*   761 */     return (isArray(testObject) ? testObject : ((typeof testObject === "undefined") ? [] : [testObject,]));
              };
/*   764 */   function endsWith(str, suffix) {
/*   765 */     return (str.indexOf(suffix, (str.length - suffix.length)) !== -1);
              };
/*   768 */   function exec(cmd, cb) {
/*   769 */     child_process.exec(cmd, function(err, stdout, stderr) {
/*   770 */       cb(err, {
/*   771 */         stdout: stdout,
/*   772 */         stderr: stderr
                  });
