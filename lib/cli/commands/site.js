...
/*   120 */       href = "https://commonuxfx-bvt01.cloudapp.net/";
/*   121 */       if (name) {
/*   122 */         href = (((href + "#Workspaces/WebsiteExtension/Website/") + name) + "/dashboard");
                  }
                ;
/*   125 */       common.launchBrowser(href);
                  _();
                });
              });
...
/*   143 */           href = ("http://" + toArray(siteData.HostNames)[0]);
/*   145 */           common.launchBrowser(href);
                      _();
                    }));
                  }));
                });
...
/*   173 */   site.lookupSiteWebSpace = function lookupSiteWebSpace(context, _) {
                var sites, index;
                var __frame = {
