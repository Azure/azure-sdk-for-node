...
exports.init = function(cli) {
  ...
  site.command("create [name]").whiteListPowershell().description("Create a new web site").option("-s, --subscription <id>", "use the subscription id").option("--location <location>", "the geographic region to create the website").option("--hostname <hostname>", "custom host name to use").option("--git", "configure git on web site and local folder").option("--github", "configure github on web site and local folder").option("-u, --username <user>", "The username").option("-up, --pass <pass>", "The password").option("-r, --repository <repository>", "The github repository").execute(function __2(nameArg, options, _) { var context;
    ...
    function promptForSiteName(_) { var __frame = { name: "promptForSiteName", line: 176 }; return __func(_, this, arguments, promptForSiteName, 0, __frame, function __$promptForSiteName() {
    ...
    function determineIfSiteExists(_) { var sites, hits, displayNameMatches; var __frame = { name: "determineIfSiteExists", line: 184 }; return __func(_, this, arguments, determineIfSiteExists, 0, __frame, function __$determineIfSiteExists() {
    ...
    function promptForLocation(_) { var displayNameMatches; var __frame = { name: "promptForLocation", line: 207 }; return __func(_, this, arguments, promptForLocation, 0, __frame, function __$promptForLocation() {
    ...
    function createSite(_) { var __frame = { name: "createSite", line: 263 }; return __func(_, this, arguments, createSite, 0, __frame, function __$createSite() {
    ...
    function initializeRemoteRepo(_) { var __frame = { name: "initializeRemoteRepo", line: 270 }; return __func(_, this, arguments, initializeRemoteRepo, 0, __frame, function __$initializeRemoteRepo() {
    ...
    function addRemoteToLocalGitRepo(_) { var remotes, azureExists, gitUri; var __frame = { name: "addRemoteToLocalGitRepo", line: 286 }; return __func(_, this, arguments, addRemoteToLocalGitRepo, 0, __frame, function __$addRemoteToLocalGitRepo() {
    ...
    function ensureRepositoryUri(_) { var siteData, repositoryUri; var __frame = { name: "ensureRepositoryUri", line: 313 }; return __func(_, this, arguments, ensureRepositoryUri, 0, __frame, function __$ensureRepositoryUri() {
        return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 1, 27, function ___(__0, __1) { siteData = __1;
          repositoryUri = (siteData && site.getRepositoryUri(siteData)); return (function __$ensureRepositoryUri(__then) {
            ...
            if (repositoryUri) {
              ...
              return _(null, context.repositoryUri = repositoryUri); } ; _(); }); }, true)); }); }; var __frame = { name: "__2", line: 126 }; return __func(_, this, arguments, __2, 2, __frame, function __$__2() { context = { subscription: cli.category("account").lookupSubscriptionId(options.subscription), git: options.git, site: { name: nameArg, webspace: options.location, hostname: options.hostname }, username: options.username, password: options.pass, remoteUri: options.repository, flags: { } }; if ((options.git && options.github)) { return _(new Error("Please run the command with either --git or --github options. Not both.")); } ; return promptForSiteName(__cb(_, __frame, 20, 10, function __$__2() { return promptForLocation(__cb(_, __frame, 21, 10, function __$__2() { return determineIfSiteExists(__cb(_, __frame, 22, 10, function __$__2() { return createSite(__cb(_, __frame, 23, 10, function __$__2() { return (function __$__2(__then) { if ((options.git || options.github)) { if (options.github) { context.lvcClient = LinkedRevisionControl.createClient(cli, "github"); } else { if (options.git) { context.lvcClient = LinkedRevisionControl.createClient(cli, "git"); } ; } ; return context.lvcClient.init(context, __cb(_, __frame, 33, 12, function __$__2() { return copyIisNodeWhenServerJsPresent(__cb(_, __frame, 36, 12, function __$__2() { return updateLocalConfigWithSiteName(__cb(_, __frame, 37, 12, function __$__2() { return initializeRemoteRepo(__cb(_, __frame, 39, 12, function __$__2() { return (function __$__2(__then) { if (options.git) { return addRemoteToLocalGitRepo(__cb(_, __frame, 42, 14, __then, true)); } else { return (function __$__2(__then) { if (options.github) { return ensureRepositoryUri(__cb(_, __frame, 44, 14, __then, true)); } else { __then(); } ; })(__then); } ; })(function __$__2() { return context.lvcClient.deploy(context, __cb(_, __frame, 47, 12, __then, true)); }); }, true)); }, true)); }, true)); }, true)); } else { __then(); } ; })(_); }, true)); }, true)); }, true)); }, true)); }); });
  ...
  site.command("delete [name]").whiteListPowershell().description("Delete a web site").option("-s, --subscription <id>", "use the subscription id").option("-q, --quiet", "quiet mode, do not ask for delete confirmation").execute(function __7(name, options, _) { var context, progress, result; var __frame = { name: "__7", line: 613 }; return __func(_, this, arguments, __7, 2, __frame, function __$__7() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 8, 10, function __$__7() {
        ...
        log.info("Deleting site", context.site.name); return (function __$__7(_) {
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return confirm((("Delete " + context.site.name) + " site?  (y/n) "), __cb(_, __frame, 11, 33, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -612, 17, function ___(__0, __2) { return (function __$__7(__then) { if (__2) { return _(null); } else { __then(); } ; })(function __$__7() {
  ...
  site.command("start [name]").whiteListPowershell().description("Start a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __8(name, options, _) { var context, progress, result; var __frame = { name: "__8", line: 651 }; return __func(_, this, arguments, __8, 2, __frame, function __$__8() {
  ...
  site.command("stop [name]").whiteListPowershell().description("Stop a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __9(name, options, _) { var context, progress, result; var __frame = { name: "__9", line: 702 }; return __func(_, this, arguments, __9, 2, __frame, function __$__9() {
  ...
  site.readConfig = function site_readConfig__10(_) { var __frame = { name: "site_readConfig__10", line: 753 }; return __func(_, this, arguments, site_readConfig__10, 0, __frame, function __$site_readConfig__10() {
  ...
  site.writeConfig = function site_writeConfig__11(cfg, _) { var __frame = { name: "site_writeConfig__11", line: 760 }; return __func(_, this, arguments, site_writeConfig__11, 1, __frame, function __$site_writeConfig__11() {
  ...
  site.readConfigValue = function site_readConfigValue__12(name, _) { var result; var __frame = { name: "site_readConfigValue__12", line: 765 }; return __func(_, this, arguments, site_readConfigValue__12, 1, __frame, function __$site_readConfigValue__12() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$site_readConfigValue__12() {
  ...
  site.writeConfigValue = function site_writeConfigValue__13(name, value, _) { var __frame = { name: "site_writeConfigValue__13", line: 776 }; return __func(_, this, arguments, site_writeConfigValue__13, 2, __frame, function __$site_writeConfigValue__13() {
  ...
  site.doSpacesGet = function site_doSpacesGet__14(options, _) { var progress, result, spaces; var __frame = { name: "site_doSpacesGet__14", line: 874 }; return __func(_, this, arguments, site_doSpacesGet__14, 1, __frame, function __$site_doSpacesGet__14() {
      log.verbose("Subscription", options.subscription);
  ...
  site.doSitesGet = function site_doSitesGet__15(options, _) { var spaces, channel, progress, result, sites; var __frame = { name: "site_doSitesGet__15", line: 896 }; return __func(_, this, arguments, site_doSitesGet__15, 1, __frame, function __$site_doSitesGet__15() {
      log.verbose("Subscription", options.subscription);
      ...
      return site.doSpacesGet(options, __cb(_, __frame, 3, 17, function ___(__0, __2) { spaces = __2;
        ...
        progress = cli.progress("Enumerating sites"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$site_doSitesGet__15() {
              ...
              return async.map(spaces, function __1(webspace, _) { var __frame = { name: "__1", line: 910 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
  ...
  site.doRepositoryGet = function site_doRepositoryGet__16(options, _) { var siteData; var __frame = { name: "site_doRepositoryGet__16", line: 987 }; return __func(_, this, arguments, site_doRepositoryGet__16, 1, __frame, function __$site_doRepositoryGet__16() {
  ...
  site.doPublishingUsersGet = function site_doPublishingUsersGet__17(options, _) { var progress, publishingUsers; var __frame = { name: "site_doPublishingUsersGet__17", line: 992 }; return __func(_, this, arguments, site_doPublishingUsersGet__17, 1, __frame, function __$site_doPublishingUsersGet__17() {
