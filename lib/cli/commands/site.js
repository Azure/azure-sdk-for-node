...
exports.init = function(cli) {
  ...
  site.command("create [name]").whiteListPowershell().description("Create a new web site").option("-s, --subscription <id>", "use the subscription id").option("--location <location>", "the geographic region to create the website").option("--hostname <hostname>", "custom host name to use").option("--git", "configure git on web site and local folder").option("--github", "configure github on web site and local folder").option("-u, --username <user>", "The username").option("-up, --pass <pass>", "The password").execute(function __2(nameArg, options, _) { var context;
    ...
    function promptForSiteName(_) { var __frame = { name: "promptForSiteName", line: 171 }; return __func(_, this, arguments, promptForSiteName, 0, __frame, function __$promptForSiteName() {
    ...
    function determineIfSiteExists(_) { var sites, hits; var __frame = { name: "determineIfSiteExists", line: 179 }; return __func(_, this, arguments, determineIfSiteExists, 0, __frame, function __$determineIfSiteExists() {
    ...
    function promptForLocation(_) { var spaces, displayNameMatches; var __frame = { name: "promptForLocation", line: 198 }; return __func(_, this, arguments, promptForLocation, 0, __frame, function __$promptForLocation() {
    ...
    function promptForGithubCredentials(_) { var __frame = { name: "promptForGithubCredentials", line: 235 }; return __func(_, this, arguments, promptForGithubCredentials, 0, __frame, function __$promptForGithubCredentials() {
    ...
    function copyIisNodeWhenServerJsPresent(_) { var sourcePath; var __frame = { name: "copyIisNodeWhenServerJsPresent", line: 254 }; return __func(_, this, arguments, copyIisNodeWhenServerJsPresent, 0, __frame, function __$copyIisNodeWhenServerJsPresent() {
    ...
    function updateLocalConfigWithSiteName(_) { var cfg; var __frame = { name: "updateLocalConfigWithSiteName", line: 263 }; return __func(_, this, arguments, updateLocalConfigWithSiteName, 0, __frame, function __$updateLocalConfigWithSiteName() {
    ...
    function createSite(_) { var __frame = { name: "createSite", line: 273 }; return __func(_, this, arguments, createSite, 0, __frame, function __$createSite() {
    ...
    function initializeRemoteRepo(_) { var __frame = { name: "initializeRemoteRepo", line: 280 }; return __func(_, this, arguments, initializeRemoteRepo, 0, __frame, function __$initializeRemoteRepo() {
    ...
    function addRemoteToLocalGitRepo(_) { var remotes, azureExists, gitUri; var __frame = { name: "addRemoteToLocalGitRepo", line: 296 }; return __func(_, this, arguments, addRemoteToLocalGitRepo, 0, __frame, function __$addRemoteToLocalGitRepo() {
        ...
        if (!context.flags.isGitWorkingTree) {
          ...
          return exec("git remote", __cb(_, __frame, 12, 26, function ___(__0, __3) { remotes = __3;
            azureExists = ((remotes.stdout + remotes.stderr)).split("\n").some(function(item) {
              ...
              return exec(("git remote add azure " + gitUri), __cb(_, __frame, 24, 12, _, true)); }); }, true)); }); }); }; var __frame = { name: "__2", line: 125 }; return __func(_, this, arguments, __2, 2, __frame, function __$__2() { context = { subscription: cli.category("account").lookupSubscriptionId(options.subscription), git: options.git, site: { name: nameArg, webspace: options.location, hostname: options.hostname }, flags: { } }; if ((options.git && options.github)) { return _(new Error("Please run the command with either --git or --github options. Not both.")); } ; return promptForSiteName(__cb(_, __frame, 17, 10, function __$__2() { return determineIfSiteExists(__cb(_, __frame, 18, 10, function __$__2() { return promptForLocation(__cb(_, __frame, 19, 10, function __$__2() { return (function __$__2(__then) { if ((options.git || options.github)) { return (function __$__2(__then) { if (options.github) { return promptForGithubCredentials(__cb(_, __frame, 23, 14, __then, true)); } else { if (options.git) { context.lvcClient = LinkedRevisionControl.createClient(cli, "git"); } ; __then(); } ; })(__then); } else { __then(); } ; })(function __$__2() { return (function __$__2(__then) { if (context.lvcClient) { return context.lvcClient.init(context, __cb(_, __frame, 30, 12, __then, true)); } else { __then(); } ; })(function __$__2() { return copyIisNodeWhenServerJsPresent(__cb(_, __frame, 33, 10, function __$__2() { return updateLocalConfigWithSiteName(__cb(_, __frame, 34, 10, function __$__2() { return createSite(__cb(_, __frame, 35, 10, function __$__2() { return (function __$__2(__then) { if (context.lvcClient) { return (function __$__2(__then) { if (options.git) { return initializeRemoteRepo(__cb(_, __frame, 39, 14, function __$__2() { return addRemoteToLocalGitRepo(__cb(_, __frame, 40, 14, __then, true)); }, true)); } else { __then(); } ; })(function __$__2() { return context.lvcClient.deploy(context, __cb(_, __frame, 43, 12, __then, true)); }); } else { __then(); } ; })(_); }, true)); }, true)); }, true)); }); }); }, true)); }, true)); }, true)); }); });



  function portalCreateSiteInstruction(context, _) { var href; var __frame = { name: "portalCreateSiteInstruction", line: 324 }; return __func(_, this, arguments, portalCreateSiteInstruction, 1, __frame, function __$portalCreateSiteInstruction() {
  ...
  function getPublishingUser(context, _) { var publishingUsers, filters; var __frame = { name: "getPublishingUser", line: 343 }; return __func(_, this, arguments, getPublishingUser, 1, __frame, function __$getPublishingUser() {
  ...
  function portalGitInitInstruction(context, _) { var href; var __frame = { name: "portalGitInitInstruction", line: 361 }; return __func(_, this, arguments, portalGitInitInstruction, 1, __frame, function __$portalGitInitInstruction() {
  ...
  location.command("list").whiteListPowershell().description("List locations available for your account").execute(function __3(options, _) { var context, spaces, s; var __frame = { name: "__3", line: 384 }; return __func(_, this, arguments, __3, 1, __frame, function __$__3() {
  ...
  site.command("portal [name]").whiteListPowershell().description("Opens the portal in a browser to manage your web sites").option("-r, --realm <realm>", "specifies organization used for login").execute(function __4(name, options, _) { var href; var __frame = { name: "__4", line: 407 }; return __func(_, this, arguments, __4, 2, __frame, function __$__4() {
  ...
  site.command("browse [name]").whiteListPowershell().description("Open your web site in a browser.").option("-s, --subscription <id>", "use the subscription id").execute(function __5(name, options, _) { var context, cache, siteData, href; var __frame = { name: "__5", line: 427 }; return __func(_, this, arguments, __5, 2, __frame, function __$__5() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 9, 22, function ___(__0, __2) { cache = __2; return (function __$__5(_) {
          var __1 = cache; if (__1) { return _(null, __1); } ; return site.doSiteGet(context, __cb(_, __frame, 10, 40, _, true)); })(__cb(_, __frame, -426, 17, function ___(__0, __3) { siteData = clean(__3);
  ...
  site.command("show [name]").whiteListPowershell().description("Show details for a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __6(name, options, _) { var context, result, repositoryUri, gitUri, settings, data, index; var __frame = { name: "__6", line: 448 }; return __func(_, this, arguments, __6, 2, __frame, function __$__6() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 8, 10, function __$__6() {
        ...
        return async.parallel([function __1(_) { var __frame = { name: "__1", line: 462 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
            return site.doSiteGet(context, __cb(_, __frame, 0, 34, _, true)); });
        },function __2(_) { var __frame = { name: "__2", line: 463 }; return __func(_, this, arguments, __2, 0, __frame, function __$__2() { return site.doSiteConfigGet(context, __cb(_, __frame, 0, 34, _, true)); }); },], __cb(_, __frame, 13, 23, function ___(__0, __3) { result = __3;
  ...
  function lookupSiteName(context, _) { var cfg; var __frame = { name: "lookupSiteName", line: 495 }; return __func(_, this, arguments, lookupSiteName, 1, __frame, function __$lookupSiteName() {
  ...
  function lookupSiteWebSpace(context, _) { var sites, index; var __frame = { name: "lookupSiteWebSpace", line: 516 }; return __func(_, this, arguments, lookupSiteWebSpace, 1, __frame, function __$lookupSiteWebSpace() {
  ...
  function lookupSiteNameAndWebSpace(context, _) { var cache; var __frame = { name: "lookupSiteNameAndWebSpace", line: 530 }; return __func(_, this, arguments, lookupSiteNameAndWebSpace, 1, __frame, function __$lookupSiteNameAndWebSpace() {
  ...
  site.command("delete [name]").whiteListPowershell().description("Delete a web site").option("-s, --subscription <id>", "use the subscription id").option("-q, --quiet", "quiet mode, do not ask for delete confirmation").execute(function __7(name, options, _) { var context, progress, result; var __frame = { name: "__7", line: 609 }; return __func(_, this, arguments, __7, 2, __frame, function __$__7() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 8, 10, function __$__7() {
        ...
        log.info("Deleting site", context.site.name); return (function __$__7(_) {
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return confirm((("Delete " + context.site.name) + " site?  (y/n) "), __cb(_, __frame, 11, 33, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -608, 17, function ___(__0, __2) { return (function __$__7(__then) { if (__2) { return _(null); } else { __then(); } ; })(function __$__7() {
  ...
  site.command("start [name]").whiteListPowershell().description("Start a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __8(name, options, _) { var context, progress, result; var __frame = { name: "__8", line: 647 }; return __func(_, this, arguments, __8, 2, __frame, function __$__8() {
  ...
  site.command("stop [name]").whiteListPowershell().description("Stop a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __9(name, options, _) { var context, progress, result; var __frame = { name: "__9", line: 698 }; return __func(_, this, arguments, __9, 2, __frame, function __$__9() {
  ...
  site.readConfig = function site_readConfig__10(_) { var __frame = { name: "site_readConfig__10", line: 749 }; return __func(_, this, arguments, site_readConfig__10, 0, __frame, function __$site_readConfig__10() {
  ...
  site.writeConfig = function site_writeConfig__11(cfg, _) { var __frame = { name: "site_writeConfig__11", line: 756 }; return __func(_, this, arguments, site_writeConfig__11, 1, __frame, function __$site_writeConfig__11() {
  ...
  site.readConfigValue = function site_readConfigValue__12(name, _) { var result; var __frame = { name: "site_readConfigValue__12", line: 761 }; return __func(_, this, arguments, site_readConfigValue__12, 1, __frame, function __$site_readConfigValue__12() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$site_readConfigValue__12() {
  ...
  site.writeConfigValue = function site_writeConfigValue__13(name, value, _) { var __frame = { name: "site_writeConfigValue__13", line: 772 }; return __func(_, this, arguments, site_writeConfigValue__13, 2, __frame, function __$site_writeConfigValue__13() {
  ...
  site.doSpacesGet = function site_doSpacesGet__14(options, _) { var progress, result, spaces; var __frame = { name: "site_doSpacesGet__14", line: 870 }; return __func(_, this, arguments, site_doSpacesGet__14, 1, __frame, function __$site_doSpacesGet__14() {
      log.verbose("Subscription", options.subscription);
  ...
  site.doSitesGet = function site_doSitesGet__15(options, _) { var spaces, channel, progress, result, sites; var __frame = { name: "site_doSitesGet__15", line: 892 }; return __func(_, this, arguments, site_doSitesGet__15, 1, __frame, function __$site_doSitesGet__15() {
      log.verbose("Subscription", options.subscription);
      ...
      return site.doSpacesGet(options, __cb(_, __frame, 3, 17, function ___(__0, __2) { spaces = __2;
        ...
        progress = cli.progress("Enumerating sites"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$site_doSitesGet__15() {
              ...
              return async.map(spaces, function __1(webspace, _) { var __frame = { name: "__1", line: 906 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
  ...
  site.doRepositoryGet = function site_doRepositoryGet__16(options, _) { var siteData; var __frame = { name: "site_doRepositoryGet__16", line: 983 }; return __func(_, this, arguments, site_doRepositoryGet__16, 1, __frame, function __$site_doRepositoryGet__16() {
  ...
  site.doPublishingUsersGet = function site_doPublishingUsersGet__17(options, _) { var progress, publishingUsers; var __frame = { name: "site_doPublishingUsersGet__17", line: 988 }; return __func(_, this, arguments, site_doPublishingUsersGet__17, 1, __frame, function __$site_doPublishingUsersGet__17() {
