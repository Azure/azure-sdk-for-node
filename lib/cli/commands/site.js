...
/*   660 */       return getChannel().path(options.subscription).path("services").path("webspaces").path("?properties=publishingUsers").GET(__cb(_, __frame, 6, 36, function ___(__0, __1) {
