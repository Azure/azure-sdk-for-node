...
exports.init = function(cli) {
  ...
  scm.command("github [name]").whiteListPowershell().usage("[options]").description("Redeploy your git deployment").execute(function __4(nameArg, options, _) { var context;
    ...
    function linkRemoteGitRepo(_) { var parsedRepositoryUri, hookUrl, hooks, existingHook; var __frame = { name: "linkRemoteGitRepo", line: 247 }; return __func(_, this, arguments, linkRemoteGitRepo, 0, __frame, function __$linkRemoteGitRepo() {
  ...
  scm.doGetHooks = function scm_doGetHooks__6(context, _) { var progress; var __frame = { name: "scm_doGetHooks__6", line: 293 }; return __func(_, this, arguments, scm_doGetHooks__6, 1, __frame, function __$scm_doGetHooks__6() {
      progress = cli.progress("Retrieving website hooks"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$scm_doGetHooks__6() {


            return context.github.repos.getHooks({
              user: context.repository.owner.login,
              repo: context.repository.name }, __cb(_, __frame, 4, 13, _, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$scm_doGetHooks__6() {
  ...
  scm.doGetGitOriginUri = function scm_doGetGitOriginUri__7(context, _) { var progress, originUri, remotes, origin; var __frame = { name: "scm_doGetGitOriginUri__7", line: 306 }; return __func(_, this, arguments, scm_doGetGitOriginUri__7, 1, __frame, function __$scm_doGetGitOriginUri__7() {
      progress = cli.progress("Retrieving local git repositories");
      originUri = null; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$scm_doGetGitOriginUri__7() {
            ...
            return exec("git remote -v", __cb(_, __frame, 5, 20, function ___(__0, __1) { remotes = __1;
              ...
              if ((origin && (origin.length > 0))) {
                originUri = origin[0].split("	")[1].split(" ")[0]; } ; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$scm_doGetGitOriginUri__7() {


              progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$scm_doGetGitOriginUri__7() {


          return _(null, originUri); }); }); }); };


  scm.doGetRepositories = function scm_doGetRepositories__8(context, _) { var progress, userRepos, orgs, i, org; var __frame = { name: "scm_doGetRepositories__8", line: 328 }; return __func(_, this, arguments, scm_doGetRepositories__8, 1, __frame, function __$scm_doGetRepositories__8() {
      progress = cli.progress("Retrieving repositories");
      userRepos = []; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$scm_doGetRepositories__8() {
            ...
            return context.github.repos.getFromUser({ user: context.username }, __cb(_, __frame, 5, 18, function ___(__0, __3) { userRepos = __3;
              return context.github.user.getOrgs({ user: context.username }, __cb(_, __frame, 6, 17, function ___(__0, __4) { orgs = __4;
                var __1 = __forIn(orgs); var __2 = 0; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$scm_doGetRepositories__8() { __more = false; var __8 = (__2 < __1.length); if (__8) { i = __1[__2++]; return (function __$scm_doGetRepositories__8(__then) {
                        if (orgs.hasOwnProperty(i)) {
                          org = orgs[i]; return (function __$scm_doGetRepositories__8(__then) {
                            if (org.login) {
                              return context.github.repos.getFromOrg({ org: org.login }, __cb(_, __frame, 11, 20, function ___(__0, __5) { repos = __5;

                                userRepos = userRepos.concat(repos); __then(); }, true)); } else { __then(); } ; })(__then); } else { __then(); } ; })(function __$scm_doGetRepositories__8() { while (__more) { __loop(); }; __more = true; }); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(function __$scm_doGetRepositories__8() { _(null, null, true); }); }, true)); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$scm_doGetRepositories__8() {




              progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$scm_doGetRepositories__8() {


          return _(null, userRepos); }); }); }); };


  scm.doDeploymentsGet = function scm_doDeploymentsGet__9(context, _) { var maxItems, channel, progress, deployments; var __frame = { name: "scm_doDeploymentsGet__9", line: 352 }; return __func(_, this, arguments, scm_doDeploymentsGet__9, 1, __frame, function __$scm_doDeploymentsGet__9() {
      ...
      progress = cli.progress("Enumerating deployments"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$scm_doDeploymentsGet__9() {

            return channel.GET(__cb(_, __frame, 13, 44, function ___(__0, __1) { deployments = ensureShortCommitId(__1);
              return cacheUtils.saveCommitIds(context, deployments, __cb(_, __frame, 14, 6, function __$scm_doDeploymentsGet__9() {
                return _(null, deployments.map(formatDeployment)); }, true)); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$scm_doDeploymentsGet__9() {

              progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, _); }); }); };



  scm.doDeploymentGet = function scm_doDeploymentGet__10(context, _) { var channel, progress; var __frame = { name: "scm_doDeploymentGet__10", line: 373 }; return __func(_, this, arguments, scm_doDeploymentGet__10, 1, __frame, function __$scm_doDeploymentGet__10() {


      channel = getScmChannel(context).path("deployments").path(context.id);
      progress = cli.progress("Retrieving deployment info"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$scm_doDeploymentGet__10() {

            return channel.GET(__cb(_, __frame, 6, 30, function ___(__0, __2) { var __1 = formatDeployment(__2); return _(null, __1); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$scm_doDeploymentGet__10() {

              progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, _); }); }); };



  scm.doDeploymentPut = function scm_doDeploymentPut__11(context, _) { var channel, progress; var __frame = { name: "scm_doDeploymentPut__11", line: 385 }; return __func(_, this, arguments, scm_doDeploymentPut__11, 1, __frame, function __$scm_doDeploymentPut__11() {


      channel = getScmChannel(context).path("deployments").path(context.id);
      progress = cli.progress("Redeploying deployment"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$scm_doDeploymentPut__11() {

            return channel.PUT(null, __cb(_, __frame, 6, 13, _, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$scm_doDeploymentPut__11() {

              progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, _); }); }); };



  scm.doLogGet = function scm_doLogGet__12(context, _) { var channel, progress, logs; var __frame = { name: "scm_doLogGet__12", line: 397 }; return __func(_, this, arguments, scm_doLogGet__12, 1, __frame, function __$scm_doLogGet__12() {



      channel = getScmChannel(context).path("deployments").path(context.id).path("log");
      progress = cli.progress("Retrieving deployment log info"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$scm_doLogGet__12() {

            return channel.GET(__cb(_, __frame, 7, 17, function ___(__0, __1) { logs = __1;
              return _(null, logs.map(formatLog)); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$scm_doLogGet__12() {

              progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, _); }); }); };



  function listDeployments(context, _) { var deployments, authorLength, messageLength; var __frame = { name: "listDeployments", line: 411 }; return __func(_, this, arguments, listDeployments, 1, __frame, function __$listDeployments() {
  ...
  function getLogDetails(context, _) { var results, logs, progress, i; var __frame = { name: "getLogDetails", line: 429 }; return __func(_, this, arguments, getLogDetails, 1, __frame, function __$getLogDetails() {
      ...
      return scm.doLogGet(context, __cb(_, __frame, 2, 15, function ___(__0, __2) { logs = __2; return (function __$getLogDetails(__then) {
          if ((logs && logs.length)) {
            progress = cli.progress("Retrieving log details"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$getLogDetails() {
                  ...
                  return async.map(logs, function __1(log, _) { var details; var __frame = { name: "__1", line: 435 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() { return (function __$__1(__then) {
                        if (log.hasDetails) {
  ...
  function ensureRepositoryUri(context, _) { var siteData, repositoryUri; var __frame = { name: "ensureRepositoryUri", line: 528 }; return __func(_, this, arguments, ensureRepositoryUri, 1, __frame, function __$ensureRepositoryUri() {
