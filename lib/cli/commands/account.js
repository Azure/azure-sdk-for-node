  ...
  account.command('import <file>')
        ...
        .execute(function (file, options, callback) {
          ...
          function processSettings(file, settings) {
            if (!settings.PublishProfile || !settings.PublishProfile.ManagementCertificate) {
              throw new Error('Wrong format of the publishSettings file. Make sure you use "azure account download" to get your publish settings file instead of getting it directly from the portal.');
            }
