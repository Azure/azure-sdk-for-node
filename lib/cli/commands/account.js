...
exports.init = function (cli) {
  ...
  account.command('set <subscription>')
    ...
    .execute(function (subscription, options, callback) {
      ...
      var filtered = subscriptions.filter(function (subscription) { return subscription.Name === subscription });
      if (!filtered.length) {
        // If nothing was found try matching on Id
        importByName = false;
        filtered = subscriptions.filter(function (subscription) { return subscription.Id === subscription });
