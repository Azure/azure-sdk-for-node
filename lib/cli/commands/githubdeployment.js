    ...
    function promptForGithubCredentials(_) { var __frame = { name: "promptForGithubCredentials", line: 49 }; return __func(_, this, arguments, promptForGithubCredentials, 0, __frame, function __$promptForGithubCredentials() {
        log.help("Enter your github credentials"); return (function __$promptForGithubCredentials(__then) {
          ...
          if (options.username) {
            ...
            return context.lvcClient.authenticate(context.username, context.password, __cb(_, __frame, 16, 8, _, true)); }); }); }); }; var __frame = { name: "__1", line: 33 }; return __func(_, this, arguments, __1, 2, __frame, function __$__1() { context = { subscription: cli.category("account").lookupSubscriptionId(options.subscription), site: { name: name } }; return scm.ensureRepositoryUri(context, __cb(_, __frame, 9, 6, function __$__1() { return promptForGithubCredentials(__cb(_, __frame, 10, 6, function __$__1() { context.flags = { forceRepositorySelection: true }; return context.lvcClient.init(context, __cb(_, __frame, 13, 6, function __$__1() { return context.lvcClient.deploy(context, __cb(_, __frame, 14, 6, _, true)); }, true)); }, true)); }, true)); }); });
