...
exports.init = function(cli) {
  ...
  diagnostic.command("tail [name]").whiteListPowershell().description("Live diagnostic log").option("-s, --subscription <id>", "use the subscription id").option("-p, --path <path>", "the log path under LogFiles folder").execute(function __2(name, options, _) { var context, repositoryUri, buf; var __frame = { name: "__2", line: 79 }; return __func(_, this, arguments, __2, 2, __frame, function __$__2() {
