...
exports.vhdCreatorApplication = 'azur';
...
var getVHDInfo = 
  ...
  vhdInfo.getReadStream = function(streamOptions) {
    ...
    process.nextTick(function() {createNextStream(block0, startPosWithinBlock0);});
    ...
    function createNextStream(block, startPosWithinBlock) {
      ...
      startPosWithinBlock = startPosWithinBlock || 0; // this walue is used only on the first call
      block--;
