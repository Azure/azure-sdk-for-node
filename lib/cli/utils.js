...
exports.portal = function() {
  return 'https://' + (process.env.AZURE_PORTAL || 'windows.azure-test.net') + '/';
};
...
exports.createServiceManagementService = function(subscriptionId, account, logger) {
  ...
  return azure.createServiceManagementService(subscriptionId, {
    ...
    port: process.env.AZURE_ENDPOINT_PORT || account.endpointPort() || constants.Constants.DEFAULT_HTTPS_PORT,
...
exports.validateEndpoint = function (endpoint) {
  ...
  return { endpointHost: parts.hostname, endpointPort: parseInt(parts.port, 10) };
};
