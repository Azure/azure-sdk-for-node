...
exports.createServiceManagementService = function(subscriptionId, account, logger) {
  ...
  return azure.createServiceManagementService(subscriptionId, {
    ...
    host: process.env.AZURE_ENDPOINT_HOST || account.endpointHost() || 'management-preview.core.windows-int.net',
    port: process.env.AZURE_ENDPOINT_PORT || account.endpointPort() || 443,
