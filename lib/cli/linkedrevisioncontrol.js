...
GithubClient.prototype.authenticate = function GithubClient_prototype_authenticate__5(username, password, _) { var __this = this; var __frame = { name: "GithubClient_prototype_authenticate__5", line: 104 }; return __func(_, this, arguments, GithubClient_prototype_authenticate__5, 2, __frame, function __$GithubClient_prototype_authenticate__5() {
    __this.username = username;
    __this.password = password; _(); });};


GithubClient.prototype.authenticateAuth = function GithubClient_prototype_authenticateAuth__6(_) { var oauthToken, __this = this; var __frame = { name: "GithubClient_prototype_authenticateAuth__6", line: 109 }; return __func(_, this, arguments, GithubClient_prototype_authenticateAuth__6, 0, __frame, function __$GithubClient_prototype_authenticateAuth__6() {
    ...
    return __this.client.oauth.createAuthorization({ user: __this.username }, __cb(_, __frame, 8, 19, function ___(__0, __1) { oauthToken = __1;
      __this.client.authenticate({
        type: "oauth",
...
GithubClient.prototype.init = function GithubClient_prototype_init__7(context, _) { var repositories, parsedRepositoryUri, pathParts, owner, name, localRepositories, __this = this; var __frame = { name: "GithubClient_prototype_init__7", line: 124 }; return __func(_, this, arguments, GithubClient_prototype_init__7, 1, __frame, function __$GithubClient_prototype_init__7() {
            ...
            if ((!context.flags.forceRepositorySelection && context.remoteUri)) {
              ...
              if ((pathParts.length === 3)) {
                ...
                if ((localRepositories && (localRepositories.length > 0))) {
                  context.repository = localRepositories[0]; } ; } ; } ; return (function __$GithubClient_prototype_init__7(__then) {
...
GithubClient.prototype.deploy = function GithubClient_prototype_deploy__8(context, _) { var parsedRepositoryUri, hookUrl, parsedCloneUrl, gitUri, __this = this; var __frame = { name: "GithubClient_prototype_deploy__8", line: 155 }; return __func(_, this, arguments, GithubClient_prototype_deploy__8, 1, __frame, function __$GithubClient_prototype_deploy__8() {
    __this.authenticateAuth();
    ...
    return context.lvcClient.createOrUpdateHook(context.repository.owner.login, context.repository.name, hookUrl, __cb(_, __frame, 7, 2, function __$GithubClient_prototype_deploy__8() {
      ...
      gitUri = url.format(parsedCloneUrl); return (function __$GithubClient_prototype_deploy__8(__then) {
        if ((context.remoteUri && (context.remoteUri.toLowerCase() !== gitUri.toLowerCase()))) {
          ...
          return __this._exec("git remote rm azure", __cb(_, __frame, 17, 4, function __$GithubClient_prototype_deploy__8() {
          ...
          if (!context.remoteUri) {
            ...
            return __this._exec(("git remote add azure " + gitUri), __cb(_, __frame, 24, 4, __then, true)); } else { __then(); } ; })(_); }); }, true)); });};



GithubClient.prototype.getRepositories = function GithubClient_prototype_getRepositories__9(username, _) { var progress, userRepos, orgs, orgRepos, i, org, __this = this;
  ...
  function filterPrivate(repository) {
    return (repository["private"] !== true); }; var __frame = { name: "GithubClient_prototype_getRepositories__9", line: 183 }; return __func(_, this, arguments, GithubClient_prototype_getRepositories__9, 1, __frame, function __$GithubClient_prototype_getRepositories__9() { progress = __this.cli.progress("Retrieving repositories"); userRepos = []; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$GithubClient_prototype_getRepositories__9() {



          return __this.authenticateAuth(__cb(_, __frame, 14, 4, function __$GithubClient_prototype_getRepositories__9() {
            return __this.client.repos.getFromUser({ user: username }, __cb(_, __frame, 15, 16, function ___(__0, __3) { userRepos = __3.filter(filterPrivate).sort(sortFunction);



              return __this.client.orgs.getFromUser({ user: username }, __cb(_, __frame, 19, 15, function ___(__0, __4) { orgs = __4; return (function __$GithubClient_prototype_getRepositories__9(__then) {
                  if (orgs) {
                    orgRepos = [];
                    var __1 = __forIn(orgs); var __2 = 0; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$GithubClient_prototype_getRepositories__9() { __more = false; var __9 = (__2 < __1.length); if (__9) { i = __1[__2++]; return (function __$GithubClient_prototype_getRepositories__9(__then) {
                            if (orgs.hasOwnProperty(i)) {
                              org = orgs[i]; return (function __$GithubClient_prototype_getRepositories__9(__then) {
                                if (org.login) {
                                  return __this.client.repos.getFromOrg({ org: org.login }, __cb(_, __frame, 26, 20, function ___(__0, __5) { repos = __5;
                  ...
                  userRepos = userRepos.concat(orgRepos); _(null, null, true); }); }, true)); }, true)); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$GithubClient_prototype_getRepositories__9() {
...
GithubClient.prototype.createHook = function GithubClient_prototype_createHook__11(hook, _) { var progress, __this = this; var __frame = { name: "GithubClient_prototype_createHook__11", line: 270 }; return __func(_, this, arguments, GithubClient_prototype_createHook__11, 1, __frame, function __$GithubClient_prototype_createHook__11() {
    progress = __this.cli.progress("Creating new hook"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$GithubClient_prototype_createHook__11() {
          ...
          return __this.authenticateAuth(__cb(_, __frame, 4, 4, function __$GithubClient_prototype_createHook__11() {
            return __this.client.repos.createHook(hook, __cb(_, __frame, 5, 11, _, true)); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$GithubClient_prototype_createHook__11() {
...
GithubClient.prototype.updateHook = function GithubClient_prototype_updateHook__12(hook, _) { var progress, __this = this; var __frame = { name: "GithubClient_prototype_updateHook__12", line: 281 }; return __func(_, this, arguments, GithubClient_prototype_updateHook__12, 1, __frame, function __$GithubClient_prototype_updateHook__12() {
    progress = __this.cli.progress("Updating hook"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$GithubClient_prototype_updateHook__12() {
          ...
          return __this.authenticateAuth(__cb(_, __frame, 4, 4, function __$GithubClient_prototype_updateHook__12() {
            return __this.client.repos.updateHook(hook, __cb(_, __frame, 5, 11, _, true)); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$GithubClient_prototype_updateHook__12() {

            progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, _); }); });};



GithubClient.prototype.testHook = function GithubClient_prototype_testHook__13(hook, _) { var progress, __this = this; var __frame = { name: "GithubClient_prototype_testHook__13", line: 292 }; return __func(_, this, arguments, GithubClient_prototype_testHook__13, 1, __frame, function __$GithubClient_prototype_testHook__13() {
    progress = __this.cli.progress("Testing new hook"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$GithubClient_prototype_testHook__13() {
          ...
          return __this.authenticateAuth(__cb(_, __frame, 4, 4, function __$GithubClient_prototype_testHook__13() {
            return __this.client.repos.testHook(hook, __cb(_, __frame, 5, 4, function __$GithubClient_prototype_testHook__13() { _(null, null, true); }, true)); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$GithubClient_prototype_testHook__13() {

            progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, _); }); });};



GithubClient.prototype.getHooks = function GithubClient_prototype_getHooks__14(username, repository, _) { var progress, __this = this; var __frame = { name: "GithubClient_prototype_getHooks__14", line: 303 }; return __func(_, this, arguments, GithubClient_prototype_getHooks__14, 2, __frame, function __$GithubClient_prototype_getHooks__14() {
    progress = __this.cli.progress("Retrieving website hooks"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$GithubClient_prototype_getHooks__14() {
          ...
          return __this.authenticateAuth(__cb(_, __frame, 4, 4, function __$GithubClient_prototype_getHooks__14() {
            return __this.client.repos.getHooks({
              user: username,
              repo: repository }, __cb(_, __frame, 5, 11, _, true)); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$GithubClient_prototype_getHooks__14() {
