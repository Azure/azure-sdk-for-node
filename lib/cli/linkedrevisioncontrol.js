...
LinkedRevisionControlClient.prototype.initGitOnCurrentDirectory = function LinkedRevisionControlClient_prototype_initGitOnCurrentDirectory__2(context, scaffold, _) { var __this = this; var __frame = { name: "LinkedRevisionControlClient_prototype_initGitOnCurrentDirectory__2", line: 77 }; return __func(_, this, arguments, LinkedRevisionControlClient_prototype_initGitOnCurrentDirectory__2, 2, __frame, function __$LinkedRevisionControlClient_prototype_initGitOnCurrentDirectory__2() {
...
GitClient.prototype.init = function GitClient_prototype_init__3(context, _) { var __this = this; var __frame = { name: "GitClient_prototype_init__3", line: 109 }; return __func(_, this, arguments, GitClient_prototype_init__3, 1, __frame, function __$GitClient_prototype_init__3() {
...
GitClient.prototype.deploy = function GitClient_prototype_deploy__4(context, _) { var __frame = { name: "GitClient_prototype_deploy__4", line: 114 }; return __func(_, this, arguments, GitClient_prototype_deploy__4, 1, __frame, _);};
...
GithubClient.prototype.authenticate = function GithubClient_prototype_authenticate__5(username, password, _) { var __this = this; var __frame = { name: "GithubClient_prototype_authenticate__5", line: 126 }; return __func(_, this, arguments, GithubClient_prototype_authenticate__5, 2, __frame, function __$GithubClient_prototype_authenticate__5() {
...
GithubClient.prototype.authenticateAuth = function GithubClient_prototype_authenticateAuth__6(username, password, _) { var oauthToken, __this = this; var __frame = { name: "GithubClient_prototype_authenticateAuth__6", line: 134 }; return __func(_, this, arguments, GithubClient_prototype_authenticateAuth__6, 2, __frame, function __$GithubClient_prototype_authenticateAuth__6() {
    __this.client.authenticate({
      type: "basic",
      username: username,
      password: password });
    ...
    return __this.client.oauth.createAuthorization({ user: username }, __cb(_, __frame, 8, 19, function ___(__0, __1) { oauthToken = __1;
      __this.client.authenticate({
        type: "oauth",
...
GithubClient.prototype.init = function GithubClient_prototype_init__7(context, _) { var repositories, __this = this; var __frame = { name: "GithubClient_prototype_init__7", line: 149 }; return __func(_, this, arguments, GithubClient_prototype_init__7, 1, __frame, function __$GithubClient_prototype_init__7() {
    return __this.determineIfCurrentDirectoryIsGitWorkingTree(context, __cb(_, __frame, 1, 2, function __$GithubClient_prototype_init__7() {
      return __this.initGitOnCurrentDirectory(context, false, __cb(_, __frame, 2, 2, function __$GithubClient_prototype_init__7() {
        ...
        return __this.getRepositories(context.username, __cb(_, __frame, 4, 21, function ___(__0, __1) { repositories = __1; return (function __$GithubClient_prototype_init__7(__then) {
            ...
            if (context.remoteUri) {
              context.repository = LinkedRevisionControlClient.getRepository(repositories, context.remoteUri); } ; return (function __$GithubClient_prototype_init__7(__then) {
              ...
              if ((((context.flags && context.flags.forceRepositorySelection)) || !context.repository)) {
                ...
                return choose(__this.cli, repositories.map(function(repository) {
                  return repository.full_name; }), __cb(_, __frame, 18, 38, function ___(__0, __3) { context.repository = repositories[__3]; __then(); }, true)); } else { __then(); } ; })(_); }); }, true)); }, true)); }, true)); });};




GithubClient.prototype.deploy = function GithubClient_prototype_deploy__8(context, _) { var parsedRepositoryUri, hookUrl, parsedCloneUrl, gitUri, azureRemote, __this = this; var __frame = { name: "GithubClient_prototype_deploy__8", line: 173 }; return __func(_, this, arguments, GithubClient_prototype_deploy__8, 1, __frame, function __$GithubClient_prototype_deploy__8() {
    ...
    return context.lvcClient.createOrUpdateHook(context.repository.owner.login, context.repository.name, hookUrl, __cb(_, __frame, 5, 2, function __$GithubClient_prototype_deploy__8() {
...
GithubClient.prototype.getRepositories = function GithubClient_prototype_getRepositories__9(username, _) { var progress, userRepos, orgs, orgRepos, i, org, repos, __this = this;
  ...
  function filterPrivate(repository) {
    return (repository["private"] !== true); }; var __frame = { name: "GithubClient_prototype_getRepositories__9", line: 204 }; return __func(_, this, arguments, GithubClient_prototype_getRepositories__9, 1, __frame, function __$GithubClient_prototype_getRepositories__9() { progress = __this.cli.progress("Retrieving repositories"); userRepos = []; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$GithubClient_prototype_getRepositories__9() {
          ...
          return __this.client.repos.getFromUser({ user: username }, __cb(_, __frame, 14, 16, function ___(__0, __3) { userRepos = __3.filter(filterPrivate).sort(sortFunction);
            ...
            return __this.client.orgs.getFromUser({ user: username }, __cb(_, __frame, 18, 15, function ___(__0, __4) { orgs = __4; return (function __$GithubClient_prototype_getRepositories__9(__then) {
                if (orgs) {
                  orgRepos = [];
                  var __1 = __forIn(orgs); var __2 = 0; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$GithubClient_prototype_getRepositories__9() { __more = false; var __8 = (__2 < __1.length); if (__8) { i = __1[__2++]; return (function __$GithubClient_prototype_getRepositories__9(__then) {
                ...
                userRepos = userRepos.concat(orgRepos); _(null, null, true); }); }, true)); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$GithubClient_prototype_getRepositories__9() {

            progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$GithubClient_prototype_getRepositories__9() {


        return _(null, userRepos); }); }); });};


GithubClient.prototype.createOrUpdateHook = function GithubClient_prototype_createOrUpdateHook__10(username, repository, deployUri, _) { var hook, hooks, parsedDeployUri, existingHook, __this = this; var __frame = { name: "GithubClient_prototype_createOrUpdateHook__10", line: 246 }; return __func(_, this, arguments, GithubClient_prototype_createOrUpdateHook__10, 3, __frame, function __$GithubClient_prototype_createOrUpdateHook__10() {
    hook = {
      name: "web",
      user: username,
      repo: repository,
    ...
    return __this.getHooks(username, repository, __cb(_, __frame, 14, 14, function ___(__0, __1) { hooks = __1;
      ...
      existingHook = hooks.filter(function(hook) { if (hook.config) { return ((hook.name === "web") && (url.parse(hook.config.url).hostname.toLowerCase() === parsedDeployUri.hostname.toLowerCase())); } ; return false; })[0]; return (function __$GithubClient_prototype_createOrUpdateHook__10(__then) {

        if (existingHook) { return (function __$GithubClient_prototype_createOrUpdateHook__10(__then) {
...
GithubClient.prototype.createHook = function GithubClient_prototype_createHook__11(hook, _) { var progress, __this = this; var __frame = { name: "GithubClient_prototype_createHook__11", line: 290 }; return __func(_, this, arguments, GithubClient_prototype_createHook__11, 1, __frame, function __$GithubClient_prototype_createHook__11() {
    progress = __this.cli.progress("Creating new hook"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$GithubClient_prototype_createHook__11() {
          ...
          return __this.client.repos.createHook(hook, __cb(_, __frame, 4, 11, _, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$GithubClient_prototype_createHook__11() {

            progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, _); }); });};



GithubClient.prototype.updateHook = function GithubClient_prototype_updateHook__12(hook, _) { var progress, __this = this; var __frame = { name: "GithubClient_prototype_updateHook__12", line: 300 }; return __func(_, this, arguments, GithubClient_prototype_updateHook__12, 1, __frame, function __$GithubClient_prototype_updateHook__12() {
    progress = __this.cli.progress("Updating hook"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$GithubClient_prototype_updateHook__12() {
          ...
          return __this.client.repos.updateHook(hook, __cb(_, __frame, 4, 11, _, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$GithubClient_prototype_updateHook__12() {

            progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, _); }); });};



GithubClient.prototype.testHook = function GithubClient_prototype_testHook__13(hook, _) { var progress, __this = this; var __frame = { name: "GithubClient_prototype_testHook__13", line: 310 }; return __func(_, this, arguments, GithubClient_prototype_testHook__13, 1, __frame, function __$GithubClient_prototype_testHook__13() {
    progress = __this.cli.progress("Testing new hook"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$GithubClient_prototype_testHook__13() {
          ...
          return __this.client.repos.testHook(hook, __cb(_, __frame, 4, 4, function __$GithubClient_prototype_testHook__13() { _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$GithubClient_prototype_testHook__13() {

            progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, _); }); });};



GithubClient.prototype.getHooks = function GithubClient_prototype_getHooks__14(username, repository, _) { var progress, __this = this; var __frame = { name: "GithubClient_prototype_getHooks__14", line: 320 }; return __func(_, this, arguments, GithubClient_prototype_getHooks__14, 2, __frame, function __$GithubClient_prototype_getHooks__14() {
    progress = __this.cli.progress("Retrieving website hooks"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$GithubClient_prototype_getHooks__14() {
          ...
          return __this.client.repos.getHooks({
            user: username,
            repo: repository }, __cb(_, __frame, 4, 11, _, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$GithubClient_prototype_getHooks__14() {
