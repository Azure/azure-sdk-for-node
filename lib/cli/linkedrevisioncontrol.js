...
GithubClient.prototype.ensureCredentials = function GithubClient_prototype_ensureCredentials__7(context, _) { var __frame = { name: "GithubClient_prototype_ensureCredentials__7", line: 157 }; return __func(_, this, arguments, GithubClient_prototype_ensureCredentials__7, 1, __frame, function __$GithubClient_prototype_ensureCredentials__7() {
    if ((!context.username || !context.pass)) {
      cli.output.help("Enter your github credentials"); } ; return (function __$GithubClient_prototype_ensureCredentials__7(__then) {


      if (!context.username) {
        return prompt("Username: ", __cb(_, __frame, 6, 23, function ___(__0, __1) { context.username = __1; __then(); }, true)); } else { __then(); } ; })(function __$GithubClient_prototype_ensureCredentials__7() { return (function __$GithubClient_prototype_ensureCredentials__7(__then) {


        if (!context.password) {
          return promptPassword("Password: ", __cb(_, __frame, 10, 23, function ___(__0, __2) { context.password = __2; __then(); }, true)); } else { __then(); } ; })(_); }); });};
...
GithubClient.prototype.testHook = function GithubClient_prototype_testHook__14(hook, _) { var progress, __this = this; var __frame = { name: "GithubClient_prototype_testHook__14", line: 334 }; return __func(_, this, arguments, GithubClient_prototype_testHook__14, 1, __frame, function __$GithubClient_prototype_testHook__14() {
    progress = __this.cli.progress("Testing new hook"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$GithubClient_prototype_testHook__14() {
