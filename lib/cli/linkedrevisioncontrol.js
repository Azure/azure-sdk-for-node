...
GithubClient.prototype.init = function GithubClient_prototype_init__8(context, _) { var repositories, remoteUris, __this = this; var __frame = { name: "GithubClient_prototype_init__8", line: 177 }; return __func(_, this, arguments, GithubClient_prototype_init__8, 1, __frame, function __$GithubClient_prototype_init__8() {
        ...
        return __this.initGitOnCurrentDirectory(context, false, __cb(_, __frame, 5, 2, function __$GithubClient_prototype_init__8() {
          ...
          return __this.getRepositories(context.github.username, __cb(_, __frame, 8, 21, function ___(__0, __1) { repositories = __1; return (function __$GithubClient_prototype_init__8(__then) {
              if ((!((context.flags && context.flags.forceRepositorySelection)) && !context.github.repositoryFullName)) {
                ...
                return __this._getRemoteUris(__cb(_, __frame, 12, 21, function ___(__0, __2) { remoteUris = __2;

                  if ((remoteUris.length === 1)) {
                    context.github.repositoryFullName = remoteUris[0]; }
                   else {

                    repositories = repositories.filter(function(repository) {
                      return remoteUris.some(function(remoteUri) {
                        return (remoteUri === repository.git_url); }); }); } ; __then(); }, true)); } else { __then(); } ; })(function __$GithubClient_prototype_init__8() {
              ...
              if (context.github.repositoryFullName) {
                ...
                if (!context.github.repository) {
                  ...
                  return choose(__this.cli, repositories.map(function(repository) {
                    return repository.full_name; }), __cb(_, __frame, 38, 45, function ___(__0, __3) { context.github.repository = repositories[__3]; __then(); }, true)); } else { __then(); } ; })(_); }); }, true)); }, true)); }, true)); }, true)); });};




GithubClient.prototype.deploy = function GithubClient_prototype_deploy__9(context, _) { var __frame = { name: "GithubClient_prototype_deploy__9", line: 221 }; return __func(_, this, arguments, GithubClient_prototype_deploy__9, 1, __frame, function __$GithubClient_prototype_deploy__9() {
...
GithubClient.prototype.createOrUpdateHook = function GithubClient_prototype_createOrUpdateHook__11(username, repository, websitesRepositoryUri, websitesRepositoryAuth, _) { var parsedRepositoryUri, deployUri, hooks, existingHook, newHook, __this = this; var __frame = { name: "GithubClient_prototype_createOrUpdateHook__11", line: 272 }; return __func(_, this, arguments, GithubClient_prototype_createOrUpdateHook__11, 4, __frame, function __$GithubClient_prototype_createOrUpdateHook__11() {
        ...
        if (existingHook) { return (function __$GithubClient_prototype_createOrUpdateHook__11(__then) {
            ...
            if ((existingHook.config.url.toLowerCase() !== deployUri.toLowerCase())) {
              ...
              return __this.updateHook(existingHook, __cb(_, __frame, 28, 21, function ___(__0, __2) { existingHook = __2;
                return __this.testHook(existingHook, __cb(_, __frame, 29, 6, __then, true)); }, true)); } else {
          ...
          return __this.createHook(newHook, __cb(_, __frame, 48, 14, function ___(__0, __3) { newHook = __3;
            newHook.user = username;
            newHook.repo = repository;
            return __this.testHook(newHook, __cb(_, __frame, 51, 4, __then, true)); }, true)); } ; })(_); }, true)); });};



GithubClient.prototype.createHook = function GithubClient_prototype_createHook__12(hook, _) { var progress, __this = this; var __frame = { name: "GithubClient_prototype_createHook__12", line: 327 }; return __func(_, this, arguments, GithubClient_prototype_createHook__12, 1, __frame, function __$GithubClient_prototype_createHook__12() {
...
GithubClient.prototype.updateHook = function GithubClient_prototype_updateHook__13(hook, _) { var progress, __this = this; var __frame = { name: "GithubClient_prototype_updateHook__13", line: 337 }; return __func(_, this, arguments, GithubClient_prototype_updateHook__13, 1, __frame, function __$GithubClient_prototype_updateHook__13() {
...
GithubClient.prototype.testHook = function GithubClient_prototype_testHook__14(hook, _) { var progress, __this = this; var __frame = { name: "GithubClient_prototype_testHook__14", line: 347 }; return __func(_, this, arguments, GithubClient_prototype_testHook__14, 1, __frame, function __$GithubClient_prototype_testHook__14() {
