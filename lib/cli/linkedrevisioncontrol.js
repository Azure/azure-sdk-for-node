...
LinkedRevisionControlClient.prototype.initGitOnCurrentDirectory = function LinkedRevisionControlClient_prototype_initGitOnCurrentDirectory__1(context, _) { var __this = this; var __frame = { name: "LinkedRevisionControlClient_prototype_initGitOnCurrentDirectory__1", line: 41 }; return __func(_, this, arguments, LinkedRevisionControlClient_prototype_initGitOnCurrentDirectory__1, 1, __frame, function __$LinkedRevisionControlClient_prototype_initGitOnCurrentDirectory__1() {
    ...
    return exec("git init", __cb(_, __frame, 7, 2, function __$LinkedRevisionControlClient_prototype_initGitOnCurrentDirectory__1() { return (function __$LinkedRevisionControlClient_prototype_initGitOnCurrentDirectory__1(__then) {

        if (!utils.pathExistsSync(".gitignore")) {
          __this.cli.output.info("Creating default .gitignore file");
          return fs.writeFile(".gitignore", "node_modules\nazure_error", __cb(_, __frame, 11, 4, __then, true)); } else { __then(); } ; })(function __$LinkedRevisionControlClient_prototype_initGitOnCurrentDirectory__1() {


        context.flags.isGitWorkingTree = true; _(); }); }, true)); });};


LinkedRevisionControlClient.prototype.determineIfCurrentDirectoryIsGitWorkingTree = function LinkedRevisionControlClient_prototype_determineIfCurrentDirectoryIsGitWorkingTree__2(context, _) { var isInsideWorkTree, lines, __this = this; var __frame = { name: "LinkedRevisionControlClient_prototype_determineIfCurrentDirectoryIsGitWorkingTree__2", line: 58 }; return __func(_, this, arguments, LinkedRevisionControlClient_prototype_determineIfCurrentDirectoryIsGitWorkingTree__2, 1, __frame, function __$LinkedRevisionControlClient_prototype_determineIfCurrentDirectoryIsGitWorkingTree__2() {
    __this.cli.output.silly("determineIfCurrentDirectoryIsGitWorkingTree"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$LinkedRevisionControlClient_prototype_determineIfCurrentDirectoryIsGitWorkingTree__2() {
          ...
          return exec("git rev-parse --git-dir", __cb(_, __frame, 4, 27, function ___(__0, __1) { isInsideWorkTree = __1;
            ...
            context.flags.isGitWorkingTree = lines.split("\n").some(function(line) {
              return (line === ".git"); }); __then(); }, true)); }); })(function ___(err, __result) { __tryCatch(_, function __$LinkedRevisionControlClient_prototype_determineIfCurrentDirectoryIsGitWorkingTree__2() { if (err) {
...
GitClient.prototype.init = function GitClient_prototype_init__3(context, _) { var __this = this; var __frame = { name: "GitClient_prototype_init__3", line: 78 }; return __func(_, this, arguments, GitClient_prototype_init__3, 1, __frame, function __$GitClient_prototype_init__3() {
    return __this.determineIfCurrentDirectoryIsGitWorkingTree(context, __cb(_, __frame, 1, 2, function __$GitClient_prototype_init__3() {
      return __this.initGitOnCurrentDirectory(context, __cb(_, __frame, 2, 2, _, true)); }, true)); });};
        ...
        if (context.remoteUri) {
          ...
          if (!context.repository) {
            ...
            return choose(__this.cli, repositories.map(function(repository) {
              return repository.full_name; }), __cb(_, __frame, 22, 38, function ___(__0, __3) { context.repository = repositories[__3]; __then(); }, true)); } else { __then(); } ; })(_); }, true)); }, true)); });};




GithubClient.prototype.deploy = function GithubClient_prototype_deploy__6(context, _) { var parsedRepositoryUri, hookUrl, gitUri, __this = this; var __frame = { name: "GithubClient_prototype_deploy__6", line: 131 }; return __func(_, this, arguments, GithubClient_prototype_deploy__6, 1, __frame, function __$GithubClient_prototype_deploy__6() {
    ...
    return context.lvcClient.createOrUpdateHook(context.repository.owner.login, context.repository.name, hookUrl, __cb(_, __frame, 6, 2, function __$GithubClient_prototype_deploy__6() { return (function __$GithubClient_prototype_deploy__6(__then) {
        ...
        if (!context.remoteUri) {
          ...
          return exec(("git remote add azure " + gitUri), __cb(_, __frame, 16, 4, __then, true)); } else { __then(); } ; })(_); }, true)); });};



GithubClient.prototype.getRepositories = function GithubClient_prototype_getRepositories__7(username, _) { var progress, userRepos, orgs, i, org, __this = this; var __frame = { name: "GithubClient_prototype_getRepositories__7", line: 151 }; return __func(_, this, arguments, GithubClient_prototype_getRepositories__7, 1, __frame, function __$GithubClient_prototype_getRepositories__7() {
...
GithubClient.prototype.createHook = function GithubClient_prototype_createHook__9(hook, _) { var progress, __this = this; var __frame = { name: "GithubClient_prototype_createHook__9", line: 215 }; return __func(_, this, arguments, GithubClient_prototype_createHook__9, 1, __frame, function __$GithubClient_prototype_createHook__9() {
...
GithubClient.prototype.getHooks = function GithubClient_prototype_getHooks__11(username, repository, _) { var progress, __this = this; var __frame = { name: "GithubClient_prototype_getHooks__11", line: 235 }; return __func(_, this, arguments, GithubClient_prototype_getHooks__11, 2, __frame, function __$GithubClient_prototype_getHooks__11() {
...
GithubClient.prototype._getRemoteUri = function GithubClient_prototype__getRemoteUri__12(context, _) { var progress, originUri, __this = this; var __frame = { name: "GithubClient_prototype__getRemoteUri__12", line: 248 }; return __func(_, this, arguments, GithubClient_prototype__getRemoteUri__12, 1, __frame, function __$GithubClient_prototype__getRemoteUri__12() {
...
function getRemote(name, _) { var origin; var __frame = { name: "getRemote", line: 277 }; return __func(_, this, arguments, getRemote, 1, __frame, function __$getRemote() {
