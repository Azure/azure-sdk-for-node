...
Channel.prototype.send = function (method, data, cb, chunkcb) {
  ...
  var req = https.request(options, function (res) {
    ...
    res.on('data', function (chunk) {
      ...
      if (chunkcb) {
        parseContent(contentType, chunk, chunkcb);
      } else {
        data.push(chunk);
...
Channel.prototype.GET = function (cb, chunkcb) {
  return this.send('GET', null, cb, chunkcb);
};
