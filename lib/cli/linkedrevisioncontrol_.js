...
GithubClient.prototype.authenticate = function (username, password, _) {
...
GithubClient.prototype.authenticateAuth = function(username, password, _) {
  this.client.authenticate({
    type: "basic",
    username: username,
    password: password
  ...
  var oauthToken = this.client.oauth.createAuthorization({ user: username }, _);
  this.client.authenticate({
    type: "oauth",
