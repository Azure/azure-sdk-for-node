...
export interface DataManagers {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    updateWithHttpOperationResponse(resourceGroupName: string, dataManagerName: string, dataManagerUpdateParameter: models.DataManagerUpdateParameter, options?: { ifMatch? : string, customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.DataManager>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    update(resourceGroupName: string, dataManagerName: string, dataManagerUpdateParameter: models.DataManagerUpdateParameter, options?: { ifMatch? : string, customHeaders? : { [headerName: string]: string; } }): Promise<models.DataManager>;
    update(resourceGroupName: string, dataManagerName: string, dataManagerUpdateParameter: models.DataManagerUpdateParameter, callback: ServiceCallback<models.DataManager>): void;
    update(resourceGroupName: string, dataManagerName: string, dataManagerUpdateParameter: models.DataManagerUpdateParameter, options: { ifMatch? : string, customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.DataManager>): void;
