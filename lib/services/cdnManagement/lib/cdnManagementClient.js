 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
CdnManagementClient.prototype.checkResourceUsage = function (options, callback) {
  var client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
CdnManagementClient.prototype.checkResourceUsageNext = function (nextPageLink, options, callback) {
  var client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
