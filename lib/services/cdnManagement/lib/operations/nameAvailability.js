 ...
 * as a CDN endpoint.
 *
 * @param {object} checkNameAvailabilityInput Input to check.
 * 
 * @param {string} [checkNameAvailabilityInput.name] The resource name to
 * validate.
 * 
 * @param {string} [checkNameAvailabilityInput.type] The type of the resource
 * whose name is to be validated. Possible values include:
 ...
 */
NameAvailability.prototype.checkNameAvailability = function (checkNameAvailabilityInput, options, callback) {
