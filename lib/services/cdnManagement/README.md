# Microsoft Azure SDK for Node.js - CDN Management

This project provides a Node.js package that makes it easy to manage Microsoft Azure CDN Resources.Right now it supports:
...
### Create the CdnManagementClient
