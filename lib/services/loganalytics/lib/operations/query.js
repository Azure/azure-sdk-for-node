 ...
 */
function _execute(workspaceId, body, options, callback) {
...
class Query {
  /**
   * Create a Query.
   * @param {LogAnalyticsClient} client Reference to the service client.
   */
  constructor(client) {
    this.client = client;
   ...
   */
  executeWithHttpOperationResponse(workspaceId, body, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._execute(workspaceId, body, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  execute(workspaceId, body, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._execute(workspaceId, body, options, optionalCallback);
    }
  }
