...
SqlService.prototype.createServerDatabase = function (databaseName, optionsOrCallback, callback) {
  ...
  var webResource = WebResource.post('/v1/ManagementService.svc/Server2(\'' + this.serverName + '\')/Databases');
...
SqlService.prototype.deleteServerDatabase = function (databaseId, callback) {
  ...
  var webResource = WebResource.del('/v1/ManagementService.svc/Server2(\'' + this.serverName + '\')/Databases(' + databaseId + ')');
...
SqlService.prototype.listServerDatabases = function (callback) {
  ...
  var webResource = WebResource.get('/v1/ManagementService.svc/Server2(\'' + this.serverName + '\')/Databases');
