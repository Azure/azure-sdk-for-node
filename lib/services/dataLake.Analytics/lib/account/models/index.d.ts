 ...
 *
 * @property {string} [id] The resource identifer.
 ...
 * @property {array} [storageAccounts] The list of Azure Blob Storage accounts
 * associated with this account.
 * @property {array} [computePolicies] The list of compute policies associated
 * with this account.
 ...
 * @property {number} [systemMaxJobCount] The system defined maximum supported
 ...
 * @property {number} [maxDegreeOfParallelism] The maximum supported degree of
 * parallelism for this account. Default value: 30 .
 * @property {number} [systemMaxDegreeOfParallelism] The system defined maximum
 ...
 *
 * @property {string} [accessToken] The access token for the associated Azure
 * Storage Container.
 */
 ...
 * @property {string} [reason] The reason why the Data Lake Analytics account
 ...
 *
 * @property {string} name The unique name of the Azure Storage account to add.
 ...
 * @property {uuid} objectId The AAD object identifier for the entity to create
 * a policy for.
 * @property {string} objectType The type of AAD object the object identifier
 * refers to. Possible values include: 'User', 'Group', 'ServicePrincipal'
 * @property {number} [maxDegreeOfParallelismPerJob] The maximum degree of
 ...
 * @property {string} defaultDataLakeStoreAccount The default Data Lake Store
 * account associated with this account.
 * @property {array} dataLakeStoreAccounts The list of Data Lake Store accounts
 * associated with this account.
 * @property {array} [storageAccounts] The list of Azure Blob Storage accounts
 * associated with this account.
 * @property {array} [computePolicies] The list of compute policies associated
 ...
 * Analytics account.
 *
 * @property {string} name The unique name of the compute policy to update.
 * @property {uuid} [objectId] The AAD object identifier for the entity to
 * create a policy for.
 * @property {string} [objectType] The type of AAD object the object identifier
 * refers to. Possible values include: 'User', 'Group', 'ServicePrincipal'
