...
class CreateOrUpdateComputePolicyParameters {
  /**
   * Create a CreateOrUpdateComputePolicyParameters.
  ...
  /**
   * Defines the metadata of CreateOrUpdateComputePolicyParameters
   *
...
module.exports = CreateOrUpdateComputePolicyParameters;
