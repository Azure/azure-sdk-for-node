...
class DataLakeAnalyticsAccount extends models['Resource'] {
   ...
   * @property {string} [state] The state of the Data Lake Analytics account.
   ...
   * @property {string} [defaultDataLakeStoreAccount] The default Data Lake
   * Store account associated with this account.
   * @property {array} [dataLakeStoreAccounts] The list of Data Lake Store
   * accounts associated with this account.
   * @property {array} [storageAccounts] The list of Azure Blob Storage
   * accounts associated with this account.
   * @property {array} [computePolicies] The list of compute policies
   ...
   * 'Enabled', 'Disabled'
   * @property {string} [newTier] The commitment tier for the next month.
   ...
   * @property {number} [maxJobCount] The maximum supported jobs running under
   * the account at the same time. Default value: 3 .
   * @property {number} [systemMaxJobCount] The system defined maximum
   * supported jobs running under the account at the same time, which restricts
   * the maximum number of running jobs the user can set for the account.
   * @property {number} [maxDegreeOfParallelism] The maximum supported degree
   * of parallelism for this account. Default value: 30 .
   * @property {number} [systemMaxDegreeOfParallelism] The system defined
   * maximum supported degree of parallelism for this account, which restricts
   * the maximum value of parallelism the user can set for the account.
   * @property {number} [maxDegreeOfParallelismPerJob] The maximum supported
   * degree of parallelism per job for this account.
   * @property {number} [minPriorityPerJob] The minimum supported priority per
   * job for this account.
   * @property {number} [queryStoreRetention] The number of days that job
