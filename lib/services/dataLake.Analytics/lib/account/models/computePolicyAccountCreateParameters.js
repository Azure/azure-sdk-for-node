...
class ComputePolicyAccountCreateParameters {
  ...
  /**
   * Defines the metadata of ComputePolicyAccountCreateParameters
   *
   * @returns {object} metadata of ComputePolicyAccountCreateParameters
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ComputePolicyAccountCreateParameters',
      type: {
        name: 'Composite',
...
module.exports = ComputePolicyAccountCreateParameters;
