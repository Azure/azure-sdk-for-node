 ...
 *
 * @param {string} [options.parameters.newTier] the billing tier to use for
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Account.prototype.update = function (resourceGroupName, accountName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Send request
  this.beginUpdate(resourceGroupName, accountName, options, function (err, parsedResult, httpRequest, response){
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Account.prototype.beginUpdate = function (resourceGroupName, accountName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
