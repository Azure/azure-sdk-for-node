 ...
 */
function DataLakeAnalyticsCatalogManagementClient(credentials, subscriptionId, catalogserviceuri, baseUri, options) {
  ...
  if (catalogserviceuri === null || catalogserviceuri === undefined) {
    throw new Error('\'catalogserviceuri\' cannot be null.');
  }
  ...
  if (!this.baseUri) {
    this.baseUri = 'https://accountname.catalogserviceuri';
  }
