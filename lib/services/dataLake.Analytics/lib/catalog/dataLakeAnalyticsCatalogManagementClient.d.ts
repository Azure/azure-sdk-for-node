 ...
 */
declare interface DataLakeAnalyticsCatalogManagementClientOptions extends ServiceClientOptions {
        /**
...
declare class DataLakeAnalyticsCatalogManagementClient extends AzureServiceClient {
  /**
