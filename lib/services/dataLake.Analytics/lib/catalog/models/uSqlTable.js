...
function USqlTable(parameters) {
  USqlTable['super_'].call(this, parameters);
...
USqlTable.prototype.serialize = function () {
  var payload = USqlTable['super_'].prototype.serialize.call(this);
...
USqlTable.prototype.deserialize = function (instance) {
  USqlTable['super_'].prototype.deserialize.call(this, instance);
  if (instance) {
