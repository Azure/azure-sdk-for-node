...
function USqlAssembly(parameters) {
  USqlAssembly['super_'].call(this, parameters);
...
USqlAssembly.prototype.serialize = function () {
  var payload = USqlAssembly['super_'].prototype.serialize.call(this);
...
USqlAssembly.prototype.deserialize = function (instance) {
  USqlAssembly['super_'].prototype.deserialize.call(this, instance);
  if (instance) {
