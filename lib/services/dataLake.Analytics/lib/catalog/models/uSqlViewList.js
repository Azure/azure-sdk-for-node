 ...
 * @member {array} [value] Gets or sets the list of view in the database and
 * schema combination
 * 
 */
...
/**
 * Deserialize the instance to USqlViewList schema
 *
 * @param {JSON} instance
 *
 */
USqlViewList.prototype.deserialize = function (instance) {
  if (instance) {
    if (instance['value']) {
      var deserializedInstancevalue = [];
        instance['value'].forEach(function(element) {
        if (element) {
          element = new models['USqlView']().deserialize(element);
        }
