 ...
 * @member {array} [value] Gets or sets the list of types in the database and
 * schema combination
 * 
...
/**
 * Deserialize the instance to USqlTypeList schema
 *
 * @param {JSON} instance
 *
 */
USqlTypeList.prototype.deserialize = function (instance) {
  if (instance) {
    if (instance['value']) {
      var deserializedInstancevalue = [];
        instance['value'].forEach(function(element) {
        if (element) {
          element = new models['USqlType']().deserialize(element);
        }
