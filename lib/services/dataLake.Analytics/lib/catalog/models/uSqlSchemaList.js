 ...
 * @member {array} [value] Gets or sets the list of schemas in the database
 * 
 */
...
/**
 * Deserialize the instance to USqlSchemaList schema
 *
 * @param {JSON} instance
 *
 */
USqlSchemaList.prototype.deserialize = function (instance) {
  if (instance) {
    if (instance['value']) {
      var deserializedInstancevalue = [];
        instance['value'].forEach(function(element) {
        if (element) {
          element = new models['USqlSchema']().deserialize(element);
        }
