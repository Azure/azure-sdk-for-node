 ...
 * 
 */
function USqlTableColumn(parameters) {
...
/**
 * Validate the payload against the USqlTableColumn schema
 *
 * @param {JSON} payload
 *
 */
USqlTableColumn.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to USqlTableColumn schema
 *
 * @param {JSON} instance
 *
 */
USqlTableColumn.prototype.deserialize = function (instance) {
  if (instance) {
