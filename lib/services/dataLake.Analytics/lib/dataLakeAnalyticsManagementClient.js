...
var DataLakeAnalyticsManagementClient = ( /** @lends DataLakeAnalyticsManagementClient */ function() {
  ...
  DataLakeAnalyticsManagementClient.prototype.getLongRunningOperationStatus = function(azureAsyncOperation, callback) {
    ...
    // Set Headers
    httpRequest.headers['x-ms-version'] = '2015-08-01-preview';
...
var DataLakeAnalyticsAccountOperations = ( /** @lends DataLakeAnalyticsAccountOperations */ function() {
   ...
   * account to add
   * 
   * @param {AddDataLakeParameters} [parametersOrCallback] The parameters
   ...
   * Gets or sets the properties for the Data Lake account being added.
   * 
  ...
  DataLakeAnalyticsAccountOperations.prototype.addDataLakeStoreAccount = function(resourceGroupName, accountName, dataLakeStoreAccountName, parametersOrCallback, callback) {
    ...
    url2 = url2 + '/providers/';
    url2 = url2 + 'Microsoft.BigAnalytics';
    url2 = url2 + '/';
    url2 = url2 + 'accounts';
    url2 = url2 + '/';
    url2 = url2 + encodeURIComponent(accountName);
    url2 = url2 + '/DataLakeAccounts/';
    url2 = url2 + encodeURIComponent(dataLakeStoreAccountName);
    var queryParameters = [];
    queryParameters.push('api-version=2015-08-01-preview');
    ...
    if ('Azure SDK - Microsoft.Azure.Management.DataLake.Analytics 0.9.0-preview' + this.client.userAgentSuffix !== null && 'Azure SDK - Microsoft.Azure.Management.DataLake.Analytics 0.9.0-preview' + this.client.userAgentSuffix !== undefined) {
      httpRequest.headers['useragent'] = 'Azure SDK - Microsoft.Azure.Management.DataLake.Analytics 0.9.0-preview' + this.client.userAgentSuffix;
    }
    if ('Azure SDK - Microsoft.Azure.Management.DataLake.Analytics 0.9.0-preview' + this.client.userAgentSuffix !== null && 'Azure SDK - Microsoft.Azure.Management.DataLake.Analytics 0.9.0-preview' + this.client.userAgentSuffix !== undefined) {
      httpRequest.headers['User-Agent'] = 'Azure SDK - Microsoft.Azure.Management.DataLake.Analytics 0.9.0-preview' + this.client.userAgentSuffix;
    }
    ...
    if (parameters !== null && parameters !== undefined) {
      var addDataLakeParametersValue = {};
      requestDoc = addDataLakeParametersValue;
      
      if (parameters.properties !== null && parameters.properties !== undefined) {
        var propertiesValue = {};
        addDataLakeParametersValue['properties'] = propertiesValue;
   ...
   * 
   * @param {string}
   * [parameters.dataLakeAnalyticsAccount.properties.defaultDataLakeAccount]
   * Gets or sets the default data lake account associated with this Data Lake
   * Analytics account.
   * 
   * @param {number}
   ...
   * 
   * @param {ICollection}
   * [parameters.dataLakeAnalyticsAccount.properties.dataLakeAccounts] Gets or
   * sets the list of Data Lake storage accounts associated with this account.
   * 
   * @param {ICollection}
  ...
  DataLakeAnalyticsAccountOperations.prototype.beginCreate = function(resourceGroupName, parameters, callback) {
    ...
    if (parameters.dataLakeAnalyticsAccount.properties !== null && parameters.dataLakeAnalyticsAccount.properties !== undefined) {
      ...
      if (parameters.dataLakeAnalyticsAccount.properties.defaultDataLakeAccount !== null && parameters.dataLakeAnalyticsAccount.properties.defaultDataLakeAccount !== undefined) {
      ...
      if (parameters.dataLakeAnalyticsAccount.properties.dataLakeAccounts !== null && parameters.dataLakeAnalyticsAccount.properties.dataLakeAccounts !== undefined) {
        var dataLakeAccountsArray = [];
        for (var loweredIndex1 = 0; loweredIndex1 < parameters.dataLakeAnalyticsAccount.properties.dataLakeAccounts.length; loweredIndex1 = loweredIndex1 + 1) {
          var dataLakeAccountsItem = parameters.dataLakeAnalyticsAccount.properties.dataLakeAccounts[loweredIndex1];
          var dataLakeStoreAccountValue = {};
          dataLakeAccountsArray.push(dataLakeStoreAccountValue);
          
          if (dataLakeAccountsItem.name !== null && dataLakeAccountsItem.name !== undefined) {
            dataLakeStoreAccountValue['name'] = dataLakeAccountsItem.name;
          }
          
          if (dataLakeAccountsItem.properties !== null && dataLakeAccountsItem.properties !== undefined) {
            var propertiesValue2 = {};
            dataLakeStoreAccountValue['properties'] = propertiesValue2;
            
            if (dataLakeAccountsItem.properties.suffix !== null && dataLakeAccountsItem.properties.suffix !== undefined) {
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (propertiesValue !== null && propertiesValue !== undefined) {
            var propertiesInstance = { dataLakeAccounts: [], storageAccounts: [] };
            ...
            var defaultDataLakeAccountValue = propertiesValue['defaultDataLakeAccount'];
            if (defaultDataLakeAccountValue !== null && defaultDataLakeAccountValue !== undefined) {
              var defaultDataLakeAccountInstance = defaultDataLakeAccountValue;
            ...
            var dataLakeAccountsArray = propertiesValue['dataLakeAccounts'];
            if (dataLakeAccountsArray !== null && dataLakeAccountsArray !== undefined) {
              for (var loweredIndex1 = 0; loweredIndex1 < dataLakeAccountsArray.length; loweredIndex1 = loweredIndex1 + 1) {
                var dataLakeAccountsValue = dataLakeAccountsArray[loweredIndex1];
                var dataLakeStoreAccountInstance = {};
                propertiesInstance.dataLakeAccounts.push(dataLakeStoreAccountInstance);
                
                var nameValue2 = dataLakeAccountsValue['name'];
                if (nameValue2 !== null && nameValue2 !== undefined) {
                  var nameInstance2 = nameValue2;
                  dataLakeStoreAccountInstance.name = nameInstance2;
                }
                
                var propertiesValue2 = dataLakeAccountsValue['properties'];
          ...
          if (valueArray !== null && valueArray !== undefined) {
            for (var loweredIndex1 = 0; loweredIndex1 < valueArray.length; loweredIndex1 = loweredIndex1 + 1) {
              ...
              if (propertiesValue !== null && propertiesValue !== undefined) {
                ...
                var dataLakeAccountsArray = propertiesValue['dataLakeAccounts'];
                if (dataLakeAccountsArray !== null && dataLakeAccountsArray !== undefined) {
                  for (var loweredIndex2 = 0; loweredIndex2 < dataLakeAccountsArray.length; loweredIndex2 = loweredIndex2 + 1) {
                    var dataLakeAccountsValue = dataLakeAccountsArray[loweredIndex2];
                    var dataLakeStoreAccountInstance = {};
                    propertiesInstance.dataLakeAccounts.push(dataLakeStoreAccountInstance);
