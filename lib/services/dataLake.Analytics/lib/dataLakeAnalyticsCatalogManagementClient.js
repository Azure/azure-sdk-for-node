...
var CatalogOperations = ( /** @lends CatalogOperations */ function() {
  ...
  CatalogOperations.prototype.createSecret = function(resourceGroupName, accountName, databaseName, parameters, callback) {
    ...
    if ('Azure SDK - Microsoft.Azure.Management.DataLake.AnalyticsCatalog 0.9.1-preview' + this.client.userAgentSuffix !== null && 'Azure SDK - Microsoft.Azure.Management.DataLake.AnalyticsCatalog 0.9.1-preview' + this.client.userAgentSuffix !== undefined) {
      httpRequest.headers['useragent'] = 'Azure SDK - Microsoft.Azure.Management.DataLake.AnalyticsCatalog 0.9.1-preview' + this.client.userAgentSuffix;
    }
    if ('Azure SDK - Microsoft.Azure.Management.DataLake.AnalyticsCatalog 0.9.1-preview' + this.client.userAgentSuffix !== null && 'Azure SDK - Microsoft.Azure.Management.DataLake.AnalyticsCatalog 0.9.1-preview' + this.client.userAgentSuffix !== undefined) {
      httpRequest.headers['User-Agent'] = 'Azure SDK - Microsoft.Azure.Management.DataLake.AnalyticsCatalog 0.9.1-preview' + this.client.userAgentSuffix;
    }
    if (resourceGroupName !== null && resourceGroupName !== undefined) {
