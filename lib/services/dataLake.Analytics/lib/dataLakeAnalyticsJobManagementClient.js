...
var JobOperations = ( /** @lends JobOperations */ function() {
  ...
  JobOperations.prototype.build = function(resourceGroupName, accountName, parameters, callback) {
    ...
    if ('Azure SDK - Microsoft.Azure.Management.DataLake.AnalyticsJob 0.9.2-preview' + this.client.userAgentSuffix !== null && 'Azure SDK - Microsoft.Azure.Management.DataLake.AnalyticsJob 0.9.2-preview' + this.client.userAgentSuffix !== undefined) {
      httpRequest.headers['useragent'] = 'Azure SDK - Microsoft.Azure.Management.DataLake.AnalyticsJob 0.9.2-preview' + this.client.userAgentSuffix;
    }
    if ('Azure SDK - Microsoft.Azure.Management.DataLake.AnalyticsJob 0.9.2-preview' + this.client.userAgentSuffix !== null && 'Azure SDK - Microsoft.Azure.Management.DataLake.AnalyticsJob 0.9.2-preview' + this.client.userAgentSuffix !== undefined) {
      httpRequest.headers['User-Agent'] = 'Azure SDK - Microsoft.Azure.Management.DataLake.AnalyticsJob 0.9.2-preview' + this.client.userAgentSuffix;
    }
    if (resourceGroupName !== null && resourceGroupName !== undefined) {
