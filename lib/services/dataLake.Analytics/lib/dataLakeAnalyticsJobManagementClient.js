...
var JobOperations = ( /** @lends JobOperations */ function() {
   ...
   * 
   * @param {JobErrorDetails} [parameters.job.errorMessage] Gets or sets the
   * error message details for the job, if it failed.
   * 
   * @param {string} [parameters.job.errorMessage.description] Gets or sets the
   * error message description
   * 
   * @param {string} [parameters.job.errorMessage.details] Gets or sets the
   * details of the error message.
   * 
   * @param {number} [parameters.job.errorMessage.endOffset] Gets or sets the
   * end offset in the job where the error was found.
   * 
   * @param {string} [parameters.job.errorMessage.errorId] Gets or sets the
   * specific identifier for the type of error encountered in the job.
   * 
   * @param {string} [parameters.job.errorMessage.filePath] Gets or sets the
   * path to any supplemental error files, if any.
   * 
   * @param {string} [parameters.job.errorMessage.helpLink] Gets or sets the
   * link to MSDN or Azure help for this type of error, if any.
   * 
   * @param {string} [parameters.job.errorMessage.internalDiagnostics] Gets or
   * sets the internal diagnostic stack trace if the user requesting the job
   * error details has sufficient permissions it will be retrieved, otherwise
   * it will be empty.
   * 
   * @param {number} [parameters.job.errorMessage.lineNumber] Gets or sets the
   * specific line number in the job where the error occured.
   * 
   * @param {string} [parameters.job.errorMessage.message] Gets or sets the
   * user friendly error message for the failure.
   * 
   * @param {string} [parameters.job.errorMessage.resolution] Gets or sets the
   * recommended resolution for the failure, if any.
   * 
   * @param {string} [parameters.job.errorMessage.severity] Gets or sets the
   * severity level of the failure.
   * 
   * @param {string} [parameters.job.errorMessage.source] Gets or sets the
   * ultimate source of the failure (usually either SYSTEM or USER).
   * 
   * @param {string} [parameters.job.errorMessage.startOffset] Gets or sets the
   * end offset in the job where the error was found
   * 
  ...
  JobOperations.prototype.build = function(resourceGroupName, accountName, parameters, callback) {
    ...
    if (parameters.job !== null && parameters.job !== undefined) {
      ...
      if (parameters.job.errorMessage !== null && parameters.job.errorMessage !== undefined) {
        ...
        jobInfoBuildOrCreateParametersValue['errorMessage'] = errorMessageValue;
        
        if (parameters.job.errorMessage.description !== null && parameters.job.errorMessage.description !== undefined) {
          errorMessageValue['description'] = parameters.job.errorMessage.description;
        }
        
        if (parameters.job.errorMessage.details !== null && parameters.job.errorMessage.details !== undefined) {
          errorMessageValue['details'] = parameters.job.errorMessage.details;
        }
        
        if (parameters.job.errorMessage.endOffset !== null && parameters.job.errorMessage.endOffset !== undefined) {
          errorMessageValue['endOffset'] = parameters.job.errorMessage.endOffset;
        }
        
        if (parameters.job.errorMessage.errorId !== null && parameters.job.errorMessage.errorId !== undefined) {
          errorMessageValue['errorId'] = parameters.job.errorMessage.errorId;
        }
        
        if (parameters.job.errorMessage.filePath !== null && parameters.job.errorMessage.filePath !== undefined) {
          errorMessageValue['filePath'] = parameters.job.errorMessage.filePath;
        }
        
        if (parameters.job.errorMessage.helpLink !== null && parameters.job.errorMessage.helpLink !== undefined) {
          errorMessageValue['helpLink'] = parameters.job.errorMessage.helpLink;
        }
        
        if (parameters.job.errorMessage.internalDiagnostics !== null && parameters.job.errorMessage.internalDiagnostics !== undefined) {
          errorMessageValue['internalDiagnostics'] = parameters.job.errorMessage.internalDiagnostics;
        }
        
        if (parameters.job.errorMessage.lineNumber !== null && parameters.job.errorMessage.lineNumber !== undefined) {
          errorMessageValue['lineNumber'] = parameters.job.errorMessage.lineNumber;
        }
        
        if (parameters.job.errorMessage.message !== null && parameters.job.errorMessage.message !== undefined) {
          errorMessageValue['message'] = parameters.job.errorMessage.message;
        }
        
        if (parameters.job.errorMessage.resolution !== null && parameters.job.errorMessage.resolution !== undefined) {
          errorMessageValue['resolution'] = parameters.job.errorMessage.resolution;
        }
        
        if (parameters.job.errorMessage.severity !== null && parameters.job.errorMessage.severity !== undefined) {
          errorMessageValue['severity'] = parameters.job.errorMessage.severity;
        }
        
        if (parameters.job.errorMessage.source !== null && parameters.job.errorMessage.source !== undefined) {
          errorMessageValue['source'] = parameters.job.errorMessage.source;
        }
        
        if (parameters.job.errorMessage.startOffset !== null && parameters.job.errorMessage.startOffset !== undefined) {
          errorMessageValue['startOffset'] = parameters.job.errorMessage.startOffset;
        }
      }
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          var errorMessageValue2 = responseDoc['errorMessage'];
