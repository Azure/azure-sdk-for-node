 ...
 */
function _listAvailableSkus(location, country, location1, options, callback) {
  ...
  try {
    ...
    if (country === null || country === undefined || typeof country.valueOf() !== 'string') {
      throw new Error('country cannot be null or undefined and it must be of type string.');
    }
    if (location1 === null || location1 === undefined || typeof location1.valueOf() !== 'string') {
      throw new Error('location1 cannot be null or undefined and it must be of type string.');
    }
  ...
  let availableSkuRequest = new client.models['AvailableSkuRequest']();
  try {
    if ((country !== null && country !== undefined) || (location1 !== null && location1 !== undefined))
    {
...
class Service {
   ...
   */
  listAvailableSkusWithHttpOperationResponse(location, country, location1, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listAvailableSkus(location, country, location1, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listAvailableSkus(location, country, location1, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._listAvailableSkus(location, country, location1, options, optionalCallback);
    }
  }
