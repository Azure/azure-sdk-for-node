 ...
 */
class MigrateSqlServerSqlMISyncTaskProperties extends models['ProjectTaskProperties'] {
  /**
   * Create a MigrateSqlServerSqlMISyncTaskProperties.
  ...
  /**
   * Defines the metadata of MigrateSqlServerSqlMISyncTaskProperties
   *
        ...
        modelProperties: {
          ...
          output: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'MigrateSqlServerSqlMISyncTaskOutputElementType',
                  type: {
                    name: 'Composite',
                    polymorphicDiscriminator: {
...
module.exports = MigrateSqlServerSqlMISyncTaskProperties;
