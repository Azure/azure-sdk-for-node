...
/**
 * Class representing a MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputTableLevel.
 * @extends models['MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutput']
 */
class MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputTableLevel extends models['MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutput'] {
  /**
   * Create a MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputTableLevel.
  ...
  /**
   * Defines the metadata of MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputTableLevel
   *
   * @returns {object} metadata of MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputTableLevel
   *
   */
  mapper() {
    return {
...
module.exports = MigratePostgreSqlAzureDbForPostgreSqlSyncTaskOutputTableLevel;
