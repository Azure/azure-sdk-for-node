 ...
 *
 * @member {string} [extension] Optional File extension. If submitted it should
 * not have a leading period and must match the extension from filePath.
 ...
 * @member {string} [mediaType] File content type. This propery can be modified
 * to reflect the file content type.
 ...
 * from filePath.
 * @member {string} [properties.filePath] Relative path of this file resource.
 ...
 * @member {string} [properties.mediaType] File content type. This propery can
 * be modified to reflect the file content type.
 ...
 *
 * @member {number} bytesCopied The number of document bytes copied during the
 * Copying stage
 ...
 * @member {string} [qualifiedName] The qualified name of the progress object.
 * For a collection, this is the database-qualified name. For a database, this
 ...
 * @member {number} totalBytes The total number of document bytes on the source
 * at the beginning of the Copying stage, or -1 if the total size was unknown
 * @member {number} totalDocuments The total number of documents on the source
 * at the beginning of the Copying stage, or -1 if the total count was unknown
 */
 ...
 *
 * @member {object} [databases] The progress of the databases in the migration.
 ...
 * @member {number} [targetRUs] The RUs that should be configured on a CosmosDB
 ...
 * provisioned for the database. This has no effect on non-CosmosDB targets.
 */
 ...
 * @member {object} databases The databases on the source cluster to migrate to
 * the target. The keys are the names of the databases.
 * @member {string} [replication] Describes how changes will be replicated from
 * the source to the target. The default is OneTime. Possible values include:
 ...
 * the migration
 * @member {number} [throttling.minFreeCpu] The percentage of CPU time that the
 * migrator will try to avoid using, from 0 to 100
 * @member {number} [throttling.minFreeMemoryMb] The number of megabytes of RAM
 * that the migrator will try to avoid using
 ...
 * cluster
 * @member {string} [input.source.connectionString] A MongoDB connection string
 ...
 * cluster
 * @member {string} [input.target.connectionString] A MongoDB connection string
 * or blob container URL. The user name and password can be specified here or
 * in the userName and password properties
 ...
 * @member {number} [input.throttling.minFreeMemoryMb] The number of megabytes
 * of RAM that the migrator will try to avoid using
 ...
 *
 * @member {number} averageDocumentSize The average document size, or -1 if the
 * average size is unknown
 * @member {number} dataSize The estimated total data size, in bytes, or -1 if
 * the size is unknown.
 ...
 * collection
 * @member {object} [shardKey] The shard key on the collection, or null if the
 ...
 * necessary.
 * @member {string} [viewOf] The name of the collection that this is a view of,
 * if IsView is true
 */
 ...
 *
 * @member {string} [objectName] The qualified name of a database or collection
 * to act upon, or null to act upon the entire migration
 */
