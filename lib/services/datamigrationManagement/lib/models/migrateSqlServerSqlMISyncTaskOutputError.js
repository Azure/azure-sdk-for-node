...
/**
 * Class representing a MigrateSqlServerSqlMISyncTaskOutputError.
 * @extends models['MigrateSqlServerSqlMISyncTaskOutput']
 */
class MigrateSqlServerSqlMISyncTaskOutputError extends models['MigrateSqlServerSqlMISyncTaskOutput'] {
  /**
   * Create a MigrateSqlServerSqlMISyncTaskOutputError.
  ...
  /**
   * Defines the metadata of MigrateSqlServerSqlMISyncTaskOutputError
   *
   * @returns {object} metadata of MigrateSqlServerSqlMISyncTaskOutputError
   *
   */
  mapper() {
    return {
...
module.exports = MigrateSqlServerSqlMISyncTaskOutputError;
