...
class Certificate extends models['ProxyResource'] {
   ...
   * @property {string} [thumbprint] The thumbprint of the certificate. This
   * must match the thumbprint from the name.
   ...
   * 'Failed'
   * @property {date} [previousProvisioningStateTransitionTime] The time at
   * which the certificate entered its previous state.
   ...
   * programmatically.
   * @property {string} [deleteCertificateError.message] A message describing
   * the error, intended to be suitable for display in a user interface.
