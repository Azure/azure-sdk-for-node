 ...
 */
function _activate(resourceGroupName, accountName, applicationId, version, format, options, callback) {
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _create(resourceGroupName, accountName, applicationId, version, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _deleteMethod(resourceGroupName, accountName, applicationId, version, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _get(resourceGroupName, accountName, applicationId, version, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
...
class ApplicationPackageOperations {
  ...
  activateWithHttpOperationResponse(resourceGroupName, accountName, applicationId, version, format, options) {
    ...
    return new Promise((resolve, reject) => {
      self._activate(resourceGroupName, accountName, applicationId, version, format, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  activate(resourceGroupName, accountName, applicationId, version, format, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._activate(resourceGroupName, accountName, applicationId, version, format, options, optionalCallback);
    }
  }
  ...
  createWithHttpOperationResponse(resourceGroupName, accountName, applicationId, version, options) {
    ...
    let self = this;
    return new Promise((resolve, reject) => {
      self._create(resourceGroupName, accountName, applicationId, version, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  create(resourceGroupName, accountName, applicationId, version, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._create(resourceGroupName, accountName, applicationId, version, options, optionalCallback);
    }
  }
  ...
  deleteMethodWithHttpOperationResponse(resourceGroupName, accountName, applicationId, version, options) {
    ...
    let self = this;
    return new Promise((resolve, reject) => {
      self._deleteMethod(resourceGroupName, accountName, applicationId, version, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  deleteMethod(resourceGroupName, accountName, applicationId, version, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._deleteMethod(resourceGroupName, accountName, applicationId, version, options, optionalCallback);
    }
  }
  ...
  getWithHttpOperationResponse(resourceGroupName, accountName, applicationId, version, options) {
    ...
    let self = this;
    return new Promise((resolve, reject) => {
      self._get(resourceGroupName, accountName, applicationId, version, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  get(resourceGroupName, accountName, applicationId, version, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._get(resourceGroupName, accountName, applicationId, version, options, optionalCallback);
    }
  }
