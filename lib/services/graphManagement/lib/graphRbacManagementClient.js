...
class GraphRbacManagementClient extends ServiceClient {
   ...
   */
  constructor(credentials, tenantID, applicationID, baseUri, options) {
...
module.exports['default'] = GraphRbacManagementClient;
module.exports.GraphRbacManagementClient = GraphRbacManagementClient;
module.exports.GraphRbacManagementModels = models;
