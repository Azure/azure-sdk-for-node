 ...
 *
 */
function GraphRbacManagementClient(credentials, subscriptionId, tenantID, baseUri, options) {
  ...
  GraphRbacManagementClient['super_'].call(this, credentials, options);
...
util.inherits(GraphRbacManagementClient, ServiceClient);
