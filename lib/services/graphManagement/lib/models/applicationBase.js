 ...
 */
class ApplicationBase extends models['DirectoryObject'] {
  /**
   * Create a ApplicationBase.
   ...
   * application.
   * @property {object} [informationalUrls] urls with more informations of the
   * application.
   ...
   * objects
   * @property {array} [preAuthorizedApplications] list of pre-authorizaed
   * applications.
  ...
  /**
   * Defines the metadata of ApplicationBase
   *
   * @returns {object} metadata of ApplicationBase
   *
   */
  mapper() {
    return {
