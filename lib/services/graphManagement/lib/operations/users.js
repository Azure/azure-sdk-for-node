...
Users.prototype.create = function (parameters, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + '{tenantID}/users';
...
Users.prototype.get = function (upnOrObjectId, options, callback) {
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + '{tenantID}/users/{upnOrObjectId}';
...
Users.prototype.getMemberGroups = function (objectId, securityEnabledOnly, options, callback) {
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + '{tenantID}/users/{objectId}/getMemberGroups';
