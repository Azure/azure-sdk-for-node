 ...
 * for next set.
 */
class SignalRUsageList extends Array {
  /**
   * Create a SignalRUsageList.
  ...
  /**
   * Defines the metadata of SignalRUsageList
   *
   * @returns {object} metadata of SignalRUsageList
   *
   */
  mapper() {
    return {
        ...
        modelProperties: {
          value: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'SignalRUsageElementType',
                  type: {
                    name: 'Composite',
...
module.exports = SignalRUsageList;
