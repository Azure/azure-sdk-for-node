 ...
 * 
 */
function DeleteOperationResult(parameters) {
...
/**
 * Validate the payload against the DeleteOperationResult schema
 *
 * @param {JSON} payload
 *
 */
DeleteOperationResult.prototype.serialize = function () {
  var payload = {};
  if (this['operationId'] === null || this['operationId'] === undefined || typeof this['operationId'].valueOf() !== 'string') {
    throw new Error('this[\'operationId\'] cannot be null or undefined and it must be of type string.');
  }
  ...
  if (this['status'] !== null && this['status'] !== undefined) {
    ...
    throw new Error('this[\'status\'] cannot be null or undefined.');
  }

  if(!this['startTime'] || !(this['startTime'] instanceof Date || (typeof this['startTime'].valueOf() === 'string' && !isNaN(Date.parse(this['startTime']))))) {
    throw new Error('this[\'startTime\'] cannot be null or undefined and it must be of type date.');
  }
...
/**
 * Deserialize the instance to DeleteOperationResult schema
 *
 * @param {JSON} instance
 *
 */
DeleteOperationResult.prototype.deserialize = function (instance) {
  if (instance) {
