...
class VirtualMachineScaleSetVM extends models['Resource'] {
   ...
   * machine.
   * @property {object} [networkProfileConfiguration] Specifies the network
   * profile configuration of the virtual machine.
   * @property {array}
   * [networkProfileConfiguration.networkInterfaceConfigurations] The list of
   ...
   * @property {string} [modelDefinitionApplied] Specifies whether the model
   ...
   * @property {object} [protectionPolicy] Specifies the protection policy of
   * the virtual machine.
   * @property {boolean} [protectionPolicy.protectFromScaleIn] Indicates that
   * the virtual machine scale set VM shouldn't be considered for deletion
   * during a scale-in operation.
   * @property {boolean} [protectionPolicy.protectFromScaleSetActions]
