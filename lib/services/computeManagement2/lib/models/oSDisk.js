...
class OSDisk {
   ...
   * @member {object} [encryptionSettings.diskEncryptionKey] The disk
   ...
   * @member {string} [vhd.uri] The virtual hard disk's URI. Must be a valid
   ...
   * machine. If SourceImage is provided, the destination virtual hard disk
   * must not exist.
   ...
   * @member {string} [managedDisk.storageAccountType] The Storage Account
