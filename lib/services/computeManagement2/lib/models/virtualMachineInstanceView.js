 ...
 * 
 */
function VirtualMachineInstanceView(parameters) {
...
/**
 * Validate the payload against the VirtualMachineInstanceView schema
 *
 * @param {JSON} payload
 *
 */
VirtualMachineInstanceView.prototype.serialize = function () {
  var payload = {};
  ...
  if (util.isArray(this['disks'])) {
    ...
    for (var i = 0; i < this['disks'].length; i++) {
      if (this['disks'][i]) {
        if (payload['disks'] === null || payload['disks'] === undefined) {
          payload['disks'] = {};
        }
...
/**
 * Deserialize the instance to VirtualMachineInstanceView schema
 *
 * @param {JSON} instance
 *
 */
VirtualMachineInstanceView.prototype.deserialize = function (instance) {
  if (instance) {
