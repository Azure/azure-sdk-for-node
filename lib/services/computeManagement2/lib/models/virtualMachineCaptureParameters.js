 ...
 * @member {string} [vhdPrefix] Gets or sets the captured VirtualHardDisk's
 * name prefix.
 * 
...
VirtualMachineCaptureParameters.prototype.serialize = function () {
  var payload = {};
  if (this['vhdPrefix'] !== null && this['vhdPrefix'] !== undefined) {
    if (typeof this['vhdPrefix'].valueOf() !== 'string') {
      throw new Error('this[\'vhdPrefix\'] must be of type string.');
    }
    payload['vhdPrefix'] = this['vhdPrefix'];
  }

  if (this['destinationContainerName'] !== null && this['destinationContainerName'] !== undefined) {
    if (typeof this['destinationContainerName'].valueOf() !== 'string') {
      throw new Error('this[\'destinationContainerName\'] must be of type string.');
    }
    payload['destinationContainerName'] = this['destinationContainerName'];
  }

  if (this['overwriteVhds'] !== null && this['overwriteVhds'] !== undefined) {
    if (typeof this['overwriteVhds'] !== 'boolean') {
      throw new Error('this[\'overwriteVhds\'] must be of type boolean.');
    }
