...
class VirtualMachine extends models['Resource'] {
   ...
   * the encryption settings for the OS Disk. <br><br> Minimum api-version:
   * 2015-06-15
   * @property {object}
   ...
   * the virtual machine. <br><br> This name cannot be updated after the VM is
   ...
   * of the binary array is 65535 bytes. <br><br> For using cloud-init for your
   ...
   * <br><br>This may only be set to False when no extensions are present on
   * the virtual machine.
