...
class VirtualMachine extends models['Resource'] {
   ...
   * @member {string} [storageProfile.imageReference.version] The image
   ...
   * virtual hard disk. The virtual hard disk will be copied before using it to
   * attach to the virtual machine. If SourceImage is provided, the destination
   * virtual hard disk must not exist.
   ...
   * in GB, for blank data disks, and the new desired size for resizing
   ...
   * @member {string} [osProfile.windowsConfiguration.timeZone] The time zone
   * of the VM
   ...
   * a debugging feature which allows the user to view console output and/or a
   ...
   * @member {object} [availabilitySet] The reference Id of the availability
   * set to which the virtual machine belongs.
