...
class StorageProfile {
   ...
   * @member {string} [osDisk.osType] The Operating System type. Possible
   ...
   * The virtual hard disk will be copied before using it to attach to the
   ...
   * @member {number} [osDisk.diskSizeGB] The initial disk size, in GB, for
   * blank data disks, and the new desired size for resizing existing OS and
   * data disks.
