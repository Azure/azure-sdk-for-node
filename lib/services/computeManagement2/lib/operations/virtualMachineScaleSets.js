 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
VirtualMachineScaleSets.prototype.deallocate = function (resourceGroupName, vmScaleSetName, instanceIds, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Send request
  this.beginDeallocate(resourceGroupName, vmScaleSetName, instanceIds, options, function (err, parsedResult, httpRequest, response){
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
VirtualMachineScaleSets.prototype.beginDeallocate = function (resourceGroupName, vmScaleSetName, instanceIds, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
VirtualMachineScaleSets.prototype.beginDelete = function (resourceGroupName, vmScaleSetName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
VirtualMachineScaleSets.prototype.powerOff = function (resourceGroupName, vmScaleSetName, instanceIds, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Send request
  this.beginPowerOff(resourceGroupName, vmScaleSetName, instanceIds, options, function (err, parsedResult, httpRequest, response){
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
VirtualMachineScaleSets.prototype.beginPowerOff = function (resourceGroupName, vmScaleSetName, instanceIds, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
VirtualMachineScaleSets.prototype.restart = function (resourceGroupName, vmScaleSetName, instanceIds, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Send request
  this.beginRestart(resourceGroupName, vmScaleSetName, instanceIds, options, function (err, parsedResult, httpRequest, response){
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
VirtualMachineScaleSets.prototype.beginRestart = function (resourceGroupName, vmScaleSetName, instanceIds, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
VirtualMachineScaleSets.prototype.start = function (resourceGroupName, vmScaleSetName, instanceIds, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Send request
  this.beginStart(resourceGroupName, vmScaleSetName, instanceIds, options, function (err, parsedResult, httpRequest, response){
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
VirtualMachineScaleSets.prototype.beginStart = function (resourceGroupName, vmScaleSetName, instanceIds, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
