...
ContainerServices.prototype.list = function (options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/providers/Microsoft.ContainerService/containerServices';
 ...
 * 
 * @param {string} parameters.linuxProfile.adminUsername The administrator user
 * name to use for Linux VMs.
 * 
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ContainerServices.prototype.createOrUpdate = function (resourceGroupName, containerServiceName, parameters, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ContainerServices.prototype.deleteMethod = function (resourceGroupName, containerServiceName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ContainerServices.prototype.beginCreateOrUpdate = function (resourceGroupName, containerServiceName, parameters, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ContainerServices.prototype.beginDeleteMethod = function (resourceGroupName, containerServiceName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
