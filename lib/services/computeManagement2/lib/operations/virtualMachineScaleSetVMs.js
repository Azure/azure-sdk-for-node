 ...
 * machine.
 *
 * @param {object} [parameters.networkProfileConfiguration] Specifies the
 * network profile configuration of the virtual machine.
 *
 * @param {array}
 * [parameters.networkProfileConfiguration.networkInterfaceConfigurations] The
 ...
 *
 * @param {object} [parameters.protectionPolicy] Specifies the protection
 * policy of the virtual machine.
 *
 * @param {boolean} [parameters.protectionPolicy.protectFromScaleIn] Indicates
 * that the virtual machine scale set VM shouldn't be considered for deletion
 * during a scale-in operation.
 *
 * @param {boolean} [parameters.protectionPolicy.protectFromScaleSetActions]
 * Indicates that model updates or actions (including scale-in) initiated on
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _runCommand(resourceGroupName, vmScaleSetName, instanceId, parameters, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Send request
  this.beginRunCommand(resourceGroupName, vmScaleSetName, instanceId, parameters, options, (err, parsedResult, httpRequest, response) => {
    if (err) return callback(err);
...
function _beginReimage(resourceGroupName, vmScaleSetName, instanceId, options, callback) {
  ...
  let vmScaleSetVMReimageInput;
  if (tempDisk !== null && tempDisk !== undefined) {
    vmScaleSetVMReimageInput = new client.models['VirtualMachineScaleSetVMReimageParameters']();
  ...
  try {
    if (vmScaleSetVMReimageInput !== null && vmScaleSetVMReimageInput !== undefined) {
      let requestModelMapper = new client.models['VirtualMachineScaleSetVMReimageParameters']().mapper();
      requestModel = client.serialize(requestModelMapper, vmScaleSetVMReimageInput, 'vmScaleSetVMReimageInput');
      requestContent = JSON.stringify(requestModel);
    }
  } catch (error) {
    let serializationError = new Error(`Error "${error.message}" occurred in serializing the ` +
        `payload - ${JSON.stringify(vmScaleSetVMReimageInput, null, 2)}.`);
...
function _beginRunCommand(resourceGroupName, vmScaleSetName, instanceId, parameters, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/virtualmachines/{instanceId}/runCommand';
  requestUrl = requestUrl.replace('{resourceGroupName}', encodeURIComponent(resourceGroupName));
  requestUrl = requestUrl.replace('{vmScaleSetName}', encodeURIComponent(vmScaleSetName));
  requestUrl = requestUrl.replace('{instanceId}', encodeURIComponent(instanceId));
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
...
class VirtualMachineScaleSetVMs {
   ...
   * @reject {Error} - The error object.
   */
  runCommandWithHttpOperationResponse(resourceGroupName, vmScaleSetName, instanceId, parameters, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._runCommand(resourceGroupName, vmScaleSetName, instanceId, parameters, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  runCommand(resourceGroupName, vmScaleSetName, instanceId, parameters, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._runCommand(resourceGroupName, vmScaleSetName, instanceId, parameters, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  beginRunCommandWithHttpOperationResponse(resourceGroupName, vmScaleSetName, instanceId, parameters, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginRunCommand(resourceGroupName, vmScaleSetName, instanceId, parameters, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  beginRunCommand(resourceGroupName, vmScaleSetName, instanceId, parameters, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._beginRunCommand(resourceGroupName, vmScaleSetName, instanceId, parameters, options, optionalCallback);
    }
  }
