 ...
 *                      See {@link ComputeLongRunningOperationResult} for more
 *                      information.
 *
  ...
  this.beginCapture(resourceGroupName, vmName, parameters, options, function (err, parsedResult, httpRequest, response){
    ...
    client.getPostOrDeleteOperationResult(initialResult, options, function (err, pollingResult) {
      ...
      try {
        ...
        if (parsedResponse) {
          result = new client._models['ComputeLongRunningOperationResult'](parsedResponse);
        }
 ...
 * code.
 * 
 * @param {array} [parameters.resources] Gets the virtual machine child
 * extension resources.
 * 
 ...
 * 'Standard_A6', 'Standard_A7', 'Standard_A8', 'Standard_A9', 'Standard_G1',
 ...
 * 
 * @param {object} [parameters.instanceView] Gets the virtual machine instance
 * view.
 * 
 * @param {number} [parameters.instanceView.platformUpdateDomain] Gets or sets
 * the Update Domain count.
 * 
 * @param {number} [parameters.instanceView.platformFaultDomain] Gets or sets
 * the Fault Domain count.
 * 
 * @param {string} [parameters.instanceView.rdpThumbPrint] Gets or sets the
 * Remote desktop certificate thumbprint.
 * 
 * @param {object} [parameters.instanceView.vmAgent] Gets or sets the VM Agent
 ...
 * 
 * @param {object} [parameters.instanceView.bootDiagnostics] Gets or sets the
 * boot diagnostics.
 * 
 * @param {string}
 * [parameters.instanceView.bootDiagnostics.consoleScreenshotBlobUri] Gets or
 * sets the console screenshot blob Uri.
 * 
 * @param {string}
 * [parameters.instanceView.bootDiagnostics.serialConsoleLogBlobUri] Gets or
 * sets the Linux serial console log blob Uri.
 * 
 * @param {array} [parameters.instanceView.statuses] Gets or sets the resource
 * status information.
 * 
 ...
 * @param {string} vmName The name of the virtual machine.
 * 
 * @param {string} [expand] Name of the property to expand. Allowed value is
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
VirtualMachines.prototype.get = function (resourceGroupName, vmName, expand, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
