 ...
 */
function _getExtensions(resourceGroupName, vmName, options, callback) {
...
class VirtualMachines {
  ...
  getExtensionsWithHttpOperationResponse(resourceGroupName, vmName, options) {
    ...
    return new Promise((resolve, reject) => {
      self._getExtensions(resourceGroupName, vmName, options, (err, result, request, response) => {
  ...
  getExtensions(resourceGroupName, vmName, options, optionalCallback) {
    ...
    if (!optionalCallback) {
      ...
      return self._getExtensions(resourceGroupName, vmName, options, optionalCallback);
    }
  }
