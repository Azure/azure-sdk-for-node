...
VirtualMachines.prototype.convertToManagedDisks = function (resourceGroupName, vmName, options, callback) {
  ...
  // Send request
  this.beginConvertToManagedDisks(resourceGroupName, vmName, options, function (err, parsedResult, httpRequest, response){
    if (err) return callback(err);
...
VirtualMachines.prototype.beginConvertToManagedDisks = function (resourceGroupName, vmName, options, callback) {
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachines/{vmName}/convertToManagedDisks';
  requestUrl = requestUrl.replace('{resourceGroupName}', encodeURIComponent(resourceGroupName));
  requestUrl = requestUrl.replace('{vmName}', encodeURIComponent(vmName));
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  var queryParameters = [];
