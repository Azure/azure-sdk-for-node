...
class TestFailoverInputProperties {
   ...
   * @property {string} [networkType] Network type to be used for test
   * failover.
   * @property {string} [networkId] The id of the network to be used for test
   * failover
   * @property {string} [skipTestFailoverCleanup] A value indicating whether
   * the test failover cleanup is to be skipped.
