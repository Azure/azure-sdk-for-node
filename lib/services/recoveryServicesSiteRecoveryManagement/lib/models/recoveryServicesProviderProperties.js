...
class RecoveryServicesProviderProperties {
   ...
   * @property {string} [identityDetails.tenantId] The tenant Id for the
   * service principal with which the on-premise management/data plane
   * components would communicate with our Azure services.
   * @property {string} [identityDetails.applicationId] The application/client
   * Id for the service principal with which the on-premise management/data
