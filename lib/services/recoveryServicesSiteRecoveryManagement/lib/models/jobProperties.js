...
class JobProperties {
   ...
   * @property {string} [state] The status of the Job. It is one of these
   * values - NotStarted, InProgress, Succeeded, Failed, Cancelled, Suspended
   * or Other.
   ...
   * class.
   * @property {object} [customDetails] The custom job details like test
   * failover job details.
   * @property {object} [customDetails.affectedObjectDetails] The affected
   * object properties like source server, source cloud, target server, target
   * cloud etc. based on the workflow object details.
