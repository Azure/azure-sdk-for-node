...
class VCenter extends models['Resource'] {
   ...
   * @property {date} [properties.lastHeartbeat] The time when the last
   * heartbeat was received by vCenter.
   ...
   * @property {string} [properties.fabricArmResourceName] The ARM resource
   * name of the fabric containing this VCenter.
