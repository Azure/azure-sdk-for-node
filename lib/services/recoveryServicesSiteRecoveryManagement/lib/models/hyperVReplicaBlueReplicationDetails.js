 ...
 */
class HyperVReplicaBlueReplicationDetails extends models['ReplicationProviderSpecificSettings'] {
  /**
   * Create a HyperVReplicaBlueReplicationDetails.
  ...
  /**
   * Defines the metadata of HyperVReplicaBlueReplicationDetails
   *
   * @returns {object} metadata of HyperVReplicaBlueReplicationDetails
   *
   */
  mapper() {
    return {
...
module.exports = HyperVReplicaBlueReplicationDetails;
