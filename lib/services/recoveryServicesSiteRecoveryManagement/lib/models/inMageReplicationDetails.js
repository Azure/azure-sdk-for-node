...
class InMageReplicationDetails extends models['ReplicationProviderSpecificSettings'] {
   ...
   * @property {string} [activeSiteType] The active location of the VM. If the
   * VM is being protected from Azure, this field will take values from {
   * Azure, OnPrem }. If the VM is being protected between two data-centers,
   * this field will be OnPrem always.
   * @property {number} [sourceVmCpuCount] The CPU count of the VM on the
   * primary side.
   * @property {number} [sourceVmRamSizeInMB] The RAM size of the VM on the
   * primary side.
   * @property {object} [osDetails] The OS details.
   * @property {string} [osDetails.osVhdId] The id of the disk containing the
   * OS.
   ...
   * replication type.
   * @property {string} [resyncDetails.initialReplicationProgressPercentage]
   ...
   * @property {number} [compressedDataRateInMB] The compressed data change
   * rate in MB.
   ...
   * @property {object} [consistencyPoints] The collection of Consistency
   * points.
   * @property {string} [diskResized] A value indicating whether any disk is
   * resized for this VM.
   * @property {string} [rebootAfterUpdateStatus] A value indicating whether
   ...
   * @property {string} [multiVmSyncStatus] A value indicating whether the
   * multi vm sync is enabled or disabled.
   ...
   * @property {string} [agentDetails.postUpdateRebootStatus] A value
   * indicating whether reboot is required after update is applied.
   * @property {date} [agentDetails.agentExpiryDate] Agent expiry date.
   * @property {string} [vCenterInfrastructureId] The vCenter infrastructure
   * Id.
   * @property {string} [infrastructureVmId] The infrastructure VM Id.
   * @property {array} [vmNics] The PE Network details.
   * @property {string} [discoveryType] A value indicating the discovery type
   * of the machine.
   * @property {string} [azureStorageAccountId] A value indicating the
   * underlying Azure storage account. If the VM is not running in Azure, this
   * value shall be set to null.
   * @property {array} [datastores] The data stores of the on-premise machine
   * Value can be list of strings that contain data store names
   * @property {array} [validationErrors] The validation errors of the
   ...
   * @property {date} [lastUpdateReceivedTime] The last update time received
