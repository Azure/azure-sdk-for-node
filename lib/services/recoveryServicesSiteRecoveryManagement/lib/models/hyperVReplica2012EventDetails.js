 ...
 */
class HyperVReplica2012EventDetails extends models['EventProviderSpecificDetails'] {
  /**
   * Create a HyperVReplica2012EventDetails.
  ...
  /**
   * Defines the metadata of HyperVReplica2012EventDetails
   *
   * @returns {object} metadata of HyperVReplica2012EventDetails
   *
   */
  mapper() {
    return {
...
module.exports = HyperVReplica2012EventDetails;
