...
class InMageVolumeExclusionOptions {
   ...
   * @property {string} [onlyExcludeIfSingleVolume] The value indicating
   * whether to exclude multi volume disk or not. If a disk has multiple
   * volumes and one of the volume has label matching with VolumeLabel this
   * disk will be excluded from replication if OnlyExcludeIfSingleVolume is
   * false.
   */
  constructor() {
  }
