...
class HyperVReplicaAzureReplicationDetails extends models['ReplicationProviderSpecificSettings'] {
   ...
   * @property {string} [recoveryAzureStorageAccount] The recovery Azure
   * storage account.
   * @property {string} [recoveryAzureLogStorageAccountId] The ARM id of the
   * log storage account used for replication. This will be set to null if no
   * log storage account was provided during enable protection.
   ...
   * @property {object} [initialReplicationDetails] Initial replication
   * details.
   ...
   * @property {string} [recoveryAzureResourceGroupId] The target resource
   * group Id.
