 ...
 */
class HyperVReplicaAzureUpdateReplicationProtectedItemInput extends models['UpdateReplicationProtectedItemProviderInput'] {
  /**
   * Create a HyperVReplicaAzureUpdateReplicationProtectedItemInput.
  ...
  /**
   * Defines the metadata of HyperVReplicaAzureUpdateReplicationProtectedItemInput
   *
   * @returns {object} metadata of HyperVReplicaAzureUpdateReplicationProtectedItemInput
   *
   */
  mapper() {
    return {
...
module.exports = HyperVReplicaAzureUpdateReplicationProtectedItemInput;
