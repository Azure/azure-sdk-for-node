...
class OperationsDiscovery {
   ...
   * @property {string} [display.operation] The operation. The localized
   * friendly name for the operation, as it should be shown to the user. It
   * should be concise (to fit in drop downs) but clear (i.e.
   * self-documenting). It should use Title Casing. Prescriptive guidance: Read
   * Create or Update Delete 'ActionName'
   ...
   * @property {string} [origin] Origin. The intended executor of the
