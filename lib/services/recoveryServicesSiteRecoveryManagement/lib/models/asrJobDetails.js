 ...
 */
class AsrJobDetails extends models['JobDetails'] {
  /**
   * Create a AsrJobDetails.
   */
  constructor() {
    super();
  }
  ...
  /**
   * Defines the metadata of AsrJobDetails
   *
   * @returns {object} metadata of AsrJobDetails
   *
   */
  mapper() {
    return {
