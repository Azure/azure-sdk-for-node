...
class HealthErrorSummary {
   ...
   * 'FabricInfrastructure', 'ContainerInfrastructure', 'VersionExpiry',
   * 'AgentAutoUpdate'
      ...
      type: {
        ...
        modelProperties: {
          ...
          category: {
            ...
            type: {
              name: 'Enum',
              allowedValues: [ 'None', 'Replication', 'TestFailover', 'Configuration', 'FabricInfrastructure', 'ContainerInfrastructure', 'VersionExpiry', 'AgentAutoUpdate' ]
            }
          },
          severity: {
            required: false,
