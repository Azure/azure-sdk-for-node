...
var SettingOperations = ( /** @lends SettingOperations */ function() {
  ...
  SettingOperations.prototype.createOrUpdate = function(resourceGroupName, autoscaleSettingName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '/providers/microsoft.insights/autoscalesettings/' + autoscaleSettingName.trim() + '?';
  ...
  SettingOperations.prototype.list = function(resourceGroupName, targetResourceUri, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '/providers/microsoft.insights/autoscalesettings?';
    url2 = url2 + 'api-version=2014-04';
