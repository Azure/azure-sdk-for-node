...
var AlertsClient = ( /** @lends AlertsClient */ function() {
   ...
   * 
   * @param {string} [baseUri] Optional base uri parameter for Azure REST.
   * 
   * @param {Array} filters
   */
...
var IncidentOperations = ( /** @lends IncidentOperations */ function() {
  ...
  IncidentOperations.prototype.get = function(incidentId, callback) {
    ...
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/monitoring/alertincidents/' + incidentId.trim();
  ...
  IncidentOperations.prototype.listActiveForSubscription = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/monitoring/alertincidents?$filter=IsActive eq true';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  IncidentOperations.prototype.listForRule = function(ruleId, isActive, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/monitoring/alertrules/' + ruleId.trim() + '/alertincidents?';
...
var RuleOperations = ( /** @lends RuleOperations */ function() {
  ...
  RuleOperations.prototype.createOrUpdate = function(parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/monitoring/alertrules/' + parameters.rule.id.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
    ...
    if (parameters.rule) {
      if (parameters.rule.id) {
        requestDoc = {};
        requestDoc['Id'] = parameters.rule.id;
      }
      
      if (parameters.rule.name) {
        requestDoc = {};
        requestDoc['Name'] = parameters.rule.name;
      }
      
      if (parameters.rule.description) {
        requestDoc = {};
  ...
  RuleOperations.prototype.delete = function(ruleId, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/monitoring/alertrules/' + ruleId.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  RuleOperations.prototype.list = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/monitoring/alertrules';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
