...
var IncidentOperations = ( /** @lends IncidentOperations */ function() {
  ...
  IncidentOperations.prototype.get = function(resourceGroupName, ruleName, incidentName, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '/providers/microsoft.insights/alertrules/' + ruleName.trim() + '/incidents/' + incidentName.trim() + '?';
  ...
  IncidentOperations.prototype.listForRule = function(resourceGroupName, ruleName, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '/providers/microsoft.insights/alertrules/' + ruleName.trim() + '/incidents?';
    url2 = url2 + 'api-version=2014-04';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
...
var RuleOperations = ( /** @lends RuleOperations */ function() {
  ...
  RuleOperations.prototype.createOrUpdate = function(resourceGroupName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '/providers/microsoft.insights/alertrules/' + (parameters.properties.name !== null && parameters.properties.name !== undefined ? parameters.properties.name.trim() : '') + '?';
    url2 = url2 + 'api-version=2014-04';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
    ...
    if (parameters.properties !== null && parameters.properties !== undefined) {
      ...
      if (parameters.properties.condition !== null && parameters.properties.condition !== undefined) {
        ...
        if (parameters.properties.condition.type === 'Microsoft.WindowsAzure.Management.Monitoring.Alerts.Models.LocationThresholdRuleCondition') {
          ...
          if (derived3.dataSource !== null && derived3.dataSource !== undefined) {
            ...
            if (derived3.dataSource.type === 'Microsoft.WindowsAzure.Management.Monitoring.Alerts.Models.RuleMetricDataSource') {
              ...
              if (derived4.resourceUri !== null && derived4.resourceUri !== undefined) {
                dataSourceValue2['resourceUri'] = derived4.resourceUri;
              }
              
              if (derived4.metricNamespace !== null && derived4.metricNamespace !== undefined) {
                dataSourceValue2['metricNamespace'] = derived4.metricNamespace;
              }
              
              if (derived4.metricName !== null && derived4.metricName !== undefined) {
      ...
      if (parameters.properties.action !== null && parameters.properties.action !== undefined) {
        ...
        if (parameters.properties.action.type === 'Microsoft.WindowsAzure.Management.Monitoring.Alerts.Models.RuleEmailAction') {
          ...
          if (derived5.customEmails !== null && derived5.customEmails !== undefined) {
  ...
  RuleOperations.prototype.delete = function(resourceGroupName, ruleName, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '/providers/microsoft.insights/alertrules/' + ruleName.trim() + '?';
    url2 = url2 + 'api-version=2014-04';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
  ...
  RuleOperations.prototype.list = function(resourceGroupName, targetResourceUri, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '/providers/microsoft.insights/alertrules?';
    url2 = url2 + 'api-version=2014-04';
    if (targetResourceUri !== null && targetResourceUri !== undefined) {
      url2 = url2 + '&$filter=targetResourceUri eq ' + encodeURIComponent(targetResourceUri !== null && targetResourceUri !== undefined ? targetResourceUri.trim() : '');
    }
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
