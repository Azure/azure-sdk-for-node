...
var IncidentOperations = ( /** @lends IncidentOperations */ function() {
  ...
  IncidentOperations.prototype.get = function(incidentId, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/monitoring/alertincidents/' + incidentId.trim();
  ...
  IncidentOperations.prototype.listActiveForSubscription = function(callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/monitoring/alertincidents?$filter=IsActive eq true';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  IncidentOperations.prototype.listForRule = function(ruleId, isActive, callback) {
    ...
    if (isActive === null || isActive === undefined) {
      return callback(new Error('isActive cannot be null.'));
    }
    
    // Tracing
    
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/monitoring/alertrules/' + ruleId.trim() + '/alertincidents?';
    var appendFilter = true;
    appendFilter = false;
    url2 = url2 + '$filter=IsActive eq ' + encodeURIComponent(isActive.toString());
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
...
var RuleOperations = ( /** @lends RuleOperations */ function() {
  ...
  RuleOperations.prototype.createOrUpdate = function(parameters, callback) {
    ...
    if (parameters.rule !== null && parameters.rule !== undefined) {
      if (parameters.rule.isEnabled === null || parameters.rule.isEnabled === undefined) {
        return callback(new Error('parameters.rule.isEnabled cannot be null.'));
      }
      if (parameters.rule.lastUpdatedTime === null || parameters.rule.lastUpdatedTime === undefined) {
        return callback(new Error('parameters.rule.lastUpdatedTime cannot be null.'));
      }
    }
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/monitoring/alertrules/' + (parameters.rule.id !== null && parameters.rule.id !== undefined ? parameters.rule.id.trim() : '');
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
   ...
   * @returns {Stream} The response stream.
   */
  RuleOperations.prototype.delete = function(ruleId, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/monitoring/alertrules/' + ruleId.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  RuleOperations.prototype.list = function(callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/monitoring/alertrules';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
