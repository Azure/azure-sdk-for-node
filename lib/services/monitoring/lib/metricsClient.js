...
var MetricDefinitionOperations = ( /** @lends MetricDefinitionOperations */ function() {
  ...
  MetricDefinitionOperations.prototype.list = function(parameters, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/providers/microsoft.insights/metricDefinitions/resource/' + parameters.resourceId.trim() + '?';
...
var MetricValueOperations = ( /** @lends MetricValueOperations */ function() {
  ...
  MetricValueOperations.prototype.list = function(parameters, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/providers/microsoft.insights/metrics/resource/' + parameters.resourceId.trim() + '?';
    url2 = url2 + 'api-version=2014-01';
    url2 = url2 + '&names=' + encodeURIComponent(parameters.metricNames.join(','));
