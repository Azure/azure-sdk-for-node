...
var EventsClient = ( /** @lends EventsClient */ function() {
   ...
   * @constructor
   * 
   * @param {SubscriptionCloudCredentials} credentials Windows Azure
   * subscription id.
   * 
...
var EventDataOperations = ( /** @lends EventDataOperations */ function() {
  ...
  EventDataOperations.prototype.listEvents = function(parameters, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + '/subscriptions/' + this.client.credentials.subscriptionId + '/providers/microsoft.insights/eventtypes/management/values?';
    url2 = url2 + 'api-version=2014-04';
    url2 = url2 + '&$filter=eventTimestamp ge \'' + encodeURIComponent(parameters.startTime.toString()) + '\' and ';
    if (parameters.endTime) {
      url2 = url2 + '&eventTimestamp le \'' + encodeURIComponent(parameters.endTime.toString()) + '\' and ';
    }
    ...
    if (parameters.nextLink) {
      url2 = url2 + '&$skipToken=' + encodeURIComponent(parameters.nextLink);
    }
  ...
  EventDataOperations.prototype.listEventsForCorrelationId = function(parameters, callback) {
    ...
    var url2 = this.client.baseUri + '/subscriptions/' + this.client.credentials.subscriptionId + '/providers/microsoft.insights/eventtypes/management/values?';
    url2 = url2 + 'api-version=2014-04';
    url2 = url2 + '&$filter=correlationId eq \'' + encodeURIComponent(parameters.correlationId) + '\' and ';
    url2 = url2 + '&eventTimestamp ge \'' + encodeURIComponent(parameters.startTime.toString()) + '\' and ';
    if (parameters.endTime) {
      url2 = url2 + '&eventTimestamp le \'' + encodeURIComponent(parameters.endTime.toString()) + '\' and ';
    }
    if (parameters.eventChannels) {
  ...
  EventDataOperations.prototype.listEventsForEventSource = function(parameters, callback) {
    ...
    var url2 = this.client.baseUri + '/subscriptions/' + this.client.credentials.subscriptionId + '/providers/microsoft.insights/eventtypes/management/values?';
    url2 = url2 + 'api-version=2014-04';
    url2 = url2 + '&$filter=eventSource eq \'' + encodeURIComponent(parameters.eventSource) + '\' and ';
    url2 = url2 + '&eventTimestamp ge \'' + encodeURIComponent(parameters.startTime.toString()) + '\' and ';
    if (parameters.endTime) {
      url2 = url2 + '&eventTimestamp le \'' + encodeURIComponent(parameters.endTime.toString()) + '\' and ';
    }
  ...
  EventDataOperations.prototype.listEventsForResource = function(parameters, callback) {
    ...
    var url2 = this.client.baseUri + '/subscriptions/' + this.client.credentials.subscriptionId + '/providers/microsoft.insights/eventtypes/management/values?';
    url2 = url2 + 'api-version=2014-04';
    url2 = url2 + '&$filter=resourceUri eq \'' + encodeURIComponent(parameters.resourceUri) + '\' and ';
    url2 = url2 + '&eventTimestamp ge \'' + encodeURIComponent(parameters.startTime.toString()) + '\' and ';
    if (parameters.endTime) {
      url2 = url2 + '&eventTimestamp le \'' + encodeURIComponent(parameters.endTime.toString()) + '\' and ';
    }
  ...
  EventDataOperations.prototype.listEventsForResourceGroup = function(parameters, callback) {
    ...
    var url2 = this.client.baseUri + '/subscriptions/' + this.client.credentials.subscriptionId + '/providers/microsoft.insights/eventtypes/management/values?';
    url2 = url2 + 'api-version=2014-04';
    url2 = url2 + '&$filter=resourceGroupName eq \'' + encodeURIComponent(parameters.resourceGroupName) + '\' and ';
    url2 = url2 + '&eventTimestamp ge \'' + encodeURIComponent(parameters.startTime.toString()) + '\' and ';
    if (parameters.endTime) {
      url2 = url2 + '&eventTimestamp le \'' + encodeURIComponent(parameters.endTime.toString()) + '\' and ';
    }
  ...
  EventDataOperations.prototype.listEventsForResourceProvider = function(parameters, callback) {
    ...
    var url2 = this.client.baseUri + '/subscriptions/' + this.client.credentials.subscriptionId + '/providers/microsoft.insights/eventtypes/management/values?';
    url2 = url2 + 'api-version=2014-04';
    url2 = url2 + '&$filter=resourceProvider eq \'' + encodeURIComponent(parameters.resourceProvider) + '\' and ';
    url2 = url2 + '&eventTimestamp ge \'' + encodeURIComponent(parameters.startTime.toString()) + '\' and ';
    if (parameters.endTime) {
      url2 = url2 + '&eventTimestamp le \'' + encodeURIComponent(parameters.endTime.toString()) + '\' and ';
    }
