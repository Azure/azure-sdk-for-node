...
var EventDataOperations = ( /** @lends EventDataOperations */ function() {
  ...
  EventDataOperations.prototype.listEvents = function(parameters, callback) {
    ...
    var url2 = '/subscriptions/' + this.client.credentials.subscriptionId.trim() + '/providers/microsoft.insights/eventtypes/management/values?';
    ...
    if (parameters.nextLink) {
      url2 = url2 + '&$skipToken=' + encodeURIComponent(parameters.nextLink.trim());
    }
