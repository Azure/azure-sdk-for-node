...
var StorageAccountOperations = ( /** @lends StorageAccountOperations */ function() {
  ...
  StorageAccountOperations.prototype.checkNameAvailability = function(accountName, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + '/' + this.client.credentials.subscriptionId + '/services/storageservices/operations/isavailable/' + accountName;
  ...
  StorageAccountOperations.prototype.delete = function(accountName, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + '/' + this.client.credentials.subscriptionId + '/services/storageservices/' + accountName;
  ...
  StorageAccountOperations.prototype.getKeys = function(accountName, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + '/' + this.client.credentials.subscriptionId + '/services/storageservices/' + accountName + '/keys';
  ...
  StorageAccountOperations.prototype.regenerateKeys = function(parameters, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + '/' + this.client.credentials.subscriptionId + '/services/storageservices/' + parameters.name + '/keys?action=regenerate';
