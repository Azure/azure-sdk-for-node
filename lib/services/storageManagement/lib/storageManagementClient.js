...
var StorageAccountOperations = (function() {
   ...
   * Represents the name of an extended storage account property. Each
   * extended property must have both a defined name and value. You can have a
   * maximum of 50 extended property name/value pairs.  The maximum length of
   ...
   * extended property owned by the same storage account, will result in a
   * status code 400 (Bad Request) error.  Each extended property value has a
   ...
   * extended property owned by the same storage account, will result in a
   * status code 400 (Bad Request) error.  Each extended property value has a
   * maximum length of 255 characters.  You can delete an extended property by
