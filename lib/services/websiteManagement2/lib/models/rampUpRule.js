...
class RampUpRule {
  /**
   * Create a RampUpRule.
   * @property {string} [actionHostName] Hostname of a slot to which the
   * traffic will be redirected if decided to. E.g.
   * myapp-stage.azurewebsites.net.
   * @property {number} [reroutePercentage] Percentage of the traffic which
   * will be redirected to <code>ActionHostName</code>.
   * @property {number} [changeStep] In auto ramp up scenario this is the step
   * to to add/remove from <code>ReroutePercentage</code> until it reaches
   ...
   * @property {number} [changeIntervalInMinutes] Specifies interval in
   ...
   * which ReroutePercentage will stay.
   * @property {string} [changeDecisionCallbackUrl] Custom decision algorithm
