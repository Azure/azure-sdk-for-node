...
class BackupSchedule {
   ...
   * @property {number} frequencyInterval How often the backup should be
   ...
   * @property {boolean} keepAtLeastOneBackup True if the retention policy
   * should always keep at least one backup in the storage account, regardless
   * how old it is; false otherwise. Default value: true .
   * @property {number} retentionPeriodInDays After how many days backups
