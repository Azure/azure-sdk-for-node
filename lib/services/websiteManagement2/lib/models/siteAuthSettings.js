...
class SiteAuthSettings extends models['ProxyOnlyResource'] {
   ...
   * <code>false</code>.
   * @property {string} [runtimeVersion] The RuntimeVersion of the
   ...
   * @property {string} [unauthenticatedClientAction] The action to take when
   ...
   * @property {string} [defaultProvider] The default authentication provider
   ...
   * the client secret, that is the thumbprint of a certifite used for signing
   ...
   * @property {string} [twitterConsumerSecret] The OAuth 1.0a consumer secret
