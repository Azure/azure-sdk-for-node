...
class CustomHostnameAnalysisResult extends models['ProxyOnlyResource'] {
   ...
   * code.
   * @property {string} [customDomainVerificationFailureInfo.message] Any
   * details of the error.
   * @property {boolean} [hasConflictOnScaleUnit] <code>true</code> if there is
   * a conflict on a scale unit; otherwise, <code>false</code>.
   ...
   * @property {string} [conflictingAppResourceId] Name of the conflicting app
   ...
   * hostname.
   * @property {array} [aRecords] A records controller can see for this
   * hostname.
   * @property {array} [alternateCNameRecords] Alternate CName records
   * controller can see for this hostname.
   * @property {array} [alternateTxtRecords] Alternate TXT records controller
