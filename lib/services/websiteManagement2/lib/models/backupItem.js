...
class BackupItem extends models['ProxyOnlyResource'] {
   ...
   * @property {string} [blobName] Name of the blob which contains data for
   * this backup.
   ...
   * @property {boolean} [scheduled] True if this backup has been created due
   * to a schedule being triggered.
   ...
   * @property {string} [correlationId] Unique correlation identifier. Please
   * use this along with the timestamp while communicating with Azure support.
