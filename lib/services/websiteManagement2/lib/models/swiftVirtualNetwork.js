...
class SwiftVirtualNetwork extends models['ProxyOnlyResource'] {
   ...
   * @property {string} [subnetResourceId] The Virtual Network subnet's
   * resource ID. This is the subnet that this Web App will join. This subnet
   * must have a delegation to Microsoft.Web/serverFarms defined first.
   * @property {boolean} [swiftSupported] A flag that specifies if the scale
   * unit this Web App is on supports Swift integration.
   */
  constructor() {
    super();
  }
