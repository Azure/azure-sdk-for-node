...
class AppServicePlanPatchResource extends models['ProxyOnlyResource'] {
   ...
   * @property {number} [maximumNumberOfWorkers] Maximum number of instances
   * that can be assigned to this App Service plan.
   * @property {string} [geoRegion] Geographical location for the App Service
   * plan.
   * @property {boolean} [perSiteScaling] If <code>true</code>, apps assigned
   ...
   * owns spot instances.
   * @property {date} [spotExpirationTime] The time when the server farm
   ...
   * @property {boolean} [reserved] If Linux app service plan
