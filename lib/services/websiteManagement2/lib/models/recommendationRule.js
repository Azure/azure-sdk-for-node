...
class RecommendationRule extends models['ProxyOnlyResource'] {
   ...
   * @property {string} [description] Localized detailed description of the
   * rule.
   * @property {string} [actionName] Name of action that is recommended by this
   * rule in string.
   * @property {string} [level] Level of impact indicating how critical this
   * rule is. Possible values include: 'Critical', 'Warning', 'Information',
   * 'NonUrgentSuggestion'
