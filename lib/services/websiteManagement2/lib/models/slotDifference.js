...
class SlotDifference extends models['ProxyOnlyResource'] {
   ...
   * @property {string} [level] Level of the difference: Information, Warning
   * or Error.
   * @property {string} [settingType] The type of the setting: General,
   * AppSetting or ConnectionString.
   * @property {string} [diffRule] Rule that describes how to process the
   * setting difference during a slot swap.
   * @property {string} [settingName] Name of the setting.
   * @property {string} [valueInCurrentSlot] Value of the setting in the
   * current slot.
