...
class SiteConfigResource extends models['ProxyOnlyResource'] {
   ...
   * @property {number} [logsDirectorySizeLimit] HTTP logs directory size
   * limit.
   ...
   * 'VSO'
   * @property {boolean} [use32BitWorkerProcess] <code>true</code> to use
   ...
   * @property {object} [experiments] This is work around for polymorphic
   * types.
   ...
   * MB.
   * @property {number} [limits.maxDiskSizeInMb] Maximum allowed disk size
   * usage in MB.
   * @property {boolean} [autoHealEnabled] <code>true</code> if Auto Heal is
   * enabled; otherwise, <code>false</code>.
   * @property {object} [autoHealRules] Auto Heal rules.
   * @property {object} [autoHealRules.triggers] Conditions that describe when
   * to execute the auto-heal actions.
   ...
   * interval.
   * @property {number} [autoHealRules.triggers.privateBytesInKB] A rule based
   * on private bytes.
   ...
   * @property {object} [autoHealRules.actions.customAction] Custom action to
   * be taken.
   * @property {string} [autoHealRules.actions.customAction.exe] Executable to
   * be run.
   ...
   * '1.1', '1.2'
   * @property {string} [ftpsState] State of FTP / FTPS service. Possible
