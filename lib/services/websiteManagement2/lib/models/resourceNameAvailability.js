...
class ResourceNameAvailability {
   ...
   * unavailable, or both.
   * @property {string} [reason] <code>Invalid</code> indicates the name
   ...
   * 'AlreadyExists'
   * @property {string} [message] If reason == invalid, provide the user with
   * the reason why the given name is invalid, and provide the resource naming
