...
class DomainAvailablilityCheckResult {
   ...
   * @property {boolean} [available] <code>true</code> if domain can be
   * purchased using CreateDomain API; otherwise, <code>false</code>.
   * @property {string} [domainType] Valid values are Regular domain: Azure
