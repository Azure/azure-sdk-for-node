...
class PremierAddOnOffer extends models['ProxyOnlyResource'] {
   ...
   * @property {boolean} [promoCodeRequired] <code>true</code> if promotion
   * code is required; otherwise, <code>false</code>.
   * @property {number} [quota] Premier add on offer Quota.
   * @property {string} [webHostingPlanRestrictions] App Service plans this
   * offer is restricted to. Possible values include: 'None', 'Free', 'Shared',
