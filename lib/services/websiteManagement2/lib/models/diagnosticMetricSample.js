...
class DiagnosticMetricSample {
   ...
   * @property {string} [roleInstance] Role Instance. Null if this counter is
   * not per instance
   ...
   * period
   * @property {boolean} [isAggregated] Whether the values are aggregates
   * across all workers or not
   */
  constructor() {
  }
