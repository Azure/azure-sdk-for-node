...
class SitePatchResource extends models['ProxyOnlyResource'] {
   ...
   * version.
   * @member {boolean} [siteConfig.httpLoggingEnabled] <code>true</code> if
   ...
   * @member {boolean} [siteConfig.localMySqlEnabled] <code>true</code> to
   ...
   * retained.
   * @member {boolean} [cloningInfo.configureLoadBalancing] <code>true</code>
   ...
   * /subscriptions/{subId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName}/slots/{slotName}
   * for other slots.
   * @member {boolean} [snapshotInfo.overwrite] If <code>true</code> the
