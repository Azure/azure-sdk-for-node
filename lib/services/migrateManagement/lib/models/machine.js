...
class Machine extends models['BaseResource'] {
   ...
   * @property {string} [name] Name of the machine. It is a GUID which is
   * unique identifier of machine in private data center. For user-readable
   ...
   * attached to the machine. Key is ID of network adapter. Value is a network
   * adapter object
   */
  constructor() {
    super();
