...
class AssessedMachine extends models['BaseResource'] {
   ...
   * @property {array} [groups] List of references to the groups that the
   * machine is member of.
   * @property {date} [discoveredTimestamp] Time when this machine was
   * discovered by Azure Migrate agent. Date-Time represented in ISO-8601
   * format.
   * @property {string} [bootType] Boot type of the machine. Possible values
   * include: 'Unknown', 'EFI', 'BIOS'
   * @property {string} [datacenterContainer] Container defined in the
   * management solution that this machine is part of in the datacenter.
   * @property {string} [datacenterManagementServer] Name of the server hosting
   * the datacenter management solution.
   * @property {string} [datacenterMachineId] ID of the machine as tracked by
   * the datacenter management solution.
   ...
   * @property {number} [monthlyBandwidthCost] Monthly network cost estimate
   * for the network adapters that are attached to this machine as a group, for
   * a 31-day month.
   ...
   * month.
   * @property {object} [disks] Dictionary of disks attached to the machine.
   * Key is ID of disk. Value is a disk object.
   * @property {object} [networkAdapters] Dictionary of network adapters
   * attached to the machine. Key is name of the adapter. Value is a network
   * adapter object.
   ...
   * @property {number} [numberOfCoresForRecommendedSize] Number of CPU cores
   * in the Recommended Azure VM Size.
   * @property {number} [megabytesOfMemoryForRecommendedSize] Megabytes of
   * memory in the Recommended Azure VM Size.
   * @property {number} [monthlyComputeCostForRecommendedSize] Compute Cost for
   * a 31-day month, if the machine is migrated to Azure with the Recommended
   * Size.
   ...
   * data points for percentage of cores utilization.
   * @property {number} [percentageMemoryUtilizationDataPointsExpected]
   * Expected data points for percentage of memory utilization.
   * @property {number} [percentageMemoryUtilizationDataPointsReceived]
   ...
   * @property {date} [updatedTimestamp] Time when this machine was last
