...
class Assessment extends models['BaseResource'] {
   ...
   * @property {string} azureStorageRedundancy Storage Redundancy type offered
   ...
   * @property {string} stage User configurable setting that describes the
   ...
   * @property {date} [pricesTimestamp] Time when the Azure Prices were
   * queried. Date-Time represented in ISO-8601 format.
   ...
   * for the machines that are part of this assessment as a group, for a 31-day
   * month.
   * @property {number} [monthlyStorageCost] Monthly storage cost estimate for
   * the machines that are part of this assessment as a group, for a 31-day
   * month.
   * @property {string} [status] Whether the assessment has been created and is
