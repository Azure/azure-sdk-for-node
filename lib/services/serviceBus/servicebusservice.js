...
* @param {string}             [optionsOrCallback.brokerProperties.contentType]                     The message's content type.
* @param {string}             [optionsOrCallback.brokerProperties.correlationId]                   The message's correlation identifier (x-ms-correlation-id).
* @param {string}             [optionsOrCallback.brokerProperties.groupId]                         The message's group identifier (x-ms-group-id).
* @param {string}             [optionsOrCallback.brokerProperties.label]                           The message's lable (x-ms-lalel).
* @param {string}             [optionsOrCallback.brokerProperties.replyTo]                         The message's reply to (x-ms-reply-to).
* @param {string}             [optionsOrCallback.brokerProperties.timeToLive]                      The message's time to live (x-ms-ttl).
* @param {string}             [optionsOrCallback.brokerProperties.scheduledEnqueueTimeUtc]         The message's scheduled enqueue time in UTC (x-ms-scheduled-enqueue-time).
...
* @param {string}             [optionsOrCallback.filter.correlationExpression]          Defines the expression that the rule evaluates. Only the messages whose CorrelationId match the CorrelationId set in the filter expression are allowed. Only one between a correlation and a sql expression can be defineed.
