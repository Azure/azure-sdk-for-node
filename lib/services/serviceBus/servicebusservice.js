...
ServiceBusService.prototype.createQueue = function (queuePath, optionsOrCallback, callback) {
  ...
  this._createResource(queuePath, QueueResult, optionsOrCallback, callback);
};
...
ServiceBusService.prototype.createTopic = function (topic, optionsOrCallback, callback) {
  ...
  this._createResource(topic, TopicResult, optionsOrCallback, callback);
};
...
ServiceBusService.prototype.createSubscription = function (topicPath, subscriptionPath, optionsOrCallback, callback) {
  ...
  var subscriptionFullPath = createSubscriptionPath(topicPath, subscriptionPath);
  this._createResource(subscriptionFullPath, SubscriptionResult, optionsOrCallback, callback);
};
...
ServiceBusService.prototype.listSubscriptions = function (topicPath, optionsOrCallback, callback) {
  ...
  var validateResult = function (responseObject) {
    if (!responseObject.error && responseObject.response.body.feed.id.indexOf(topicPath + '/Subscriptions/') === -1) {
      responseObject.error = new Error();
      responseObject.error.code = Constants.ServiceBusErrorCodeStrings.TOPIC_NOT_FOUND;
      responseObject.error.details = 'Invalid Topic';
...
ServiceBusService.prototype.createRule = function (topicPath, subscriptionPath, rulePath, optionsOrCallback, callback) {
  ...
  this._createResource(ruleFullPath, RuleResult, optionsOrCallback, callback);
};
...
ServiceBusService.prototype.listRules = function (topicPath, subscriptionPath, optionsOrCallback, callback) {
  ...
  var subscriptionFullPath = createSubscriptionPath(topicPath, subscriptionPath) + '/Rules/';

  var validateResult = function (responseObject) {
    if (!responseObject.error && responseObject.response.body.feed.id.indexOf(subscriptionFullPath + '/Rules/') === -1) {
      responseObject.error = new Error();
      responseObject.error.code = Constants.ServiceBusErrorCodeStrings.SUBSCRIPTION_NOT_FOUND;
      responseObject.error.details = 'Invalid Subscription';
  ...
  this._listResources(subscriptionFullPath, RuleResult, [ validateResult ], optionsOrCallback, callback);
};
...
* @return {undefined}
*/
ServiceBusService.prototype._createResource = function (path, handler, optionsOrCallback, callback) {
  var options = null;
  if (typeof optionsOrCallback === 'function' && !callback) {
    callback = optionsOrCallback;
  } else {
...
* @return {undefined}
*/
ServiceBusService.prototype._getResource = function (path, handler, validators, callback) {
  validateCallback(callback);
...
* @return {undefined}
*/
ServiceBusService.prototype._listResources = function (path, handler, validators, optionsOrCallback, callback) {
  var options = null;
  if (typeof optionsOrCallback === 'function' && !callback) {
    callback = optionsOrCallback;
  } else {
...
* @return {undefined}
*/
ServiceBusService.prototype._deleteResource = function (path, callback) {
  validateCallback(callback);
