  ...
  var processResponseCallback = function (responseObject, next) {
    ...
    if (!responseObject.error) {
      ...
      if (responseObject.response.body.feed && responseObject.response.body.feed.entry) {
        queues = responseObject.response.body.feed.entry;
...
ServiceBusService.prototype.createTopic = function (topic, optionsOrCallback, callback) {
  ...
  var processResponseCallback = function (responseObject, next) {
    if (!responseObject.error) {
      responseObject.topic = TopicResult.parse(responseObject.response.body.entry);
    }
...
ServiceBusService.prototype.listTopics = function (optionsOrCallback, callback) {
  ...
  var processResponseCallback = function (responseObject, next) {
    ...
    if (!responseObject.error) {
      ...
      var topics = [];
      if (responseObject.response.body.feed && responseObject.response.body.feed.entry) {
        topics = responseObject.response.body.feed.entry;
      } else if (responseObject.response.body.entry) {
...
ServiceBusService.prototype.createSubscription = function (topicPath, subscriptionPath, optionsOrCallback, callback) {
  ...
  var processResponseCallback = function (responseObject, next) {
    if (!responseObject.error) {
      responseObject.subscription = SubscriptionResult.parse(responseObject.response.body.entry);
    }
...
ServiceBusService.prototype.listSubscriptions = function (topicPath, optionsOrCallback, callback) {
  ...
  var processResponseCallback = function (responseObject, next) {
    ...
    if (!responseObject.error) {
      if (!responseObject.response.body || responseObject.response.body.feed.id[0].indexOf(topicPath + '/Subscriptions/') === -1) {
        responseObject.error = {
          code: Constants.ServiceBusErrorCodeStrings.TOPIC_NOT_FOUND,
          details: 'Invalid Topic'
        };
        ...
        var subscriptions = [];
        if (responseObject.response.body.feed && responseObject.response.body.feed.entry) {
          subscriptions = responseObject.response.body.feed.entry;
        } else if (responseObject.response.body.entry) {
          subscriptions = [responseObject.response.body.entry];
        }

        subscriptions.forEach(function (currentSubscription) {
...
ServiceBusService.prototype.createRule = function (topicPath, subscriptionPath, rulePath, optionsOrCallback, callback) {
  ...
  var processResponseCallback = function (responseObject, next) {
    if (!responseObject.error) {
      responseObject.rule = RuleResult.parse(responseObject.response.body.entry);
    }
...
ServiceBusService.prototype.listRules = function (topicPath, subscriptionPath, optionsOrCallback, callback) {
  ...
  var processResponseCallback = function (responseObject, next) {
    ...
    if (!responseObject.error) {
      if (!responseObject.response.body || responseObject.response.body.feed.id[0].indexOf(subscriptionFullPath + '/Rules/') === -1) {
        responseObject.error = {
          code: Constants.ServiceBusErrorCodeStrings.SUBSCRIPTION_NOT_FOUND,
          details: 'Invalid Subscription'
        };
        ...
        var rules = [];
        if (responseObject.response.body.feed && responseObject.response.body.feed.entry) {
          rules = responseObject.response.body.feed.entry;
        } else if (responseObject.response.body.entry) {
