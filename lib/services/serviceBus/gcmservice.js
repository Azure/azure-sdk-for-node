...
GcmService.prototype.listRegistrationsByGcmRegistrationId = function (gcmRegistrationId, optionsOrCallback, callback) {
  ...
  var webResource = WebResource.get(this.notificationHubService.hubName + '/registrations/')
    .withQueryOption('$filter', 'GcmRegistrationId eq \'' + gcmRegistrationId.toUpperCase() + '\'');
...
*/
GcmService.prototype._createBody = function (elementName, registrationId, tags, template) {
  var registration = {};
...
* @return {string}  The template body.
*/
GcmService.prototype._createTemplateBody = function (token, tags, template, options) {
  return this._createBody('GcmTemplateRegistrationDescription', token, tags, template, options);
};
