...
NotificationHubService.prototype.createRegistrationId = function (callback) {
  ...
  var webResource = WebResource.post(this.hubName + '/registrationids').withQueryOption(Constants.API_VERSION_QUERY_KEY, Constants.ServiceBusConstants.CURRENT_API_VERSION);
  webResource.headers = {
    'content-length': null,
    'content-type': null
  };
...
NotificationHubService.prototype.getRegistration = function (registrationId, optionsOrCallback, callback) {
  ...
  var webResource = WebResource.get(this.hubName + '/registrations/' + registrationId).withQueryOption(Constants.API_VERSION_QUERY_KEY, Constants.ServiceBusConstants.CURRENT_API_VERSION);
...
NotificationHubService.prototype.deleteRegistration = function (registrationId, optionsOrCallback, callback) {
  ...
  var webResource = WebResource.del(this.hubName + '/registrations/' + registrationId).withQueryOption(Constants.API_VERSION_QUERY_KEY, Constants.ServiceBusConstants.CURRENT_API_VERSION);
...
NotificationHubService.prototype.updateRegistration = function (registration, optionsOrCallback, callback) {
  ...
  var webResource = WebResource.put(this.hubName + '/registrations/' + registration.RegistrationId).withQueryOption(Constants.API_VERSION_QUERY_KEY, Constants.ServiceBusConstants.CURRENT_API_VERSION);
...
NotificationHubService.prototype.listRegistrations = function (optionsOrCallback, callback) {
  ...
  var webResource = WebResource.get(this.hubName + '/registrations').withQueryOption(Constants.API_VERSION_QUERY_KEY, Constants.ServiceBusConstants.CURRENT_API_VERSION);
...
NotificationHubService.prototype.listRegistrationsByTag = function (tag, optionsOrCallback, callback) {
  ...
  var webResource = WebResource.get(this.hubName + '/tags/' + tag + '/registrations').withQueryOption(Constants.API_VERSION_QUERY_KEY, Constants.ServiceBusConstants.CURRENT_API_VERSION);
...
NotificationHubService.prototype._sendNotification = function (payload, optionsOrCallback, callback) {
  ...
  var webResource = WebResource.post(this.hubName + '/Messages').withQueryOption(Constants.API_VERSION_QUERY_KEY, Constants.ServiceBusConstants.CURRENT_API_VERSION);
...
NotificationHubService.prototype.createOrUpdateInstallation = function (installation, optionsOrCallback, callback) {
  ...
  var webResource = WebResource.put(this.hubName + '/installations/' + installation.installationId).withQueryOption(Constants.API_VERSION_QUERY_KEY, Constants.ServiceBusConstants.CURRENT_API_VERSION);
...
NotificationHubService.prototype.patchInstallation = function (installationId, partialUpdateOperations, optionsOrCallback, callback) {
  ...
  var webResource = WebResource.patch(this.hubName + '/installations/' + installationId).withQueryOption(Constants.API_VERSION_QUERY_KEY, Constants.ServiceBusConstants.CURRENT_API_VERSION);
...
NotificationHubService.prototype.deleteInstallation = function (installationId, optionsOrCallback, callback) {
  ...
  var webResource = WebResource.del(this.hubName + '/installations/' + installationId).withQueryOption(Constants.API_VERSION_QUERY_KEY, Constants.ServiceBusConstants.CURRENT_API_VERSION);
...
NotificationHubService.prototype.getInstallation = function (installationId, optionsOrCallback, callback) {
  ...
  var webResource = WebResource.get(this.hubName + '/installations/' + installationId).withQueryOption(Constants.API_VERSION_QUERY_KEY, Constants.ServiceBusConstants.CURRENT_API_VERSION);
