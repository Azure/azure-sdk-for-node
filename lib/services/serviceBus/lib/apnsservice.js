...
ApnsService.prototype.createNativeRegistration = function (token, tags, optionsOrCallback, callback) {
  ...
  var webResource = WebResource.post(this.notificationHubService.hubName + '/registrations').withQueryOption(Constants.API_VERSION_QUERY_KEY, Constants.ServiceBusConstants.CURRENT_API_VERSION);
...
ApnsService.prototype.createOrUpdateNativeRegistration = function (registrationId, token, tags, optionsOrCallback, callback) {
  ...
  var registrationXml = this._createBody('AppleRegistrationDescription', token, tags, null, options);
  var webResource = WebResource.put(this.notificationHubService.hubName + '/registrations/' + registrationId).withQueryOption(Constants.API_VERSION_QUERY_KEY, Constants.ServiceBusConstants.CURRENT_API_VERSION);
