...
* @param {string} password                The service bus issuer password.
* @param {string} host                    The host for the service.
*/
function WrapTokenManager(acsnamespace, issuer, password, host) {
  this.activeTokens = { };

  this.wrapService = new WrapService(acsnamespace, issuer, password, host);
}
