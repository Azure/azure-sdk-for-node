...
exports.serialize = function (resource) {
  ...
  if (resource) {
    ...
    properties.forEach(function (credentialType) {
      if (resource[credentialType]) {
        formattedResource[credentialType] = {
          'Properties': {
            'Property': []
          }
        };

        Object.keys(resource[credentialType]).forEach(function (propertyName) {
          formattedResource[credentialType]['Properties']['Property'].push({
            'Name': propertyName,
            'Value': resource[credentialType][propertyName]
          });
        });
      }
    });
