...
* @param {object|function}    [optionsOrCallback.wnsHeaders] The wns headers.
...
WnsService.prototype.send = function (tags, payload, type, optionsOrCallback, callback) {
  ...
  if (options && options.wnsHeaders) {
    Object.keys(options.wnsHeaders).forEach(function (header) {
      headers[header] = options.wnsHeaders[header];
    });
  }
