...
export interface Sku {
   ...
   * search unit. 'standard3': Offers maximum capacity per search unit with up to 12 partitions and
   * 12 replicas (or up to 3 partitions with more indexes if you also set the hostingMode property
   * to 'highDensity'). Possible values include: 'free', 'basic', 'standard', 'standard2',
   * 'standard3'
   */
  name?: string;
}
