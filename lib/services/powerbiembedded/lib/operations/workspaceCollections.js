 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
WorkspaceCollections.prototype.create = function (resourceGroupName, workspaceCollectionName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  var body = new client.models['CreateWorkspaceCollectionRequest']();
  try {
    if ((location !== null && location !== undefined) || (tags !== null && tags !== undefined))
    {
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
WorkspaceCollections.prototype.update = function (resourceGroupName, workspaceCollectionName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  var body = new client.models['UpdateWorkspaceCollectionRequest']();
  try {
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
WorkspaceCollections.prototype.checkNameAvailability = function (location, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  var type = (options && options.type !== undefined) ? options.type : 'Microsoft.PowerBI/workspaceCollections';
  // Validate
  try {
    if (this.client.subscriptionId === null || this.client.subscriptionId === undefined || typeof this.client.subscriptionId.valueOf() !== 'string') {
      throw new Error('this.client.subscriptionId cannot be null or undefined and it must be of type string.');
  ...
  if ((name !== null && name !== undefined) || (type !== null && type !== undefined)) {
      body = new client.models['CheckNameRequest']();
      body.name = name;
      body.type = type;
  }
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
WorkspaceCollections.prototype.regenerateKey = function (resourceGroupName, workspaceCollectionName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  if (keyName !== null && keyName !== undefined) {
      body = new client.models['WorkspaceCollectionAccessKey']();
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
WorkspaceCollections.prototype.migrate = function (resourceGroupName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  if ((targetResourceGroup !== null && targetResourceGroup !== undefined) || (resources !== null && resources !== undefined)) {
      body = new client.models['MigrateWorkspaceCollectionRequest']();
