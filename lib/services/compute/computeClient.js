          ...
          if (configurationSetsItem.inputEndpoints) {
            ...
            for (var loweredIndex10 = 0; loweredIndex10 < configurationSetsItem.inputEndpoints.length; loweredIndex10 = loweredIndex10 + 1) {
              ...
              if (inputEndpointsItem.accessControlList) {
                ...
                if (inputEndpointsItem.accessControlList.rules) {
                  var rulesSequenceElement = js2xml.createElement('Rules', 'http://schemas.microsoft.com/windowsazure');
                  for (var loweredIndex11 = 0; loweredIndex11 < inputEndpointsItem.accessControlList.rules.length; loweredIndex11 = loweredIndex11 + 1) {
                    var rulesItem = inputEndpointsItem.accessControlList.rules[loweredIndex11];
                    var ruleElement = js2xml.createElement('Rule', 'http://schemas.microsoft.com/windowsazure');
                    js2xml.addChildElement(rulesSequenceElement, ruleElement);
      ...
      if (parameters.provisioningConfiguration.inputEndpoints) {
        ...
        for (var loweredIndex5 = 0; loweredIndex5 < parameters.provisioningConfiguration.inputEndpoints.length; loweredIndex5 = loweredIndex5 + 1) {
          ...
          if (inputEndpointsItem.accessControlList) {
            ...
            if (inputEndpointsItem.accessControlList.rules) {
              var rulesSequenceElement = js2xml.createElement('Rules', 'http://schemas.microsoft.com/windowsazure');
              for (var loweredIndex6 = 0; loweredIndex6 < inputEndpointsItem.accessControlList.rules.length; loweredIndex6 = loweredIndex6 + 1) {
                var rulesItem = inputEndpointsItem.accessControlList.rules[loweredIndex6];
                var ruleElement = js2xml.createElement('Rule', 'http://schemas.microsoft.com/windowsazure');
                js2xml.addChildElement(rulesSequenceElement, ruleElement);
