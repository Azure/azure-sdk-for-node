 ...
 */
class HeavyJobDetails extends models['JobDetails'] {
  /**
   * Create a HeavyJobDetails.
  ...
  /**
   * Defines the metadata of HeavyJobDetails
   *
   * @returns {object} metadata of HeavyJobDetails
   *
   */
  mapper() {
    return {
...
module.exports = HeavyJobDetails;
