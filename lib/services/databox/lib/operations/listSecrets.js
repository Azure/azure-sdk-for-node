 ...
 */
function _listByJobs(resourceGroupName, jobName, options, callback) {
...
/** Class representing a ListSecrets. */
class ListSecrets {
  /**
   * Create a ListSecrets.
   * @param {DataBoxManagementClient} client Reference to the service client.
   */
  constructor(client) {
    this.client = client;
    this._listByJobs = _listByJobs;
  }
   ...
   */
  listByJobsWithHttpOperationResponse(resourceGroupName, jobName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listByJobs(resourceGroupName, jobName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listByJobs(resourceGroupName, jobName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._listByJobs(resourceGroupName, jobName, options, optionalCallback);
    }
  }
