 ...
 */
class ExtendedServerBlobAuditingPolicy extends models['ProxyResource'] {
  /**
   * Create a ExtendedServerBlobAuditingPolicy.
   * @property {string} [predicateExpression] Specifies condition of where
  ...
  /**
   * Defines the metadata of ExtendedServerBlobAuditingPolicy
   *
   * @returns {object} metadata of ExtendedServerBlobAuditingPolicy
   *
   */
  mapper() {
    return {
...
module.exports = ExtendedServerBlobAuditingPolicy;
