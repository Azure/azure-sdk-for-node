 ...
 */
class ServerBlobAuditingPolicy extends models['ProxyResource'] {
  /**
   * Create a ServerBlobAuditingPolicy.
  ...
  /**
   * Defines the metadata of ServerBlobAuditingPolicy
   *
   * @returns {object} metadata of ServerBlobAuditingPolicy
   *
   */
  mapper() {
    return {
...
module.exports = ServerBlobAuditingPolicy;
