...
function _listByLocation(locationName, options, callback) {
  ...
  let include = (options && options.include !== undefined) ? options.include : undefined;
  ...
  try {
    ...
    if (include !== null && include !== undefined && typeof include.valueOf() !== 'string') {
      throw new Error('include must be of type string.');
    }
  ...
  if (include !== null && include !== undefined) {
    queryParameters.push('include=' + encodeURIComponent(include));
  }
