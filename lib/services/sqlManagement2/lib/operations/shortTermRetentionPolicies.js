    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['ShortTermRetentionPolicy']().mapper();
...
function _beginCreateOrUpdate(resourceGroupName, serverName, databaseName, parameters, options, callback) {
  ...
  try {
    if (parameters !== null && parameters !== undefined) {
      let requestModelMapper = new client.models['ShortTermRetentionPolicy']().mapper();
...
/** Class representing a ShortTermRetentionPolicies. */
class ShortTermRetentionPolicies {
  /**
   * Create a ShortTermRetentionPolicies.
...
module.exports = ShortTermRetentionPolicies;
