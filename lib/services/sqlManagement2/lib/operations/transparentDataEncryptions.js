...
function _createOrUpdate(resourceGroupName, serverName, databaseName, parameters, options, callback) {
  ...
  let transparentDataEncryptionName = 'current';
  // Validate
  try {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/transparentDataEncryption/{transparentDataEncryptionName}';
  ...
  requestUrl = requestUrl.replace('{transparentDataEncryptionName}', encodeURIComponent(transparentDataEncryptionName));
  let queryParameters = [];
...
module.exports = TransparentDataEncryptions;
