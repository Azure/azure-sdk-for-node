 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getDatabases(resourceGroupName, serverName, recommendedElasticPoolName, databaseName, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _listDatabases(resourceGroupName, serverName, recommendedElasticPoolName, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 * Initializes a new instance of the RecommendedElasticPools class.
 * @constructor
 *
...
class RecommendedElasticPools {
  constructor(client) {
    this.client = client;
    this._get = _get;
    this._getDatabases = _getDatabases;
   ...
   * @reject {Error} - The error object.
   */
  getDatabasesWithHttpOperationResponse(resourceGroupName, serverName, recommendedElasticPoolName, databaseName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getDatabases(resourceGroupName, serverName, recommendedElasticPoolName, databaseName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getDatabases(resourceGroupName, serverName, recommendedElasticPoolName, databaseName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getDatabases(resourceGroupName, serverName, recommendedElasticPoolName, databaseName, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  listDatabasesWithHttpOperationResponse(resourceGroupName, serverName, recommendedElasticPoolName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listDatabases(resourceGroupName, serverName, recommendedElasticPoolName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listDatabases(resourceGroupName, serverName, recommendedElasticPoolName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._listDatabases(resourceGroupName, serverName, recommendedElasticPoolName, options, optionalCallback);
    }
  }
