...
function _get(resourceGroupName, clusterName, options, callback) {
  ...
  try {
    ...
    if (this.client.serviceName === null || this.client.serviceName === undefined || typeof this.client.serviceName.valueOf() !== 'string') {
      throw new Error('this.client.serviceName cannot be null or undefined and it must be of type string.');
    }
  ...
  requestUrl = requestUrl.replace('{serviceName}', encodeURIComponent(this.client.serviceName));
  let queryParameters = [];
