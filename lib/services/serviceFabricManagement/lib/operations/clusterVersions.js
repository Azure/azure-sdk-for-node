 ...
 */
function _list(location, environment, options, callback) {
...
class ClusterVersions {
   ...
   */
  listWithHttpOperationResponse(location, environment, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._list(location, environment, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  list(location, environment, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._list(location, environment, options, optionalCallback);
    }
  }
