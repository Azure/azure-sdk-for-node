...
class StatefulServiceUpdateProperties extends models['ServiceResourceUpdateProperties'] {
  /**
   * Create a StatefulServiceUpdateProperties.
  ...
  /**
   * Defines the metadata of StatefulServiceUpdateProperties
   *
   * @returns {object} metadata of StatefulServiceUpdateProperties
   *
   */
  mapper() {
    return {
...
module.exports = StatefulServiceUpdateProperties;
