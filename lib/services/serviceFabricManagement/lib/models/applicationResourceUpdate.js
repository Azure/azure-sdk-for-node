 ...
 */
class ApplicationResourceUpdate extends models['ProxyResource'] {
  /**
   * Create a ApplicationResourceUpdate.
   * @member {string} [typeVersion] The version of the application type as
   * defined in the application manifest.
   * @member {object} [parameters] List of application parameters with
  ...
  /**
   * Defines the metadata of ApplicationResourceUpdate
   *
   * @returns {object} metadata of ApplicationResourceUpdate
   *
   */
  mapper() {
    return {
...
module.exports = ApplicationResourceUpdate;
