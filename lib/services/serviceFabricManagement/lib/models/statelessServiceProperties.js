 ...
 *
 * @extends models['ServiceResourceProperties']
 */
class StatelessServiceProperties extends models['ServiceResourceProperties'] {
  /**
   * Create a StatelessServiceProperties.
  ...
  /**
   * Defines the metadata of StatelessServiceProperties
   *
   * @returns {object} metadata of StatelessServiceProperties
   *
   */
  mapper() {
    return {
...
module.exports = StatelessServiceProperties;
