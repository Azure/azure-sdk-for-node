 ...
 */
class StatefulServiceProperties extends models['ServiceResourceProperties'] {
  /**
   * Create a StatefulServiceProperties.
  ...
  /**
   * Defines the metadata of StatefulServiceProperties
   *
   * @returns {object} metadata of StatefulServiceProperties
   *
   */
  mapper() {
    return {
...
module.exports = StatefulServiceProperties;
