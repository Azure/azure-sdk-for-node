 ...
 */
function _list(locationName, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/providers/Microsoft.DBforPostgreSQL/locations/{locationName}/performanceTiers';
...
class LocationBasedPerformanceTier {
   ...
   */
  listWithHttpOperationResponse(locationName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._list(locationName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  list(locationName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._list(locationName, options, optionalCallback);
    }
  }

}

module.exports = LocationBasedPerformanceTier;
