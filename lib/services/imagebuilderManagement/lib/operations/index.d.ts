 ...
 */
export interface VirtualMachineImageTemplate {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    patchWithHttpOperationResponse(parameters: models.ImageTemplateUpdateParameters, resourceGroupName: string, imageTemplateName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.ImageTemplate>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    patch(parameters: models.ImageTemplateUpdateParameters, resourceGroupName: string, imageTemplateName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<models.ImageTemplate>;
    patch(parameters: models.ImageTemplateUpdateParameters, resourceGroupName: string, imageTemplateName: string, callback: ServiceCallback<models.ImageTemplate>): void;
    patch(parameters: models.ImageTemplateUpdateParameters, resourceGroupName: string, imageTemplateName: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.ImageTemplate>): void;
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    getRunOutputsWithHttpOperationResponse(resourceGroupName: string, imageTemplateName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.RunOutputCollection>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    getRunOutputs(resourceGroupName: string, imageTemplateName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<models.RunOutputCollection>;
    getRunOutputs(resourceGroupName: string, imageTemplateName: string, callback: ServiceCallback<models.RunOutputCollection>): void;
    getRunOutputs(resourceGroupName: string, imageTemplateName: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.RunOutputCollection>): void;
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    getRunOutputsNextWithHttpOperationResponse(nextPageLink: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.RunOutputCollection>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    getRunOutputsNext(nextPageLink: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<models.RunOutputCollection>;
    getRunOutputsNext(nextPageLink: string, callback: ServiceCallback<models.RunOutputCollection>): void;
    getRunOutputsNext(nextPageLink: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.RunOutputCollection>): void;
}
