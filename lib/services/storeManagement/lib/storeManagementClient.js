...
var AddOnOperations = ( /** @lends AddOnOperations */ function() {
  ...
  AddOnOperations.prototype.beginCreating = function(cloudServiceName, resourceName, addOnName, parameters, callback) {
    ...
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/CloudServices/' + cloudServiceName.trim() + '/resources/' + parameters.type.trim() + '/' + resourceName.trim() + '/' + addOnName.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  AddOnOperations.prototype.beginDeleting = function(cloudServiceName, resourceProviderNamespace, resourceProviderType, resourceProviderName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/CloudServices/' + cloudServiceName.trim() + '/resources/' + resourceProviderNamespace.trim() + '/' + resourceProviderType.trim() + '/' + resourceProviderName.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var CloudServiceOperations = ( /** @lends CloudServiceOperations */ function() {
  ...
  CloudServiceOperations.prototype.beginCreating = function(parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/CloudServices/' + parameters.name.trim() + '/';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  CloudServiceOperations.prototype.list = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/CloudServices/';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
