 ...
 */
function _get(operationId, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.Subscription/subscriptionOperations/{operationId}';
...
class SubscriptionOperationOperations {
   ...
   */
  getWithHttpOperationResponse(operationId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._get(operationId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  get(operationId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._get(operationId, options, optionalCallback);
    }
  }

}

module.exports = SubscriptionOperationOperations;
