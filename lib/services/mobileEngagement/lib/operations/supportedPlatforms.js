...
function _list(options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/providers/Microsoft.MobileEngagement/supportedPlatforms';
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['SupportedPlatformsListResult']().mapper();
...
/** Class representing a SupportedPlatforms. */
class SupportedPlatforms {
  /**
   * Create a SupportedPlatforms.
