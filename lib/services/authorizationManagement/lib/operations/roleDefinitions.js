...
RoleDefinitions.prototype.deleteMethod = function (scope, roleDefinitionId, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + '{scope}/providers/Microsoft.Authorization/roleDefinitions/{roleDefinitionId}';
...
RoleDefinitions.prototype.getById = function (roleDefinitionId, options, callback) {
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + '{roleDefinitionId}';
...
RoleDefinitions.prototype.list = function (scope, options, callback) {
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + '{scope}/providers/Microsoft.Authorization/roleDefinitions';
  requestUrl = requestUrl.replace('{scope}', scope);
  var queryParameters = [];
