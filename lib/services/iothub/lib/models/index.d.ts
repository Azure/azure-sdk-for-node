...
export interface RoutingServiceBusQueueEndpointProperties {
  ...
  */
   ...
   * are reserved:  events, operationsMonitoringEvents, fileNotifications, $default. Endpoint names
...
export interface IotHubProperties {
  ...
  */
  ...
  /**
   * The Event Hub-compatible endpoint properties. The possible keys to this dictionary are events
   * and operationsMonitoringEvents. Both of these keys have to be present in the dictionary while
