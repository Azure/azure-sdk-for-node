...
class RoutingEndpoints {
   ...
   * @property {array} [serviceBusQueues] The list of Service Bus queue
   * endpoints that IoT hub routes the messages to, based on the routing rules.
   * @property {array} [serviceBusTopics] The list of Service Bus topic
   * endpoints that the IoT hub routes the messages to, based on the routing
   * rules.
   * @property {array} [eventHubs] The list of Event Hubs endpoints that IoT
