...
class RouteProperties {
   ...
   * @property {string} source The source that the routing rule is to be
   ...
   * @property {string} [condition] The condition that is evaluated to apply
   * the routing rule. If no condition is provided, it evaluates to true by
   * default. For grammar, see:
   * https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language
   * @property {array} endpointNames The list of endpoints to which messages
