 ...
 *
 */
function IotHubClient(credentials, baseUri, options) {
  ...
  IotHubClient['super_'].call(this, credentials, options);
  ...
  if(options.asyncinfo !== null && options.asyncinfo !== undefined) { 
...
util.inherits(IotHubClient, ServiceClient);
