 ...
 */
class ResourceWriteSuccessData extends models['EventGridEventData'] {
  /**
   * Create a ResourceWriteSuccessData.
  ...
  /**
   * Defines the metadata of ResourceWriteSuccessData
   *
   * @returns {object} metadata of ResourceWriteSuccessData
   *
   */
  mapper() {
    return {
...
module.exports = ResourceWriteSuccessData;
