 ...
 */
class ResourceDeleteFailureData extends models['EventGridEventData'] {
  /**
   * Create a ResourceDeleteFailureData.
  ...
  /**
   * Defines the metadata of ResourceDeleteFailureData
   *
   * @returns {object} metadata of ResourceDeleteFailureData
   *
   */
  mapper() {
    return {
...
module.exports = ResourceDeleteFailureData;
