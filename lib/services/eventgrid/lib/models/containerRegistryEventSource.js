...
class ContainerRegistryEventSource {
  /**
   * Create a ContainerRegistryEventSource.
  ...
  /**
   * Defines the metadata of ContainerRegistryEventSource
   *
   * @returns {object} metadata of ContainerRegistryEventSource
   *
   */
  mapper() {
    return {
...
module.exports = ContainerRegistryEventSource;
