...
class MapsGeofenceEventProperties {
   ...
   * @property {array} [expiredGeofenceGeometryId] Lists of the geometry ID of
   * the geofence which is expired relative to the user time in the request.
   * @property {array} [geometries] Lists the fence geometries that either
   * fully contain the coordinate position or have an overlap with the
   * searchBuffer around the fence.
   * @property {array} [invalidPeriodGeofenceGeometryId] Lists of the geometry
   * ID of the geofence which is in invalid period relative to the user time in
   * the request.
   * @property {boolean} [isEventPublished] True if at least one event is
