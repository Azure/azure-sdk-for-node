...
class MapsGeofenceGeometry {
   ...
   * @property {string} [deviceId] ID of the device.
   * @property {number} [distance] Distance from the coordinate to the closest
   ...
   * @property {string} [geometryId] The unique ID for the geofence geometry.
   * @property {number} [nearestLat] Latitude of the nearest point of the
   * geometry.
   * @property {number} [nearestLon] Longitude of the nearest point of the
   * geometry.
   * @property {string} [udId] The unique id returned from user upload service
