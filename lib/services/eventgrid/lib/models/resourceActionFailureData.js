...
class ResourceActionFailureData {
  /**
   * Create a ResourceActionFailureData.
  ...
  /**
   * Defines the metadata of ResourceActionFailureData
   *
   * @returns {object} metadata of ResourceActionFailureData
   *
   */
  mapper() {
    return {
...
module.exports = ResourceActionFailureData;
