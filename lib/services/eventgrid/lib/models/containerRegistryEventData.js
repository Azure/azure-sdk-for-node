 ...
 */
class ContainerRegistryEventData extends models['EventGridEventData'] {
  /**
   * Create a ContainerRegistryEventData.
  ...
  /**
   * Defines the metadata of ContainerRegistryEventData
   *
   * @returns {object} metadata of ContainerRegistryEventData
   *
   */
  mapper() {
    return {
...
module.exports = ContainerRegistryEventData;
