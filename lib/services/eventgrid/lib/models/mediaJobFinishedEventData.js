 ...
 */
class MediaJobFinishedEventData extends models['MediaJobStateChangeEventData'] {
  /**
   * Create a MediaJobFinishedEventData.
  ...
  /**
   * Defines the metadata of MediaJobFinishedEventData
   *
   * @returns {object} metadata of MediaJobFinishedEventData
   *
   */
  mapper() {
    return {
...
module.exports = MediaJobFinishedEventData;
