...
BatchServiceClient.prototype.commitBatch = function (optionsOrCallback, callback) {
  ...
  webResource.withHeader(HeaderConstants.CONTENT_TYPE, 'multipart/mixed; boundary=' + batchBoundary);
  ...
  webResource.withHeader(HeaderConstants.CONTENT_LENGTH, body.length);
