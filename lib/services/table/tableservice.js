...
TableService.prototype.setServiceProperties = function (serviceProperties, optionsOrCallback, callback) {
  ...
  webResource.withHeader(HeaderConstants.CONTENT_LENGTH, Buffer.byteLength(servicePropertiesXml, 'utf8'));
...
TableService.prototype.getTable = function (table, optionsOrCallback, callback) {
  ...
  var processResponseCallback = function (responseObject, next) {
    ...
    if (!responseObject.error) {
      responseObject.tableResponse = tableResult.parse(responseObject.response.body.entry);
    }
...
TableService.prototype.createTable = function (table, optionsOrCallback, callback) {
  ...
  webResource.withHeader(HeaderConstants.CONTENT_TYPE, 'application/atom+xml;charset="utf-8"');
  webResource.withHeader(HeaderConstants.CONTENT_LENGTH, Buffer.byteLength(xmlTableDescriptor, 'utf8'));
  ...
  var processResponseCallback = function (responseObject, next) {
    ...
    if (!responseObject.error) {
      ...
      if (responseObject.response.body.feed && responseObject.response.body.feed.entry) {
        tables = responseObject.response.body.feed.entry;
...
TableService.prototype.insertEntity = function (tableName, entityDescriptor, optionsOrCallback, callback) {
  ...
  webResource.withHeader(HeaderConstants.CONTENT_TYPE, 'application/atom+xml;charset="utf-8"');
  webResource.withHeader(HeaderConstants.CONTENT_LENGTH, Buffer.byteLength(entityXmlDescriptor, 'utf8'));
...
TableService.prototype.updateEntity = function (table, entityDescriptor, optionsOrCallback, callback) {
  ...
  var webResource = WebResource.put(path).withOkCode(HttpConstants.HttpResponseCodes.NoContent);
  webResource.withHeader(HeaderConstants.CONTENT_TYPE, 'application/atom+xml;charset="utf-8"');
  webResource.withHeader(HeaderConstants.CONTENT_LENGTH, Buffer.byteLength(entityXmlDescriptor, 'utf8'));
  webResource.withHeader(HeaderConstants.IF_MATCH, (entityDescriptor._ && entityDescriptor._.etag && options && options.checkEtag === true ? entityDescriptor._.etag : '*'));
...
TableService.prototype.mergeEntity = function (tableName, entityDescriptor, optionsOrCallback, callback) {
  ...
  var webResource = WebResource.merge(path).withOkCode(HttpConstants.HttpResponseCodes.NoContent);
  webResource.withHeader(HeaderConstants.CONTENT_TYPE, 'application/atom+xml;charset="utf-8"');
  webResource.withHeader(HeaderConstants.CONTENT_LENGTH, Buffer.byteLength(entityXmlDescriptor, 'utf8'));
  webResource.withHeader(HeaderConstants.IF_MATCH, (entityDescriptor._ && entityDescriptor._.etag && options && options.checkEtag === true ? entityDescriptor._.etag : '*'));
