...
/**
 * WebSearchClientOptions for WebSearchClient.
 */
declare interface WebSearchClientOptions extends ServiceClientOptions {
  /**
...
export default class WebSearchClient extends ServiceClient {
  /**
   * @class
   ...
   *
   */
  constructor(credentials: ServiceClientCredentials, options?: WebSearchClientOptions);
...
export { WebSearchClient, models as WebSearchModels };
