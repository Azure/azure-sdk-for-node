 ...
 *
 */
function MonitorManagementClient(credentials, subscriptionId, baseUri, options) {
  ...
  MonitorManagementClient['super_'].call(this, credentials, options);
...
util.inherits(MonitorManagementClient, ServiceClient);
