...
class AutoscaleProfile {
   ...
   * this profile.
   * @member {string} [capacity.minimum] the minimum number of instances for
   * the resource.
   * @member {string} [capacity.maximum] the maximum number of instances for
   ...
   * @member {array} rules the collection of rules that provide the triggers
   ...
   * @member {date} [fixedDate.start] the start time for the profile in ISO
   * 8601 format.
