 ...
 * an action group is not enabled, then none of its receviers will receive
 ...
 * 
 */
function ActionGroupResource() {
  ActionGroupResource['super_'].call(this);
}

util.inherits(ActionGroupResource, models['Resource']);
 ...
 *
 */
ActionGroupResource.prototype.mapper = function () {
  return {
    required: false,
