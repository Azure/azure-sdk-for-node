...
class BaselineResponse {
   ...
   * @property {object} [name] the name and the display name of the metric,
   ...
   * @property {string} [timespan] The timespan for which the data was
   * retrieved. Its value consists of two datatimes concatenated, separated by
   * '/'.  This may be adjusted in the future and returned back from what was
   * originally requested.
   * @property {moment.duration} [interval] The interval (window size) for
   * which the metric data was returned in.  This may be adjusted in the future
   * and returned back from what was originally requested.  This is not present
