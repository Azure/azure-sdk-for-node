...
class AutoscaleSettingResourcePatch {
   ...
   * @property {array} profiles the collection of automatic scaling profiles
   ...
   * @property {boolean} [enabled] the enabled flag. Specifies whether
   * automatic scaling is enabled for the resource. The default value is
