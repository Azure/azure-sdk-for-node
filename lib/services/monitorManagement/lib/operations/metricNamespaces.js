...
function _list(resourceUri, options, callback) {
  ...
  let apiVersion = '2017-12-01-preview';
  // Validate
  try {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + '{resourceUri}/providers/microsoft.insights/metricNamespaces';
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['MetricNamespaceCollection']().mapper();
...
module.exports = MetricNamespaces;
