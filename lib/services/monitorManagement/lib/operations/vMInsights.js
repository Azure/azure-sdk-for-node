 ...
 */
function _getOnboardingStatus(resourceUri, options, callback) {
  ...
  let apiVersion = '2018-11-27-preview';
  // Validate
  try {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + '{resourceUri}/providers/Microsoft.Insights/vmInsightsOnboardingStatuses/default';
    ...
    if (statusCode !== 200) {
      ...
      try {
        ...
        if (parsedErrorResponse !== null && parsedErrorResponse !== undefined) {
          let resultMapper = new client.models['ResponseWithError']().mapper();
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['VMInsightsOnboardingStatus']().mapper();
...
class VMInsights {
  ...
  constructor(client) {
    this.client = client;
    this._getOnboardingStatus = _getOnboardingStatus;
  }
   ...
   */
  getOnboardingStatusWithHttpOperationResponse(resourceUri, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getOnboardingStatus(resourceUri, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getOnboardingStatus(resourceUri, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._getOnboardingStatus(resourceUri, options, optionalCallback);
    }
  }

}

module.exports = VMInsights;
