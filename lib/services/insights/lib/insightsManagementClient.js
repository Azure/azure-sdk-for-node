...
var AgentDiagnosticSettingsOperations = ( /** @lends AgentDiagnosticSettingsOperations */ function() {
   ...
   * 
   * @param {AgentDiagnosticSettings} [parameters.properties] The public
   * configuration settings.
   * 
   * @param {string} [parameters.properties.name] The setting name.
   * 
   * @param {string} [parameters.properties.description] The setting
   * description.
   * 
   * @param {PublicMonitoringConfiguration}
   * [parameters.properties.publicConfiguration] The public diagnostic
   * configuration.
   * 
   * @param {DiagnosticMonitorConfiguration}
   * [parameters.properties.publicConfiguration.diagnosticMonitorConfiguration]
   * Configuration settings for the telemetry data to be collected.
   * 
   * @param {number}
   * [parameters.properties.publicConfiguration.diagnosticMonitorConfiguration.overallQuotaInMB]
   * The maximum amount of local disk space that may be consumed by the
   * various types of diagnostic data collected by the agent. The default
   * setting is 5120MB.
   * 
   ...
   * infrastructure logs are useful for troubleshooting the diagnostics system
   * itself.
   * 
   * @param {LogLevel}
   ...
   * Configures the minimum severity level of the logs collected.
   * 
   * @param {TimeSpan}
   ...
   * The interval between scheduled transfers to storage rounded up to the
   * nearest minute.
   * 
   * @param {Metrics}
   * [parameters.properties.publicConfiguration.diagnosticMonitorConfiguration.metrics]
   * This element enables you to generate a performance counter table that is
   * optimized for fast queries. Each performance counter that is defined in
   * the PerformanceCounters element is stored in the Metrics table in
   ...
   * The resource ID of the resource the agent runs on.
   * 
   * @param {array}
   ...
   * Including this element in the configuration enables the collection of IIS
   * logs.
   * 
   * @param {string}
   * [parameters.properties.publicConfiguration.diagnosticMonitorConfiguration.directories.failedRequestLogs]
   * Including this element in the configuration enables collection of logs
   * about failed requests to an IIS site or application. You must also enable
   * tracing options under system.WebServer in Web.config.
   * 
   * @param {TimeSpan}
   ...
   * Enable the collection of Windows Event Logs.
   * 
   * @param {array}
   * [parameters.properties.publicConfiguration.diagnosticMonitorConfiguration.windowsEventLog.dataSources]
   * The Windows Event logs to collect. A list of XPath queries describing the
   * windows events to be collected. For example: "System!*[System[(Level
   * &lt;=3)]]". To collect all events specify "*".
   * 
   * @param {TimeSpan}
   ...
   * Configures the percentage of overallQuotaInMB that will be reserved for
   * crash dumps.
   * 
   * @param {CrashDumpType}
   * [parameters.properties.publicConfiguration.diagnosticMonitorConfiguration.crashDumps.dumpType]
   * Configures collection of Mini or Full cash dumps.
   * 
   * @param {string}
   * [parameters.properties.publicConfiguration.diagnosticMonitorConfiguration.crashDumps.containerName]
   * The name of the blob container in your Azure Storage account that will be
   * used to store crash dumps.
   * 
   * @param {array}
   * [parameters.properties.publicConfiguration.diagnosticMonitorConfiguration.crashDumps.processes]
   * The names of the process you want to collect a crash dump for.
   * 
   * @param {DirectoryAbsolute}
   * [parameters.properties.publicConfiguration.localResourceDirectory] The
   * directory on the virtual machine to be used by the Monitoring Agent to
   * store event data. If not set the default directory will be used.
   * 
   * @param {boolean}
   * [parameters.properties.publicConfiguration.localResourceDirectory.expandEnvironment]
   * Configures whether or not environment variables in Path will be expanded.
   * 
   * @param {string}
...
var AlertOperations = ( /** @lends AlertOperations */ function() {
   ...
   * 
   * @param {string} [parameters.properties.name] Name of the alert rule.
   * 
   * @param {string} [parameters.properties.description] Description of the
   * alert rule that will be included in the alert email.
   * 
   * @param {boolean} [parameters.properties.isEnabled] Indicates whether the
   * alert rule is enabled.
   * 
   * @param {RuleCondition} [parameters.properties.condition] The condition
   * that results in the alert rule being activated.
   * 
   * @param {RuleAction} [parameters.properties.action] The action that is
...
var AutomatedExportOperations = ( /** @lends AutomatedExportOperations */ function() {
   ...
   * @param {object} [parameters.tags] The tags of the rule.
   * 
   * @param {AutomatedExportSetting} [parameters.properties] The setting to
   * create or update.
   * 
   * @param {DatabaseServerCredential}
   * [parameters.properties.databaseCredential] The credential for the server
   * hosting the database.
   * 
   * @param {string}
   * [parameters.properties.databaseCredential.databaseUserName] The database
   * user name.
   * 
   * @param {string}
   * [parameters.properties.databaseCredential.databasePassword] The database
   * password.
   * 
   * @param {BackupLocationProfile} [parameters.properties.blobStorageSetting]
   * The blob storage settings, where the exported file will be written.
   * 
   * @param {string} [parameters.properties.blobStorageSetting.storageAccount]
   * The name of the storage account.
   * 
   * @param {DatabaseBackupOption} [parameters.properties.backupOption] The
   * backup job options.
   * 
   * @param {date} [parameters.properties.backupOption.startTime] The start
   * time for the job.
   * 
   * @param {TimeSpan} [parameters.properties.backupOption.repeatInterval] How
   * often the automated export job will run.
   * 
   * @param {TimeSpan} [parameters.properties.backupOption.retentionPeriod] How
   * long the exported files will be saved.
   * 
   * @param {boolean} [parameters.properties.backupOption.keepAtLeastOneBackup]
   * Whether at least one exported file will be kept.
   * 
   * @param {DatabaseConsistencyOption}
   * [parameters.properties.backupOption.consistencyOption] The database
   * consistency option.
   * 
   * @param {boolean} [parameters.properties.enabled] Specifies whether
   * automated export is enabled for the resource.
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
...
var AutoscaleOperations = ( /** @lends AutoscaleOperations */ function() {
   ...
   * update.
   * 
   * @param {array} [parameters.properties.profiles] Contains a collection of
   * automatic scaling profiles that specify different scaling parameters for
   * different time periods. A maximum of 20 profiles can be specified.
   * 
   * @param {boolean} [parameters.properties.enabled] Specifies whether
   * automatic scaling is enabled for the resource.
   * 
   * @param {string} [parameters.properties.name] The name of the autoscale
   * setting.
   * 
   * @param {string} [parameters.properties.targetResourceUri] The resource
...
var MonitoringConfigurationOperations = ( /** @lends MonitoringConfigurationOperations */ function() {
   ...
   * Parameters supplied to the operation.
   * 
   * @param {DiagnosticSettings} [parameters.properties] The public
   * configuration settings.
   * 
   * @param {string} [parameters.properties.name] The setting name.
   * 
   ...
   * Parameters supplied to the operation.
   * 
   * @param {StorageConfiguration} [parameters.properties] The public
   * configuration settings.
   * 
   * @param {StorageLoggingConfiguration}
   * [parameters.properties.loggingConfiguration] Settings for logging
   * successful and failed requests to a storage service. This information can
   * be used to monitor individual requests and to diagnose issues with a
   * storage service. Requests are logged on a best-effort basis.
   * 
   * @param {boolean} [parameters.properties.loggingConfiguration.delete]
   * Indicates whether all delete requests should be logged.
   * 
   * @param {boolean} [parameters.properties.loggingConfiguration.read]
   * Indicates whether all read requests should be logged.
   * 
   * @param {boolean} [parameters.properties.loggingConfiguration.write]
   * Indicates whether all write requests should be logged.
   * 
   * @param {TimeSpan} [parameters.properties.loggingConfiguration.retention]
   * Indicates the how long log data should be retained (must be an even
   * number of days). All data older than this value will be deleted. The
   * minimum number of days is 1; the largest value is 365 (one year).
   * 
   * @param {StorageMetricConfiguration}
   * [parameters.properties.metricConfiguration] Settings for metrics that
   * include aggregated transaction statistics and capacity data about
   * requests to a storage service.
   * 
   * @param {array}
   * [parameters.properties.metricConfiguration.metricAggregations] The list
   * of aggregations to generate.
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
...
var ServiceDiagnosticSettingsOperations = ( /** @lends ServiceDiagnosticSettingsOperations */ function() {
   ...
   * supplied to the operation.
   * 
   * @param {ServiceDiagnosticSettings} [parameters.properties] The public
   * configuration settings.
   * 
   * @param {string} [parameters.properties.storageAccountName] The name of the
   * Azure Storage account to store the data in.
   * 
   * @param {DiagnosticSettingsStatus} [parameters.properties.status] Indicates
   * the status of the last call to set the configuration. Don't need to set
   * this flag when applying configuration.
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
...
var SkuOperations = ( /** @lends SkuOperations */ function() {
   ...
   * 
   * @param {string} [parameters.sku]
   * 
   * @param {number} [parameters.workerSize]
   * 
   * @param {number} [parameters.numberOfWorkers]
   * 
   * @param {string} apiVersion The resource provider api version.
   * 
   * @param {function} callback
   ...
   * 
   * @param {CurrentSku} [parameters.sku]
   * 
   * @param {string} [parameters.sku.name] The name of the sku.
   * 
   * @param {string} [parameters.sku.tier] The tier of the sku.
   * 
   * @param {number} [parameters.sku.capacity] The current capacity.
   * 
   * @param {string} apiVersion The resource provider api version.
   * 
   * @param {function} callback
...
var StorageDiagnosticSettingsOperations = ( /** @lends StorageDiagnosticSettingsOperations */ function() {
   ...
   * 
   * @param {StorageDiagnosticSettings} [parameters.properties] The storage
   * diagnostic settings.
   * 
   * @param {StorageLoggingDiagnosticSettings}
   * [parameters.properties.loggingDiagnosticSettings] The logging diagnostic
   * settings.
   * 
   ...
   * [parameters.properties.metricDiagnosticSettings] The metrics diagnostic
   * settings.
   * 
   * @param {array}
   * [parameters.properties.metricDiagnosticSettings.metricAggregations] the
   * list of aggregations to generate.
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
