  ...
  AlertOperations.prototype.createOrUpdateRule = function(resourceGroupName, parameters, callback) {
    ...
    if (parameters.properties !== null && parameters.properties !== undefined) {
      ...
      if (parameters.properties.action !== null && parameters.properties.action !== undefined) {
        ...
        if (parameters.properties.action.type === 'Microsoft.Azure.Management.Insights.Models.RuleWebhookAction') {
          actionValue['odata.type'] = parameters.properties.action.type;
          var derived11 = parameters.properties.action;
      ...
      if (parameters.properties.actions !== null && parameters.properties.actions !== undefined) {
        var actionsArray = [];
        for (var loweredIndex2 = 0; loweredIndex2 < parameters.properties.actions.length; loweredIndex2 = loweredIndex2 + 1) {
          var actionsItem = parameters.properties.actions[loweredIndex2];
          var ruleActionValue = {};
          ...
          if (actionsItem.type === 'Microsoft.Azure.Management.Insights.Models.RuleEmailAction') {
            ...
            var derived12 = actionsItem;
            
            if (derived12.sendToServiceOwners !== null && derived12.sendToServiceOwners !== undefined) {
              ruleActionValue['sendToServiceOwners'] = derived12.sendToServiceOwners;
            }
            
            if (derived12.customEmails !== null && derived12.customEmails !== undefined) {
              var customEmailsArray2 = [];
              for (var loweredIndex3 = 0; loweredIndex3 < derived12.customEmails.length; loweredIndex3 = loweredIndex3 + 1) {
                var customEmailsItem2 = derived12.customEmails[loweredIndex3];
                customEmailsArray2.push(customEmailsItem2);
              }
          ...
          if (actionsItem.type === 'Microsoft.Azure.Management.Insights.Models.RuleWebhookAction') {
            ruleActionValue['odata.type'] = actionsItem.type;
            var derived13 = actionsItem;
            
            if (derived13.serviceUri !== null && derived13.serviceUri !== undefined) {
              ruleActionValue['serviceUri'] = derived13.serviceUri;
            }
            
            if (derived13.properties !== null && derived13.properties !== undefined) {
              var propertiesDictionary2 = {};
              for (var propertiesKey2 in derived13.properties) {
                var propertiesValue3 = derived13.properties[propertiesKey2];
          ...
          if (propertiesValue !== null && propertiesValue !== undefined) {
            ...
            if (actionValue !== null && actionValue !== undefined) {
              ...
              if (typeName5 === 'Microsoft.Azure.Management.Insights.Models.RuleWebhookAction') {
                ...
                var serviceUriValue = actionValue['serviceUri'];
                ...
                var propertiesSequenceElement = actionValue['properties'];
            ...
            if (actionsArray !== null && actionsArray !== undefined) {
              for (var loweredIndex2 = 0; loweredIndex2 < actionsArray.length; loweredIndex2 = loweredIndex2 + 1) {
                ...
                var typeName6 = actionsValue['odata.type'];
                if (typeName6 === 'Microsoft.Azure.Management.Insights.Models.RuleEmailAction') {
                  var ruleEmailActionInstance2 = { customEmails: [] };
                  
                  var sendToServiceOwnersValue2 = actionsValue['sendToServiceOwners'];
                  if (sendToServiceOwnersValue2 !== null && sendToServiceOwnersValue2 !== undefined) {
                    var sendToServiceOwnersInstance2 = sendToServiceOwnersValue2;
                    ruleEmailActionInstance2.sendToServiceOwners = sendToServiceOwnersInstance2;
                  }
                  
                  var customEmailsArray2 = actionsValue['customEmails'];
                  if (customEmailsArray2 !== null && customEmailsArray2 !== undefined) {
                    for (var loweredIndex3 = 0; loweredIndex3 < customEmailsArray2.length; loweredIndex3 = loweredIndex3 + 1) {
                      var customEmailsValue2 = customEmailsArray2[loweredIndex3];
                      ruleEmailActionInstance2.customEmails.push(customEmailsValue2);
                    }
                  }
                  propertiesInstance.actions.push(ruleEmailActionInstance2);
                }
                if (typeName6 === 'Microsoft.Azure.Management.Insights.Models.RuleWebhookAction') {
                  var ruleWebhookActionInstance2 = { properties: {} };
                  
                  var serviceUriValue2 = actionsValue['serviceUri'];
                  if (serviceUriValue2 !== null && serviceUriValue2 !== undefined) {
                    var serviceUriInstance2 = serviceUriValue2;
                    ruleWebhookActionInstance2.serviceUri = serviceUriInstance2;
                  }
                  
                  var propertiesSequenceElement2 = actionsValue['properties'];
                  if (propertiesSequenceElement2 !== null && propertiesSequenceElement2 !== undefined) {
                    for (var property3 in propertiesSequenceElement2) {
                      var propertiesKey2 = property3;
                      var propertiesValue3 = propertiesSequenceElement2[property3];
                      ruleWebhookActionInstance2.properties[propertiesKey2] = propertiesValue3;
                    }
                  }
                  propertiesInstance.actions.push(ruleWebhookActionInstance2);
                }
              }
            }
                ...
                if (actionsArray !== null && actionsArray !== undefined) {
                  for (var loweredIndex3 = 0; loweredIndex3 < actionsArray.length; loweredIndex3 = loweredIndex3 + 1) {
                    ...
                    if (typeName6 === 'Microsoft.Azure.Management.Insights.Models.RuleEmailAction') {
                      ...
                      var customEmailsArray2 = actionsValue['customEmails'];
                      if (customEmailsArray2 !== null && customEmailsArray2 !== undefined) {
                        for (var loweredIndex4 = 0; loweredIndex4 < customEmailsArray2.length; loweredIndex4 = loweredIndex4 + 1) {
                          var customEmailsValue2 = customEmailsArray2[loweredIndex4];
                          ruleEmailActionInstance2.customEmails.push(customEmailsValue2);
                        }
                      }
                      propertiesInstance.actions.push(ruleEmailActionInstance2);
