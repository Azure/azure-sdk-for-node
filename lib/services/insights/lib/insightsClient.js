 ...
 *
 */
function InsightsClient(credentials, subscriptionId, baseUri, options) {
  ...
  InsightsClient['super_'].call(this, credentials, options);
  ...
  this.usageMetrics = new operations.UsageMetrics(this);
  this.eventCategories = new operations.EventCategories(this);
  this.events = new operations.Events(this);
  this.tenantEvents = new operations.TenantEvents(this);
...
util.inherits(InsightsClient, ServiceClient);
