...
var UsageMetricsOperations = ( /** @lends UsageMetricsOperations */ function() {
   ...
   * @returns {Stream} The response stream.
   */
  UsageMetricsOperations.prototype.list = function(resourceUri, filterString, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
   ...
   * @returns {Stream} The response stream.
   */
  UsageMetricsOperations.prototype.listDeprecated = function(resourceUri, metricNames, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
