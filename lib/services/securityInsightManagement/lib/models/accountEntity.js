...
class AccountEntity extends models['Entity'] {
   ...
   * @property {string} [accountEntityName] The name of the account. This field
   ...
   * @property {string} [aadTenantId] The AAD tenant id.
   * @property {string} [aadUserId] The AAD user id.
   * @property {string} [puid] The AAD Passport User ID.
   * @property {boolean} [isDomainJoined] Determines whether this is a domain
   * account.
   * @property {string} [objectGuid] The objectGUID attribute is a single-value
