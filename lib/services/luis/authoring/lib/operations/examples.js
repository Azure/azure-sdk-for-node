 ...
 */
function _add(azureRegion, azureCloud, appId, versionId, exampleLabelObject, options, callback) {
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _batch(azureRegion, azureCloud, appId, versionId, exampleLabelObjectArray, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _deleteMethod(azureRegion, azureCloud, appId, versionId, exampleId, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
...
class Examples {
   ...
   */
  addWithHttpOperationResponse(azureRegion, azureCloud, appId, versionId, exampleLabelObject, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._add(azureRegion, azureCloud, appId, versionId, exampleLabelObject, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  add(azureRegion, azureCloud, appId, versionId, exampleLabelObject, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._add(azureRegion, azureCloud, appId, versionId, exampleLabelObject, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  batchWithHttpOperationResponse(azureRegion, azureCloud, appId, versionId, exampleLabelObjectArray, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._batch(azureRegion, azureCloud, appId, versionId, exampleLabelObjectArray, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  batch(azureRegion, azureCloud, appId, versionId, exampleLabelObjectArray, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._batch(azureRegion, azureCloud, appId, versionId, exampleLabelObjectArray, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  deleteMethodWithHttpOperationResponse(azureRegion, azureCloud, appId, versionId, exampleId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._deleteMethod(azureRegion, azureCloud, appId, versionId, exampleId, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  deleteMethod(azureRegion, azureCloud, appId, versionId, exampleId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._deleteMethod(azureRegion, azureCloud, appId, versionId, exampleId, options, optionalCallback);
    }
  }
