 ...
 */
function _clone(appId, versionId, versionCloneObject, options, callback) {
...
class Versions {
   ...
   */
  cloneWithHttpOperationResponse(appId, versionId, versionCloneObject, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._clone(appId, versionId, versionCloneObject, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  clone(appId, versionId, versionCloneObject, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._clone(appId, versionId, versionCloneObject, options, optionalCallback);
    }
  }
