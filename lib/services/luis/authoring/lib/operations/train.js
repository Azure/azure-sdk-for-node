 ...
 */
function _trainVersion(azureRegion, azureCloud, appId, versionId, options, callback) {
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getStatus(azureRegion, azureCloud, appId, versionId, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
...
class Train {
   ...
   */
  trainVersionWithHttpOperationResponse(azureRegion, azureCloud, appId, versionId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._trainVersion(azureRegion, azureCloud, appId, versionId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  trainVersion(azureRegion, azureCloud, appId, versionId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._trainVersion(azureRegion, azureCloud, appId, versionId, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getStatusWithHttpOperationResponse(azureRegion, azureCloud, appId, versionId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getStatus(azureRegion, azureCloud, appId, versionId, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getStatus(azureRegion, azureCloud, appId, versionId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getStatus(azureRegion, azureCloud, appId, versionId, options, optionalCallback);
    }
  }
