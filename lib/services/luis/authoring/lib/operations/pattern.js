 ...
 */
function _addPattern(azureRegion, azureCloud, appId, versionId, pattern, options, callback) {
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _listPatterns(azureRegion, azureCloud, appId, versionId, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _updatePatterns(azureRegion, azureCloud, appId, versionId, patterns, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _batchAddPatterns(azureRegion, azureCloud, appId, versionId, patterns, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _deletePatterns(azureRegion, azureCloud, appId, versionId, patternIds, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _updatePattern(azureRegion, azureCloud, appId, versionId, patternId, pattern, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _deletePattern(azureRegion, azureCloud, appId, versionId, patternId, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _listIntentPatterns(azureRegion, azureCloud, appId, versionId, intentId, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
...
class Pattern {
  ...
  constructor(client) {
    ...
    this._listPatterns = _listPatterns;
    ...
    this._listIntentPatterns = _listIntentPatterns;
  }
   ...
   */
  addPatternWithHttpOperationResponse(azureRegion, azureCloud, appId, versionId, pattern, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._addPattern(azureRegion, azureCloud, appId, versionId, pattern, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  addPattern(azureRegion, azureCloud, appId, versionId, pattern, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._addPattern(azureRegion, azureCloud, appId, versionId, pattern, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  listPatternsWithHttpOperationResponse(azureRegion, azureCloud, appId, versionId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listPatterns(azureRegion, azureCloud, appId, versionId, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listPatterns(azureRegion, azureCloud, appId, versionId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._listPatterns(azureRegion, azureCloud, appId, versionId, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  updatePatternsWithHttpOperationResponse(azureRegion, azureCloud, appId, versionId, patterns, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._updatePatterns(azureRegion, azureCloud, appId, versionId, patterns, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  updatePatterns(azureRegion, azureCloud, appId, versionId, patterns, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._updatePatterns(azureRegion, azureCloud, appId, versionId, patterns, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  batchAddPatternsWithHttpOperationResponse(azureRegion, azureCloud, appId, versionId, patterns, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._batchAddPatterns(azureRegion, azureCloud, appId, versionId, patterns, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  batchAddPatterns(azureRegion, azureCloud, appId, versionId, patterns, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._batchAddPatterns(azureRegion, azureCloud, appId, versionId, patterns, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  deletePatternsWithHttpOperationResponse(azureRegion, azureCloud, appId, versionId, patternIds, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._deletePatterns(azureRegion, azureCloud, appId, versionId, patternIds, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  deletePatterns(azureRegion, azureCloud, appId, versionId, patternIds, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._deletePatterns(azureRegion, azureCloud, appId, versionId, patternIds, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  updatePatternWithHttpOperationResponse(azureRegion, azureCloud, appId, versionId, patternId, pattern, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._updatePattern(azureRegion, azureCloud, appId, versionId, patternId, pattern, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  updatePattern(azureRegion, azureCloud, appId, versionId, patternId, pattern, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._updatePattern(azureRegion, azureCloud, appId, versionId, patternId, pattern, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  deletePatternWithHttpOperationResponse(azureRegion, azureCloud, appId, versionId, patternId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._deletePattern(azureRegion, azureCloud, appId, versionId, patternId, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  deletePattern(azureRegion, azureCloud, appId, versionId, patternId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._deletePattern(azureRegion, azureCloud, appId, versionId, patternId, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  listIntentPatternsWithHttpOperationResponse(azureRegion, azureCloud, appId, versionId, intentId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listIntentPatterns(azureRegion, azureCloud, appId, versionId, intentId, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listIntentPatterns(azureRegion, azureCloud, appId, versionId, intentId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._listIntentPatterns(azureRegion, azureCloud, appId, versionId, intentId, options, optionalCallback);
    }
  }
