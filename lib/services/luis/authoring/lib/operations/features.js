 ...
 */
function _listApplicationVersionPatternFeatures(azureRegion, azureCloud, appId, versionId, options, callback) {
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _addPhraseList(azureRegion, azureCloud, appId, versionId, phraselistCreateObject, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _listPhraseLists(azureRegion, azureCloud, appId, versionId, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _list(azureRegion, azureCloud, appId, versionId, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getPhraseList(azureRegion, azureCloud, appId, versionId, phraselistId, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _updatePhraseList(azureRegion, azureCloud, appId, versionId, phraselistId, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _deletePhraseList(azureRegion, azureCloud, appId, versionId, phraselistId, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
...
class Features {
  ...
  constructor(client) {
    this.client = client;
    this._listApplicationVersionPatternFeatures = _listApplicationVersionPatternFeatures;
   ...
   */
  listApplicationVersionPatternFeaturesWithHttpOperationResponse(azureRegion, azureCloud, appId, versionId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listApplicationVersionPatternFeatures(azureRegion, azureCloud, appId, versionId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listApplicationVersionPatternFeatures(azureRegion, azureCloud, appId, versionId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._listApplicationVersionPatternFeatures(azureRegion, azureCloud, appId, versionId, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  addPhraseListWithHttpOperationResponse(azureRegion, azureCloud, appId, versionId, phraselistCreateObject, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._addPhraseList(azureRegion, azureCloud, appId, versionId, phraselistCreateObject, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  addPhraseList(azureRegion, azureCloud, appId, versionId, phraselistCreateObject, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._addPhraseList(azureRegion, azureCloud, appId, versionId, phraselistCreateObject, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  listPhraseListsWithHttpOperationResponse(azureRegion, azureCloud, appId, versionId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listPhraseLists(azureRegion, azureCloud, appId, versionId, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listPhraseLists(azureRegion, azureCloud, appId, versionId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._listPhraseLists(azureRegion, azureCloud, appId, versionId, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  listWithHttpOperationResponse(azureRegion, azureCloud, appId, versionId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._list(azureRegion, azureCloud, appId, versionId, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  list(azureRegion, azureCloud, appId, versionId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._list(azureRegion, azureCloud, appId, versionId, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getPhraseListWithHttpOperationResponse(azureRegion, azureCloud, appId, versionId, phraselistId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getPhraseList(azureRegion, azureCloud, appId, versionId, phraselistId, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getPhraseList(azureRegion, azureCloud, appId, versionId, phraselistId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getPhraseList(azureRegion, azureCloud, appId, versionId, phraselistId, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  updatePhraseListWithHttpOperationResponse(azureRegion, azureCloud, appId, versionId, phraselistId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._updatePhraseList(azureRegion, azureCloud, appId, versionId, phraselistId, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  updatePhraseList(azureRegion, azureCloud, appId, versionId, phraselistId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._updatePhraseList(azureRegion, azureCloud, appId, versionId, phraselistId, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  deletePhraseListWithHttpOperationResponse(azureRegion, azureCloud, appId, versionId, phraselistId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._deletePhraseList(azureRegion, azureCloud, appId, versionId, phraselistId, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  deletePhraseList(azureRegion, azureCloud, appId, versionId, phraselistId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._deletePhraseList(azureRegion, azureCloud, appId, versionId, phraselistId, options, optionalCallback);
    }
  }
