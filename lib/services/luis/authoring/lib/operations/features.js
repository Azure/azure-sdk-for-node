 ...
 */
function _listApplicationVersionPatternFeatures(appId, versionId, options, callback) {
...
class Features {
   ...
   */
  listApplicationVersionPatternFeaturesWithHttpOperationResponse(appId, versionId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listApplicationVersionPatternFeatures(appId, versionId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listApplicationVersionPatternFeatures(appId, versionId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._listApplicationVersionPatternFeatures(appId, versionId, options, optionalCallback);
    }
  }
