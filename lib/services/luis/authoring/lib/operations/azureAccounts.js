 ...
 */
function _assignToApp(azureRegion, azureCloud, appId, options, callback) {
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getAssigned(azureRegion, azureCloud, appId, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _removeFromApp(azureRegion, azureCloud, appId, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _listUserLUISAccounts(azureRegion, azureCloud, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
...
class AzureAccounts {
  ...
  constructor(client) {
    ...
    this._listUserLUISAccounts = _listUserLUISAccounts;
  }
   ...
   */
  assignToAppWithHttpOperationResponse(azureRegion, azureCloud, appId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._assignToApp(azureRegion, azureCloud, appId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  assignToApp(azureRegion, azureCloud, appId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._assignToApp(azureRegion, azureCloud, appId, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getAssignedWithHttpOperationResponse(azureRegion, azureCloud, appId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getAssigned(azureRegion, azureCloud, appId, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getAssigned(azureRegion, azureCloud, appId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getAssigned(azureRegion, azureCloud, appId, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  removeFromAppWithHttpOperationResponse(azureRegion, azureCloud, appId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._removeFromApp(azureRegion, azureCloud, appId, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  removeFromApp(azureRegion, azureCloud, appId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._removeFromApp(azureRegion, azureCloud, appId, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  listUserLUISAccountsWithHttpOperationResponse(azureRegion, azureCloud, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listUserLUISAccounts(azureRegion, azureCloud, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listUserLUISAccounts(azureRegion, azureCloud, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._listUserLUISAccounts(azureRegion, azureCloud, options, optionalCallback);
    }
  }
