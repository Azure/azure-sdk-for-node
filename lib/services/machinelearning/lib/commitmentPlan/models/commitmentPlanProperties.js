...
class CommitmentPlanProperties {
   ...
   * @property {boolean} [chargeForOverage] Indicates whether usage beyond the
   * commitment plan's included quantities will be charged.
   * @property {boolean} [chargeForPlan] Indicates whether the commitment plan
   * will incur a charge.
   * @property {date} [creationDate] The date at which this commitment plan was
   * created, in ISO 8601 format.
   * @property {object} [includedQuantities] The included resource quantities
   * this plan gives you.
   * @property {number} [maxAssociationLimit] The maximum number of commitment
   * associations that can be children of this commitment plan.
   * @property {number} [maxCapacityLimit] The maximum scale-out capacity for
   * this commitment plan.
   * @property {number} [minCapacityLimit] The minimum scale-out capacity for
   * this commitment plan.
   * @property {string} [planMeter] The Azure meter which will be used to
   * charge for this commitment plan.
   * @property {number} [refillFrequencyInDays] The frequency at which this
   * commitment plan's included quantities are refilled.
   * @property {boolean} [suspendPlanOnOverage] Indicates whether this
