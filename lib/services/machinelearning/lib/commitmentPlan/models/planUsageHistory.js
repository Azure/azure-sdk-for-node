...
class PlanUsageHistory {
   ...
   * @property {object} [planDeletionOverage] Overage incurred as a result of
   * deleting a commitment plan.
   * @property {object} [planMigrationOverage] Overage incurred as a result of
   * migrating a commitment plan from one SKU to another.
   * @property {object} [planQuantitiesAfterUsage] Included quantities
   * remaining after usage against the commitment plan's associated resources
   * was calculated.
   * @property {object} [planQuantitiesBeforeUsage] Included quantities
   * remaining before usage against the commitment plan's associated resources
   * was calculated.
   * @property {object} [planUsageOverage] Usage against the commitment plan's
   * associated resources which was not covered by included quantities and is
   * therefore overage.
   * @property {object} [usage] Usage against the commitment plan's associated
   * resources.
   * @property {date} [usageDate] The date of usage, in ISO 8601 format.
   */
  constructor() {
  }
