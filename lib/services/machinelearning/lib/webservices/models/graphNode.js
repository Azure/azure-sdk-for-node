...
class GraphNode {
  /**
   * Create a GraphNode.
   * @property {string} [assetId] The id of the asset represented by this node.
   * @property {string} [inputId] The id of the input element represented by
   * this node.
   * @property {string} [outputId] The id of the output element represented by
   * this node.
   * @property {object} [parameters] If applicable, parameters of the node.
