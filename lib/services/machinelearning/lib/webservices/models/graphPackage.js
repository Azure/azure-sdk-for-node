...
class GraphPackage {
   ...
   * @property {object} [nodes] The set of nodes making up the graph, provided
   * as a nodeId to GraphNode map
   * @property {array} [edges] The list of edges making up the graph.
   * @property {object} [graphParameters] The collection of global parameters
   * for the graph, given as a global parameter name to GraphParameter map.
   * Each parameter here has a 1:1 match with the global parameters values map
