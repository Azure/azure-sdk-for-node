...
class ColumnSpecification {
   ...
   * @property {string} type Data type of the column. Possible values include:
   * 'Boolean', 'Integer', 'Number', 'String'
   * @property {string} [format] Additional format information for the data
   * type. Possible values include: 'Byte', 'Char', 'Complex64', 'Complex128',
   * 'Date-time', 'Date-timeOffset', 'Double', 'Duration', 'Float', 'Int8',
   * 'Int16', 'Int32', 'Int64', 'Uint8', 'Uint16', 'Uint32', 'Uint64'
   * @property {array} [enum] If the data type is categorical, this provides
   * the list of accepted categories.
   * @property {boolean} [xMsIsnullable] Flag indicating if the type supports
   * null values or not.
   * @property {boolean} [xMsIsordered] Flag indicating whether the categories
