...
class WebServicePropertiesForGraph extends models['WebServiceProperties'] {
   ...
   * @property {object} [packageProperty] The definition of the graph package
   * making up this web service.
   * @property {object} [packageProperty.nodes] The set of nodes making up the
   * graph, provided as a nodeId to GraphNode map
   * @property {array} [packageProperty.edges] The list of edges making up the
   * graph.
   * @property {object} [packageProperty.graphParameters] The collection of
