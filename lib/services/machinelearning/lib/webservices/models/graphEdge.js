...
class GraphEdge {
  /**
   * Create a GraphEdge.
   * @property {string} [sourceNodeId] The source graph node's identifier.
   * @property {string} [sourcePortId] The identifier of the source node's port
   * that the edge connects from.
   * @property {string} [targetNodeId] The destination graph node's identifier.
   * @property {string} [targetPortId] The identifier of the destination node's
