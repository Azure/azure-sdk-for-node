...
class GraphParameter {
   ...
   * @property {string} [description] Description of this graph parameter.
   * @property {string} type Graph parameter's type. Possible values include:
   * 'String', 'Int', 'Float', 'Enumerated', 'Script', 'Mode', 'Credential',
   * 'Boolean', 'Double', 'ColumnPicker', 'ParameterRange', 'DataGatewayName'
   * @property {array} links Association links for this parameter to nodes in
   * the graph.
   */
  constructor() {
  }
