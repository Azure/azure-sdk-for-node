 ...
 * 
 */
function RedisResource(parameters) {
  RedisResource['super_'].call(this, parameters);
...
/**
 * Validate the payload against the RedisResource schema
 *
 * @param {JSON} payload
 *
 */
RedisResource.prototype.serialize = function () {
  var payload = RedisResource['super_'].prototype.serialize.call(this);
...
/**
 * Deserialize the instance to RedisResource schema
 *
 * @param {JSON} instance
 *
 */
RedisResource.prototype.deserialize = function (instance) {
  RedisResource['super_'].prototype.deserialize.call(this, instance);
  if (instance) {
