 ...
 * 
 */
function RedisCreateParameters() {
  RedisCreateParameters['super_'].call(this);
}

util.inherits(RedisCreateParameters, models['Resource']);
 ...
 *
 */
RedisCreateParameters.prototype.mapper = function () {
  return {
    required: false,
