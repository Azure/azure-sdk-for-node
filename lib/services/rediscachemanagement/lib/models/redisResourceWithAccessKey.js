 ...
 * 
 */
function RedisResourceWithAccessKey(parameters) {
  RedisResourceWithAccessKey['super_'].call(this, parameters);
  if (parameters !== null && parameters !== undefined) {
    if (parameters.accessKeys) {
      this.accessKeys = new models['RedisAccessKeys'](parameters.accessKeys);
    }
    ...
    if (parameters.sslPort !== undefined) {
      this.sslPort = parameters.sslPort;
    }
...
/**
 * Validate the payload against the RedisResourceWithAccessKey schema
 *
 * @param {JSON} payload
 *
 */
RedisResourceWithAccessKey.prototype.serialize = function () {
  var payload = RedisResourceWithAccessKey['super_'].prototype.serialize.call(this);
  if (this['accessKeys']) {
    if (payload['properties'] === null || payload['properties'] === undefined) {
      payload['properties'] = {};
    }
    payload['properties']['accessKeys'] = this['accessKeys'].serialize();
  }
  ...
  if (this['hostName'] !== null && this['hostName'] !== undefined) {
    if (typeof this['hostName'].valueOf() !== 'string') {
      throw new Error('this[\'hostName\'] must be of type string.');
    }
    if (payload['properties'] === null || payload['properties'] === undefined) {
      payload['properties'] = {};
    }
  ...
  if (this['sslPort'] !== null && this['sslPort'] !== undefined) {
    if (typeof this['sslPort'] !== 'number') {
      throw new Error('this[\'sslPort\'] must be of type number.');
    }
    if (payload['properties'] === null || payload['properties'] === undefined) {
      payload['properties'] = {};
    }
    payload['properties']['sslPort'] = this['sslPort'];
  }
...
/**
 * Deserialize the instance to RedisResourceWithAccessKey schema
 *
 * @param {JSON} instance
 *
 */
RedisResourceWithAccessKey.prototype.deserialize = function (instance) {
  RedisResourceWithAccessKey['super_'].prototype.deserialize.call(this, instance);
  if (instance) {
    if (instance['properties'] !== null && instance['properties'] !== undefined) {
      if (instance['properties']['accessKeys']) {
        this['accessKeys'] = new models['RedisAccessKeys']().deserialize(instance['properties']['accessKeys']);
      }
    }
    ...
    if (instance['properties'] !== null && instance['properties'] !== undefined) {
      if (instance['properties']['sslPort'] !== undefined) {
        this['sslPort'] = instance['properties']['sslPort'];
      }
    }
