...
PatchSchedules.prototype.createOrUpdate = function (resourceGroupName, name, scheduleEntries, options, callback) {
  ...
  var parameters = new client.models['RedisPatchSchedule']();
  try {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/Redis/{name}/patchSchedules/default';
  ...
  try {
    if (parameters !== null && parameters !== undefined) {
      var requestModelMapper = new client.models['RedisPatchSchedule']().mapper();
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = new client.models['RedisPatchSchedule']().mapper();
