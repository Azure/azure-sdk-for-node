 ...
 */
function RedisFirewallRuleOperations(client) {
  this.client = client;
}
 ...
 */
RedisFirewallRuleOperations.prototype.createOrUpdate = function (resourceGroupName, cacheName, ruleName, parameters, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cache/Redis/{cacheName}/firewallRules/{ruleName}';
  ...
  try {
    if (parameters !== null && parameters !== undefined) {
      var requestModelMapper = new client.models['RedisFirewallRule']().mapper();
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = new client.models['RedisFirewallRule']().mapper();
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
RedisFirewallRuleOperations.prototype.get = function (resourceGroupName, cacheName, ruleName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
RedisFirewallRuleOperations.prototype.deleteMethod = function (resourceGroupName, cacheName, ruleName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
