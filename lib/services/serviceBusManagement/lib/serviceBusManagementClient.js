...
var ServiceBusManagementClient = ( /** @lends ServiceBusManagementClient */ function() {
  ...
  ServiceBusManagementClient.prototype.getServiceBusRegions = function(callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.credentials.subscriptionId ? this.credentials.subscriptionId.trim() : '') + '/services/servicebus/regions';
    var baseUrl = this.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
...
var NamespaceOperations = ( /** @lends NamespaceOperations */ function() {
  ...
  NamespaceOperations.prototype.checkAvailability = function(namespaceName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/ServiceBus/CheckNamespaceAvailability?';
  ...
  NamespaceOperations.prototype.create = function(namespaceName, region, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/servicebus/namespaces/' + namespaceName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  NamespaceOperations.prototype.createAuthorizationRule = function(namespaceName, rule, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/servicebus/namespaces/' + namespaceName.trim() + '/AuthorizationRules';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  NamespaceOperations.prototype.deleteAuthorizationRule = function(namespaceName, ruleName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/servicebus/namespaces/' + namespaceName.trim() + '/AuthorizationRules/' + ruleName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  NamespaceOperations.prototype.getAuthorizationRule = function(namespaceName, entityName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/servicebus/namespaces/' + namespaceName.trim() + '/AuthorizationRules/' + entityName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  NamespaceOperations.prototype.getNamespaceDescription = function(namespaceName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/servicebus/namespaces/' + namespaceName.trim() + '/ConnectionDetails';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  NamespaceOperations.prototype.list = function(callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/servicebus/namespaces/';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  NamespaceOperations.prototype.updateAuthorizationRule = function(namespaceName, rule, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/servicebus/namespaces/' + namespaceName.trim() + '/AuthorizationRules/' + (rule.keyName ? rule.keyName.trim() : '');
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
...
var NotificationHubOperations = ( /** @lends NotificationHubOperations */ function() {
  ...
  NotificationHubOperations.prototype.delete = function(namespaceName, notificationHubName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/servicebus/namespaces/' + namespaceName.trim() + '/NotificationHubs/' + notificationHubName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  NotificationHubOperations.prototype.getConnectionDetails = function(namespaceName, notificationHubName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/servicebus/namespaces/' + namespaceName.trim() + '/NotificationHubs/' + notificationHubName.trim() + '/ConnectionDetails';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  NotificationHubOperations.prototype.list = function(namespaceName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/servicebus/namespaces/' + namespaceName.trim() + '/NotificationHubs';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
...
var QueueOperations = ( /** @lends QueueOperations */ function() {
  ...
  QueueOperations.prototype.create = function(namespaceName, queue, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/servicebus/namespaces/' + namespaceName.trim() + '/queues/' + queue.name.trim() + '/';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    if (queue.enableBatchedOperations) {
    ...
    if (queue.isAnonymousAccessible) {
    ...
    if (queue.authorizationRules) {
      ...
      for (var loweredIndex2 = 0; loweredIndex2 < queue.authorizationRules.length; loweredIndex2 = loweredIndex2 + 1) {
        ...
        if (authorizationRulesItem.createdTime) {
          var createdTimeElement = js2xml.createElement('CreatedTime', 'http://schemas.microsoft.com/netservices/2010/10/servicebus/connect');
        ...
        if (authorizationRulesItem.modifiedTime) {
          var modifiedTimeElement = js2xml.createElement('ModifiedTime', 'http://schemas.microsoft.com/netservices/2010/10/servicebus/connect');
    ...
    if (queue.countDetails) {
      ...
      if (queue.countDetails.activeMessageCount) {
      ...
      if (queue.countDetails.deadLetterMessageCount) {
      ...
      if (queue.countDetails.scheduledMessageCount) {
      ...
      if (queue.countDetails.transferDeadLetterMessageCount) {
      ...
      if (queue.countDetails.transferMessageCount) {
  ...
  QueueOperations.prototype.delete = function(namespaceName, queueName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/servicebus/namespaces/' + namespaceName.trim() + '/Queues/' + queueName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  QueueOperations.prototype.getConnectionDetails = function(namespaceName, queueName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/servicebus/namespaces/' + namespaceName.trim() + '/Queues/' + queueName.trim() + '/ConnectionDetails';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  QueueOperations.prototype.list = function(namespaceName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/servicebus/namespaces/' + namespaceName.trim() + '/Queues';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  QueueOperations.prototype.update = function(namespaceName, queue, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/servicebus/namespaces/' + namespaceName.trim() + '/queues/' + (queue.name ? queue.name.trim() : '') + '/';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
...
var RelayOperations = ( /** @lends RelayOperations */ function() {
  ...
  RelayOperations.prototype.getConnectionDetails = function(namespaceName, relayName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/servicebus/namespaces/' + namespaceName.trim() + '/Relays/' + relayName.trim() + '/ConnectionDetails';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
...
var TopicOperations = ( /** @lends TopicOperations */ function() {
  ...
  TopicOperations.prototype.create = function(namespaceName, topic, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/servicebus/namespaces/' + namespaceName.trim() + '/topics/' + (topic.name ? topic.name.trim() : '') + '/';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    if (topic.enableBatchedOperations) {
      var enableBatchedOperationsElement = js2xml.createElement('EnableBatchedOperations', 'http://schemas.microsoft.com/netservices/2010/10/servicebus/connect');
    ...
    if (topic.filteringMessagesBeforePublishing) {
    ...
    if (topic.isAnonymousAccessible) {
      var isAnonymousAccessibleElement = js2xml.createElement('IsAnonymousAccessible', 'http://schemas.microsoft.com/netservices/2010/10/servicebus/connect');
  ...
  TopicOperations.prototype.delete = function(namespaceName, topicName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/servicebus/namespaces/' + namespaceName.trim() + '/topics/' + topicName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  TopicOperations.prototype.getConnectionDetails = function(namespaceName, topicName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/servicebus/namespaces/' + namespaceName.trim() + '/Topics/' + topicName.trim() + '/ConnectionDetails';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  TopicOperations.prototype.list = function(namespaceName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/servicebus/namespaces/' + namespaceName.trim() + '/topics/';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
