...
var NamespaceOperations = (function() {
   ...
   * 
   * @param {List`1} [rule.rights] The rights associated with the rule
   * 
...
var QueueOperations = (function() {
   ...
   * is allowed.
   * 
   * @param {List`1} [queue.authorizationRules] Gets the authorization rules
   * for the description.
   * 
...
var TopicOperations = (function() {
   ...
   * is allowed.
   * 
   * @param {List`1} [topic.authorizationRules] Gets the authorization rules
   * for the description.
   * 
