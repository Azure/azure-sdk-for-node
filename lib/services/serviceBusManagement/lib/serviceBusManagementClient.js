...
var ServiceBusManagementClient = ( /** @lends ServiceBusManagementClient */ function() {
  ...
  ServiceBusManagementClient.prototype.getServiceBusRegions = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.baseUri;
    var url2 = '/' + this.credentials.subscriptionId.trim() + '/services/servicebus/regions';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var NamespaceOperations = ( /** @lends NamespaceOperations */ function() {
  ...
  NamespaceOperations.prototype.checkAvailability = function(namespaceName, callback) {
    ...
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/ServiceBus/CheckNamespaceAvailability?';
  ...
  NamespaceOperations.prototype.create = function(namespaceName, region, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/servicebus/namespaces/' + namespaceName.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  NamespaceOperations.prototype.createAuthorizationRule = function(namespaceName, rule, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/servicebus/namespaces/' + namespaceName.trim() + '/AuthorizationRules';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  NamespaceOperations.prototype.deleteAuthorizationRule = function(namespaceName, ruleName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/servicebus/namespaces/' + namespaceName.trim() + '/AuthorizationRules/' + ruleName.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  NamespaceOperations.prototype.getAuthorizationRule = function(namespaceName, entityName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/servicebus/namespaces/' + namespaceName.trim() + '/AuthorizationRules/' + entityName.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  NamespaceOperations.prototype.getNamespaceDescription = function(namespaceName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/servicebus/namespaces/' + namespaceName.trim() + '/ConnectionDetails';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  NamespaceOperations.prototype.list = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/servicebus/namespaces/';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  NamespaceOperations.prototype.updateAuthorizationRule = function(namespaceName, rule, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/servicebus/namespaces/' + namespaceName.trim() + '/AuthorizationRules/' + rule.keyName.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var NotificationHubOperations = ( /** @lends NotificationHubOperations */ function() {
  ...
  NotificationHubOperations.prototype.get = function(namespaceName, notificationHubName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/servicebus/namespaces/' + namespaceName.trim() + '/NotificationHubs/' + notificationHubName.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  NotificationHubOperations.prototype.getConnectionDetails = function(namespaceName, notificationHubName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/servicebus/namespaces/' + namespaceName.trim() + '/NotificationHubs/' + notificationHubName.trim() + '/ConnectionDetails';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  NotificationHubOperations.prototype.list = function(namespaceName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/servicebus/namespaces/' + namespaceName.trim() + '/NotificationHubs';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var QueueOperations = ( /** @lends QueueOperations */ function() {
  ...
  QueueOperations.prototype.create = function(namespaceName, queue, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/servicebus/namespaces/' + namespaceName.trim() + '/queues/' + queue.name.trim() + '/';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  QueueOperations.prototype.get = function(namespaceName, queueName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/servicebus/namespaces/' + namespaceName.trim() + '/Queues/' + queueName.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  QueueOperations.prototype.getConnectionDetails = function(namespaceName, queueName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/servicebus/namespaces/' + namespaceName.trim() + '/Queues/' + queueName.trim() + '/ConnectionDetails';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  QueueOperations.prototype.list = function(namespaceName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/servicebus/namespaces/' + namespaceName.trim() + '/Queues';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var RelayOperations = ( /** @lends RelayOperations */ function() {
  ...
  RelayOperations.prototype.getConnectionDetails = function(namespaceName, relayName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/servicebus/namespaces/' + namespaceName.trim() + '/Relays/' + relayName.trim() + '/ConnectionDetails';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var TopicOperations = ( /** @lends TopicOperations */ function() {
  ...
  TopicOperations.prototype.create = function(namespaceName, topic, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/servicebus/namespaces/' + namespaceName.trim() + '/topics/' + topic.name.trim() + '/';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  TopicOperations.prototype.get = function(namespaceName, topicName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/servicebus/namespaces/' + namespaceName.trim() + '/topics/' + topicName.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  TopicOperations.prototype.getConnectionDetails = function(namespaceName, topicName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/servicebus/namespaces/' + namespaceName.trim() + '/Topics/' + topicName.trim() + '/ConnectionDetails';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  TopicOperations.prototype.list = function(namespaceName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/servicebus/namespaces/' + namespaceName.trim() + '/topics/';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
