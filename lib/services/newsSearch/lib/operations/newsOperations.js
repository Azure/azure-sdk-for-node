...
/**
 * @summary The News Search API lets you send a search query to Bing and get
 ...
 * both.
 *
 * @param {number} [options.count] The number of news articles to return in the
 * response. The actual number delivered may be less than requested. The
 * default is 10 and the maximum value is 100. The actual number delivered may
 * be less than requested.You may use this parameter along with the offset
 * parameter to page results. For example, if your user interface displays 20
 * articles per page, set count to 20 and offset to 0 to get the first page of
 ...
 * results.
 *
 * @param {string} [options.freshness] Filter news by the date and time that
 * Bing discovered the news. The following are the possible filter values. Day:
 * Return news discovered within the last 24 hours. Week: Return news
 * discovered within the last 7 days. Month: Return news discovered within the
 * last 30 days. Use this parameter only with the News Search API. Do not
 ...
 * number of news to skip before returning news. The default is 0. The offset
 * should be less than
 ...
 * the original article's image or the image itself. If the article includes an
 ...
 * contentUrl and thumbnailUrl URLs both point to the same thumbnail image. Use
 * this parameter only with the News Search API. Do not specify this parameter
 * when calling the Trending Topics API or News Category API.
 *
 * @param {string} [options.safeSearch] Filter news for adult content. The
 ...
 * with adult text, images, or videos. If the request comes from a market that
 * Bing's adult policy requires that safeSearch is set to Strict, Bing ignores
 * the safeSearch value and uses Strict. If you use the site: query operator,
 * there is the chance that the response may contain adult content regardless
 * of what the safeSearch query parameter is set to. Use site: only if you are
 ...
 *
 * @param {string} [options.sortBy] The order to return the news in. The
 * following are the possible case-insensitive values. Date: If the request is
 * through the News Search API, the response returns news articles sorted by
 * date from the most recent to the oldest. If the request is through the News
 ...
 *                      See {@link News} for more information.
 *
...
function _search(query, options, callback) {
  ...
  let originalImage = (options && options.originalImage !== undefined) ? options.originalImage : undefined;
  ...
  try {
    ...
    if (originalImage !== null && originalImage !== undefined && typeof originalImage !== 'boolean') {
      throw new Error('originalImage must be of type boolean.');
    }
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'news/search';
  let queryParameters = [];
  ...
  if (originalImage !== null && originalImage !== undefined) {
    queryParameters.push('originalImg=' + encodeURIComponent(originalImage.toString()));
  }
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['News']().mapper();
...
/**
 * @summary The News Category API lets lets you search on Bing and get back a
 * list of top news articles by category. This section provides technical
 * details about the query parameters and headers that you use to request news
 * and the JSON response objects that contain them.  For examples that show how
 * to make requests, see [Searching the web for
 * news](https://docs.microsoft.com/en-us/azure/cognitive-services/bing-news-search/search-the-web).
 *
 * @param {object} [options] Optional Parameters.
 *
 ...
 * both.
 *
 * @param {string} [options.category] The category of articles to return. For
 ...
 * in the last 24 hours from any category and articles from each parent
 * category (up to four articles). If the article is a headline, the article's
 * headline field is set to true. By default, the response includes up to 12
 * headline articles. To specify the number of headline articles to return, set
 * the
 ...
 * publisher's website. Otherwise, if this parameter is false, the image's
 * contentUrl and thumbnailUrl URLs both point to the same thumbnail image. Use
 * this parameter only with the News Search API or News Category API. Trending
 * Topics API ignore this parameter.
 *
 * @param {string} [options.safeSearch] Filter news for adult content. The
 * following are the possible filter values. Off: Return news articles with
 * adult text, images, or videos. Moderate: Return news articles with adult
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _category(options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  let count = (options && options.count !== undefined) ? options.count : undefined;
  let headlineCount = (options && options.headlineCount !== undefined) ? options.headlineCount : undefined;
  let market = (options && options.market !== undefined) ? options.market : undefined;
  let offset = (options && options.offset !== undefined) ? options.offset : undefined;
  let originalImage = (options && options.originalImage !== undefined) ? options.originalImage : undefined;
  let safeSearch = (options && options.safeSearch !== undefined) ? options.safeSearch : undefined;
  ...
  try {
    ...
    if (headlineCount !== null && headlineCount !== undefined && typeof headlineCount !== 'number') {
      throw new Error('headlineCount must be of type number.');
    }
    if (market !== null && market !== undefined && typeof market.valueOf() !== 'string') {
      throw new Error('market must be of type string.');
    }
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'news';
  let queryParameters = [];
  if (countryCode !== null && countryCode !== undefined) {
    queryParameters.push('cc=' + encodeURIComponent(countryCode));
  }
  ...
  if (headlineCount !== null && headlineCount !== undefined) {
    queryParameters.push('headlineCount=' + encodeURIComponent(headlineCount.toString()));
  }
  if (market !== null && market !== undefined) {
    queryParameters.push('mkt=' + encodeURIComponent(market));
  }
...
/**
 * @summary The News Trending Topics API lets lets you search on Bing and get
 * back a list of trending news topics that are currently trending on Bing.
 ...
 * properties in the response objects apply the specified language.
 *
 * @param {number} [options.since] The Unix epoch time (Unix timestamp) that
 * Bing uses to select the trending topics. Bing returns trending topics that
 * it discovered on or after the specified date and time, not the date the
 * topic was published. To use this parameter, also specify the sortBy
 * parameter. Use this parameter only with the News Trending Topics API. Do not
 * specify this parameter when calling the News Search API or News Category
 * API.
 *
 * @param {string} [options.sortBy] The order to return the news in. The
 * following are the possible case-insensitive values. Date: If the request is
 ...
 *
 *                      {object} [result]   - The deserialized result object if an error did not occur.
 *                      See {@link TrendingTopics} for more information.
 *
 *                      {object} [request]  - The HTTP Request object if an error did not occur.
 *
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
...
function _trending(options, callback) {
  ...
  let safeSearch = (options && options.safeSearch !== undefined) ? options.safeSearch : undefined;
  let setLang = (options && options.setLang !== undefined) ? options.setLang : undefined;
  let since = (options && options.since !== undefined) ? options.since : undefined;
  let sortBy = (options && options.sortBy !== undefined) ? options.sortBy : undefined;
  let textDecorations = (options && options.textDecorations !== undefined) ? options.textDecorations : undefined;
  let textFormat = (options && options.textFormat !== undefined) ? options.textFormat : undefined;
  let xBingApisSDK = 'true';
  ...
  try {
    ...
    if (since !== null && since !== undefined && typeof since !== 'number') {
      throw new Error('since must be of type number.');
    }
    if (sortBy !== null && sortBy !== undefined && typeof sortBy.valueOf() !== 'string') {
      throw new Error('sortBy must be of type string.');
    }
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'news/trendingtopics';
  let queryParameters = [];
  if (countryCode !== null && countryCode !== undefined) {
    queryParameters.push('cc=' + encodeURIComponent(countryCode));
  }
  ...
  if (since !== null && since !== undefined) {
    queryParameters.push('since=' + encodeURIComponent(since.toString()));
  }
  if (sortBy !== null && sortBy !== undefined) {
    queryParameters.push('sortBy=' + encodeURIComponent(sortBy));
  }
  ...
  return client.pipeline(httpRequest, (err, response, responseBody) => {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['TrendingTopics']().mapper();
          result = client.deserialize(resultMapper, parsedResponse, 'result');
        }
      } catch (error) {
        let deserializationError = new Error(`Error ${error} occurred in deserializing the responseBody - ${responseBody}`);
...
class NewsOperations {
   ...
   * @param {NewsSearchAPIClient} client Reference to the service client.
   */
  constructor(client) {
    this.client = client;
   ...
   *
   * @resolve {HttpOperationResponse<News>} - The deserialized result object.
   *
   ...
   *
   *                      @resolve {News} - The deserialized result object.
   *
   *                      @reject {Error} - The error object.
   *
   ...
   * @reject {Error} - The error object.
   */
  categoryWithHttpOperationResponse(options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._category(options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  category(options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._category(options, optionalCallback);
    }
  }
   ...
   * @returns {Promise} A promise is returned
   *
   * @resolve {HttpOperationResponse<TrendingTopics>} - The deserialized result object.
   *
   * @reject {Error} - The error object.
   */
   ...
   * {Promise} A promise is returned
   *
   *                      @resolve {TrendingTopics} - The deserialized result object.
   *
   *                      @reject {Error} - The error object.
   *
   * {function} optionalCallback(err, result, request, response)
