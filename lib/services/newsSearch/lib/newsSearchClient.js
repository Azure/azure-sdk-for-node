...
/** Class representing a NewsSearchClient. */
class NewsSearchClient extends ServiceClient {
  /**
   * Create a NewsSearchClient.
...
module.exports = NewsSearchClient;
module.exports['default'] = NewsSearchClient;
module.exports.NewsSearchClient = NewsSearchClient;
module.exports.NewsSearchModels = models;
