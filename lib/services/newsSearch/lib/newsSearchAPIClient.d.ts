...
/**
 * NewsSearchAPIClientOptions for NewsSearchAPIClient.
 */
declare interface NewsSearchAPIClientOptions extends ServiceClientOptions {
  /**
...
export default class NewsSearchAPIClient extends ServiceClient {
   ...
   *
   */
  constructor(credentials: ServiceClientCredentials, options?: NewsSearchAPIClientOptions);
