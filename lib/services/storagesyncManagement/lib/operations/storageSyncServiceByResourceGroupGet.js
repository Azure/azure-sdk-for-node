...
/** Class representing a StorageSyncServiceByResourceGroupGet. */
class StorageSyncServiceByResourceGroupGet {
  /**
   * Create a StorageSyncServiceByResourceGroupGet.
...
module.exports = StorageSyncServiceByResourceGroupGet;
