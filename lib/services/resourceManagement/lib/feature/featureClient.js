 ...
 *
 */
function FeatureClient(credentials, subscriptionId, baseUri, options) {
  ...
  FeatureClient['super_'].call(this, credentials, options);
...
util.inherits(FeatureClient, ServiceClient);
