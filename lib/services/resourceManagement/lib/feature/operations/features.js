...
Features.prototype.get = function (resourceProviderNamespace, featureName, options, callback) {
  ...
  try {
    ...
    if (featureName === null || featureName === undefined) {
      throw new Error('\'featureName\' cannot be null');
    }
    if (featureName !== null && featureName !== undefined && typeof featureName !== 'string') {
      throw new Error('featureName must be of type string.');
    }
    if (this.client.apiVersion === null || this.client.apiVersion === undefined) {
      throw new Error('\'this.client.apiVersion\' cannot be null');
    }
