...
class ManagedApplicationClient extends ServiceClient {
  /**
   * Create a ManagedApplicationClient.
...
module.exports = ManagedApplicationClient;
module.exports['default'] = ManagedApplicationClient;
module.exports.ManagedApplicationClient = ManagedApplicationClient;
module.exports.ManagedApplicationModels = models;
