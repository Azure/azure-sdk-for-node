 ...
 *
 */
function ManagementLinkClient(credentials, subscriptionId, baseUri, options) {
  ...
  ManagementLinkClient['super_'].call(this, credentials, options);
...
util.inherits(ManagementLinkClient, ServiceClient);
