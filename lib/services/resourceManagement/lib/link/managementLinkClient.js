...
function _listOperations(options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.Resources/operations';
  let queryParameters = [];
...
module.exports['default'] = ManagementLinkClient;
module.exports.ManagementLinkClient = ManagementLinkClient;
module.exports.ManagementLinkModels = models;
