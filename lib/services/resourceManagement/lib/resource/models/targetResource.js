...
TargetResource.prototype.validate = function (payload) {
  ...
  if (payload['resourceName'] !== null && payload['resourceName'] !== undefined && typeof payload['resourceName'] !== 'string') {
    throw new Error('payload[\'resourceName\'] must be of type string.');
  }

  if (payload['resourceType'] !== null && payload['resourceType'] !== undefined && typeof payload['resourceType'] !== 'string') {
