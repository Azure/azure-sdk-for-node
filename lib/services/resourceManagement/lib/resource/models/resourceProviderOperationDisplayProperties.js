...
function ResourceProviderOperationDisplayProperties(parameters) {
  if (parameters !== null && parameters !== undefined) {
    ...
    if (parameters.provider !== null && parameters.provider !== undefined) {
...
ResourceProviderOperationDisplayProperties.prototype.deserialize = function (instance) {
  if (instance) {
    ...
    if (instance['provider'] !== null && instance['provider'] !== undefined) {
      this['provider'] = instance['provider'];
    }

    if (instance['resource'] !== null && instance['resource'] !== undefined) {
      this['resource'] = instance['resource'];
    }

    if (instance['operation'] !== null && instance['operation'] !== undefined) {
      this['operation'] = instance['operation'];
    }

    if (instance['description'] !== null && instance['description'] !== undefined) {
