...
ResourceProviderOperationDisplayProperties.prototype.validate = function (payload) {
  ...
  if (payload['provider'] !== null && payload['provider'] !== undefined && typeof payload['provider'] !== 'string') {
    throw new Error('payload[\'provider\'] must be of type string.');
  }

  if (payload['resource'] !== null && payload['resource'] !== undefined && typeof payload['resource'] !== 'string') {
    throw new Error('payload[\'resource\'] must be of type string.');
  }

  if (payload['operation'] !== null && payload['operation'] !== undefined && typeof payload['operation'] !== 'string') {
