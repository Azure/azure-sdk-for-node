...
ParametersLink.prototype.validate = function (payload) {
  ...
  if (payload['uri'] !== null && payload['uri'] !== undefined && typeof payload['uri'] !== 'string') {
    throw new Error('payload[\'uri\'] must be of type string.');
  }

  if (payload['contentVersion'] !== null && payload['contentVersion'] !== undefined && typeof payload['contentVersion'] !== 'string') {
