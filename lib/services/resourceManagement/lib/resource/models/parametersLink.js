 ...
 * 
 */
function ParametersLink(parameters) {
  if (parameters !== null && parameters !== undefined) {
    if (parameters.uri !== null && parameters.uri !== undefined) {
      this.uri = parameters.uri;
    }
    if (parameters.contentVersion !== null && parameters.contentVersion !== undefined) {
 ...
 *
 */
ParametersLink.prototype.serialize = function () {
  var payload = {};
...
ParametersLink.prototype.deserialize = function (instance) {
  if (instance) {
    if (instance['uri'] !== null && instance['uri'] !== undefined) {
      this['uri'] = instance['uri'];
    }

    if (instance['contentVersion'] !== null && instance['contentVersion'] !== undefined) {
