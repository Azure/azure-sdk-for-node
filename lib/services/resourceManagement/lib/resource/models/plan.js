...
Plan.prototype.validate = function (payload) {
  ...
  if (payload['publisher'] !== null && payload['publisher'] !== undefined && typeof payload['publisher'] !== 'string') {
    throw new Error('payload[\'publisher\'] must be of type string.');
  }

  if (payload['product'] !== null && payload['product'] !== undefined && typeof payload['product'] !== 'string') {
    throw new Error('payload[\'product\'] must be of type string.');
  }

  if (payload['promotionCode'] !== null && payload['promotionCode'] !== undefined && typeof payload['promotionCode'] !== 'string') {
