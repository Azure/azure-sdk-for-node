 ...
 * 
 */
function ResourceGroupListResult(parameters) {
  if (parameters !== null && parameters !== undefined) {
    if (parameters.value) {
      var tempParametersvalue = [];
      parameters.value.forEach(function(element) {
        if (element) {
          element = new models['ResourceGroup'](element);
        }
 ...
 *
 */
ResourceGroupListResult.prototype.serialize = function () {
  var payload = {};
  ...
  if (instance) {
    if (instance['value']) {
      ...
      instance['value'].forEach(function(element1) {
        if (element1) {
          element1 = new models['ResourceGroup']().deserialize(element1);
        }
