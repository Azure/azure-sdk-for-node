 ...
 *                      {Error}  err        - The Error object if an error occurred, null otherwise.
 *
 *                      {object} [result]   - The result JSON object if an error did not occur.
 *
 *                      {object} [request]  - The HTTP Request object if an error did not occur.
 *
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _resourceActionRequest(resourceId, apiVersion, parameters, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Send request
  this.beginResourceActionRequest(resourceId, apiVersion, parameters, options, (err, parsedResult, httpRequest, response) => {
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _beginResourceActionRequest(resourceId, apiVersion, parameters, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
...
class Resources {
  constructor(client) {
    ...
    this._resourceActionRequest = _resourceActionRequest;
    ...
    this._beginResourceActionRequest = _beginResourceActionRequest;
   ...
   * @reject {Error} - The error object.
   */
  resourceActionRequestWithHttpOperationResponse(resourceId, apiVersion, parameters, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._resourceActionRequest(resourceId, apiVersion, parameters, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  resourceActionRequest(resourceId, apiVersion, parameters, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._resourceActionRequest(resourceId, apiVersion, parameters, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  beginResourceActionRequestWithHttpOperationResponse(resourceId, apiVersion, parameters, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginResourceActionRequest(resourceId, apiVersion, parameters, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  beginResourceActionRequest(resourceId, apiVersion, parameters, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._beginResourceActionRequest(resourceId, apiVersion, parameters, options, optionalCallback);
    }
  }
