 ...
 */
PolicyAssignments.prototype.listForResource = function (resourceGroupName, resourceProviderNamespace, parentResourcePath, resourceType, resourceName, filter, options, callback) {
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse) {
          result = new client._models['PolicyAssignmentListResult'](parsedResponse);
        }
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
PolicyAssignments.prototype.listForResourceGroup = function (resourceGroupName, filter, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['PolicyAssignment'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
...
PolicyAssignments.prototype.create = function (scope, policyAssignmentName, parameters, options, callback) {
  ...
  try {
    if (parameters) {
      requestModel = new client._models['PolicyAssignmentCreateParameters'](parameters);
    }
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
PolicyAssignments.prototype.list = function (filter, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
PolicyAssignments.prototype.listForScope = function (scope, filter, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
