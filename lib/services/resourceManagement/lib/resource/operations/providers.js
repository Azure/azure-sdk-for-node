    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['Provider']().mapper();
  ...
  return client.pipeline(httpRequest, (err, response, responseBody) => {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['ProviderListResult']().mapper();
          result = client.deserialize(resultMapper, parsedResponse, 'result');
        }
      } catch (error) {
        let deserializationError = new Error(`Error ${error} occurred in deserializing the responseBody - ${responseBody}`);
...
class Providers {
   ...
   */
  unregisterWithHttpOperationResponse(resourceProviderNamespace, options) {
    let client = this.client;
    let self = this;
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  unregister(resourceProviderNamespace, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._unregister(resourceProviderNamespace, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  registerWithHttpOperationResponse(resourceProviderNamespace, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  register(resourceProviderNamespace, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._register(resourceProviderNamespace, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getWithHttpOperationResponse(resourceProviderNamespace, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  get(resourceProviderNamespace, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._get(resourceProviderNamespace, options, optionalCallback);
    }
  }
