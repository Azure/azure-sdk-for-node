  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse) {
          result = new client._models['ResourceListResult'](parsedResponse);
        }
...
ResourceGroups.prototype.createOrUpdate = function (resourceGroupName, parameters, options, callback) {
  ...
  // Send request
  this.beginCreateOrUpdate(resourceGroupName, parameters, options, function (err, parsedResult, httpRequest, response){
    ...
    client.getPutOrPatchOperationResult(initialResult, options, function (err, pollingResult) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['ResourceGroup'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
...
ResourceGroups.prototype.beginCreateOrUpdate = function (resourceGroupName, parameters, options, callback) {
  ...
  try {
    if (parameters) {
      requestModel = new client._models['ResourceGroup'](parameters);
    }
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['ResourceGroupListResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
