...
var ResourceManagementClient = ( /** @lends ResourceManagementClient */ function() {
   ...
   * 
   * @param {string} location The request ID for the request you wish to track.
   * The request ID is returned in the x-ms-request-id response header for
   * every request.
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
   */
  ResourceManagementClient.prototype.getOperationStatus = function(location, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
...
var DeploymentOperations = ( /** @lends DeploymentOperations */ function() {
  ...
  /**
   * Begin cancel a currently running template deployment.To determine whether
   * the operation has finished processing the request, call
   * GetOperationStatus.
   * 
   * @param {string} resourceGroupName The name of the resource group. The name
   * is case insensitive.
   ...
   * @returns {Stream} The response stream.
   */
  DeploymentOperations.prototype.beginCancelling = function(resourceGroupName, deploymentName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
  ...
  DeploymentOperations.prototype.cancel = function(resourceGroupName, deploymentName, callback) {
    ...
    return client2.deployments.beginCancelling(resourceGroupName, deploymentName, function (err, result) {
      if (err) {
        return callback(err);
      }
      ...
      var pollOperation = function () {
        setTimeout(function () {
          return client2.deployments.getCancelOperationStatus(result.location, function (err2, result2) {
            if (err2) {
   ...
   * @returns {Stream} The response stream.
   */
  DeploymentOperations.prototype.getCancelOperationStatus = function(location, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
