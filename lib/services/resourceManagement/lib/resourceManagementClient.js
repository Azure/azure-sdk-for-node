...
var DeploymentOperationOperations = ( /** @lends DeploymentOperationOperations */ function() {
  ...
  DeploymentOperationOperations.prototype.get = function(resourceGroupName, deploymentName, operationId, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '/deployments/' + deploymentName.trim() + '/operations/' + operationId.trim() + '?';
  ...
  DeploymentOperationOperations.prototype.list = function(resourceGroupName, deploymentName, parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '/deployments/' + deploymentName.trim() + '/operations?';
...
var DeploymentOperations = ( /** @lends DeploymentOperations */ function() {
  ...
  DeploymentOperations.prototype.cancel = function(resourceGroupName, deploymentName, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '/deployments/' + deploymentName.trim() + '/cancel?';
    url2 = url2 + 'api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
  ...
  DeploymentOperations.prototype.createOrUpdate = function(resourceGroupName, deploymentName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '/deployments/' + deploymentName.trim() + '?';
    url2 = url2 + 'api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
  ...
  DeploymentOperations.prototype.list = function(resourceGroupName, parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/';
    ...
    if (parameters && parameters.provisioningState) {
      appendFilter = false;
      url2 = url2 + '$filter=' + 'provisioningState eq \'' + encodeURIComponent(parameters.provisioningState ? parameters.provisioningState.trim() : '') + '\'';
    }
    if (parameters && parameters.top) {
      url2 = url2 + '&$top=' + encodeURIComponent(parameters.top.toString());
    }
  ...
  DeploymentOperations.prototype.validate = function(resourceGroupName, deploymentName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '/deployments/' + deploymentName.trim() + '/validate?';
    url2 = url2 + '&api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
...
var ProviderOperations = ( /** @lends ProviderOperations */ function() {
  ...
  ProviderOperations.prototype.get = function(resourceProviderNamespace, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/providers/' + resourceProviderNamespace.trim() + '?';
    url2 = url2 + 'api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
  ...
  ProviderOperations.prototype.list = function(parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/providers?';
    if (parameters && parameters.top) {
      url2 = url2 + '$top=' + encodeURIComponent(parameters.top.toString());
    }
    url2 = url2 + '&api-version=2014-04-01-preview';
  ...
  ProviderOperations.prototype.register = function(resourceProviderNamespace, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/providers/' + resourceProviderNamespace.trim() + '/register?';
    url2 = url2 + 'api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
  ...
  ProviderOperations.prototype.unregister = function(resourceProviderNamespace, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/providers/' + resourceProviderNamespace.trim() + '/unregister?';
    url2 = url2 + 'api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
...
var ResourceGroupOperations = ( /** @lends ResourceGroupOperations */ function() {
  ...
  ResourceGroupOperations.prototype.beginDeleting = function(resourceGroupName, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '?';
    url2 = url2 + 'api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
   ...
   * @returns {Stream} The response stream.
   */
  ResourceGroupOperations.prototype.getPermissions = function(resourceGroupName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '/permissions?';
    url2 = url2 + 'api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
  ...
  ResourceGroupOperations.prototype.list = function(parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups?';
    var appendFilter = true;
    if (parameters && parameters.tagName) {
      appendFilter = false;
      url2 = url2 + '$filter=tagname eq \'' + encodeURIComponent(parameters.tagName ? parameters.tagName.trim() : '') + '\'';
    }
    if (parameters && parameters.tagValue) {
      ...
      url2 = url2 + 'tagvalue eq \'' + encodeURIComponent(parameters.tagValue ? parameters.tagValue.trim() : '') + '\'';
    }
    if (parameters && parameters.top) {
      url2 = url2 + '&$top=' + encodeURIComponent(parameters.top.toString());
    }
...
var ResourceOperations = ( /** @lends ResourceOperations */ function() {
   ...
   * @returns {Stream} The response stream.
   */
  ResourceOperations.prototype.getPermissions = function(resourceGroupName, identity, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
  ...
  ResourceOperations.prototype.list = function(parametersOrCallback, callback) {
    ...
    if (parameters && parameters.resourceGroupName) {
      url2 = url2 + 'resourceGroups/' + encodeURIComponent(parameters.resourceGroupName ? parameters.resourceGroupName.trim() : '') + '/';
    }
    url2 = url2 + 'resources?';
    var appendFilter = true;
    if (parameters && parameters.resourceType) {
      appendFilter = false;
      url2 = url2 + '$filter=resourceType eq \'' + encodeURIComponent(parameters.resourceType ? parameters.resourceType.trim() : '') + '\'';
    }
    if (parameters && parameters.tagName) {
      if (appendFilter === true) {
        appendFilter = false;
      ...
      url2 = url2 + 'tagname eq \'' + encodeURIComponent(parameters.tagName ? parameters.tagName.trim() : '') + '\'';
    }
    if (parameters && parameters.tagValue) {
      if (appendFilter === true) {
        appendFilter = false;
...
var TagOperations = ( /** @lends TagOperations */ function() {
  ...
  TagOperations.prototype.createOrUpdate = function(tagName, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/tagNames/' + tagName.trim() + '?';
    url2 = url2 + 'api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
  ...
  TagOperations.prototype.createOrUpdateValue = function(tagName, tagValue, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/tagNames/' + tagName.trim() + '/tagValues/' + tagValue.trim() + '?';
    url2 = url2 + 'api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
  ...
  TagOperations.prototype.list = function(callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/tagNames?';
    url2 = url2 + 'api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
