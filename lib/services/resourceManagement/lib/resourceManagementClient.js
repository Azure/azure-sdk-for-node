...
var ResourceGroupOperations = ( /** @lends ResourceGroupOperations */ function() {
  ...
  ResourceGroupOperations.prototype.delete = function(resourceGroupName, callback) {
    ...
    return client2.resourceGroups.beginDeleting(resourceGroupName, function (err, result) {
      ...
      if (client2.resourceGroups.longRunningOperationInitialTimeout >= 0) {
        delayInSeconds = client2.resourceGroups.longRunningOperationInitialTimeout;
      }
          ...
          return client2.getLongRunningOperationStatus(result.operationStatusLink, function (err2, result2) {
            if (err2) {
              ...
              if (result2.status !== 'InProgress') {
                ...
                if (client2.resourceGroups.longRunningOperationRetryTimeout >= 0) {
                  delayInSeconds = client2.resourceGroups.longRunningOperationRetryTimeout;
                }
                pollOperation();
              }
            }
