...
var ResourceManagementClient = ( /** @lends ResourceManagementClient */ function() {
  ...
  ResourceManagementClient.prototype.getLongRunningOperationStatus = function(operationStatusLink, callback) {
    ...
    // Construct URL
    var url2 = operationStatusLink.trim();
...
var DeploymentOperationOperations = ( /** @lends DeploymentOperationOperations */ function() {
  ...
  DeploymentOperationOperations.prototype.get = function(resourceGroupName, deploymentName, operationId, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '/deployments/' + deploymentName.trim() + '/operations/' + operationId.trim() + '?';
  ...
  DeploymentOperationOperations.prototype.list = function(resourceGroupName, deploymentName, parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '/deployments/' + deploymentName.trim() + '/operations?';
...
var DeploymentOperations = ( /** @lends DeploymentOperations */ function() {
  ...
  DeploymentOperations.prototype.cancel = function(resourceGroupName, deploymentName, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '/deployments/' + deploymentName.trim() + '/cancel?';
    url2 = url2 + 'api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
   ...
   * operation.
   * 
   * @param {string} [parameters.template] Gets or sets the template content.
  ...
  DeploymentOperations.prototype.createOrUpdate = function(resourceGroupName, deploymentName, parameters, callback) {
    ...
    if (parameters.parametersLink !== null && parameters.parametersLink !== undefined) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '/deployments/' + deploymentName.trim() + '?';
    url2 = url2 + 'api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
    ...
    if (parameters.templateLink !== null && parameters.templateLink !== undefined) {
      ...
      if (parameters.templateLink.contentVersion !== null && parameters.templateLink.contentVersion !== undefined) {
    ...
    if (parameters.parametersLink !== null && parameters.parametersLink !== undefined) {
      ...
      if (parameters.parametersLink.contentVersion !== null && parameters.parametersLink.contentVersion !== undefined) {
        parametersLinkValue['contentVersion'] = parameters.parametersLink.contentVersion;
      }
    }
    
    propertiesValue['mode'] = parameters.mode !== null && parameters.mode !== undefined ? parameters.mode.toString() : 'Incremental';
          ...
          if (dependenciesArray !== null && dependenciesArray !== undefined) {
            for (var loweredIndex4 = 0; loweredIndex4 < dependenciesArray.length; loweredIndex4 = loweredIndex4 + 1) {
              ...
              if (dependsOnArray !== null && dependsOnArray !== undefined) {
                for (var loweredIndex5 = 0; loweredIndex5 < dependsOnArray.length; loweredIndex5 = loweredIndex5 + 1) {
                  var dependsOnValue = dependsOnArray[loweredIndex5];
  ...
  DeploymentOperations.prototype.list = function(resourceGroupName, parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/';
    url2 = url2 + 'resourcegroups/' + encodeURIComponent(resourceGroupName.trim()) + '/';
    ...
    if (parameters !== null && parameters !== undefined && parameters.provisioningState !== null && parameters.provisioningState !== undefined) {
      appendFilter = false;
      url2 = url2 + '$filter=' + 'provisioningState eq \'' + encodeURIComponent(parameters.provisioningState !== null && parameters.provisioningState !== undefined ? parameters.provisioningState.trim() : '') + '\'';
    }
    if (parameters !== null && parameters !== undefined && parameters.top !== null && parameters.top !== undefined) {
      url2 = url2 + '&$top=' + encodeURIComponent(parameters.top.toString());
    }
  ...
  DeploymentOperations.prototype.validate = function(resourceGroupName, deploymentName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '/deployments/' + deploymentName.trim() + '/validate?';
    url2 = url2 + '&api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
...
var ProviderOperations = ( /** @lends ProviderOperations */ function() {
  ...
  ProviderOperations.prototype.get = function(resourceProviderNamespace, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/providers/' + resourceProviderNamespace.trim() + '?';
    url2 = url2 + 'api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
  ...
  ProviderOperations.prototype.list = function(parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/providers?';
    if (parameters !== null && parameters !== undefined && parameters.top !== null && parameters.top !== undefined) {
      url2 = url2 + '$top=' + encodeURIComponent(parameters.top.toString());
    }
    url2 = url2 + '&api-version=2014-04-01-preview';
  ...
  ProviderOperations.prototype.register = function(resourceProviderNamespace, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/providers/' + resourceProviderNamespace.trim() + '/register?';
    url2 = url2 + 'api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
  ...
  ProviderOperations.prototype.unregister = function(resourceProviderNamespace, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/providers/' + resourceProviderNamespace.trim() + '/unregister?';
    url2 = url2 + 'api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
...
var ResourceGroupOperations = ( /** @lends ResourceGroupOperations */ function() {
  ...
  ResourceGroupOperations.prototype.beginDeleting = function(resourceGroupName, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '?';
    url2 = url2 + 'api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
  ...
  ResourceGroupOperations.prototype.list = function(parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups?';
    var appendFilter = true;
    if (parameters !== null && parameters !== undefined && parameters.tagName !== null && parameters.tagName !== undefined) {
      appendFilter = false;
      url2 = url2 + '$filter=tagname eq \'' + encodeURIComponent(parameters.tagName !== null && parameters.tagName !== undefined ? parameters.tagName.trim() : '') + '\'';
    }
    if (parameters !== null && parameters !== undefined && parameters.tagValue !== null && parameters.tagValue !== undefined) {
      ...
      url2 = url2 + 'tagvalue eq \'' + encodeURIComponent(parameters.tagValue !== null && parameters.tagValue !== undefined ? parameters.tagValue.trim() : '') + '\'';
    }
    if (parameters !== null && parameters !== undefined && parameters.top !== null && parameters.top !== undefined) {
      url2 = url2 + '&$top=' + encodeURIComponent(parameters.top.toString());
    }
...
var ResourceOperations = ( /** @lends ResourceOperations */ function() {
  ...
  ResourceOperations.prototype.checkExistence = function(resourceGroupName, identity, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '/providers/' + identity.resourceProviderNamespace.trim() + '/' + (identity.parentResourcePath !== null && identity.parentResourcePath !== undefined ? identity.parentResourcePath.trim() : '') + '/' + identity.resourceType.trim() + '/' + identity.resourceName.trim() + '?';
    url2 = url2 + 'api-version=' + encodeURIComponent(identity.resourceProviderApiVersion.trim());
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
   ...
   * path (optional).
   * 
   * @param {BasicResource} parameters Create or update resource parameters.
   * 
   * @param {string} parameters.location Gets or sets the location of the
   * resource.
   * 
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (responseDoc !== null && responseDoc !== undefined) {
        ...
        if (planValue2 !== null && planValue2 !== undefined) {
          ...
          var nameValue2 = planValue2['name'];
  ...
  ResourceOperations.prototype.list = function(parametersOrCallback, callback) {
    ...
    if (parameters !== null && parameters !== undefined && parameters.resourceGroupName !== null && parameters.resourceGroupName !== undefined) {
      url2 = url2 + 'resourceGroups/' + encodeURIComponent(parameters.resourceGroupName !== null && parameters.resourceGroupName !== undefined ? parameters.resourceGroupName.trim() : '') + '/';
    }
    url2 = url2 + 'resources?';
    var appendFilter = true;
    if (parameters !== null && parameters !== undefined && parameters.resourceType !== null && parameters.resourceType !== undefined) {
      appendFilter = false;
      url2 = url2 + '$filter=resourceType eq \'' + encodeURIComponent(parameters.resourceType !== null && parameters.resourceType !== undefined ? parameters.resourceType.trim() : '') + '\'';
    }
    if (parameters !== null && parameters !== undefined && parameters.tagName !== null && parameters.tagName !== undefined) {
      if (appendFilter === true) {
        appendFilter = false;
      ...
      url2 = url2 + 'tagname eq \'' + encodeURIComponent(parameters.tagName !== null && parameters.tagName !== undefined ? parameters.tagName.trim() : '') + '\'';
    }
    if (parameters !== null && parameters !== undefined && parameters.tagValue !== null && parameters.tagValue !== undefined) {
      if (appendFilter === true) {
        appendFilter = false;
...
var TagOperations = ( /** @lends TagOperations */ function() {
  ...
  TagOperations.prototype.createOrUpdate = function(tagName, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/tagNames/' + tagName.trim() + '?';
    url2 = url2 + 'api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
  ...
  TagOperations.prototype.createOrUpdateValue = function(tagName, tagValue, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/tagNames/' + tagName.trim() + '/tagValues/' + tagValue.trim() + '?';
    url2 = url2 + 'api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
   ...
   * @returns {Stream} The response stream.
   */
  TagOperations.prototype.delete = function(tagName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
  ...
  TagOperations.prototype.list = function(callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/tagNames?';
    url2 = url2 + 'api-version=2014-04-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
