...
var DeploymentOperations = ( /** @lends DeploymentOperations */ function() {
  ...
  DeploymentOperations.prototype.list = function(resourceGroupName, parametersOrCallback, callback) {
    ...
    if (parameters && parameters.provisioningState) {
      appendFilter = false;
      url2 = url2 + '$filter=' + 'provisioningState eq \'' + encodeURIComponent(parameters.provisioningState ? parameters.provisioningState.trim() : '') + '\'' + encodeURIComponent(parameters.provisioningState ? parameters.provisioningState.trim() : '');
    }
    if (parameters && parameters.top) {
      url2 = url2 + '&$top=' + encodeURIComponent(parameters.top.toString());
    }
...
var SubscriptionOperations = ( /** @lends SubscriptionOperations */ function() {
   ...
   * ResourceManagementClient~ResourceManagementClient#subscriptions}.
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (responseDoc) {
        ...
        if (valueArray) {
          for (var loweredIndex1 = 0; loweredIndex1 < valueArray.length; loweredIndex1 = loweredIndex1 + 1) {
            var valueValue = valueArray[loweredIndex1];
            var subscriptionIdDescriptionInstance = {};
            result.subscriptionIds.push(subscriptionIdDescriptionInstance);
...
var TenantOperations = ( /** @lends TenantOperations */ function() {
   ...
   * ResourceManagementClient~ResourceManagementClient}.
   * See [tenants] {@link
   * ResourceManagementClient~ResourceManagementClient#tenants}.
