    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (responseDoc) {
        ...
        if (propertiesValue2) {
          ...
          var trackingIdValue = propertiesValue2['trackingId'];
          if (trackingIdValue) {
            var trackingIdInstance = trackingIdValue;
            propertiesInstance.trackingId = trackingIdInstance;
          }
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (responseDoc) {
        ...
        if (propertiesValue) {
          ...
          var trackingIdValue = propertiesValue['trackingId'];
          if (trackingIdValue) {
            var trackingIdInstance = trackingIdValue;
            propertiesInstance.trackingId = trackingIdInstance;
          }
...
var ResourceOperations = ( /** @lends ResourceOperations */ function() {
  ...
  ResourceOperations.prototype.get = function(resourceGroupName, identity, callback) {
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      result.requestId = response.headers['x-ms-request-id'];
      if (statusCode === 200) {
        result.resource.resourceGroup = resourceGroupName;
      }
