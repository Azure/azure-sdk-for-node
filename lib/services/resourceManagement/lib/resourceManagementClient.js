...
var PermissionOperations = ( /** @lends PermissionOperations */ function() {
   ...
   * ResourceManagementClient~ResourceManagementClient#permissions}.
  ...
  /**
   * Gets a resource group permission.
   * 
   ...
   * @returns {Stream} The response stream.
   */
  PermissionOperations.prototype.get = function(resourceGroupName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
