      ...
      if (responseDoc) {
        ...
        if (propertiesValue) {
          ...
          if (targetResourceValue) {
            ...
            var idValue = targetResourceValue['id'];
            if (idValue) {
  ...
  DeploymentOperations.prototype.createOrUpdate = function(resourceGroupName, deploymentName, parameters, callback) {
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (responseDoc) {
        ...
        if (propertiesValue2) {
          var propertiesInstance = { providers: [] };
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (responseDoc) {
        ...
        if (valueArray) {
          for (var loweredIndex1 = 0; loweredIndex1 < valueArray.length; loweredIndex1 = loweredIndex1 + 1) {
            var valueValue = valueArray[loweredIndex1];
            var permittedActionDefinitionInstance = { actions: [] };
            result.permittedActions.push(permittedActionDefinitionInstance);
            ...
            if (actionsArray) {
              for (var loweredIndex2 = 0; loweredIndex2 < actionsArray.length; loweredIndex2 = loweredIndex2 + 1) {
                ...
                permittedActionDefinitionInstance.actions.push(actionsValue);
              }
            }
          }
        }
