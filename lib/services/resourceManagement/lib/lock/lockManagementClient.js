 ...
 *
 */
function LockManagementClient(credentials, subscriptionId, baseUri, options) {
  ...
  LockManagementClient['super_'].call(this, credentials, options);
...
util.inherits(LockManagementClient, ServiceClient);

module.exports = LockManagementClient;
