...
Subscription.prototype.validate = function (payload) {
  ...
  if (payload['subscriptionId'] !== null && payload['subscriptionId'] !== undefined && typeof payload['subscriptionId'] !== 'string') {
    throw new Error('payload[\'subscriptionId\'] must be of type string.');
  }

  if (payload['displayName'] !== null && payload['displayName'] !== undefined && typeof payload['displayName'] !== 'string') {
    throw new Error('payload[\'displayName\'] must be of type string.');
  }

  if (payload['state'] !== null && payload['state'] !== undefined && typeof payload['state'] !== 'string') {
