 ...
 * lock.
 * 
 * @param {string} [parameters.properties.level] Gets or sets the lock level
 * of the management lock. Possible values for this property include:
 * 'NotSpecified', 'CanNotDelete', 'ReadOnly'.
 * 
 * @param {string} [parameters.properties.notes] Gets or sets the notes of the
 * management lock.
 * 
 ...
 *                      See {@link ManagementLock} for more information.
 *
...
ManagementLocks.prototype.createOrUpdateAtResourceGroupLevel = function (resourceGroupName, lockName, parameters, options, callback) {
  ...
  try {
    if (parameters) {
      requestModel = new client._models['ManagementLock'](parameters);
    }
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse) {
          result = new client._models['ManagementLock'](parsedResponse);
        }
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['ManagementLockListResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
