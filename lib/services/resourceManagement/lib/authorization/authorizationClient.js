 ...
 *
 */
function AuthorizationClient(credentials, subscriptionId, baseUri, options) {
  ...
  AuthorizationClient['super_'].call(this, credentials, options);
...
util.inherits(AuthorizationClient, ServiceClient);
