...
var VaultOperations = ( /** @lends VaultOperations */ function() {
   ...
   * 
   * @param {VaultCreateOrUpdateParameters} parameters Parameters to create or
   * update the vault
   * 
   * @param {VaultProperties} parameters.properties Gets or sets the properties
   * of the vault.
   * 
   * @param {string} [parameters.properties.vaultUri] URL of the vault
   * 
   * @param {Guid} [parameters.properties.tenantId] Tenant ID
   * 
   * @param {Sku} [parameters.properties.sku] SKU details
   * 
   * @param {string} [parameters.properties.sku.family] SKU family name
   * 
   * @param {string} [parameters.properties.sku.name] SKU name
   * 
   * @param {AccessPolicyEntry[]} [parameters.properties.accessPolicies] Access
   * policies for one or more principals
   * 
  ...
  VaultOperations.prototype.createOrUpdate = function(resourceGroupName, vaultName, parameters, callback) {
    ...
    if (parameters.properties.accessPolicies !== null && parameters.properties.accessPolicies !== undefined) {
      ...
      for (var loweredIndex1 = 0; loweredIndex1 < parameters.properties.accessPolicies.length; loweredIndex1 = loweredIndex1 + 1) {
        ...
        if (accessPoliciesItem.applicationId !== null && accessPoliciesItem.applicationId !== undefined) {
          accessPolicyEntryValue['applicationId'] = accessPoliciesItem.applicationId;
        }
        
        if (accessPoliciesItem.permissionsRawJsonString !== null && accessPoliciesItem.permissionsRawJsonString !== undefined) {
          accessPolicyEntryValue['permissions'] = accessPoliciesItem.permissionsRawJsonString;
        }
      }
    ...
    if (parameters.properties.enabledForDiskEncryption !== null && parameters.properties.enabledForDiskEncryption !== undefined) {
      propertiesValue['enabledForDiskEncryption'] = parameters.properties.enabledForDiskEncryption;
    }
    
    if (parameters.properties.enabledForTemplateDeployment !== null && parameters.properties.enabledForTemplateDeployment !== undefined) {
      propertiesValue['enabledForTemplateDeployment'] = parameters.properties.enabledForTemplateDeployment;
    }
          ...
          if (propertiesValue2 !== null && propertiesValue2 !== undefined) {
            ...
            if (accessPoliciesArray2 !== null && accessPoliciesArray2 !== undefined) {
              for (var loweredIndex2 = 0; loweredIndex2 < accessPoliciesArray2.length; loweredIndex2 = loweredIndex2 + 1) {
                ...
                if (applicationIdValue !== null && applicationIdValue !== undefined) {
                  var applicationIdInstance = applicationIdValue;
            ...
            if (enabledForDiskEncryptionValue !== null && enabledForDiskEncryptionValue !== undefined) {
              var enabledForDiskEncryptionInstance = enabledForDiskEncryptionValue;
            ...
            if (enabledForTemplateDeploymentValue !== null && enabledForTemplateDeploymentValue !== undefined) {
              var enabledForTemplateDeploymentInstance = enabledForTemplateDeploymentValue;
  ...
  /**
   * The List operation gets information about the vaults associated either
   * with the subscription if no resource group is specified or within the
  ...
  /**
   * Get the next set of vaults based on the previously returned NextLink value.
   * 
