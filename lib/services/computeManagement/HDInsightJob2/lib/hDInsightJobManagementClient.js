...
var HDInsightJobManagementClient = ( /** @lends HDInsightJobManagementClient */ function() {
  ...
  function HDInsightJobManagementClient(clusterDnsName, credentials, filters) {
    ...
    if (this.sdkUserAgent === null || this.sdkUserAgent === undefined) {
      this.sdkUserAgent = '';
    }
...
var JobOperations = ( /** @lends JobOperations */ function() {
   ...
   */
  JobOperations.prototype.getAppState = function(appId, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    if (appId === null || appId === undefined) {
      return callback(new Error('appId cannot be null.'));
    }
    ...
    url2 = url2 + '/ws/v1/cluster/apps/';
    url2 = url2 + encodeURIComponent(appId);
    url2 = url2 + '/state';
    ...
    if ('HDInsight Job SDK ' + this.client.sdkUserAgent + this.client.userAgentSuffix !== null && 'HDInsight Job SDK ' + this.client.sdkUserAgent + this.client.userAgentSuffix !== undefined) {
      httpRequest.headers['useragent'] = 'HDInsight Job SDK ' + this.client.sdkUserAgent + this.client.userAgentSuffix;
    }
    if ('HDInsight Job SDK ' + this.client.sdkUserAgent + this.client.userAgentSuffix !== null && 'HDInsight Job SDK ' + this.client.sdkUserAgent + this.client.userAgentSuffix !== undefined) {
      httpRequest.headers['User-Agent'] = 'HDInsight Job SDK ' + this.client.sdkUserAgent + this.client.userAgentSuffix;
    }
  ...
  JobOperations.prototype.getJob = function(jobId, callback) {
    ...
    var queryParameters = [];
    if (this.client.userName !== null && this.client.userName !== undefined) {
      queryParameters.push('user.name=' + encodeURIComponent(this.client.userName));
    }
  ...
  /**
   * Initiates cancel on given running job in the specified HDInsight cluster.
   * 
   * @param {string} jobId The id of the job.
   * 
   * @param {function} callback
  ...
  JobOperations.prototype.killJob = function(jobId, callback) {
    ...
    if (jobId.length <= 0) {
      return callback(new Error('jobId cannot be empty.'));
    }
   ...
   * 
   * @param {Number} [numOfJobs] Number of jobs to fetch. Use -1 to get all.
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
   */
  JobOperations.prototype.listJobsAfterJobId = function(jobId, numOfJobs, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    queryParameters.push('fields=*');
    if (jobId !== null && jobId !== undefined) {
      queryParameters.push('jobid=' + encodeURIComponent(jobId));
    }
    if (numOfJobs !== null && numOfJobs !== undefined) {
      queryParameters.push('numrecords=' + encodeURIComponent(numOfJobs.toString()));
    }
    if (queryParameters.length > 0) {
      url2 = url2 + '?' + queryParameters.join('&');
    }
   ...
   * 
   * @param {JobSubmissionParameters} parameters Hive job parameters.
   * 
  ...
  JobOperations.prototype.submitHiveJob = function(parameters, callback) {
    ...
    // Serialize Request
    var requestContent = parameters.content;
   ...
   * 
   * @param {JobSubmissionParameters} parameters MapReduce job parameters.
   * 
   * @param {string} [parameters.content]
   * 
   * @param {function} callback
   ...
   * 
   * @param {JobSubmissionParameters} parameters Pig job parameters.
   * 
   * @param {string} [parameters.content]
   * 
   * @param {function} callback
   ...
   * 
   * @param {JobSubmissionParameters} parameters Sqoop job parameters.
   * 
   * @param {string} [parameters.content]
   * 
   * @param {function} callback
   ...
   * @returns {Stream} The response stream.
   */
  JobOperations.prototype.submitSqoopJob = function(parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
