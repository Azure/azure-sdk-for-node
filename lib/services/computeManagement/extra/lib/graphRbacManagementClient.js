...
var ApplicationOperations = ( /** @lends ApplicationOperations */ function() {
  ...
  ApplicationOperations.prototype.create = function(parameters, callback) {
    ...
    var queryParameters = [];
    queryParameters.push('api-version=1.6-internal');
  ...
  ApplicationOperations.prototype.list = function(parameters, callback) {
    ...
    if (parameters.appId !== null && parameters.appId !== undefined) {
      odataFilter.push('appId eq \'' + encodeURIComponent(parameters.appId) + '\'');
    }
...
var GroupOperations = ( /** @lends GroupOperations */ function() {
  ...
  GroupOperations.prototype.getGroupMembersNext = function(nextLink, callback) {
    ...
    url2 = url2 + '/';
    url2 = url2 + nextLink;
    url2 = url2 + '&api-version=1.6-internal';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
...
var UserOperations = ( /** @lends UserOperations */ function() {
   ...
   * 
   * @param {string} userPrincipalName Filter based on userPrincipalName. This
   * works well with guest users upn.
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
   */
  UserOperations.prototype.getByUserPrincipalName = function(userPrincipalName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    if (userPrincipalName === null || userPrincipalName === undefined) {
      return callback(new Error('userPrincipalName cannot be null.'));
    }
    ...
    var queryParameters = [];
    var odataFilter = [];
    odataFilter.push('userPrincipalName eq \'' + encodeURIComponent(userPrincipalName) + '\'');
    if (odataFilter.length > 0) {
      queryParameters.push('$filter=' + odataFilter.join(null));
    }
    queryParameters.push('api-version=1.6-internal');
