...
var ClusterOperations = ( /** @lends ClusterOperations */ function() {
  ...
  ClusterOperations.prototype.beginConfiguringHttpSettings = function(resourceGroupName, clusterName, httpSettingsParameters, callback) {
    ...
    httpRequest.headers['User-Agent'] = 'ARM SDK v1.3.0';
   ...
   * 
   * @param {object}
   * [clusterCreateParameters.properties.clusterDefinition.componentVersion]
  ...
  ClusterOperations.prototype.beginCreating = function(resourceGroupName, clusterName, clusterCreateParameters, callback) {
    ...
    if (clusterCreateParameters.properties !== null && clusterCreateParameters.properties !== undefined) {
      ...
      if (clusterCreateParameters.properties.clusterDefinition !== null && clusterCreateParameters.properties.clusterDefinition !== undefined) {
        ...
        if (clusterCreateParameters.properties.clusterDefinition.componentVersion !== null && clusterCreateParameters.properties.clusterDefinition.componentVersion !== undefined) {
          var componentVersionDictionary = {};
          for (var componentVersionKey in clusterCreateParameters.properties.clusterDefinition.componentVersion) {
            var componentVersionValue = clusterCreateParameters.properties.clusterDefinition.componentVersion[componentVersionKey];
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (propertiesValue2 !== null && propertiesValue2 !== undefined) {
            ...
            if (clusterDefinitionValue2 !== null && clusterDefinitionValue2 !== undefined) {
              var clusterDefinitionInstance = { componentVersion: {} };
              ...
              var componentVersionSequenceElement = clusterDefinitionValue2['componentVersion'];
              if (componentVersionSequenceElement !== null && componentVersionSequenceElement !== undefined) {
                for (var property2 in componentVersionSequenceElement) {
                  var componentVersionKey2 = property2;
                  var componentVersionValue2 = componentVersionSequenceElement[property2];
                  clusterDefinitionInstance.componentVersion[componentVersionKey2] = componentVersionValue2;
                }
              }
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (propertiesValue !== null && propertiesValue !== undefined) {
            ...
            if (clusterDefinitionValue !== null && clusterDefinitionValue !== undefined) {
              ...
              var componentVersionSequenceElement = clusterDefinitionValue['componentVersion'];
              if (componentVersionSequenceElement !== null && componentVersionSequenceElement !== undefined) {
                for (var property2 in componentVersionSequenceElement) {
                  var componentVersionKey = property2;
                  var componentVersionValue = componentVersionSequenceElement[property2];
                  clusterDefinitionInstance.componentVersion[componentVersionKey] = componentVersionValue;
                }
              }
