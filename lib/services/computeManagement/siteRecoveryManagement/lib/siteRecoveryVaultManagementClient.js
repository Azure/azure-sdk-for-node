...
var SiteRecoveryVaultManagementClient = ( /** @lends SiteRecoveryVaultManagementClient */ function() {
  /**
   * @class
   * Initializes a new instance of the SiteRecoveryVaultManagementClient class.
   * @constructor
   * 
   ...
   * @param {Array} filters
   */
  function SiteRecoveryVaultManagementClient(resourceNamespace, resourceType, credentials, baseUri, filters) {
    ...
    SiteRecoveryVaultManagementClient['super_'].call(this, credentials, filters);
  ...
  util.inherits(SiteRecoveryVaultManagementClient, Service);
   ...
   */
  SiteRecoveryVaultManagementClient.prototype.getOperationStatus = function(requestId, callback) {
  ...
  return SiteRecoveryVaultManagementClient;
})();
exports.SiteRecoveryVaultManagementClient = SiteRecoveryVaultManagementClient;
...
var ResourceGroupsOperations = ( /** @lends ResourceGroupsOperations */ function() {
   ...
   * instance of the [SiteRecoveryVaultManagementClient] {@link
   * SiteRecoveryVaultManagementClient~SiteRecoveryVaultManagementClient}.
   * See [resourceGroup] {@link
   * SiteRecoveryVaultManagementClient~SiteRecoveryVaultManagementClient#resourceGroup}.
   * Initializes a new instance of the ResourceGroupsOperations class.
   * @constructor
   * 
   * @param {SiteRecoveryVaultManagementClient} client Reference to the service
   * client.
   */
...
var VaultExtendedInfoOperations = ( /** @lends VaultExtendedInfoOperations */ function() {
   ...
   * SiteRecoveryVaultManagementClient~SiteRecoveryVaultManagementClient#vaultExtendedInfo}.
   ...
   * exnteded info input parameters.
   * 
   * @param {string} extendedInfoArgs.contractVersion Contract version for the
   * entity.
   * 
   * @param {string} extendedInfoArgs.extendedInfo Serialized blob for the
   * extended info
   * 
   * @param {string} extendedInfoArgs.extendedInfoETag ETag for the request
   * 
  ...
  VaultExtendedInfoOperations.prototype.createExtendedInfo = function(resourceGroupName, resourceName, extendedInfoArgs, customRequestHeaders, callback) {
    ...
    if (extendedInfoArgs.contractVersion === null || extendedInfoArgs.contractVersion === undefined) {
      return callback(new Error('extendedInfoArgs.contractVersion cannot be null.'));
    }
    if (extendedInfoArgs.extendedInfo === null || extendedInfoArgs.extendedInfo === undefined) {
      return callback(new Error('extendedInfoArgs.extendedInfo cannot be null.'));
    }
    if (extendedInfoArgs.extendedInfoETag === null || extendedInfoArgs.extendedInfoETag === undefined) {
      return callback(new Error('extendedInfoArgs.extendedInfoETag cannot be null.'));
    }
    ...
    url2 = url2 + '/';
    url2 = url2 + encodeURIComponent(this.client.resourceType);
    url2 = url2 + '/';
    url2 = url2 + encodeURIComponent(resourceName);
    url2 = url2 + '/ExtendedInfo';
    var queryParameters = [];
    queryParameters.push('api-version=2015-08-15');
    if (queryParameters.length > 0) {
      url2 = url2 + '?' + queryParameters.join('&');
    }
    var baseUrl = this.client.baseUri;
  ...
  VaultExtendedInfoOperations.prototype.getExtendedInfo = function(resourceGroupName, resourceName, customRequestHeaders, callback) {
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          var extendedInformationInstance = {};
          ...
          var extendedInfoValue = responseDoc['extendedInfo'];
          if (extendedInfoValue !== null && extendedInfoValue !== undefined) {
            var extendedInfoInstance = extendedInfoValue;
            extendedInformationInstance.extendedInfo = extendedInfoInstance;
          }
          
          var extendedInfoETagValue = responseDoc['extendedInfoETag'];
          if (extendedInfoETagValue !== null && extendedInfoETagValue !== undefined) {
            var extendedInfoETagInstance = extendedInfoETagValue;
          ...
          var resourceNameValue = responseDoc['resourceName'];
          ...
          var resourceTypeValue = responseDoc['resourceType'];
   ...
   * @param {string} resourceName The name of the resource.
   * 
   * @param {ResourceExtendedInformationArgs} [extendedInfoArgs] Update
   * resource exnteded info input parameters.
   * 
   * @param {string} [extendedInfoArgs.contractVersion] Contract version for
   * the entity.
   * 
   * @param {string} [extendedInfoArgs.extendedInfo] Serialized blob for the
   * extended info
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          var clientRequestIdValue = responseDoc['ClientRequestId'];
          ...
          var correlationRequestIdValue = responseDoc['CorrelationRequestId'];
          if (correlationRequestIdValue !== null && correlationRequestIdValue !== undefined) {
            var correlationRequestIdInstance = correlationRequestIdValue;
            result.correlationRequestId = correlationRequestIdInstance;
          }
          
          var dateValue = responseDoc['Date'];
          if (dateValue !== null && dateValue !== undefined) {
            var dateInstance = dateValue;
            result.date = dateInstance;
          }
          
          var contentTypeValue = responseDoc['ContentType'];
...
var VaultOperations = ( /** @lends VaultOperations */ function() {
   ...
   * SiteRecoveryVaultManagementClient~SiteRecoveryVaultManagementClient}.
   * See [vaults] {@link
   * SiteRecoveryVaultManagementClient~SiteRecoveryVaultManagementClient#vaults}.
   ...
   * service containing the job collection.
   * 
   ...
   * 
   * @param {VaultSku} [vaultCreationInput.properties.sku] Sku
   * 
   * @param {string} [vaultCreationInput.properties.sku.name] Name
   * 
  ...
  VaultOperations.prototype.beginCreating = function(resourceGroupName, vaultName, vaultCreationInput, callback) {
    ...
    if (vaultCreationInput.properties !== null && vaultCreationInput.properties !== undefined) {
      ...
      if (vaultCreationInput.properties.sku !== null && vaultCreationInput.properties.sku !== undefined) {
        var skuValue = {};
        propertiesValue['sku'] = skuValue;
        
        if (vaultCreationInput.properties.sku.name !== null && vaultCreationInput.properties.sku.name !== undefined) {
   ...
   * @returns {Stream} The response stream.
   */
  VaultOperations.prototype.get = function(resourceGroupName, customRequestHeaders, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
