...
var ResourceManagementClient = ( /** @lends ResourceManagementClient */ function() {
  ...
  ResourceManagementClient.prototype.getLongRunningOperationStatus = function(operationStatusLink, callback) {
    ...
    // Set Headers
    httpRequest.headers['x-ms-version'] = '2016-02-01';
...
var DeploymentOperationOperations = ( /** @lends DeploymentOperationOperations */ function() {
  ...
  DeploymentOperationOperations.prototype.get = function(resourceGroupName, deploymentName, operationId, callback) {
    ...
    var queryParameters = [];
    queryParameters.push('api-version=2016-02-01');
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (propertiesValue !== null && propertiesValue !== undefined) {
            ...
            var serviceRequestIdValue = propertiesValue['serviceRequestId'];
            if (serviceRequestIdValue !== null && serviceRequestIdValue !== undefined) {
              var serviceRequestIdInstance = serviceRequestIdValue;
              propertiesInstance.serviceRequestId = serviceRequestIdInstance;
            }
            ...
            var requestValue = propertiesValue['request'];
            if (requestValue !== null && requestValue !== undefined) {
              var requestInstance = {};
              propertiesInstance.request = requestInstance;
              
              var contentValue = requestValue['content'];
              if (contentValue !== null && contentValue !== undefined) {
                var contentInstance = contentValue;
                requestInstance.content = contentInstance;
              }
            }
            
            var responseValue = propertiesValue['response'];
            if (responseValue !== null && responseValue !== undefined) {
              var responseInstance = {};
              propertiesInstance.response = responseInstance;
              
              var contentValue2 = responseValue['content'];
              if (contentValue2 !== null && contentValue2 !== undefined) {
                var contentInstance2 = contentValue2;
                responseInstance.content = contentInstance2;
              }
            }
          }
        }
...
var DeploymentOperations = ( /** @lends DeploymentOperations */ function() {
   ...
   * deployment mode.
   * 
   * @param {DeploymentDebugSetting} [parameters.properties.debugSetting] Gets
   * or sets the deployment debug setting.
   * 
   * @param {string}
   * [parameters.properties.debugSetting.deploymentDebugDetailLevel]
   * Deployment debug detail level. Any combination of None, RequestContent
   * and ResponseContent
   * 
   * @param {function} callback
   * 
  ...
  DeploymentOperations.prototype.createOrUpdate = function(resourceGroupName, deploymentName, parameters, callback) {
    ...
    if (parameters.properties !== null && parameters.properties !== undefined) {
      if (parameters.properties.debugSetting !== null && parameters.properties.debugSetting !== undefined) {
        if (parameters.properties.debugSetting.deploymentDebugDetailLevel === null || parameters.properties.debugSetting.deploymentDebugDetailLevel === undefined) {
          return callback(new Error('parameters.properties.debugSetting.deploymentDebugDetailLevel cannot be null.'));
        }
      }
      ...
      if (statusCode === 200 || statusCode === 201) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (propertiesValue2 !== null && propertiesValue2 !== undefined) {
            ...
            var validatedResourcesArray = propertiesValue2['validatedResources'];
            if (validatedResourcesArray !== null && validatedResourcesArray !== undefined) {
              for (var loweredIndex7 = 0; loweredIndex7 < validatedResourcesArray.length; loweredIndex7 = loweredIndex7 + 1) {
                var validatedResourcesValue = validatedResourcesArray[loweredIndex7];
                var deploymentPreFlightResourceInstance = { dependsOn: [], tags: {} };
                propertiesInstance.validatedResources.push(deploymentPreFlightResourceInstance);
                
                var apiVersionValue = validatedResourcesValue['apiVersion'];
                if (apiVersionValue !== null && apiVersionValue !== undefined) {
                  var apiVersionInstance = apiVersionValue;
                  deploymentPreFlightResourceInstance.apiVersion = apiVersionInstance;
                }
                
                var dependsOnArray2 = validatedResourcesValue['dependsOn'];
                if (dependsOnArray2 !== null && dependsOnArray2 !== undefined) {
                  for (var loweredIndex8 = 0; loweredIndex8 < dependsOnArray2.length; loweredIndex8 = loweredIndex8 + 1) {
                    var dependsOnValue2 = dependsOnArray2[loweredIndex8];
                    deploymentPreFlightResourceInstance.dependsOn.push(dependsOnValue2);
                  }
                }
                
                var propertiesValue4 = validatedResourcesValue['properties'];
                if (propertiesValue4 !== null && propertiesValue4 !== undefined) {
                  var propertiesInstance2 = propertiesValue4;
                  deploymentPreFlightResourceInstance.properties = propertiesInstance2;
                }
                
                var provisioningStateValue2 = validatedResourcesValue['provisioningState'];
                ...
                var typeValue = validatedResourcesValue['type'];
                if (typeValue !== null && typeValue !== undefined) {
                  var typeInstance = typeValue;
                  deploymentPreFlightResourceInstance.type = typeInstance;
                }
                
                var locationValue = validatedResourcesValue['location'];
                ...
                var tagsSequenceElement = validatedResourcesValue['tags'];
                if (tagsSequenceElement !== null && tagsSequenceElement !== undefined) {
                  for (var property2 in tagsSequenceElement) {
                    ...
                    deploymentPreFlightResourceInstance.tags[tagsKey] = tagsValue;
                  }
                }
              }
            }
            
            var debugSettingValue2 = propertiesValue2['debugSetting'];
            if (debugSettingValue2 !== null && debugSettingValue2 !== undefined) {
              var debugSettingInstance = {};
              propertiesInstance.debugSettingResponse = debugSettingInstance;
              
              var detailLevelValue = debugSettingValue2['detailLevel'];
              if (detailLevelValue !== null && detailLevelValue !== undefined) {
                var detailLevelInstance = detailLevelValue;
            ...
            var debugSettingValue3 = propertiesValue2['debugSetting'];
            if (debugSettingValue3 !== null && debugSettingValue3 !== undefined) {
              var debugSettingInstance2 = {};
              propertiesInstance.debugSetting = debugSettingInstance2;
              
              var detailLevelValue2 = debugSettingValue3['detailLevel'];
              if (detailLevelValue2 !== null && detailLevelValue2 !== undefined) {
                var detailLevelInstance2 = detailLevelValue2;
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (propertiesValue !== null && propertiesValue !== undefined) {
            ...
            var validatedResourcesArray = propertiesValue['validatedResources'];
            if (validatedResourcesArray !== null && validatedResourcesArray !== undefined) {
              for (var loweredIndex7 = 0; loweredIndex7 < validatedResourcesArray.length; loweredIndex7 = loweredIndex7 + 1) {
                var validatedResourcesValue = validatedResourcesArray[loweredIndex7];
                var deploymentPreFlightResourceInstance = { dependsOn: [], tags: {} };
                ...
                var propertiesValue3 = validatedResourcesValue['properties'];
                if (propertiesValue3 !== null && propertiesValue3 !== undefined) {
                  var propertiesInstance2 = propertiesValue3;
                  deploymentPreFlightResourceInstance.properties = propertiesInstance2;
                }
            ...
            var debugSettingValue = propertiesValue['debugSetting'];
            if (debugSettingValue !== null && debugSettingValue !== undefined) {
              var debugSettingInstance = {};
              propertiesInstance.debugSettingResponse = debugSettingInstance;
              
              var detailLevelValue = debugSettingValue['detailLevel'];
              if (detailLevelValue !== null && detailLevelValue !== undefined) {
                var detailLevelInstance = detailLevelValue;
                debugSettingInstance.deploymentDebugDetailLevel = detailLevelInstance;
              }
            ...
            var debugSettingValue2 = propertiesValue['debugSetting'];
            if (debugSettingValue2 !== null && debugSettingValue2 !== undefined) {
              var debugSettingInstance2 = {};
              propertiesInstance.debugSetting = debugSettingInstance2;
              
              var detailLevelValue2 = debugSettingValue2['detailLevel'];
              if (detailLevelValue2 !== null && detailLevelValue2 !== undefined) {
                var detailLevelInstance2 = detailLevelValue2;
                debugSettingInstance2.deploymentDebugDetailLevel = detailLevelInstance2;
              }
          ...
          if (valueArray !== null && valueArray !== undefined) {
            for (var loweredIndex1 = 0; loweredIndex1 < valueArray.length; loweredIndex1 = loweredIndex1 + 1) {
              ...
              if (propertiesValue !== null && propertiesValue !== undefined) {
                ...
                var validatedResourcesArray = propertiesValue['validatedResources'];
                if (validatedResourcesArray !== null && validatedResourcesArray !== undefined) {
                  for (var loweredIndex8 = 0; loweredIndex8 < validatedResourcesArray.length; loweredIndex8 = loweredIndex8 + 1) {
                    var validatedResourcesValue = validatedResourcesArray[loweredIndex8];
                    var deploymentPreFlightResourceInstance = { dependsOn: [], tags: {} };
                    propertiesInstance.validatedResources.push(deploymentPreFlightResourceInstance);
                    ...
                    var dependsOnArray2 = validatedResourcesValue['dependsOn'];
                    if (dependsOnArray2 !== null && dependsOnArray2 !== undefined) {
                      for (var loweredIndex9 = 0; loweredIndex9 < dependsOnArray2.length; loweredIndex9 = loweredIndex9 + 1) {
                        var dependsOnValue2 = dependsOnArray2[loweredIndex9];
                        deploymentPreFlightResourceInstance.dependsOn.push(dependsOnValue2);
                      }
                    }
      ...
      if (statusCode === 200 || statusCode === 400) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (errorValue !== null && errorValue !== undefined) {
            ...
            var detailsValue = errorValue['details'];
          ...
          if (propertiesValue2 !== null && propertiesValue2 !== undefined) {
            ...
            if (validatedResourcesArray !== null && validatedResourcesArray !== undefined) {
              for (var loweredIndex7 = 0; loweredIndex7 < validatedResourcesArray.length; loweredIndex7 = loweredIndex7 + 1) {
                ...
                var idValue4 = validatedResourcesValue['id'];
                if (idValue4 !== null && idValue4 !== undefined) {
                  var idInstance4 = idValue4;
                  deploymentPreFlightResourceInstance.id = idInstance4;
                }
                
                var nameValue2 = validatedResourcesValue['name'];
                if (nameValue2 !== null && nameValue2 !== undefined) {
                  var nameInstance2 = nameValue2;
