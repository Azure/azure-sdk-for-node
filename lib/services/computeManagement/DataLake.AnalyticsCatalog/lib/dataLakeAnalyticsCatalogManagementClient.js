    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          var secretNameValue = responseDoc['secretName'];
          if (secretNameValue !== null && secretNameValue !== undefined) {
            var secretNameInstance = secretNameValue;
            secretInstance.name = secretNameInstance;
          }
          ...
          if (uriValue !== null && uriValue !== undefined) {
            ...
            secretInstance.uri = uriInstance;
          }
          
          var passwordValue = responseDoc['password'];
          if (passwordValue !== null && passwordValue !== undefined) {
            var passwordInstance = passwordValue;
            secretInstance.password = passwordInstance;
          }
          ...
          if (indexListArray !== null && indexListArray !== undefined) {
            for (var loweredIndex2 = 0; loweredIndex2 < indexListArray.length; loweredIndex2 = loweredIndex2 + 1) {
              ...
              if (distributionInfoValue !== null && distributionInfoValue !== undefined) {
                ...
                var dynamicCountValue = distributionInfoValue['dynamicCount'];
                if (dynamicCountValue !== null && dynamicCountValue !== undefined) {
                  var dynamicCountInstance = dynamicCountValue;
                  distributionInfoInstance.dynamicCount = dynamicCountInstance;
                }
              }
