...
var MetricSettingOperations = ( /** @lends MetricSettingOperations */ function() {
  ...
  MetricSettingOperations.prototype.createOrUpdate = function(parameters, callback) {
    ...
    var metricSettingsPutParametersValue = {};
    requestDoc = metricSettingsPutParametersValue;
    
    metricSettingsPutParametersValue['ResourceId'] = parameters.metricSetting.resourceId;
    
    if (parameters.metricSetting.namespace !== null && parameters.metricSetting.namespace !== undefined) {
      metricSettingsPutParametersValue['Namespace'] = parameters.metricSetting.namespace;
    }
    
    var valueValue = {};
    metricSettingsPutParametersValue['Value'] = valueValue;
