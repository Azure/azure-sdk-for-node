...
var DeploymentOperations = (function() {
   ...
   * 
   * @param {string} parameters.configuration Required. The base-64 encoded
   ...
   * 
   * @param {IDictionary`2} [parameters.extendedProperties] Optional.
   * Represents the name of an extended deployment property. Each extended
   * property must have both a defined name and value. You can have a maximum
   * of 25 extended property name/value pairs. The maximum length of the Name
   * element is 64 characters, only alphanumeric characters and underscores
   * are valid in the Name, and the name must start with a letter. Attempting
   * to use other characters, starting the Name with a non-letter character,
   * or entering a name that is identical to that of another extended property
   * owned by the same hosted service, will result in a status code 400 (Bad
   * Request) error.
   * 
   ...
   * that is base-64 encoded. The name can be up to 100 characters in length.
   * It is recommended that the label be unique within the subscription. The
   * name can be used identify the hosted service for your tracking purposes.
   * 
   * @param {string} parameters.configuration Required. The base-64 encoded
   * service configuration file for the deployment.
   * 
...
var HostedServiceOperations = (function() {
   ...
   * property must have both a defined name and value. You can have a maximum
   * of 50 extended property name and value pairs.  The maximum length of the
   * Name element is 64 characters, only alphanumeric characters and
   ...
   * that is base64-encoded. The name may be up to 100 characters in length.
...
var ServiceCertificateOperations = (function() {
   ...
   * 
   * @param {buffer} parameters.data The base-64 encoded form of the pfx or
   * .cer file.
   * 
...
var VirtualMachineImageOperations = (function() {
   ...
   * 
   * @param {VirtualMachineRoleSize} [parameters.recommendedVMSize] Optional.
...
var VirtualMachineOperations = (function() {
   ...
   * 
   * @param {VirtualMachineRoleSize} [parameters.roleSize] The size of the
   * virtual machine.
   * 
