...
var VirtualMachineOperations = (function() {
   ...
   * virtual machine.
   * 
   * @param {IList`1} [parameters.configurationSets] Contains the collection of
   * configuration sets that contain system and application configuration
   * settings.
   * 
   * @param {IList`1} [parameters.dataVirtualHardDisks] Contains the parameters
   ...
   * 
   * @param {IList`1} parameters.roles Required. Contains the provisioning
   ...
   * 
   * @param {IList`1} [parameters.roles] The set of roles to shut down
   * 
   ...
   * 
   * @param {IList`1} [parameters.loadBalancedEndpoints] A list of load
   * balanced InputEndpoints to update.
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
