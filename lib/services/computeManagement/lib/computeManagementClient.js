...
var DeploymentOperations = ( /** @lends DeploymentOperations */ function() {
                ...
                for (var loweredIndex12 = 0; loweredIndex12 < js2xml.getElements(responseDoc, resourceExtensionReferencesSequenceElement, 'RESOURCEEXTENSIONREFERENCE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex12 = loweredIndex12 + 1) {
                  ...
                  if (resourceExtensionParameterValuesSequenceElement) {
                    for (var loweredIndex13 = 0; loweredIndex13 < js2xml.getElements(responseDoc, resourceExtensionParameterValuesSequenceElement, 'RESOURCEEXTENSIONPARAMETERVALUE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex13 = loweredIndex13 + 1) {
                      ...
                      if (valueElement) {
                        var valueInstance = new Buffer(valueElement, 'base64').toString('ascii');
  ...
  DeploymentOperations.prototype.getPackageByName = function(serviceName, deploymentName, parameters, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + '/' + this.client.credentials.subscriptionId + '/services/hostedservices/' + serviceName + '/deployments/' + deploymentName + '/package?';
  ...
  DeploymentOperations.prototype.getPackageBySlot = function(serviceName, deploymentSlot, parameters, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + '/' + this.client.credentials.subscriptionId + '/services/hostedservices/' + serviceName + '/deploymentslots/' + deploymentSlot + '/package?';
    url2 = url2 + 'containerUri=' + encodeURIComponent(parameters.containerUri) + ' +';
    if (parameters.overwriteExisting) {
      url2 = url2 + '&overwriteExisting=' + encodeURIComponent(parameters.overwriteExisting.toString());
    }
...
var HostedServiceOperations = ( /** @lends HostedServiceOperations */ function() {
   ...
   * 
   * @param {string} [parameters.version] Optional. Specifies the version of
   * the extension. If this element is not specified or an asterisk (*) is
   * used as the value, the latest version of the extension is used. If the
   * value is specified with a major version number and an asterisk as the
   * minor version number (X.*), the latest minor version of the specified
   * major version is selected. If a major version number and a minor version
  ...
  HostedServiceOperations.prototype.beginDeletingAll = function(serviceName, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + '/' + this.client.credentials.subscriptionId + '/services/hostedservices/' + serviceName + '?comp=media';
  ...
  HostedServiceOperations.prototype.listExtensionVersions = function(providerNamespace, extensionType, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + '/' + this.client.credentials.subscriptionId + '/services/extensions/' + providerNamespace + '/' + extensionType;
...
var VirtualMachineExtensionOperations = ( /** @lends VirtualMachineExtensionOperations */ function() {
  ...
  VirtualMachineExtensionOperations.prototype.list = function(callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + '/' + this.client.credentials.subscriptionId + '/services/resourceextensions';
        ...
        if (resourceExtensionsSequenceElement) {
          for (var loweredIndex1 = 0; loweredIndex1 < js2xml.getElements(responseDoc, resourceExtensionsSequenceElement, 'RESOURCEEXTENSION', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex1 = loweredIndex1 + 1) {
            ...
            if (sampleConfigElement) {
              var sampleConfigInstance = new Buffer(sampleConfigElement, 'base64').toString('ascii');
  ...
  VirtualMachineExtensionOperations.prototype.listVersions = function(publisherName, extensionName, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + '/' + this.client.credentials.subscriptionId + '/services/resourceextensions/' + publisherName + '/' + extensionName;
...
var VirtualMachineImageOperations = ( /** @lends VirtualMachineImageOperations */ function() {
  ...
  VirtualMachineImageOperations.prototype.create = function(parameters, callback) {
    ...
    if (parameters.publishedDate) {
      ...
      var dateText = JSON.stringify(parameters.publishedDate);
      js2xml.setElementValue(publishedDateElement, dateText.substr(1, dateText.length - 2));
