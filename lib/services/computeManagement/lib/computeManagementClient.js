...
var ComputeManagementClient = ( /** @lends ComputeManagementClient */ function() {
  ...
  ComputeManagementClient.prototype.getOperationStatus = function(requestId, callback) {
    ...
    var url2 = '/' + this.credentials.subscriptionId.trim() + '/operations/' + requestId.trim();
...
var DeploymentOperations = ( /** @lends DeploymentOperations */ function() {
   ...
   * 
   * @param {string} parameters.configuration Required. The encoded service
   * configuration file for the deployment.
   * 
   * @param {boolean} [parameters.treatWarningsAsError] Optional. Indicates
   * whether to treat package validation warnings as errors. The default value
   * is false. If set to true, the Created Deployment operation fails if there
   * are validation warnings on the service package.
   * 
   * @param {DeploymentChangeConfigurationMode} [parameters.mode] Optional.
   * Possible values are: Auto, Manual.  If not specified the default value is
   * Auto. If set to Manual, WalkUpgradeDomain must be called to apply the
   * update. If set to Auto, the update is automatically applied to each
   * update domain for the service.
   * 
   * @param {object} [parameters.extendedProperties] Optional. Represents the
   * name of an extended deployment property. Each extended property must have
   * both a defined name and value. You can have a maximum of 25 extended
   ...
   * deployment.
   * 
   * @param {array} [parameters.extensionConfiguration.allRoles] Optional.
   * Specifies a list of extensions that are applied to all roles in a
   * deployment.
   * 
   * @param {array} [parameters.extensionConfiguration.namedRoles] Optional.
  ...
  DeploymentOperations.prototype.beginChangingConfigurationByName = function(serviceName, deploymentName, parameters, callback) {
    ...
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deployments/' + deploymentName.trim() + '/?comp=config';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  DeploymentOperations.prototype.beginChangingConfigurationBySlot = function(serviceName, deploymentSlot, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deploymentslots/' + deploymentSlot + '/?comp=config';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
   ...
   * 
   * @param {string} parameters.name Required. The name for the deployment. The
   * deployment name must be unique among other deployments for the cloud
   * service.
   * 
   * @param {string} parameters.packageUri Required. A URL that refers to the
   * location of the service package in the Blob service. The service package
   * can be located either in a storage account beneath the same subscription
   * or a Shared Access Signature (SAS) URI from any storage account. For more
   * info about Shared Access Signatures, see Delegating Access with a Shared
   * Access Signature (REST API) at
   * http://msdn.microsoft.com/en-us/library/windowsazure/ee395415.aspx.
   * 
   * @param {string} parameters.label Required. A name for the hosted service.
   * The name can be up to 100 characters in length. It is recommended that
   * the label be unique within the subscription. The name can be used
   * identify the hosted service for your tracking purposes.
   * 
   * @param {string} parameters.configuration Required. The service
   * configuration file for the deployment.
   * 
   * @param {boolean} [parameters.startDeployment] Optional. Indicates whether
   * to start the deployment immediately after it is created. The default
   * value is false.  If false, the service model is still deployed to the
   * virtual machines but the code is not run immediately. Instead, the
   * service is Suspended until you call Update Deployment Status and set the
   * status toRunning, at which time the service will be started. A deployed
  ...
  DeploymentOperations.prototype.beginCreating = function(serviceName, deploymentSlot, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deploymentslots/' + deploymentSlot;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  DeploymentOperations.prototype.beginDeletingByName = function(serviceName, deploymentName, deleteFromStorage, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deployments/' + deploymentName.trim() + '?';
  ...
  DeploymentOperations.prototype.beginRebootingRoleInstanceByDeploymentName = function(serviceName, deploymentName, roleInstanceName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deployments/' + deploymentName.trim() + '/roleinstances/' + roleInstanceName.trim() + '?comp=reboot';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  DeploymentOperations.prototype.beginRebootingRoleInstanceByDeploymentSlot = function(serviceName, deploymentSlot, roleInstanceName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deploymentslots/' + deploymentSlot + '/roleinstances/' + roleInstanceName.trim() + '?comp=reboot';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  DeploymentOperations.prototype.beginReimagingRoleInstanceByDeploymentName = function(serviceName, deploymentName, roleInstanceName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deployments/' + deploymentName.trim() + '/roleinstances/' + roleInstanceName.trim() + '?comp=reimage';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  DeploymentOperations.prototype.beginReimagingRoleInstanceByDeploymentSlot = function(serviceName, deploymentSlot, roleInstanceName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deploymentslots/' + deploymentSlot + '/roleinstances/' + roleInstanceName.trim() + '?comp=reimage';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
   ...
   * 
   * @param {string} [parameters.productionDeployment] The optional  name of
   * the production deployment.
   * 
   * @param {string} parameters.sourceDeployment Required. The name of the
   * source deployment.
   * 
   * @param {function} callback
   * 
  ...
  DeploymentOperations.prototype.beginSwapping = function(serviceName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
   ...
   * 
   * @param {UpdatedDeploymentStatus} parameters.status Required. The new
  ...
  DeploymentOperations.prototype.beginUpdatingStatusByDeploymentName = function(serviceName, deploymentName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deployments/' + deploymentName.trim() + '/?comp=status';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  DeploymentOperations.prototype.beginUpdatingStatusByDeploymentSlot = function(serviceName, deploymentSlot, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deploymentslots/' + deploymentSlot + '/?comp=status';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
   ...
   * Upgrade Deployment operation.
   * 
   * @param {DeploymentUpgradeMode} parameters.mode Required. The type of
   * update to initiate. Role instances are allocated to update domains when
   * the service is deployed. Updates can be initiated manually in each update
   * domain or initiated automatically in all update domains. Possible values
   * are: Auto, Manual.  If not specified, the default value is Auto. If set
   * to Manual, WalkUpgradeDomain must be called to apply the update. If set
   * to Auto, the update is automatically applied to each update domain in
   * sequence.
   * 
   * @param {string} parameters.packageUri Required. A URL that refers to the
   * location of the service package in the Blob service. The service package
   ...
   * identify the hosted service for your tracking purposes.
   * 
   * @param {string} [parameters.roleToUpgrade] Optional. The name of the
   * specific role instance to update.
   * 
   * @param {boolean} parameters.force Required. Specifies whether the rollback
   * should proceed even when it will cause local data to be lost from some
   * role instances. True if the rollback should proceed; otherwise false.
   * 
   * @param {object} [parameters.extendedProperties] Optional. Represents the
   * name of an extended deployment property. Each extended property must have
   * both a defined name and value. You can have a maximum of 25 extended
  ...
  DeploymentOperations.prototype.beginUpgradingByName = function(serviceName, deploymentName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deployments/' + deploymentName.trim() + '/?comp=upgrade';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  DeploymentOperations.prototype.beginUpgradingBySlot = function(serviceName, deploymentSlot, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deploymentslots/' + deploymentSlot + '/?comp=upgrade';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
   ...
   * 
   * @param {number} parameters.upgradeDomain Required. An integer value that
   * identifies the update domain to update. Update domains are identified
   * with a zero-based index: the first update domain has an ID of 0, the
  ...
  DeploymentOperations.prototype.beginWalkingUpgradeDomainByDeploymentName = function(serviceName, deploymentName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deployments/' + deploymentName.trim() + '?comp=walkupgradedomain';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  DeploymentOperations.prototype.beginWalkingUpgradeDomainByDeploymentSlot = function(serviceName, deploymentSlot, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deploymentslots/' + deploymentSlot + '/?comp=walkupgradedomain';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  DeploymentOperations.prototype.getByName = function(serviceName, deploymentName, callback) {
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      // Deserialize Response
      var responseContent = body;
      result = { extendedProperties: {}, roleInstances: [], roles: [], virtualIPAddresses: [] };
      var options = {};
      options.trim = true;
      options.strict = false;
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (deploymentElement) {
          ...
          if (roleListSequenceElement) {
            for (var loweredIndex3 = 0; loweredIndex3 < js2xml.getElements(responseDoc, roleListSequenceElement, 'ROLE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex3 = loweredIndex3 + 1) {
              ...
              if (resourceExtensionReferencesSequenceElement) {
                for (var loweredIndex12 = 0; loweredIndex12 < js2xml.getElements(responseDoc, resourceExtensionReferencesSequenceElement, 'RESOURCEEXTENSIONREFERENCE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex12 = loweredIndex12 + 1) {
                  var resourceExtensionReferencesElement = js2xml.getElements(responseDoc, resourceExtensionReferencesSequenceElement, 'RESOURCEEXTENSIONREFERENCE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE')[loweredIndex12];
                  ...
                  var nameElement4 = js2xml.getElement(responseDoc, resourceExtensionReferencesElement, 'NAME', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE');
                  if (nameElement4) {
                    var nameInstance4 = nameElement4;
                    resourceExtensionReferenceInstance.name = nameInstance4;
                  }
                  
                  var versionElement = js2xml.getElement(responseDoc, resourceExtensionReferencesElement, 'VERSION', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE');
                  if (versionElement) {
                  ...
                  if (stateElement && (stateElement === null || stateElement === undefined || stateElement.length === 0) === false) {
                  ...
                  if (resourceExtensionParameterValuesSequenceElement) {
                    for (var loweredIndex13 = 0; loweredIndex13 < js2xml.getElements(responseDoc, resourceExtensionParameterValuesSequenceElement, 'RESOURCEEXTENSIONPARAMETERVALUE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex13 = loweredIndex13 + 1) {
                      var resourceExtensionParameterValuesElement = js2xml.getElements(responseDoc, resourceExtensionParameterValuesSequenceElement, 'RESOURCEEXTENSIONPARAMETERVALUE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE')[loweredIndex13];
                      ...
                      if (typeElement && (typeElement === null || typeElement === undefined || typeElement.length === 0) === false) {
              ...
              if (dataVirtualHardDisksSequenceElement) {
                for (var loweredIndex14 = 0; loweredIndex14 < js2xml.getElements(responseDoc, dataVirtualHardDisksSequenceElement, 'DATAVIRTUALHARDDISK', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex14 = loweredIndex14 + 1) {
                  var dataVirtualHardDisksElement = js2xml.getElements(responseDoc, dataVirtualHardDisksSequenceElement, 'DATAVIRTUALHARDDISK', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE')[loweredIndex14];
          ...
          if (extendedPropertiesSequenceElement) {
            for (var loweredIndex15 = 0; loweredIndex15 < js2xml.getElements(responseDoc, extendedPropertiesSequenceElement, 'EXTENDEDPROPERTY', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex15 = loweredIndex15 + 1) {
              var extendedPropertiesElement = js2xml.getElements(responseDoc, extendedPropertiesSequenceElement, 'EXTENDEDPROPERTY', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE')[loweredIndex15];
          ...
          if (virtualIPsSequenceElement) {
            for (var loweredIndex16 = 0; loweredIndex16 < js2xml.getElements(responseDoc, virtualIPsSequenceElement, 'VIRTUALIP', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex16 = loweredIndex16 + 1) {
              var virtualIPsElement = js2xml.getElements(responseDoc, virtualIPsSequenceElement, 'VIRTUALIP', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE')[loweredIndex16];
              ...
              var nameElement5 = js2xml.getElement(responseDoc, virtualIPsElement, 'NAME', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE');
              if (nameElement5) {
          ...
          if (dnsElement) {
            ...
            if (dnsServersSequenceElement) {
              for (var loweredIndex17 = 0; loweredIndex17 < js2xml.getElements(responseDoc, dnsServersSequenceElement, 'DNSSERVER', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex17 = loweredIndex17 + 1) {
                var dnsServersElement = js2xml.getElements(responseDoc, dnsServersSequenceElement, 'DNSSERVER', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE')[loweredIndex17];
                var dnsServerInstance = {};
                dnsInstance.dnsServers.push(dnsServerInstance);
                
                var nameElement6 = js2xml.getElement(responseDoc, dnsServersElement, 'NAME', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE');
                if (nameElement6) {
          ...
          if (extensionConfigurationElement) {
            ...
            if (allRolesSequenceElement) {
              for (var loweredIndex18 = 0; loweredIndex18 < js2xml.getElements(responseDoc, allRolesSequenceElement, 'EXTENSION', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex18 = loweredIndex18 + 1) {
                var allRolesElement = js2xml.getElements(responseDoc, allRolesSequenceElement, 'EXTENSION', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE')[loweredIndex18];
            ...
            if (namedRolesSequenceElement) {
              for (var loweredIndex19 = 0; loweredIndex19 < js2xml.getElements(responseDoc, namedRolesSequenceElement, 'ROLE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex19 = loweredIndex19 + 1) {
                var namedRolesElement = js2xml.getElements(responseDoc, namedRolesSequenceElement, 'ROLE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE')[loweredIndex19];
                ...
                if (extensionsSequenceElement) {
                  for (var loweredIndex20 = 0; loweredIndex20 < js2xml.getElements(responseDoc, extensionsSequenceElement, 'EXTENSION', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex20 = loweredIndex20 + 1) {
                    var extensionsElement = js2xml.getElements(responseDoc, extensionsSequenceElement, 'EXTENSION', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE')[loweredIndex20];
   ...
   * the Get Package operation.
   * 
   * @param {string} parameters.containerUri Required. Specifies the URI of the
   * container to which the packages will be saved.
   * 
   * @param {boolean} [parameters.overwriteExisting] Optional. Specifies
   * whether an existing package in the storage container should be
   * overwritten. If true the packages with the same names under the specified
   * storage container will be overwritten; otherwise false.
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
  ...
  DeploymentOperations.prototype.getPackageByName = function(serviceName, deploymentName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deployments/' + deploymentName.trim() + '/package?';
  ...
  DeploymentOperations.prototype.getPackageBySlot = function(serviceName, deploymentSlot, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deploymentslots/' + deploymentSlot + '/package?';
    url2 = url2 + 'containerUri=' + encodeURIComponent(parameters.containerUri) + ' +';
    if (parameters.overwriteExisting) {
      url2 = url2 + '&overwriteExisting=' + encodeURIComponent(parameters.overwriteExisting.toString());
    }
   ...
   * supplied to the Rollback Update Or Upgrade operation.
   * 
   * @param {RollbackUpdateOrUpgradeMode} parameters.mode Required. Specifies
   * whether the rollback should proceed automatically.
   * 
  ...
  DeploymentOperations.prototype.rollbackUpdateOrUpgradeByDeploymentName = function(serviceName, deploymentName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deployments/' + deploymentName.trim() + '/?comp=rollback';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  DeploymentOperations.prototype.rollbackUpdateOrUpgradeByDeploymentSlot = function(serviceName, deploymentSlot, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deploymentslots/' + deploymentSlot + '/?comp=rollback';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var HostedServiceOperations = ( /** @lends HostedServiceOperations */ function() {
   ...
   * the extension. The provider namespace for Windows Azure extensions is
   ...
   * of the certificate that is used toencrypt the configuration specified in
  ...
  HostedServiceOperations.prototype.beginAddingExtension = function(serviceName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/extensions';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  HostedServiceOperations.prototype.beginDeletingAll = function(serviceName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '?comp=media';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  HostedServiceOperations.prototype.beginDeletingExtension = function(serviceName, extensionId, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/extensions/' + extensionId.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  HostedServiceOperations.prototype.checkNameAvailability = function(serviceName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/operations/isavailable/' + serviceName.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
   ...
   * 
   * @param {string} parameters.serviceName Required. A name for the cloud
   * service that is unique within Windows Azure. This name is the DNS prefix
   * name and can be used to access the service.
   * 
   * @param {string} parameters.label Required. A name for the cloud service.
   * The name can be up to 100 characters in length. The name can be used to
   ...
   * cloud service. The description can be up to 1024 characters in length.
   * 
   * @param {string} [parameters.location] Required if AffinityGroup is not
   * specified. The location where the cloud service will be created.  Specify
   ...
   * specified. The name of an existing affinity group associated with this
   * subscription. This name is a GUID and can be retrieved by examining the
   ...
   * 
   * @param {object} [parameters.extendedProperties] Optional. Represents the
   * name of an extended cloud service property. Each extended property must
   * have both a defined name and value. You can have a maximum of 50 extended
   * property name and value pairs.  The maximum length of the Name element is
   * 64 characters, only alphanumeric characters and underscores are valid in
   * the name, and it must start with a letter. Attempting to use other
  ...
  HostedServiceOperations.prototype.create = function(parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  HostedServiceOperations.prototype.getDetailed = function(serviceName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '?embed-detail=true';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
        ...
        if (hostedServiceElement) {
            ...
            for (var loweredIndex1 = 0; loweredIndex1 < js2xml.getElements(responseDoc, deploymentsSequenceElement, 'DEPLOYMENT', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex1 = loweredIndex1 + 1) {
              ...
              if (roleListSequenceElement) {
                for (var loweredIndex4 = 0; loweredIndex4 < js2xml.getElements(responseDoc, roleListSequenceElement, 'ROLE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex4 = loweredIndex4 + 1) {
                  ...
                  var resourceExtensionReferencesSequenceElement = js2xml.getElement(responseDoc, roleListElement, 'RESOURCEEXTENSIONREFERENCES', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE');
                  if (resourceExtensionReferencesSequenceElement) {
                    for (var loweredIndex13 = 0; loweredIndex13 < js2xml.getElements(responseDoc, resourceExtensionReferencesSequenceElement, 'RESOURCEEXTENSIONREFERENCE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex13 = loweredIndex13 + 1) {
                      var resourceExtensionReferencesElement = js2xml.getElements(responseDoc, resourceExtensionReferencesSequenceElement, 'RESOURCEEXTENSIONREFERENCE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE')[loweredIndex13];
                      var resourceExtensionReferenceInstance = { resourceExtensionParameterValues: [] };
                      roleInstance.resourceExtensionReferences.push(resourceExtensionReferenceInstance);
                      ...
                      var resourceExtensionParameterValuesSequenceElement = js2xml.getElement(responseDoc, resourceExtensionReferencesElement, 'RESOURCEEXTENSIONPARAMETERVALUES', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE');
                      if (resourceExtensionParameterValuesSequenceElement) {
                        for (var loweredIndex14 = 0; loweredIndex14 < js2xml.getElements(responseDoc, resourceExtensionParameterValuesSequenceElement, 'RESOURCEEXTENSIONPARAMETERVALUE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex14 = loweredIndex14 + 1) {
                          var resourceExtensionParameterValuesElement = js2xml.getElements(responseDoc, resourceExtensionParameterValuesSequenceElement, 'RESOURCEEXTENSIONPARAMETERVALUE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE')[loweredIndex14];
                          var resourceExtensionParameterValueInstance = {};
                          resourceExtensionReferenceInstance.resourceExtensionParameterValues.push(resourceExtensionParameterValueInstance);
              ...
              if (extendedPropertiesSequenceElement) {
                for (var loweredIndex16 = 0; loweredIndex16 < js2xml.getElements(responseDoc, extendedPropertiesSequenceElement, 'EXTENDEDPROPERTY', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex16 = loweredIndex16 + 1) {
                  var extendedPropertiesElement = js2xml.getElements(responseDoc, extendedPropertiesSequenceElement, 'EXTENDEDPROPERTY', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE')[loweredIndex16];
                  var extendedPropertiesKey = js2xml.getElement(responseDoc, extendedPropertiesElement, 'NAME', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE');
                  var extendedPropertiesValue = js2xml.getElement(responseDoc, extendedPropertiesElement, 'VALUE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE');
              ...
              if (virtualIPsSequenceElement) {
                for (var loweredIndex17 = 0; loweredIndex17 < js2xml.getElements(responseDoc, virtualIPsSequenceElement, 'VIRTUALIP', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex17 = loweredIndex17 + 1) {
                  var virtualIPsElement = js2xml.getElements(responseDoc, virtualIPsSequenceElement, 'VIRTUALIP', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE')[loweredIndex17];
                  var virtualIPInstance = {};
              ...
              if (dnsElement) {
                ...
                var dnsServersSequenceElement = js2xml.getElement(responseDoc, dnsElement, 'DNSSERVERS', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE');
                if (dnsServersSequenceElement) {
                  for (var loweredIndex18 = 0; loweredIndex18 < js2xml.getElements(responseDoc, dnsServersSequenceElement, 'DNSSERVER', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex18 = loweredIndex18 + 1) {
                    var dnsServersElement = js2xml.getElements(responseDoc, dnsServersSequenceElement, 'DNSSERVER', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE')[loweredIndex18];
                    var dnsServerInstance = {};
                    dnsInstance.dnsServers.push(dnsServerInstance);
          ...
          if (hostedServicePropertiesElement) {
            ...
            if (extendedPropertiesSequenceElement2) {
              for (var loweredIndex19 = 0; loweredIndex19 < js2xml.getElements(responseDoc, extendedPropertiesSequenceElement2, 'EXTENDEDPROPERTY', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex19 = loweredIndex19 + 1) {
                var extendedPropertiesElement2 = js2xml.getElements(responseDoc, extendedPropertiesSequenceElement2, 'EXTENDEDPROPERTY', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE')[loweredIndex19];
  ...
  HostedServiceOperations.prototype.listAvailableExtensions = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/extensions';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
   ...
   * that are available to add to a cloud service. In Windows Azure, a process
   * can run as an extension of a cloud service. For example, Remote Desktop
   * Access or the Windows Azure Diagnostics Agent can run as extensions to
   * the cloud service.  (see
  ...
  HostedServiceOperations.prototype.listExtensionVersions = function(providerNamespace, extensionType, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/extensions/' + providerNamespace.trim() + '/' + extensionType.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
   ...
   * 
   * @param {string} [parameters.label] Optional. A name for the cloud service.
   * The name may be up to 100 characters in length. You must specify a value
   * for either Label or Description, or for both. It is recommended that the
   * label be unique within the subscription. The name can be used identify
   * the service for your tracking purposes.
   * 
   * @param {string} [parameters.description] Optional. A description for the
   * cloud service. The description may be up to 1024 characters in length.
...
var OperatingSystemOperations = ( /** @lends OperatingSystemOperations */ function() {
  ...
  OperatingSystemOperations.prototype.list = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/operatingsystems';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  OperatingSystemOperations.prototype.listFamilies = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/operatingsystemfamilies';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var ServiceCertificateOperations = ( /** @lends ServiceCertificateOperations */ function() {
   ...
   * certificate format. Windows Azure supports the pfx and cer file formats.
   * 
  ...
  ServiceCertificateOperations.prototype.beginCreating = function(serviceName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/certificates';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  ServiceCertificateOperations.prototype.beginDeleting = function(parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + parameters.serviceName.trim() + '/certificates/' + parameters.thumbprintAlgorithm.trim() + '-' + parameters.thumbprint.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var VirtualMachineDiskOperations = ( /** @lends VirtualMachineDiskOperations */ function() {
  ...
  VirtualMachineDiskOperations.prototype.beginDeletingDataDisk = function(serviceName, deploymentName, roleName, logicalUnitNumber, deleteFromStorage, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deployments/' + deploymentName.trim() + '/roles/' + roleName.trim() + '/DataDisks/' + logicalUnitNumber + '?';
    if (deleteFromStorage === true) {
      url2 = url2 + 'comp=media';
    }
    // Trim '/' character from the end of baseUrl and beginning of url.
   ...
   * 
   * @param {VirtualMachineDiskCreateDataDiskParameters} parameters Parameters
   * supplied to the Create Virtual Machine Data Disk operation.
   * 
   * @param {VirtualHardDiskHostCaching} parameters.hostCaching Required.
   * Specifies the platform caching behavior of data disk blob for read/write
   * efficiency. The default vault is ReadOnly. Possible values are: None,
   * ReadOnly, ReadWrite.  Warning: Setting this property impacts the
   * consistency of the disk.
   * 
   * @param {string} [parameters.diskLabel] Optional. Specifies the description
   * of the data disk. When you attach a disk, either by directly referencing
   * a media using the MediaLink element or specifying the target disk size,
   * you can use the DiskLabel element to customize the name property of the
   * target data disk.
   * 
   * @param {string} [parameters.diskName] Optional. Specifies the name of the
   * disk. Windows Azure uses the specified disk to create the data disk for
   * the machine and populates this field with the disk name.
   * 
   * @param {number} [parameters.logicalUnitNumber] Optional. Specifies the
   * Logical Unit Number (LUN) for the disk. The LUN specifies the slot in
   * which the data drive appears when mounted for usage by the virtual
   * machine.  Valid LUN values are 0 through 15.
   * 
   * @param {number} parameters.logicalDiskSizeInGB Optional. Specifies the
   * size, in GB, of an empty disk to be attached to the role. The disk can be
   * created as part of disk attach or create VM role call by specifying the
   * value for this property.  Windows Azure creates the empty disk based on
   * size preference and attaches the newly created disk to the Role.
   * 
   * @param {string} parameters.mediaLinkUri Required. Specifies the location
   * of the blob in Windows Azure blob store where the media for the disk is
   * located. The blob location must belong to the storage account in the
   ...
   * 
   * @param {string} [parameters.sourceMediaLinkUri] Optional. Specifies the
   * location of a blob in account storage which is mounted as a data disk
  ...
  VirtualMachineDiskOperations.prototype.createDataDisk = function(serviceName, deploymentName, roleName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deployments/' + deploymentName.trim() + '/roles/' + roleName.trim() + '/DataDisks';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
   ...
   * 
   * @param {string} [parameters.operatingSystemType] Required. The operating
   * system type of the disk. Possible values are: Linux, Windows.
   * 
   * @param {string} parameters.label Required. Specifies the friendly name of
   * the disk.
   * 
   * @param {string} parameters.mediaLinkUri Required. Specifies the location
   * of the blob in Windows Azure storage. The blob location must belong to a
   * storage account in the subscription specified by the SubscriptionId value
   * in the operation call.  Example:
   * http://example.blob.core.windows.net/disks/mydisk.vhd
   * 
   * @param {string} parameters.name Required. Specifies a name for the disk.
   * Windows Azure uses the name to identify the disk when creating virtual
  ...
  VirtualMachineDiskOperations.prototype.createDisk = function(parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/disks';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  VirtualMachineDiskOperations.prototype.deleteDisk = function(diskName, deleteFromStorage, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/disks/' + diskName.trim() + '?';
    if (deleteFromStorage === true) {
      url2 = url2 + 'comp=media';
    }
    // Trim '/' character from the end of baseUrl and beginning of url.
   ...
   * @param {Number} logicalUnitNumber The logical unit number of the disk.
   * 
   * @param {VirtualMachineDiskUpdateDataDiskParameters} parameters Parameters
   ...
   * 
   * @param {boolean} [parameters.hasOperatingSystem] Optional.  Specifies
   * whether the disk contains an operation system.  Note: Only a disk with an
   * operating system installed can be mounted as OS Drive.
   * 
   * @param {string} [parameters.operatingSystemType] Optional. The operating
   * system type of the disk. Possible values are: Linux, Windows.
   * 
   * @param {string} parameters.label Required. Specifies the friendly name of
   * the disk.
   * 
   * @param {string} [parameters.mediaLinkUri] Optional. Specifies the location
   * of the blob in Windows Azure storage. The blob location must belong to a
   * storage account in the subscription specified by the SubscriptionId value
   * in the operation call.  Example:
   * http://example.blob.core.windows.net/disks/mydisk.vhd
...
var VirtualMachineExtensionOperations = ( /** @lends VirtualMachineExtensionOperations */ function() {
  ...
  VirtualMachineExtensionOperations.prototype.list = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/resourceextensions';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  VirtualMachineExtensionOperations.prototype.listVersions = function(publisherName, extensionName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/resourceextensions/' + publisherName.trim() + '/' + extensionName.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var VirtualMachineImageOperations = ( /** @lends VirtualMachineImageOperations */ function() {
   ...
   * http://example.blob.core.windows.net/disks/mydisk.vhd
   * 
   * @param {string} parameters.name Required. Specifies a name that Windows
   * Azure uses to identify the image when creating one or more virtual
   * machines.
   * 
   * @param {string} parameters.operatingSystemType Required. The operating
   * system type of the OS image. Possible values are: Linux, Windows.
   * 
   * @param {string} [parameters.eula] Optional. Specifies the End User License
   ...
   * a EULA.
   * 
   * @param {string} [parameters.description] Optional. Specifies the
   * description of the OS image.
   * 
   * @param {string} [parameters.imageFamily] Optional. Specifies a value that
   * can be used to group OS images.
   * 
   * @param {date} [parameters.publishedDate] Optional. Specifies the date when
   * the OS image was added to the image repository.
   * 
   ...
   * 
   * @param {string} [parameters.privacyUri] Optional. Specifies the URI that
   * points to a document that contains the privacy policy related to the OS
   * image.
   * 
   * @param {string} [parameters.iconUri] Optional. Specifies the Uri to the
   * icon that is displayed for the image in the Management Portal.
   * 
   * @param {string} [parameters.recommendedVMSize] Optional. Specifies the
   * size to use for the virtual machine that is created from the OS image.
   * 
   * @param {string} [parameters.smallIconUri] Specifies the URI to the small
   * icon that is displayed when the image is presented in the Windows Azure
  ...
  VirtualMachineImageOperations.prototype.create = function(parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/images';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  VirtualMachineImageOperations.prototype.delete = function(imageName, deleteFromStorage, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/images/' + imageName.trim() + '?';
    if (deleteFromStorage === true) {
      url2 = url2 + 'comp=media';
    }
    // Trim '/' character from the end of baseUrl and beginning of url.
   ...
   * 
   * @param {string} parameters.label Required. Specifies the friendly name of
   * the image to be updated. You cannot use this operation to update images
   * provided by the Windows Azure platform.
   * 
   * @param {string} [parameters.eula] Optional. Specifies the End User License
   * Agreement that is associated with the image. The value for this element
   * is a string, but it is recommended that the value be a URL that points to
...
var VirtualMachineOperations = ( /** @lends VirtualMachineOperations */ function() {
   ...
   * 
   * @param {PostCaptureAction} parameters.postCaptureAction Required.
   * Specifies the action that is performed after the capture operation
   * finishes.  Possible values are:  Delete – this value causes the virtual
   * machine to be deleted after the image has been captured.   Reprovision –
   * this value causes the virtual machine to be redeployed after the image is
   * captured by using the specified information in ProvisioningConfiguration.
   * 
   * @param {ConfigurationSet} [parameters.provisioningConfiguration] Optional.
   * Provides information to be used to redeploy the virtual machine after the
   * image has been captured. This element is only used when the
   ...
   * 
   * @param {boolean}
   * [parameters.provisioningConfiguration.enableAutomaticUpdates] Optional.
   ...
   * 
   * @param {string} [parameters.provisioningConfiguration.timeZone] Optional.
   * Specifies the time zone for the virtual machine. This element is only
   * used with the WindowsProvisioningConfiguration set.  For a complete list
   * of supported time zone entries, you can:  Refer to the values listed in
   * the registry entry HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows
   ...
   * [parameters.provisioningConfiguration.domainJoin] Optional.  Contains
   * properties that specify a domain to which the virtual machine will be
   * joined. This element is only used with the
   * WindowsProvisioningConfiguration set.
   * 
   * @param {DomainJoinCredentials}
   * [parameters.provisioningConfiguration.domainJoin.credentials] Optional.
   ...
   * 
   * @param {string}
   * [parameters.provisioningConfiguration.domainJoin.domainToJoin] Optional.
   ...
   * 
   * @param {array}
   * [parameters.provisioningConfiguration.storedCertificateSettings]
   ...
   * [parameters.provisioningConfiguration.windowsRemoteManagement] Optional.
   ...
   * 2013-03-01.
   * 
   * @param {string} [parameters.provisioningConfiguration.hostName] Required.
   * Specifies the host name for the VM. Host names are ASCII character
   * strings 1 to 64 characters in length. This element is only used with the
   * LinuxProvisioningConfiguration set.
   * 
   * @param {string} [parameters.provisioningConfiguration.userName] Required.
   ...
   * character strings 6 to 72 characters in length. This element is only used
   ...
   * 
   * @param {array}
   * [parameters.provisioningConfiguration.sshSettings.publicKeys] Optional.
   ...
   * 
   * @param {string} parameters.targetImageLabel Required. Specifies the
   * friendly name of the captured image. This is the value that appears in
   * the Name column for the image in the Windows Azure Management Portal.
   * 
   * @param {string} parameters.targetImageName Required. Specifies the image
   ...
   * @returns {Stream} The response stream.
   */
  VirtualMachineOperations.prototype.beginCapturing = function(serviceName, deploymentName, virtualMachineName, parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deployments/' + deploymentName.trim() + '/roleinstances/' + virtualMachineName.trim() + '/Operations';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
   ...
   * 
   * @param {string} parameters.roleName Required. Specifies the name for the
   * virtual machine. The name must be unique within the deployment.
   * 
   * @param {string} [parameters.availabilitySetName] Optional. Specifies the
   * name of an availability set to which to add the virtual machine. This
   ...
   * settings.
   * 
   * @param {array} [parameters.resourceExtensionReferences] Optional. Contains
   * a collection of resource extensions that are to be installed on the
   * Virtual Machine. This element is used if ProvisionGuestAgent is set to
   * true.
   * 
   * @param {array} [parameters.dataVirtualHardDisks] Contains the parameters
   * Windows Azure used to create the data disk for the virtual machine.
   * 
   * @param {OSVirtualHardDisk} [parameters.oSVirtualHardDisk] Contains the
   * parameters Windows Azure used to create the operating system disk for the
   * virtual machine.
   * 
   * @param {VirtualHardDiskHostCaching}
   * [parameters.oSVirtualHardDisk.hostCaching] Specifies the platform caching
   * behavior of the operating system disk blob for read/write efficiency.
   * 
   * @param {string} [parameters.oSVirtualHardDisk.diskLabel] Specifies the
   * friendly name an operating system image in the image repository.
   * 
   * @param {string} [parameters.oSVirtualHardDisk.diskName] Specifies the name
   * an operating system image in the image repository.
   * 
   * @param {string} [parameters.oSVirtualHardDisk.mediaLink] Specifies the
   * location of the operating system disk in Windows Azure storage.
   * 
   ...
   * 
   * @param {boolean} [parameters.provisionGuestAgent] Optional. Indicates
   * whether the WindowsAzureGuestAgent service is installed on the Virtual
   * Machine. To run a resource extension in aVirtual Machine, this service
   * must be installed.
   * 
   * @param {function} callback
   * 
  ...
  VirtualMachineOperations.prototype.beginCreating = function(serviceName, deploymentName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deployments/' + deploymentName.trim() + '/roles';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
    ...
    if (parameters.resourceExtensionReferences) {
      ...
      for (var loweredIndex15 = 0; loweredIndex15 < parameters.resourceExtensionReferences.length; loweredIndex15 = loweredIndex15 + 1) {
        ...
        if (resourceExtensionReferencesItem.name) {
          ...
          js2xml.setElementValue(nameElement2, resourceExtensionReferencesItem.name);
          js2xml.addChildElement(resourceExtensionReferenceElement, nameElement2);
        }
        ...
        if (resourceExtensionReferencesItem.state) {
          ...
          js2xml.setElementValue(stateElement, resourceExtensionReferencesItem.state ? resourceExtensionReferencesItem.state.toString() : 'Enable');
        ...
        if (resourceExtensionReferencesItem.resourceExtensionParameterValues) {
          ...
          for (var loweredIndex16 = 0; loweredIndex16 < resourceExtensionReferencesItem.resourceExtensionParameterValues.length; loweredIndex16 = loweredIndex16 + 1) {
            ...
            if (resourceExtensionParameterValuesItem.type) {
              var typeElement = js2xml.createElement('Type', 'http://schemas.microsoft.com/windowsazure');
              js2xml.setElementValue(typeElement, resourceExtensionParameterValuesItem.type ? resourceExtensionParameterValuesItem.type.toString() : 'Public');
   ...
   * 
   * @param {string} parameters.name Required. A name for the deployment. The
   * deployment name must be unique among other deployments for the hosted
   * service.
   * 
   * @param {DeploymentSlot} parameters.deploymentSlot Required. Specifies the
   ...
   * 
   * @param {array} parameters.roles Required. Contains the provisioning
   * details for the new virtual machine deployment.
   * 
   * @param {string} [parameters.virtualNetworkName] Optional. Specifies the
   * name of an existing virtual network to which the deployment will belong.
   * Virtual networks are created by calling the Set Network Configuration
   * operation.
   * 
   * @param {DnsSettings} [parameters.dnsSettings] Optional. Contains a list of
   * DNS servers to associate with themachine.
   * 
   * @param {array} [parameters.dnsSettings.dnsServers] Contains a collection
   * of objects that define the DNS server settings.
   * 
   * @param {string} [parameters.reservedIPName] Optional and Preview Only.
   * Specifies the name of an existing reserved IP to which the deployment
   * will belong. Reserved IPs are created by calling the Create Reserved IP
   * operation.
   * 
   * @param {function} callback
   * 
  ...
  VirtualMachineOperations.prototype.beginCreatingDeployment = function(serviceName, parameters, callback) {
    ...
    if (parameters.roles) {
      for (var loweredIndex1 = 0; loweredIndex1 < parameters.roles.length; loweredIndex1 = loweredIndex1 + 1) {
        ...
        if (rolesParameterItem.dataVirtualHardDisks) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deployments';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
      ...
      if (parameters.dnsSettings.dnsServers) {
        ...
        for (var loweredIndex20 = 0; loweredIndex20 < parameters.dnsSettings.dnsServers.length; loweredIndex20 = loweredIndex20 + 1) {
          ...
          if (dnsServersItem.name) {
            ...
            js2xml.setElementValue(nameElement4, dnsServersItem.name);
            js2xml.addChildElement(dnsServerElement, nameElement4);
          }
   ...
   * 
   * @param {boolean} deleteFromStorage Optional. Specifies that the source
   * blob(s) for the virtual machine should also be deleted from storage.
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
  ...
  VirtualMachineOperations.prototype.beginDeleting = function(serviceName, deploymentName, virtualMachineName, deleteFromStorage, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deployments/' + deploymentName.trim() + '/roles/' + virtualMachineName.trim() + '?';
    if (deleteFromStorage === true) {
      url2 = url2 + 'comp=media';
    }
    // Trim '/' character from the end of baseUrl and beginning of url.
   ...
   * vm after shotdown (stopped or stopped and deallocated)
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
  ...
  VirtualMachineOperations.prototype.beginShuttingDownRoles = function(serviceName, deploymentName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deployments/' + deploymentName.trim() + '/Roles/Operations';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
   ...
   * @param {string} deploymentName The name of your deployment.
   * 
   * @param {VirtualMachineStartRolesParameters} parameters The set of virtual
   * machine roles to start.
   * 
   * @param {array} [parameters.roles] The set of roles to shut down.
   * 
   * @param {function} callback
   ...
   * virtual machine. The name must be unique within the deployment.
   * 
   * @param {string} [parameters.label] Optional. Specifies the friendly name
  ...
  VirtualMachineOperations.prototype.beginUpdatingLoadBalancedEndpointSet = function(serviceName, deploymentName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deployments/' + deploymentName.trim() + '?comp=UpdateLbSet';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  VirtualMachineOperations.prototype.capture = function(serviceName, deploymentName, virtualMachineName, parameters, callback) {
    ...
    return client2.virtualMachines.beginCapturing(serviceName, deploymentName, virtualMachineName, parameters, function (err, result) {
      if (err) {
        return callback(err);
      }
      var delayInSeconds = 30;
  ...
  VirtualMachineOperations.prototype.getRemoteDesktopFile = function(serviceName, deploymentName, virtualMachineName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/hostedservices/' + serviceName.trim() + '/deployments/' + deploymentName.trim() + '/roleinstances/' + virtualMachineName.trim() + '/ModelFile?FileType=RDP';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
