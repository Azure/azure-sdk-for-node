...
var VirtualMachineDiskOperations = ( /** @lends VirtualMachineDiskOperations */ function() {
   ...
   * 
   * @param {string} [parameters.label] Optional. Specifies the description of
   * the data disk. When you attach a disk, either by directly referencing a
   * media using the MediaLink element or specifying the target disk size, you
   * can use the DiskLabel element to customize the name property of the
   * target data disk.
   * 
   * @param {string} [parameters.name] Optional. Specifies the name of the
  ...
  VirtualMachineDiskOperations.prototype.deleteDisk = function(name, deleteFromStorage, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + '/' + this.client.credentials.subscriptionId + '/services/disks/' + name + '?';
    if (deleteFromStorage === true) {
      url2 = url2 + 'comp=media';
    }
...
var VirtualMachineOperations = ( /** @lends VirtualMachineOperations */ function() {
   ...
   * 
   * @param {string} [parameters.oSVirtualHardDisk.name] Specifies the name an
   * operating system image in the image repository.
   * 
