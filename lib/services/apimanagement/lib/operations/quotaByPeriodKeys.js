 ...
 */
function _get(resourceGroupName, serviceName, quotaCounterKey, quotaPeriodKey, options, callback) {
  ...
  try {
    ...
    if (quotaPeriodKey === null || quotaPeriodKey === undefined || typeof quotaPeriodKey.valueOf() !== 'string') {
      throw new Error('quotaPeriodKey cannot be null or undefined and it must be of type string.');
    }
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/quotas/{quotaCounterKey}/periods/{quotaPeriodKey}';
  ...
  requestUrl = requestUrl.replace('{quotaPeriodKey}', encodeURIComponent(quotaPeriodKey));
  let queryParameters = [];
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['QuotaCounterContract']().mapper();
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _update(resourceGroupName, serviceName, quotaCounterKey, quotaPeriodKey, parameters, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
...
class QuotaByPeriodKeys {
   ...
   */
  getWithHttpOperationResponse(resourceGroupName, serviceName, quotaCounterKey, quotaPeriodKey, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._get(resourceGroupName, serviceName, quotaCounterKey, quotaPeriodKey, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  get(resourceGroupName, serviceName, quotaCounterKey, quotaPeriodKey, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._get(resourceGroupName, serviceName, quotaCounterKey, quotaPeriodKey, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  updateWithHttpOperationResponse(resourceGroupName, serviceName, quotaCounterKey, quotaPeriodKey, parameters, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._update(resourceGroupName, serviceName, quotaCounterKey, quotaPeriodKey, parameters, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  update(resourceGroupName, serviceName, quotaCounterKey, quotaPeriodKey, parameters, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._update(resourceGroupName, serviceName, quotaCounterKey, quotaPeriodKey, parameters, options, optionalCallback);
    }
  }

}

module.exports = QuotaByPeriodKeys;
