 ...
 */
function _send(resourceGroupName, serviceName, userId, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{userId}/confirmations/password/send';
...
class UserConfirmationPassword {
   ...
   */
  sendWithHttpOperationResponse(resourceGroupName, serviceName, userId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._send(resourceGroupName, serviceName, userId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  send(resourceGroupName, serviceName, userId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._send(resourceGroupName, serviceName, userId, options, optionalCallback);
    }
  }

}

module.exports = UserConfirmationPassword;
