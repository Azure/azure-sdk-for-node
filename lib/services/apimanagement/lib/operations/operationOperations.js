 ...
 */
function _listByTags(resourceGroupName, serviceName, apiId, options, callback) {
  ...
  let includeNotTaggedOperations = (options && options.includeNotTaggedOperations !== undefined) ? options.includeNotTaggedOperations : undefined;
  // Validate
  try {
    ...
    if (includeNotTaggedOperations !== null && includeNotTaggedOperations !== undefined && typeof includeNotTaggedOperations !== 'boolean') {
      throw new Error('includeNotTaggedOperations must be of type boolean.');
    }
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/operationsByTags';
  ...
  if (includeNotTaggedOperations !== null && includeNotTaggedOperations !== undefined) {
    queryParameters.push('includeNotTaggedOperations=' + encodeURIComponent(includeNotTaggedOperations.toString()));
  }
...
class OperationOperations {
   ...
   */
  listByTagsWithHttpOperationResponse(resourceGroupName, serviceName, apiId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listByTags(resourceGroupName, serviceName, apiId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listByTags(resourceGroupName, serviceName, apiId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._listByTags(resourceGroupName, serviceName, apiId, options, optionalCallback);
    }
  }
...
module.exports = OperationOperations;
