 ...
 */
function _list(resourceGroupName, serviceName, productId, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}/subscriptions';
...
class ProductSubscriptions {
   ...
   */
  listWithHttpOperationResponse(resourceGroupName, serviceName, productId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._list(resourceGroupName, serviceName, productId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  list(resourceGroupName, serviceName, productId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._list(resourceGroupName, serviceName, productId, options, optionalCallback);
    }
  }
...
module.exports = ProductSubscriptions;
