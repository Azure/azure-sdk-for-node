...
function _listByService(resourceGroupName, serviceName, options, callback) {
  ...
  let expandApiVersionSet = (options && options.expandApiVersionSet !== undefined) ? options.expandApiVersionSet : undefined;
  // Validate
  try {
    ...
    if (expandApiVersionSet !== null && expandApiVersionSet !== undefined && typeof expandApiVersionSet !== 'boolean') {
      throw new Error('expandApiVersionSet must be of type boolean.');
    }
  ...
  if (expandApiVersionSet !== null && expandApiVersionSet !== undefined) {
    queryParameters.push('expandApiVersionSet=' + encodeURIComponent(expandApiVersionSet.toString()));
  }
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getEntityTag(resourceGroupName, serviceName, apiId, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
...
function _createOrUpdate(resourceGroupName, serviceName, apiId, parameters, options, callback) {
  ...
  // Send request
  this.beginCreateOrUpdate(resourceGroupName, serviceName, apiId, parameters, options, (err, parsedResult, httpRequest, response) => {
...
function _deleteMethod(resourceGroupName, serviceName, apiId, ifMatch, options, callback) {
  ...
  let deleteRevisions = (options && options.deleteRevisions !== undefined) ? options.deleteRevisions : undefined;
  // Validate
  try {
    if (resourceGroupName === null || resourceGroupName === undefined || typeof resourceGroupName.valueOf() !== 'string') {
      throw new Error('resourceGroupName cannot be null or undefined and it must be of type string.');
    ...
    if (deleteRevisions !== null && deleteRevisions !== undefined && typeof deleteRevisions !== 'boolean') {
      throw new Error('deleteRevisions must be of type boolean.');
    }
    if (ifMatch === null || ifMatch === undefined || typeof ifMatch.valueOf() !== 'string') {
      throw new Error('ifMatch cannot be null or undefined and it must be of type string.');
    }
  ...
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  let queryParameters = [];
  if (deleteRevisions !== null && deleteRevisions !== undefined) {
    queryParameters.push('deleteRevisions=' + encodeURIComponent(deleteRevisions.toString()));
  }
  queryParameters.push('api-version=' + encodeURIComponent(this.client.apiVersion));
  if (queryParameters.length > 0) {
    requestUrl += '?' + queryParameters.join('&');
...
function _listByTags(resourceGroupName, serviceName, options, callback) {
  ...
  let top = (options && options.top !== undefined) ? options.top : undefined;
  let skip = (options && options.skip !== undefined) ? options.skip : undefined;
  let includeNotTaggedApis = (options && options.includeNotTaggedApis !== undefined) ? options.includeNotTaggedApis : undefined;
  // Validate
  try {
    if (resourceGroupName === null || resourceGroupName === undefined || typeof resourceGroupName.valueOf() !== 'string') {
      throw new Error('resourceGroupName cannot be null or undefined and it must be of type string.');
    ...
    if (includeNotTaggedApis !== null && includeNotTaggedApis !== undefined && typeof includeNotTaggedApis !== 'boolean') {
      throw new Error('includeNotTaggedApis must be of type boolean.');
    }
    if (this.client.apiVersion === null || this.client.apiVersion === undefined || typeof this.client.apiVersion.valueOf() !== 'string') {
      throw new Error('this.client.apiVersion cannot be null or undefined and it must be of type string.');
    }
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apisByTags';
  requestUrl = requestUrl.replace('{resourceGroupName}', encodeURIComponent(resourceGroupName));
  requestUrl = requestUrl.replace('{serviceName}', encodeURIComponent(serviceName));
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  let queryParameters = [];
  ...
  if (includeNotTaggedApis !== null && includeNotTaggedApis !== undefined) {
    queryParameters.push('includeNotTaggedApis=' + encodeURIComponent(includeNotTaggedApis.toString()));
  }
  queryParameters.push('api-version=' + encodeURIComponent(this.client.apiVersion));
  if (queryParameters.length > 0) {
    requestUrl += '?' + queryParameters.join('&');
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _beginCreateOrUpdate(resourceGroupName, serviceName, apiId, parameters, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
...
class Api {
   ...
   * @reject {Error} - The error object.
   */
  getEntityTagWithHttpOperationResponse(resourceGroupName, serviceName, apiId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getEntityTag(resourceGroupName, serviceName, apiId, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getEntityTag(resourceGroupName, serviceName, apiId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getEntityTag(resourceGroupName, serviceName, apiId, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  beginCreateOrUpdateWithHttpOperationResponse(resourceGroupName, serviceName, apiId, parameters, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginCreateOrUpdate(resourceGroupName, serviceName, apiId, parameters, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  beginCreateOrUpdate(resourceGroupName, serviceName, apiId, parameters, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._beginCreateOrUpdate(resourceGroupName, serviceName, apiId, parameters, options, optionalCallback);
    }
  }
