...
class OperationEntityBaseContract {
   ...
   * @property {array} [request.queryParameters] Collection of operation
   * request query parameters.
   * @property {array} [request.headers] Collection of operation request
   * headers.
   * @property {array} [request.representations] Collection of operation
