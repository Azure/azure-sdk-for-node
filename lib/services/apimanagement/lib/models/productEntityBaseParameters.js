...
class ProductEntityBaseParameters {
   ...
   * @property {boolean} [subscriptionRequired] Whether a product subscription
   * is required for accessing APIs included in this product. If true, the
   * product is referred to as "protected" and a valid subscription key is
   * required for a request to an API included in the product to succeed. If
   ...
   * property is omitted when creating a new product it's value is assumed to
   * be true.
   ...
   * of false.
   * @property {number} [subscriptionsLimit] Whether the number of
   * subscriptions a user can have to this product at the same time. Set to
   * null or omit to allow unlimited per user subscriptions. Can be present
