...
export default class ACEProvisioningManagementPartnerAPI extends AzureServiceClient {
  /**
...
export { ACEProvisioningManagementPartnerAPI, models as ACEProvisioningManagementPartnerAPIModels };
