...
class JobDetails {
  /**
   * Create a JobDetails.
   * @property {string} [storageAccountId] The resource identifier of the
   * storage account where data will be imported to or exported from.
   ...
   * @property {string} [shippingInformation.phone] Phone number of the
   ...
   * @property {string} [returnPackage.carrierName] The name of the carrier
   * that is used to ship the import or export drives.
   * @property {string} [returnPackage.trackingNumber] The tracking number of
   * the package.
   * @property {number} [returnPackage.driveCount] The number of drives
   * included in the package.
   * @property {string} [returnPackage.shipDate] The date when the package is
   * shipped.
   * @property {string} [diagnosticsPath] The virtual blob directory to which
   * the copy logs and backups of drive manifest files (if enabled) will be
   * stored.
   * @property {string} [logLevel] Default value is Error. Indicates whether
   * error logging or verbose logging will be enabled.
   * @property {boolean} [backupDriveManifest] Default value is false.
   ...
   * @property {object} [exportProperty] A property containing information
   ...
   * blob-prefix strings.
   * @property {string} [exportProperty.blobListblobPath] The relative URI to
   * the block blob that contains the list of blob paths or blob path prefixes
   * as defined above, beginning with the container name. If the blob is in
