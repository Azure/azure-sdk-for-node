...
class DriveStatus {
   ...
   * drive.
   * @property {string} [manifestFile] The relative path of the manifest file
   * on the drive.
   ...
   * @property {string} [verboseLogUri] A URI that points to the blob
   * containing the verbose log for the data transfer operation.
