 ...
 */
function _list(jobName, resourceGroupName, options, callback) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['GetBitLockerKeysResponse']().mapper();
...
class BitLockerKeys {
   ...
   */
  listWithHttpOperationResponse(jobName, resourceGroupName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._list(jobName, resourceGroupName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  list(jobName, resourceGroupName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._list(jobName, resourceGroupName, options, optionalCallback);
    }
  }

}

module.exports = BitLockerKeys;
