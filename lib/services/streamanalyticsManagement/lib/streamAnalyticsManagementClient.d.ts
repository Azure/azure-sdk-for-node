...
export default class StreamAnalyticsManagementClient extends AzureServiceClient {
  /**
...
export { StreamAnalyticsManagementClient, models as StreamAnalyticsManagementModels };
