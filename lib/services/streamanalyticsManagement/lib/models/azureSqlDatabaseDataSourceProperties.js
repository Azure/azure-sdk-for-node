...
class AzureSqlDatabaseDataSourceProperties {
   ...
   * @property {string} [server] The name of the SQL server containing the
   ...
   * @property {string} [user] The user name that will be used to connect to
   ...
   * the Azure SQL database. Required on PUT (CreateOrReplace) requests.
   * @property {string} [table] The name of the table in the Azure SQL
