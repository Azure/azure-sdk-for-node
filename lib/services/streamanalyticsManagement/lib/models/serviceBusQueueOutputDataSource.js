 ...
 */
class ServiceBusQueueOutputDataSource extends models['OutputDataSource'] {
  /**
   * Create a ServiceBusQueueOutputDataSource.
  ...
  /**
   * Defines the metadata of ServiceBusQueueOutputDataSource
   *
   * @returns {object} metadata of ServiceBusQueueOutputDataSource
   *
   */
  mapper() {
    return {
...
module.exports = ServiceBusQueueOutputDataSource;
