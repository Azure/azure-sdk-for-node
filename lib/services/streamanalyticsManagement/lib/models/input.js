...
class Input extends models['SubResource'] {
   ...
   * @property {string} [properties.serialization.type] Polymorphic
   * Discriminator
   * @property {object} [properties.diagnostics] Describes conditions
   * applicable to the Input, Output, or the job overall, that warrant customer
   * attention.
