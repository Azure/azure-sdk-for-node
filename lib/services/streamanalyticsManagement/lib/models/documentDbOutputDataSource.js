...
class DocumentDbOutputDataSource extends models['OutputDataSource'] {
   ...
   * @property {string} [accountKey] The account key for the DocumentDB
   * account. Required on PUT (CreateOrReplace) requests.
   * @property {string} [database] The name of the DocumentDB database.
   ...
   * @property {string} [documentId] The name of the field in output events
   * used to specify the primary key which insert or update operations are
   * based on.
   */
  constructor() {
    super();
