...
class AzureMachineLearningWebServiceFunctionBinding extends models['FunctionBinding'] {
   ...
   * @property {array} [inputs.columnNames] A list of input columns for the
   ...
   * @property {number} [batchSize] Number between 1 and 10000 describing
   * maximum number of rows for every Azure ML RRS execute request. Default is
   * 1000.
   */
  constructor() {
    super();
