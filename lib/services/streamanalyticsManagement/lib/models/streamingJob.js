...
class StreamingJob extends models['Resource'] {
   ...
   * @property {object} [sku] Describes the SKU of the streaming job. Required
   ...
   * @property {string} [provisioningState] Describes the provisioning status
   ...
   * @property {date} [lastOutputEventTime] Value is either an ISO-8601
   * formatted timestamp indicating the last output event time of the streaming
   * job or null indicating that output has not yet been produced. In case of
   * multiple outputs or multiple streams, this shows the latest value in that
   * set.
   * @property {string} [eventsOutOfOrderPolicy] Indicates the policy to apply
   * to events that arrive out of order in the input event stream. Possible
   ...
   * @property {number} [eventsOutOfOrderMaxDelayInSeconds] The maximum
   ...
   * have a value of -1.
   * @property {string} [dataLocale] The data locale of the stream analytics
   * job. Value should be the name of a supported .NET Culture from the set
   ...
   * @property {date} [createdDate] Value is an ISO-8601 formatted UTC
   * timestamp indicating when the streaming job was created.
   ...
   * concurrency.
   * @property {array} [outputs] A list of one or more outputs for the
   ...
   * @property {string} [etag] The current entity tag for the streaming job.
