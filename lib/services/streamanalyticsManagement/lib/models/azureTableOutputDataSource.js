...
class AzureTableOutputDataSource extends models['OutputDataSource'] {
   ...
   * requests.
   * @property {string} [rowKey] This element indicates the name of a column
   * from the SELECT statement in the query that will be used as the row key
   * for the Azure Table. Required on PUT (CreateOrReplace) requests.
   * @property {array} [columnsToRemove] If specified, each item in the array
