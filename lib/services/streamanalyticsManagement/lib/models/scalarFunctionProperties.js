...
class ScalarFunctionProperties extends models['FunctionProperties'] {
   ...
   * @property {array} [inputs] A list of inputs describing the parameters of
   * the function.
   * @property {object} [output] The output of the function.
   * @property {string} [output.dataType] The (Azure Stream Analytics
   * supported) data type of the function output. A list of valid Azure Stream
