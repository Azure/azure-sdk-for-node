...
class EventHubOutputDataSource extends models['OutputDataSource'] {
   ...
   * @property {string} [sharedAccessPolicyKey] The shared access policy key
   * for the specified shared access policy. Required on PUT (CreateOrReplace)
   * requests.
   * @property {string} [eventHubName] The name of the Event Hub. Required on
   * PUT (CreateOrReplace) requests.
