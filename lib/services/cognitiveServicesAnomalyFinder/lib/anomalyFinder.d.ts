...
export default class AnomalyFinder extends ServiceClient {
  /**
   * @class
   * Initializes a new instance of the AnomalyFinder class.
   * @constructor
   *
   ...
   * will be which means less anomalies will be accepted. Must be between 0 and
   * 99 (inclusive)
   *
   ...
   */
  postTimeseriesEntireDetectWithHttpOperationResponse(body: models.Request, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.EntireDetectResponse>>;
   ...
   */
  postTimeseriesEntireDetect(body: models.Request, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<models.EntireDetectResponse>;
  postTimeseriesEntireDetect(body: models.Request, callback: ServiceCallback<models.EntireDetectResponse>): void;
  postTimeseriesEntireDetect(body: models.Request, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.EntireDetectResponse>): void;
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  postTimeseriesLastDetectWithHttpOperationResponse(body: models.Request, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.LastDetectResponse>>;
   ...
   *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
   */
  postTimeseriesLastDetect(body: models.Request, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<models.LastDetectResponse>;
  postTimeseriesLastDetect(body: models.Request, callback: ServiceCallback<models.LastDetectResponse>): void;
  postTimeseriesLastDetect(body: models.Request, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.LastDetectResponse>): void;
}

export { AnomalyFinder, models as AnomalyFinderModels };
