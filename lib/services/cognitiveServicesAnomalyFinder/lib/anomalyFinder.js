 ...
 */
function _postTimeseriesEntireDetect(body, options, callback) {
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _postTimeseriesLastDetect(body, options, callback) {
   /* jshint validthis: true */
  let client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
...
/** Class representing a AnomalyFinder. */
class AnomalyFinder extends ServiceClient {
  /**
   * Create a AnomalyFinder.
  ...
  constructor(credentials, endpoint, options) {
    ...
    this.models = models;
    this._postTimeseriesEntireDetect = _postTimeseriesEntireDetect;
    this._postTimeseriesLastDetect = _postTimeseriesLastDetect;
   ...
   */
  postTimeseriesEntireDetectWithHttpOperationResponse(body, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._postTimeseriesEntireDetect(body, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  postTimeseriesEntireDetect(body, options, optionalCallback) {
    let client = this;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._postTimeseriesEntireDetect(body, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  postTimeseriesLastDetectWithHttpOperationResponse(body, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._postTimeseriesLastDetect(body, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  postTimeseriesLastDetect(body, options, optionalCallback) {
    let client = this;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._postTimeseriesLastDetect(body, options, optionalCallback);
    }
  }
...
module.exports['default'] = AnomalyFinder;
module.exports.AnomalyFinder = AnomalyFinder;
