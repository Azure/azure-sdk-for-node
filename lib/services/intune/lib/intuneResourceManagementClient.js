 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
IntuneResourceManagementClient.prototype.getMAMUserDevices = function (hostName, userName, filter, top, select, options, callback) {
  var client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
IntuneResourceManagementClient.prototype.getMAMUserDeviceByDeviceName = function (hostName, userName, deviceName, select, options, callback) {
  var client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
IntuneResourceManagementClient.prototype.getMAMFlaggedUsers = function (hostName, filter, top, select, options, callback) {
  var client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
IntuneResourceManagementClient.prototype.getMAMFlaggedUserByName = function (hostName, userName, select, options, callback) {
  var client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
IntuneResourceManagementClient.prototype.getMAMUserFlaggedEnrolledApps = function (hostName, userName, filter, top, select, options, callback) {
  var client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
