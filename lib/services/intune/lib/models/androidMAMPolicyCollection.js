...
/**
 * Deserialize the instance to AndroidMAMPolicyCollection schema
 *
 * @param {JSON} instance
 *
 */
AndroidMAMPolicyCollection.prototype.deserialize = function (instance) {
  if (instance) {
    if (instance['value']) {
      var deserializedInstancevalue = [];
        instance['value'].forEach(function(element) {
        if (element) {
          element = new models['AndroidMAMPolicy']().deserialize(element);
        }
