 ...
 * 
 */
function IOSMAMPolicy(parameters) {
  IOSMAMPolicy['super_'].call(this, parameters);
  if (parameters !== null && parameters !== undefined) {
    if (parameters.fileEncryptionLevel !== undefined) {
      this.fileEncryptionLevel = parameters.fileEncryptionLevel;
    }
    if (parameters.touchId !== undefined) {
      this.touchId = parameters.touchId;
    }
...
/**
 * Validate the payload against the IOSMAMPolicy schema
 *
 * @param {JSON} payload
 *
 */
IOSMAMPolicy.prototype.serialize = function () {
  var payload = IOSMAMPolicy['super_'].prototype.serialize.call(this);
  if (this['fileEncryptionLevel'] !== null && this['fileEncryptionLevel'] !== undefined) {
    if (typeof this['fileEncryptionLevel'].valueOf() !== 'string') {
      throw new Error('this[\'fileEncryptionLevel\'] must be of type string.');
    }
    if (payload['properties'] === null || payload['properties'] === undefined) {
      payload['properties'] = {};
    }
    payload['properties']['fileEncryptionLevel'] = this['fileEncryptionLevel'];
  }

  if (this['touchId'] !== null && this['touchId'] !== undefined) {
    if (typeof this['touchId'].valueOf() !== 'string') {
      throw new Error('this[\'touchId\'] must be of type string.');
    }
    if (payload['properties'] === null || payload['properties'] === undefined) {
      payload['properties'] = {};
    }
    payload['properties']['touchId'] = this['touchId'];
  }
...
/**
 * Deserialize the instance to IOSMAMPolicy schema
 *
 * @param {JSON} instance
 *
 */
IOSMAMPolicy.prototype.deserialize = function (instance) {
  IOSMAMPolicy['super_'].prototype.deserialize.call(this, instance);
  if (instance) {
    if (instance['properties'] !== null && instance['properties'] !== undefined) {
      if (instance['properties']['fileEncryptionLevel'] !== undefined) {
        this['fileEncryptionLevel'] = instance['properties']['fileEncryptionLevel'];
      }
    }

    if (instance['properties'] !== null && instance['properties'] !== undefined) {
      if (instance['properties']['touchId'] !== undefined) {
        this['touchId'] = instance['properties']['touchId'];
      }
    }
