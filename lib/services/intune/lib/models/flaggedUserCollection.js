...
/**
 * Deserialize the instance to FlaggedUserCollection schema
 *
 * @param {JSON} instance
 *
 */
FlaggedUserCollection.prototype.deserialize = function (instance) {
  if (instance) {
    if (instance['value']) {
      var deserializedInstancevalue = [];
        instance['value'].forEach(function(element) {
        if (element) {
          element = new models['FlaggedUser']().deserialize(element);
        }
