...
/**
 * Deserialize the instance to DeviceCollection schema
 *
 * @param {JSON} instance
 *
 */
DeviceCollection.prototype.deserialize = function (instance) {
  if (instance) {
    if (instance['value']) {
      var deserializedInstancevalue = [];
        instance['value'].forEach(function(element) {
        if (element) {
          element = new models['Device']().deserialize(element);
        }
