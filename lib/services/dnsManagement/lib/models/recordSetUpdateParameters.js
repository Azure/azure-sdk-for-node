...
class RecordSetUpdateParameters {
   ...
   * @property {object} [recordSet.metadata] The metadata attached to the
   * record set.
   * @property {number} [recordSet.tTL] The TTL (time-to-live) of the records
   * in the record set.
   ...
   * record set.
   * @property {array} [recordSet.mxRecords] The list of MX records in the
   * record set.
   * @property {array} [recordSet.nsRecords] The list of NS records in the
   * record set.
   ...
   * set.
   * @property {string} [recordSet.cnameRecord.cname] The canonical name for
   * this CNAME record.
   ...
   * SOA record.
   * @property {number} [recordSet.soaRecord.serialNumber] The serial number
   * for this SOA record.
   ...
   * SOA record.
   * @property {number} [recordSet.soaRecord.expireTime] The expire time for
   * this SOA record.
