 ...
 *
 * @param {string} [options.apiVersion] - Specifies the API version.
 *
...
function DnsManagementClient(credentials, subscriptionId, baseUri, options) {
  ...
  DnsManagementClient['super_'].call(this, credentials, options);
...
util.inherits(DnsManagementClient, ServiceClient);
