...
var VirtualNetworkManagementClient = ( /** @lends VirtualNetworkManagementClient */ function() {
   ...
   * @param {Array} filters
   */
  function VirtualNetworkManagementClient(credentials, baseUri, filters) {
    if (credentials === null || credentials === undefined) {
      throw new Error('credentials cannot be null.');
    }
    
    VirtualNetworkManagementClient['super_'].call(this, credentials, filters);
...
var ClientRootCertificateOperations = ( /** @lends ClientRootCertificateOperations */ function() {
  ...
  ClientRootCertificateOperations.prototype.create = function(virtualNetworkName, parameters, callback) {
    ...
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/networking/' + virtualNetworkName.trim() + '/gateway/clientrootcertificates';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  ClientRootCertificateOperations.prototype.delete = function(virtualNetworkName, certificateThumbprint, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/networking/' + virtualNetworkName.trim() + '/gateway/clientrootcertificates/' + certificateThumbprint.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var GatewayOperations = ( /** @lends GatewayOperations */ function() {
  ...
  GatewayOperations.prototype.beginConnectDisconnectOrTesting = function(virtualNetworkName, localNetworkSiteName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/networking/' + virtualNetworkName.trim() + '/gateway/connection/' + localNetworkSiteName.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  GatewayOperations.prototype.beginCreating = function(virtualNetworkName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/networking/' + virtualNetworkName.trim() + '/gateway';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  GatewayOperations.prototype.beginResetSharedKey = function(virtualNetworkName, localNetworkName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/networking/' + virtualNetworkName.trim() + '/gateway/connection/' + localNetworkName.trim() + '/sharedkey';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  GatewayOperations.prototype.generateVpnClientPackage = function(virtualNetworkName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/networking/' + virtualNetworkName.trim() + '/gateway/vpnclientpackage';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  GatewayOperations.prototype.getDeviceConfigurationScript = function(virtualNetworkName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/networking/' + virtualNetworkName.trim() + '/gateway/vpndeviceconfigurationscript?';
    if (parameters.vendor) {
      url2 = url2 + 'vendor=' + encodeURIComponent(parameters.vendor.trim());
    }
    if (parameters.platform) {
      url2 = url2 + '&platform=' + encodeURIComponent(parameters.platform.trim());
    }
    if (parameters.oSFamily) {
      url2 = url2 + '&OSfamily=' + encodeURIComponent(parameters.oSFamily.trim());
    }
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  GatewayOperations.prototype.getOperationStatus = function(operationId, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/networking/operation/' + operationId.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  GatewayOperations.prototype.listConnections = function(virtualNetworkName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/networking/' + virtualNetworkName.trim() + '/gateway/connections';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  GatewayOperations.prototype.listSupportedDevices = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/networking/supporteddevices';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var NetworkOperations = ( /** @lends NetworkOperations */ function() {
  ...
  NetworkOperations.prototype.beginSettingConfiguration = function(parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/networking/media';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  NetworkOperations.prototype.list = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/networking/virtualnetwork';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var ReservedIPOperations = ( /** @lends ReservedIPOperations */ function() {
  ...
  ReservedIPOperations.prototype.beginCreating = function(parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/networking/reservedips';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  ReservedIPOperations.prototype.beginDeleting = function(ipName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/networking/reservedips/' + ipName.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
   ...
   * 
   * @param {NetworkReservedIPCreateParameters} parameters Parameters supplied
   * to create a network reserved IP.
   * 
   * @param {string} [parameters.name] Name of the reserved IP.
   * 
   * @param {string} [parameters.label] The friendly identifier of the site.
...
var StaticIPOperations = ( /** @lends StaticIPOperations */ function() {
  ...
  StaticIPOperations.prototype.check = function(virtualNetworkName, ipAddress, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/networking/' + virtualNetworkName.trim() + '?';
