...
var GatewayOperations = ( /** @lends GatewayOperations */ function() {
  ...
  GatewayOperations.prototype.beginCreating = function(networkName, parameters, callback) {
    ...
    js2xml.setElementValue(gatewaySizeElement, parameters.gatewaySKU ? parameters.gatewaySKU.toString() : 'Default');
  ...
  GatewayOperations.prototype.beginRemoveDefaultSites = function(networkName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/' + networkName.trim() + '/gateway/defaultsites';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  GatewayOperations.prototype.beginUpdateDiagnostics = function(networkName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/' + networkName.trim() + '/gateway/publicdiagnostics';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    if (parameters.captureDurationInSeconds) {
    ...
    if (parameters.customerStorageKey) {
    ...
    if (parameters.customerStorageName) {
    ...
    var operationElement = js2xml.createElement('Operation', 'http://schemas.microsoft.com/windowsazure');
    js2xml.setElementValue(operationElement, parameters.operation ? parameters.operation.toString() : 'StartDiagnostics');
  ...
  GatewayOperations.prototype.getDiagnostics = function(networkName, callback) {
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (gatewayPublicDiagnosticsStatusElement) {
          ...
          if (publicDiagnosticsUrlElement) {
          ...
          for (var loweredIndex1 = 0; loweredIndex1 < js2xml.getElements(responseDoc, virtualNetworkSitesSequenceElement, 'VIRTUALNETWORKSITE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex1 = loweredIndex1 + 1) {
            ...
            if (subnetsSequenceElement) {
              for (var loweredIndex3 = 0; loweredIndex3 < js2xml.getElements(responseDoc, subnetsSequenceElement, 'SUBNET', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex3 = loweredIndex3 + 1) {
                ...
                if (networkSecurityGroupElement) {
...
var NetworkSecurityGroupOperations = ( /** @lends NetworkSecurityGroupOperations */ function() {
  ...
  NetworkSecurityGroupOperations.prototype.beginAddingToSubnet = function(virtualNetworkName, subnetName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/virtualnetwork/' + virtualNetworkName.trim() + '/subnets/' + subnetName.trim() + '/networksecuritygroups';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  NetworkSecurityGroupOperations.prototype.beginCreating = function(parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/networksecuritygroups';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  NetworkSecurityGroupOperations.prototype.beginDeleting = function(networkSecurityGroupName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/networksecuritygroups/' + networkSecurityGroupName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  NetworkSecurityGroupOperations.prototype.beginDeletingRule = function(networkSecurityGroupName, ruleName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/networksecuritygroups/' + networkSecurityGroupName.trim() + '/rules/' + ruleName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  NetworkSecurityGroupOperations.prototype.beginRemovingFromSubnet = function(virtualNetworkName, subnetName, networkSecurityGroupName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/virtualnetwork/' + virtualNetworkName.trim() + '/subnets/' + subnetName.trim() + '/networksecuritygroups/' + networkSecurityGroupName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  NetworkSecurityGroupOperations.prototype.beginSettingRule = function(networkSecurityGroupName, ruleName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/networksecuritygroups/' + (networkSecurityGroupName ? networkSecurityGroupName.trim() : '') + '/rules/' + (ruleName ? ruleName.trim() : '');
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  NetworkSecurityGroupOperations.prototype.get = function(networkSecurityGroupName, detailLevel, callback) {
    ...
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/networksecuritygroups/' + networkSecurityGroupName.trim() + '?';
    if (detailLevel) {
      url2 = url2 + 'detaillevel=' + encodeURIComponent(detailLevel ? detailLevel.trim() : '');
    }
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
        ...
        if (networkSecurityGroupElement) {
          ...
          if (rulesSequenceElement) {
            for (var loweredIndex1 = 0; loweredIndex1 < js2xml.getElements(responseDoc, rulesSequenceElement, 'RULE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex1 = loweredIndex1 + 1) {
              ...
              if (destinationAddressPrefixElement) {
              ...
              if (destinationPortRangeElement) {
  ...
  NetworkSecurityGroupOperations.prototype.list = function(callback) {
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (networkSecurityGroupsSequenceElement) {
...
var RouteOperations = ( /** @lends RouteOperations */ function() {
  ...
  RouteOperations.prototype.beginAddRouteTableToSubnet = function(vnetName, subnetName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/virtualnetwork/' + vnetName.trim() + '/subnets/' + subnetName.trim() + '/routetables';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  RouteOperations.prototype.beginCreateRouteTable = function(parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/routetables';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  RouteOperations.prototype.beginDeleteRoute = function(routeTableName, routeName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/routetables/' + routeTableName.trim() + '/routes/' + routeName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  RouteOperations.prototype.beginDeleteRouteTable = function(routeTableName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/routetables/' + routeTableName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  RouteOperations.prototype.getRouteTableForSubnet = function(vnetName, subnetName, callback) {
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (routeTableAssociationElement) {
