...
var ClientRootCertificateOperations = ( /** @lends ClientRootCertificateOperations */ function() {
  ...
  ClientRootCertificateOperations.prototype.create = function(networkName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/' + networkName.trim() + '/gateway/clientrootcertificates';
  ...
  ClientRootCertificateOperations.prototype.delete = function(networkName, certificateThumbprint, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/' + networkName.trim() + '/gateway/clientrootcertificates/' + certificateThumbprint.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (clientRootCertificatesSequenceElement !== null && clientRootCertificatesSequenceElement !== undefined) {
          for (var loweredIndex1 = 0; loweredIndex1 < js2xml.getElements(responseDoc, clientRootCertificatesSequenceElement, 'CLIENTROOTCERTIFICATE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex1 = loweredIndex1 + 1) {
            ...
            if (expirationTimeElement !== null && expirationTimeElement !== undefined) {
...
var GatewayOperations = ( /** @lends GatewayOperations */ function() {
  ...
  GatewayOperations.prototype.beginConnectDisconnectOrTesting = function(networkName, localNetworkSiteName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/' + networkName.trim() + '/gateway/connection/' + localNetworkSiteName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
   ...
   * 
   * @param {GatewaySKU} parameters.gatewaySKU The SKU of this virtual network
   * gateway.
   * 
  ...
  GatewayOperations.prototype.beginCreating = function(networkName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/' + networkName.trim() + '/gateway';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    js2xml.setElementValue(gatewaySizeElement, parameters.gatewaySKU !== null && parameters.gatewaySKU !== undefined ? parameters.gatewaySKU.toString() : 'Default');
    ...
    js2xml.setElementValue(gatewayTypeElement, parameters.gatewayType !== null && parameters.gatewayType !== undefined ? parameters.gatewayType.toString() : 'StaticRouting');
  ...
  GatewayOperations.prototype.beginGenerateVpnClientPackage = function(networkName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/' + networkName.trim() + '/gateway/vpnclientpackage';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  GatewayOperations.prototype.beginRemoveDefaultSites = function(networkName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/' + networkName.trim() + '/gateway/defaultsites';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  GatewayOperations.prototype.beginResetSharedKey = function(networkName, localNetworkName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/' + networkName.trim() + '/gateway/connection/' + localNetworkName.trim() + '/sharedkey';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
   ...
   * 
   * @param {GatewaySKU} parameters.gatewaySKU
   * 
  ...
  /**
   * The Begin Update Diagnostics operation begins an asynchronous operation to
   ...
   * gateway.
   * 
   * @param {UpdateGatewayPublicDiagnostics} parameters Parameters supplied to
   * the Begin Creating Virtual Network Gateway operation.
   * 
   ...
   * account name
   * 
   * @param {UpdateGatewayPublicDiagnosticsOperation} parameters.operation The
   * update gateway diagnostics operation to perform on the gateway tenant
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.beginUpdateDiagnostics = function(networkName, parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/' + networkName.trim() + '/gateway/publicdiagnostics';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    var operationElement = js2xml.createElement('Operation', 'http://schemas.microsoft.com/windowsazure');
    js2xml.setElementValue(operationElement, parameters.operation !== null && parameters.operation !== undefined ? parameters.operation.toString() : 'StartDiagnostics');
  ...
  GatewayOperations.prototype.getDeviceConfigurationScript = function(networkName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/' + networkName.trim() + '/gateway/vpndeviceconfigurationscript?';
    if (parameters.vendor !== null && parameters.vendor !== undefined) {
      url2 = url2 + 'vendor=' + encodeURIComponent(parameters.vendor !== null && parameters.vendor !== undefined ? parameters.vendor.trim() : '');
    }
    if (parameters.platform !== null && parameters.platform !== undefined) {
      url2 = url2 + '&platform=' + encodeURIComponent(parameters.platform !== null && parameters.platform !== undefined ? parameters.platform.trim() : '');
    }
    if (parameters.oSFamily !== null && parameters.oSFamily !== undefined) {
      url2 = url2 + '&OSfamily=' + encodeURIComponent(parameters.oSFamily !== null && parameters.oSFamily !== undefined ? parameters.oSFamily.trim() : '');
    }
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
  ...
  GatewayOperations.prototype.getOperationStatus = function(operationId, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/operation/' + operationId.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  GatewayOperations.prototype.listConnections = function(networkName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/' + networkName.trim() + '/gateway/connections';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (connectionsSequenceElement !== null && connectionsSequenceElement !== undefined) {
          for (var loweredIndex1 = 0; loweredIndex1 < js2xml.getElements(responseDoc, connectionsSequenceElement, 'CONNECTION', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex1 = loweredIndex1 + 1) {
            ...
            if (connectivityStateElement !== null && connectivityStateElement !== undefined) {
            ...
            if (ingressBytesTransferredElement !== null && ingressBytesTransferredElement !== undefined) {
            ...
            if (egressBytesTransferredElement !== null && egressBytesTransferredElement !== undefined) {
            ...
            if (lastConnectionEstablishedElement !== null && lastConnectionEstablishedElement !== undefined) {
  ...
  GatewayOperations.prototype.listSupportedDevices = function(callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/supporteddevices';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
   ...
   * 
   * @param {UpdateGatewayPublicDiagnostics} parameters Parameters supplied to
   * the Update Diagnostics operation.
   * 
   * @param {string} [parameters.captureDurationInSeconds] The duration of the
   * capture in seconds (between 1 and 300)
   * 
   ...
   * @returns {Stream} The response stream.
   */
  GatewayOperations.prototype.updateDiagnostics = function(networkName, parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    var client2 = this.client;
    
    return client2.gateways.beginUpdateDiagnostics(networkName, parameters, function (err, result) {
      if (err !== null && err !== undefined) {
        return callback(err);
      }
      var delayInSeconds = 30;
...
var NetworkOperations = ( /** @lends NetworkOperations */ function() {
  ...
  NetworkOperations.prototype.beginSettingConfiguration = function(parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/media';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  NetworkOperations.prototype.list = function(callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/virtualnetwork';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
...
var NetworkSecurityGroupOperations = ( /** @lends NetworkSecurityGroupOperations */ function() {
  ...
  NetworkSecurityGroupOperations.prototype.beginAddingToSubnet = function(virtualNetworkName, subnetName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/virtualnetwork/' + virtualNetworkName.trim() + '/subnets/' + subnetName.trim() + '/networksecuritygroups';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  NetworkSecurityGroupOperations.prototype.beginCreating = function(parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/networksecuritygroups';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  NetworkSecurityGroupOperations.prototype.beginDeleting = function(networkSecurityGroupName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/networksecuritygroups/' + networkSecurityGroupName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  NetworkSecurityGroupOperations.prototype.beginDeletingRule = function(networkSecurityGroupName, ruleName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/networksecuritygroups/' + networkSecurityGroupName.trim() + '/rules/' + ruleName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  NetworkSecurityGroupOperations.prototype.beginRemovingFromSubnet = function(virtualNetworkName, subnetName, networkSecurityGroupName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/virtualnetwork/' + virtualNetworkName.trim() + '/subnets/' + subnetName.trim() + '/networksecuritygroups/' + networkSecurityGroupName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  NetworkSecurityGroupOperations.prototype.beginSettingRule = function(networkSecurityGroupName, ruleName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/networksecuritygroups/' + (networkSecurityGroupName !== null && networkSecurityGroupName !== undefined ? networkSecurityGroupName.trim() : '') + '/rules/' + (ruleName !== null && ruleName !== undefined ? ruleName.trim() : '');
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
   ...
   * @returns {Stream} The response stream.
   */
  NetworkSecurityGroupOperations.prototype.delete = function(networkSecurityGroupName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    var client2 = this.client;
  ...
  NetworkSecurityGroupOperations.prototype.get = function(networkSecurityGroupName, detailLevel, callback) {
    ...
    if (detailLevel !== null && detailLevel !== undefined) {
      url2 = url2 + 'detaillevel=' + encodeURIComponent(detailLevel !== null && detailLevel !== undefined ? detailLevel.trim() : '');
    }
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
...
var ReservedIPOperations = ( /** @lends ReservedIPOperations */ function() {
  ...
  ReservedIPOperations.prototype.beginCreating = function(parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/reservedips';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  ReservedIPOperations.prototype.beginDeleting = function(ipName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/reservedips/' + ipName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (reservedIPElement !== null && reservedIPElement !== undefined) {
          ...
          if (inUseElement !== null && inUseElement !== undefined) {
...
var RouteOperations = ( /** @lends RouteOperations */ function() {
  ...
  RouteOperations.prototype.beginAddRouteTableToSubnet = function(vnetName, subnetName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/virtualnetwork/' + vnetName.trim() + '/subnets/' + subnetName.trim() + '/routetables';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  RouteOperations.prototype.beginCreateRouteTable = function(parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/routetables';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  RouteOperations.prototype.beginDeleteRoute = function(routeTableName, routeName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/routetables/' + routeTableName.trim() + '/routes/' + routeName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  RouteOperations.prototype.beginDeleteRouteTable = function(routeTableName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/routetables/' + routeTableName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (routeTableElement !== null && routeTableElement !== undefined) {
          ...
          if (routeTableStateElement !== null && routeTableStateElement !== undefined) {
          ...
          if (routeListSequenceElement !== null && routeListSequenceElement !== undefined) {
            for (var loweredIndex1 = 0; loweredIndex1 < js2xml.getElements(responseDoc, routeListSequenceElement, 'ROUTE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex1 = loweredIndex1 + 1) {
              ...
              if (metricElement !== null && metricElement !== undefined) {
              ...
              if (routeStateElement !== null && routeStateElement !== undefined) {
  ...
  RouteOperations.prototype.getRouteTableWithDetails = function(routeTableName, detailLevel, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/routetables/' + routeTableName.trim() + '?';
    url2 = url2 + 'detailLevel=' + encodeURIComponent(detailLevel.trim());
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
...
var StaticIPOperations = ( /** @lends StaticIPOperations */ function() {
  ...
  StaticIPOperations.prototype.check = function(networkName, ipAddress, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/networking/' + networkName.trim() + '?';
