...
*/
exports.createVirtualNetworkManagementClient = function (credentials, baseUri, filters) {
  return new exports.VirtualNetworkManagementClient.VirtualNetworkManagementClient(credentials, baseUri, filters);
};
