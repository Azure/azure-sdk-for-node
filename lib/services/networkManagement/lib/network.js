...
*/
exports.createNetworkManagementClient = function (credentials, baseUri, filters) {
  return new exports.NetworkManagementClient.NetworkManagementClient(credentials, baseUri, filters);
};
