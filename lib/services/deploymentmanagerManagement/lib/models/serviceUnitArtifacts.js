...
class ServiceUnitArtifacts {
   ...
   * @property {string} [templateUri] The full URI of the ARM template file
   * with the SAS token.
   * @property {string} [parametersUri] The full URI of the ARM parameters file
   * with the SAS token.
   * @property {string} [templateArtifactSourceRelativePath] The path to the
   * ARM template file relative to the artifact source.
