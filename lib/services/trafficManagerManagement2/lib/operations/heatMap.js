 ...
 */
function _get(resourceGroupName, profileName, heatMapType, options, callback) {
  ...
  try {
    ...
    if (heatMapType === null || heatMapType === undefined || typeof heatMapType.valueOf() !== 'string') {
      throw new Error('heatMapType cannot be null or undefined and it must be of type string.');
    }
...
class HeatMap {
   ...
   */
  getWithHttpOperationResponse(resourceGroupName, profileName, heatMapType, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._get(resourceGroupName, profileName, heatMapType, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  get(resourceGroupName, profileName, heatMapType, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._get(resourceGroupName, profileName, heatMapType, options, optionalCallback);
    }
  }
