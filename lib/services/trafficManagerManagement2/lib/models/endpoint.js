...
class Endpoint {
   ...
   * @member {string} [endpointStatus] Gets or sets the status of the
   ...
   * 1000.
   * @member {number} [priority] Gets or sets the priority of this endpoint
   * when using the ‘Priority’ traffic routing method. Possible values are from
   * 1 to 1000, lower values represent higher priority. This is an optional
   ...
   * @member {string} [endpointMonitorStatus] Gets or sets the monitoring
