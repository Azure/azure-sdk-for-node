...
class MonitorConfig {
   ...
   * @property {string} [path] The path relative to the endpoint domain name
   * used to probe for endpoint health.
   * @property {number} [intervalInSeconds] The monitor interval for endpoints
   * in this profile. This is the interval at which Traffic Manager will check
   * the health of each endpoint in this profile.
        ...
        modelProperties: {
          ...
          customHeaders: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'MonitorConfigCustomHeadersItemElementType',
                  type: {
                    name: 'Composite',
          ...
          expectedStatusCodeRanges: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'MonitorConfigExpectedStatusCodeRangesItemElementType',
                  type: {
                    name: 'Composite',
