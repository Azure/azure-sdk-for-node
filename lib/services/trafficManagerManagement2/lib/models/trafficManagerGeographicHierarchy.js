 ...
 * 
 */
function TrafficManagerGeographicHierarchy() {
  TrafficManagerGeographicHierarchy['super_'].call(this);
}

util.inherits(TrafficManagerGeographicHierarchy, models['Resource']);
 ...
 *
 */
TrafficManagerGeographicHierarchy.prototype.mapper = function () {
  return {
    required: false,
