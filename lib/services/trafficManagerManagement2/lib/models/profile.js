...
class Profile extends models['TrackedResource'] {
   ...
   * @property {string} [trafficRoutingMethod] The traffic routing method of
   * the Traffic Manager profile. Possible values include: 'Performance',
   ...
   * @property {number} [monitorConfig.timeoutInSeconds] The monitor timeout
   * for endpoints in this profile. This is the time that Traffic Manager
   ...
   * @property {array} [monitorConfig.expectedStatusCodeRanges] List of
