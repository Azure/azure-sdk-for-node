 ...
 *
 */
function TrafficManagerManagementClient(credentials, subscriptionId, baseUri, options) {
  ...
  TrafficManagerManagementClient['super_'].call(this, credentials, options);
...
util.inherits(TrafficManagerManagementClient, ServiceClient);
