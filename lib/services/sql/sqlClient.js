...
var DatabaseOperations = (function() {
   ...
   * @param {Function} callback
   *
   * @returns {DatabaseCreateResponse} - A standard storage response including
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (serviceResourceElement2) {
          ...
          if (isFederationRootElement) {
            var isFederationRootInstance = isFederationRootElement;
          ...
          if (isSystemObjectElement) {
            var isSystemObjectInstance = isSystemObjectElement;
   ...
   * @param {Function} callback
   *
   * @returns {DatabaseGetResponse} - A standard storage response including an
   * HTTP status code and request ID.
   */
   ...
   * @param {Function} callback
   *
   * @returns {DatabaseUpdateResponse} - A standard storage response including
   * an HTTP status code and request ID.
   */
...
var FirewallRuleOperations = (function() {
   ...
   * @param {Function} callback
   *
   * @returns {FirewallRuleCreateResponse} - A standard storage response
   ...
   * @param {Function} callback
   *
   * @returns {FirewallRuleListResponse} - A standard storage response
   * including an HTTP status code and request ID.
   */
   ...
   * @param {Function} callback
   *
   * @returns {FirewallRuleUpdateResponse} - A standard storage response
   * including an HTTP status code and request ID.
   */
