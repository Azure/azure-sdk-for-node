...
/**
 * CustomImageSearchClientOptions for CustomImageSearchClient.
 */
declare interface CustomImageSearchClientOptions extends ServiceClientOptions {
  /**
...
export default class CustomImageSearchClient extends ServiceClient {
  /**
   * @class
   ...
   *
   */
  constructor(credentials: ServiceClientCredentials, options?: CustomImageSearchClientOptions);
...
export { CustomImageSearchClient, models as CustomImageSearchModels };
