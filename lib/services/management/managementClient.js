...
var ManagementClient = (function() {
  ...
  function ManagementClient(credentials, baseUri) {
    ...
    ManagementClient['super_'].call(this);
  }
...
var AffinityGroupOperations = (function() {
  ...
  AffinityGroupOperations.prototype.get = function(affinityGroupName, callback) {
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      // Create Result
      var result = { hostedServices: [], storageServices: [], capabilities: [] };
      result.statusCode = statusCode;
      result.requestId = response.headers['x-ms-request-id'];
...
var SubscriptionOperations = (function() {
  ...
  SubscriptionOperations.prototype.listOperations = function(parameters, callback) {
    ...
    url2 = url2 + '&StartTime=' + encodeURIComponent(iso8061date.format(parameters.startTime));
    url2 = url2 + '&EndTime=' + encodeURIComponent(iso8061date.format(parameters.endTime));
