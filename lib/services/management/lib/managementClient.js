...
var AffinityGroupOperations = ( /** @lends AffinityGroupOperations */ function() {
  ...
  AffinityGroupOperations.prototype.create = function(parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/affinitygroups';
  ...
  AffinityGroupOperations.prototype.delete = function(affinityGroupName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/affinitygroups/' + affinityGroupName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (affinityGroupElement !== null && affinityGroupElement !== undefined) {
          ...
          if (createdTimeElement !== null && createdTimeElement !== undefined && (createdTimeElement === null || createdTimeElement === undefined || createdTimeElement.length === 0) === false) {
...
var LocationOperations = ( /** @lends LocationOperations */ function() {
  ...
  LocationOperations.prototype.list = function(callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/locations';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
          ...
          for (var loweredIndex1 = 0; loweredIndex1 < js2xml.getElements(responseDoc, locationsSequenceElement, 'LOCATION', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex1 = loweredIndex1 + 1) {
            ...
            if (storageCapabilitiesElement !== null && storageCapabilitiesElement !== undefined) {
              ...
              if (storageAccountTypesSequenceElement !== null && storageAccountTypesSequenceElement !== undefined) {
                ...
                for (var loweredIndex3 = 0; loweredIndex3 < js2xml.getElements(responseDoc, storageAccountTypesSequenceElement, 'STORAGEACCOUNTTYPE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex3 = loweredIndex3 + 1) {
                  var storageAccountTypesElement = js2xml.getElements(responseDoc, storageAccountTypesSequenceElement, 'STORAGEACCOUNTTYPE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE')[loweredIndex3];
                  storageCapabilitiesInstance.storageAccountTypes.push(storageAccountTypesElement);
                }
              }
            }
...
var ManagementCertificateOperations = ( /** @lends ManagementCertificateOperations */ function() {
  ...
  ManagementCertificateOperations.prototype.create = function(parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/certificates';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    if (parameters.publicKey !== null && parameters.publicKey !== undefined) {
  ...
  ManagementCertificateOperations.prototype.delete = function(thumbprint, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/certificates/' + thumbprint.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  ManagementCertificateOperations.prototype.get = function(thumbprint, callback) {
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (subscriptionCertificateElement !== null && subscriptionCertificateElement !== undefined) {
          ...
          if (subscriptionCertificatePublicKeyElement !== null && subscriptionCertificatePublicKeyElement !== undefined) {
          ...
          if (subscriptionCertificateThumbprintElement !== null && subscriptionCertificateThumbprintElement !== undefined) {
          ...
          if (subscriptionCertificateDataElement !== null && subscriptionCertificateDataElement !== undefined) {
          ...
          if (createdElement !== null && createdElement !== undefined) {
  ...
  ManagementCertificateOperations.prototype.list = function(callback) {
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (subscriptionCertificatesSequenceElement !== null && subscriptionCertificatesSequenceElement !== undefined) {
...
var RoleSizeOperations = ( /** @lends RoleSizeOperations */ function() {
  ...
  RoleSizeOperations.prototype.list = function(callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/rolesizes';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (roleSizesSequenceElement !== null && roleSizesSequenceElement !== undefined) {
          for (var loweredIndex1 = 0; loweredIndex1 < js2xml.getElements(responseDoc, roleSizesSequenceElement, 'ROLESIZE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex1 = loweredIndex1 + 1) {
            ...
            if (coresElement !== null && coresElement !== undefined) {
            ...
            if (memoryInMbElement !== null && memoryInMbElement !== undefined) {
            ...
            if (supportedByWebWorkerRolesElement !== null && supportedByWebWorkerRolesElement !== undefined) {
            ...
            if (supportedByVirtualMachinesElement !== null && supportedByVirtualMachinesElement !== undefined) {
            ...
            if (maxDataDiskCountElement !== null && maxDataDiskCountElement !== undefined) {
            ...
            if (webWorkerResourceDiskSizeInMbElement !== null && webWorkerResourceDiskSizeInMbElement !== undefined) {
            ...
            if (virtualMachineResourceDiskSizeInMbElement !== null && virtualMachineResourceDiskSizeInMbElement !== undefined) {
...
var SubscriptionOperations = ( /** @lends SubscriptionOperations */ function() {
  ...
  SubscriptionOperations.prototype.get = function(callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '');
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (subscriptionElement !== null && subscriptionElement !== undefined) {
          ...
          if (currentVirtualNetworkSitesElement !== null && currentVirtualNetworkSitesElement !== undefined) {
          ...
          if (currentLocalNetworkSitesElement !== null && currentLocalNetworkSitesElement !== undefined) {
          ...
          if (currentDnsServersElement !== null && currentDnsServersElement !== undefined) {
  ...
  SubscriptionOperations.prototype.listOperations = function(parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/operations?';
    ...
    if (parameters.objectIdFilter !== null && parameters.objectIdFilter !== undefined) {
      url2 = url2 + '&ObjectIdFilter=' + encodeURIComponent(parameters.objectIdFilter !== null && parameters.objectIdFilter !== undefined ? parameters.objectIdFilter.trim() : '');
    }
    if (parameters.operationStatus !== null && parameters.operationStatus !== undefined) {
      url2 = url2 + '&OperationResultFilter=' + encodeURIComponent(parameters.operationStatus !== null && parameters.operationStatus !== undefined ? parameters.operationStatus.toString() : 'InProgress');
    }
    if (parameters.continuationToken !== null && parameters.continuationToken !== undefined) {
      url2 = url2 + '&ContinuationToken=' + encodeURIComponent(parameters.continuationToken !== null && parameters.continuationToken !== undefined ? parameters.continuationToken.trim() : '');
    }
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (subscriptionOperationCollectionElement !== null && subscriptionOperationCollectionElement !== undefined) {
          ...
          if (subscriptionOperationsSequenceElement !== null && subscriptionOperationsSequenceElement !== undefined) {
            for (var loweredIndex1 = 0; loweredIndex1 < js2xml.getElements(responseDoc, subscriptionOperationsSequenceElement, 'SUBSCRIPTIONOPERATION', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex1 = loweredIndex1 + 1) {
              ...
              if (operationObjectIdElement !== null && operationObjectIdElement !== undefined) {
              ...
              if (operationNameElement !== null && operationNameElement !== undefined) {
              ...
              if (operationParametersSequenceElement !== null && operationParametersSequenceElement !== undefined) {
              ...
              if (operationCallerElement !== null && operationCallerElement !== undefined) {
                ...
                if (usedServiceManagementApiElement !== null && usedServiceManagementApiElement !== undefined) {
                ...
                if (userEmailAddressElement !== null && userEmailAddressElement !== undefined) {
                ...
                if (clientIPElement !== null && clientIPElement !== undefined) {
              ...
              if (operationStartedTimeElement !== null && operationStartedTimeElement !== undefined) {
              ...
              if (operationCompletedTimeElement !== null && operationCompletedTimeElement !== undefined) {
  ...
  SubscriptionOperations.prototype.registerResource = function(resourceName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services?';
