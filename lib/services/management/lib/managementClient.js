...
var RoleSizeOperations = ( /** @lends RoleSizeOperations */ function() {
  ...
  RoleSizeOperations.prototype.list = function(callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + '/' + this.client.credentials.subscriptionId + '/rolesizes';
...
var SubscriptionOperations = ( /** @lends SubscriptionOperations */ function() {
  ...
  SubscriptionOperations.prototype.registerResource = function(resourceName, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + '/' + this.client.credentials.subscriptionId + '/services?&action=register';
  ...
  SubscriptionOperations.prototype.unregisterResource = function(resourceName, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + '/' + this.client.credentials.subscriptionId + '/services?&action=unregister';
    url2 = url2 + 'service=' + encodeURIComponent(resourceName);
