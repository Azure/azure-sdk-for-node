...
var AffinityGroupOperations = ( /** @lends AffinityGroupOperations */ function() {
   ...
   * 
   * @param {string} parameters.name Required. A name for the affinity group
   * that is unique to the subscription.
   * 
   * @param {string} parameters.label Required. A base-64 encoded name for the
   * affinity group. The name can be up to 100 characters in length.  Its
   * value defaults to the Name of the affinity group if not provided.
   * 
   * @param {string} [parameters.description] Optional. A description for the
   * affinity group. The description can be up to 1024 characters in length.
   * 
   * @param {string} parameters.location Required. The data center location
   * where the affinity group will be created. To list available locations,
   * see the List Locations operation.
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
  ...
  AffinityGroupOperations.prototype.create = function(parameters, callback) {
    ...
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/affinitygroups';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  AffinityGroupOperations.prototype.delete = function(affinityGroupName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/affinitygroups/' + affinityGroupName.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
   ...
   * 
   * @param {string} parameters.label Required. A name for the affinity
   * specified as a base-64 encoded string. The label can be up to 100
...
var LocationOperations = ( /** @lends LocationOperations */ function() {
  ...
  LocationOperations.prototype.list = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/locations';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var ManagementCertificateOperations = ( /** @lends ManagementCertificateOperations */ function() {
  ...
  ManagementCertificateOperations.prototype.create = function(parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/certificates';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  ManagementCertificateOperations.prototype.delete = function(thumbprint, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/certificates/' + thumbprint.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var RoleSizeOperations = ( /** @lends RoleSizeOperations */ function() {
  ...
  RoleSizeOperations.prototype.list = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/rolesizes';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var SubscriptionOperations = ( /** @lends SubscriptionOperations */ function() {
  ...
  SubscriptionOperations.prototype.get = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
   ...
   * 
   * @param {date} parameters.startTime Required. The start of the timeframe to
   * begin listingsubscription operations in UTC format. This parameter and
   ...
   * days in the past.
   * 
   * @param {date} parameters.endTime Required. The end of the timeframe to
   * begin listing subscription operations in UTC format. This parameter and
   * the StartTime parameter indicate the timeframe to retrieve subscription
   * operations.
   * 
   * @param {string} [parameters.objectIdFilter] Optional. Returns subscription
   ...
   * 
   * @param {OperationStatus} [parameters.operationStatus] Optional. Returns
   * subscription operations only for thespecified result status, either
   * Succeeded, Failed, or InProgress.This filter can be combined with the
   * ObjectIdFilter to selectsubscription operations for an object with a
   * specific resultstatus. If no result status is specified, a filter is not
   * applied.
   * 
   * @param {string} [parameters.continuationToken] Optional. When there are
   * too many operations to list, such as when the requested timeframe is very
   * large, the response includes an incomplete list and a token that can be
   * used to return the rest of the list. Subsequent requests must include
   * this parameter to continue listing operations from where the last
   * response left off. If no token is specified, a filter is not applied and
   * the response will begin at the specified StartTime.
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
  ...
  SubscriptionOperations.prototype.listOperations = function(parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/operations?';
    ...
    if (parameters.objectIdFilter) {
      url2 = url2 + '&ObjectIdFilter=' + encodeURIComponent(parameters.objectIdFilter.trim());
    }
    ...
    if (parameters.continuationToken) {
      url2 = url2 + '&ContinuationToken=' + encodeURIComponent(parameters.continuationToken.trim());
    }
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  SubscriptionOperations.prototype.registerResource = function(resourceName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services?';
