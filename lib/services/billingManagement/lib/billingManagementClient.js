 ...
 */
function _transactionsByBillingProfile(billingAccountId, billingProfileId, startDate, endDate, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}/transactions';
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _updateAutoRenewForBillingAccount(billingAccountId, productName, options, callback) {
   /* jshint validthis: true */
  let client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Construct URL
  let baseUrl = this.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/products/{productName}/updateAutoRenew';
  requestUrl = requestUrl.replace('{billingAccountId}', encodeURIComponent(billingAccountId));
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _updateAutoRenewForInvoiceSection(billingAccountId, invoiceSectionId, productName, options, callback) {
   /* jshint validthis: true */
  let client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Construct URL
  let baseUrl = this.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/invoiceSections/{invoiceSectionId}/products/{productName}/updateAutoRenew';
  requestUrl = requestUrl.replace('{billingAccountId}', encodeURIComponent(billingAccountId));
...
class BillingManagementClient extends ServiceClient {
   ...
   */
  transactionsByBillingProfileWithHttpOperationResponse(billingAccountId, billingProfileId, startDate, endDate, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._transactionsByBillingProfile(billingAccountId, billingProfileId, startDate, endDate, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  transactionsByBillingProfile(billingAccountId, billingProfileId, startDate, endDate, options, optionalCallback) {
    let client = this;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._transactionsByBillingProfile(billingAccountId, billingProfileId, startDate, endDate, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  updateAutoRenewForBillingAccountWithHttpOperationResponse(billingAccountId, productName, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._updateAutoRenewForBillingAccount(billingAccountId, productName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  updateAutoRenewForBillingAccount(billingAccountId, productName, options, optionalCallback) {
    let client = this;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._updateAutoRenewForBillingAccount(billingAccountId, productName, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  updateAutoRenewForInvoiceSectionWithHttpOperationResponse(billingAccountId, invoiceSectionId, productName, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._updateAutoRenewForInvoiceSection(billingAccountId, invoiceSectionId, productName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  updateAutoRenewForInvoiceSection(billingAccountId, invoiceSectionId, productName, options, optionalCallback) {
    let client = this;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._updateAutoRenewForInvoiceSection(billingAccountId, invoiceSectionId, productName, options, optionalCallback);
    }
  }
