...
function _list(options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.Billing/listBillingAccountsWithCreateInvoiceSectionPermission';
  let queryParameters = [];
...
class BillingAccountsWithCreateInvoiceSectionPermission {
  /**
...
module.exports = BillingAccountsWithCreateInvoiceSectionPermission;
