...
function _list(billingAccountId, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/enrollmentAccounts';
...
class EnrollmentAccountsByBillingAccountId {
  /**
...
module.exports = EnrollmentAccountsByBillingAccountId;
