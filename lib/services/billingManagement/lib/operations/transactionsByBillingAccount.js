 ...
 */
function _list(billingAccountName, startDate, endDate, options, callback) {
...
class TransactionsByBillingAccount {
  /**
   ...
   */
  listWithHttpOperationResponse(billingAccountName, startDate, endDate, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._list(billingAccountName, startDate, endDate, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  list(billingAccountName, startDate, endDate, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._list(billingAccountName, startDate, endDate, options, optionalCallback);
    }
  }
...
module.exports = TransactionsByBillingAccount;
