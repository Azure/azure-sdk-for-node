...
function _list(billingAccountId, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/departments';
...
class DepartmentsByBillingAccountId {
  /**
...
module.exports = DepartmentsByBillingAccountId;
