...
function _list(billingAccountId, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/listInvoiceSectionsWithCreateSubscriptionPermission';
...
class InvoiceSectionsWithCreateSubscriptionPermission {
  /**
...
module.exports = InvoiceSectionsWithCreateSubscriptionPermission;
