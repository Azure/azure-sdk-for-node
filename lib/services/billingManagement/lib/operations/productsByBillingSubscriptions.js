...
function _list(billingAccountId, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingSubscriptions';
...
class ProductsByBillingSubscriptions {
  /**
...
module.exports = ProductsByBillingSubscriptions;
