...
/**
* Creates a new NotificationHubsServiceClient object.
*
* @constructor
...
*/
function NotificationHubsServiceClient(accessKey, issuer, sharedAccessKeyName, sharedAccessKeyValue, host, acsHost, authenticationProvider) {
    NotificationHubsServiceClient['super_'].call(this, host, authenticationProvider);
...
util.inherits(NotificationHubsServiceClient, ServiceClient);
...
*/
NotificationHubsServiceClient.prototype._buildRequestOptions = function (webResource, body, options, callback) {
  ...
  NotificationHubsServiceClient['super_'].prototype._buildRequestOptions.call(this, webResource, body, options, callback);
};

module.exports = NotificationHubsServiceClient;