...
try {
    ...
    const firstLine = `Active development of this SDK has been moved to ${highlightColor}@azure/cognitiveservices-customvision-prediction${resetColor}${brightColor} package.`;
