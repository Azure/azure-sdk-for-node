...
var ItemOperations = ( /** @lends ItemOperations */ function() {
  ...
  ItemOperations.prototype.get = function(itemIdentity, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + '/Microsoft.Gallery/galleryitems/' + itemIdentity;
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (responseDoc) {
        ...
        if (definitionTemplatesValue) {
          ...
          var csmTemplateFileUrlsSequenceElement = definitionTemplatesValue['csmTemplateFileUrls'];
          if (csmTemplateFileUrlsSequenceElement) {
            for (var loweredIndex1 = 0; loweredIndex1 < csmTemplateFileUrlsSequenceElement.length; loweredIndex1 = loweredIndex1 + 1) {
              var property = csmTemplateFileUrlsSequenceElement[loweredIndex1];
              var csmTemplateFileUrlsKey = property;
              var csmTemplateFileUrlsValue = csmTemplateFileUrlsSequenceElement[property];
              definitionTemplatesInstance.deploymentTemplateFileUrls[csmTemplateFileUrlsKey] = csmTemplateFileUrlsValue;
            }
          }
        }
        ...
        if (iconFileUrlsSequenceElement) {
          for (var loweredIndex4 = 0; loweredIndex4 < iconFileUrlsSequenceElement.length; loweredIndex4 = loweredIndex4 + 1) {
            var property2 = iconFileUrlsSequenceElement[loweredIndex4];
   ...
   * 
   * @param {string} [parametersOrCallback.publisher] Gets or sets publisher to
   * filter by. Optional.
   * 
  ...
  ItemOperations.prototype.list = function(parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + '/Microsoft.Gallery/galleryitems?';
    if (parameters && parameters.publisher) {
      url2 = url2 + '$filter=Publisher eq %27' + encodeURIComponent(parameters.publisher) + '%27';
    }
        ...
        if (itemsArray) {
          for (var loweredIndex1 = 0; loweredIndex1 < itemsArray.length; loweredIndex1 = loweredIndex1 + 1) {
            ...
            if (definitionTemplatesValue) {
              ...
              var csmTemplateFileUrlsSequenceElement = definitionTemplatesValue['csmTemplateFileUrls'];
              if (csmTemplateFileUrlsSequenceElement) {
                for (var loweredIndex2 = 0; loweredIndex2 < csmTemplateFileUrlsSequenceElement.length; loweredIndex2 = loweredIndex2 + 1) {
                  var property = csmTemplateFileUrlsSequenceElement[loweredIndex2];
                  var csmTemplateFileUrlsKey = property;
                  var csmTemplateFileUrlsValue = csmTemplateFileUrlsSequenceElement[property];
                  definitionTemplatesInstance.deploymentTemplateFileUrls[csmTemplateFileUrlsKey] = csmTemplateFileUrlsValue;
                }
            ...
            if (screenshotUrlsArray) {
              for (var loweredIndex4 = 0; loweredIndex4 < screenshotUrlsArray.length; loweredIndex4 = loweredIndex4 + 1) {
                var screenshotUrlsValue = screenshotUrlsArray[loweredIndex4];
            ...
            if (iconFileUrlsSequenceElement) {
              for (var loweredIndex5 = 0; loweredIndex5 < iconFileUrlsSequenceElement.length; loweredIndex5 = loweredIndex5 + 1) {
                var property2 = iconFileUrlsSequenceElement[loweredIndex5];
                var iconFileUrlsKey = property2;
                var iconFileUrlsValue = iconFileUrlsSequenceElement[property2];
