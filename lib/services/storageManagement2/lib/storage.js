...
*/
exports.createStorageManagementClient = function (credentials, baseUri, filters) {
  return new exports.StorageManagementClient.StorageManagementClient(credentials, baseUri, filters);
};