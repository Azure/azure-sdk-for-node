...
StorageAccounts.prototype.checkNameAvailability = function (name, options, callback) {
  ...
  var type = (options && options.type !== undefined) ? options.type : 'Microsoft.Storage/storageAccounts';
  // Validate
  try {
  ...
  {
      accountName = new client._models['StorageAccountCheckNameAvailabilityParameters']();
