...
StorageAccounts.prototype.create = function (resourceGroupName, accountName, parameters, options, callback) {
  ...
  function getMethod() {
    var cb = function (callback) {
      return self.getProperties(resourceGroupName, accountName, options, callback);
    };
    return cb;
  }
  // Send request
  self.beginCreate(resourceGroupName, accountName, parameters, options, function (err, result){
 ...
 *
 * @param {String} [parameters.properties.customDomain.name] Gets or sets the custom domain name. Name is the CNAME source.
 *
