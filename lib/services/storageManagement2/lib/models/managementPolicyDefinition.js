...
class ManagementPolicyDefinition {
   ...
   * to be match.
   * @property {array} [filters.suffixMatch] An array of strings for suffixes
   * to be match.
   * @property {number} [filters.sizeInByteGreaterThan] A whole number
   * specifying the minimal blob size for this rule.
   * @property {number} [filters.sizeInByteLessThan] A whole number specifying
   * the maximum blob size for this rule.
