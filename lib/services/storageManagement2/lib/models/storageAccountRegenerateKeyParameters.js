...
StorageAccountRegenerateKeyParameters.prototype.serialize = function () {
  var payload = {};
  if (this['keyName'] === null || this['keyName'] === undefined || typeof this['keyName'].valueOf() !== 'string') {
    throw new Error('this[\'keyName\'] cannot be null or undefined and it must be of type string.');
  }
