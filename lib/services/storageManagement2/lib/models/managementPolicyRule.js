...
class ManagementPolicyRule {
   ...
   * a policy.
   * @property {string} type The valid value is Lifecycle
   ...
   * @property {array} [definition.filters.suffixMatch] An array of strings for
   * suffixes to be match.
   * @property {number} [definition.filters.sizeInByteGreaterThan] A whole
   * number specifying the minimal blob size for this rule.
   * @property {number} [definition.filters.sizeInByteLessThan] A whole number
   * specifying the maximum blob size for this rule.
