...
export interface ManagementPolicyFilter {
  ...
  */
  prefixMatch?: string[];
  /**
   * An array of strings for suffixes to be match.
  */
  suffixMatch?: string[];
  /**
   * A whole number specifying the minimal blob size for this rule.
  */
  sizeInByteGreaterThan?: number;
  /**
   * A whole number specifying the maximum blob size for this rule.
  */
  sizeInByteLessThan?: number;
  /**
