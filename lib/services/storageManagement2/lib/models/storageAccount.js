 ...
 *
 */
StorageAccount.prototype.validate = function (payload) {
  if (!payload) {
    throw new Error('StorageAccount cannot be null.');
  }
  ...
  if (payload['properties']) {
    models['StorageAccountProperties'].validate(payload['properties']);
  }
};
...
StorageAccount.prototype.deserialize = function (instance) {
  if (instance) {
    if (instance.properties !== null && instance.properties !== undefined) {
      instance.properties = models['StorageAccountProperties'].deserialize(instance.properties);
    }
  }
  return instance;
};

module.exports = new StorageAccount();
