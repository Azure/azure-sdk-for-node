...
class CertificateImportParameters {
   ...
   * @property {string} base64EncodedCertificate Base64 encoded representation
   * of the certificate object to import. This certificate needs to contain the
   * private key.
   * @property {string} [password] If the private key in
   ...
   * @property {string} [certificatePolicy.issuerParameters.validationMethod]
   ...
   * 'http-token'
   * @property {array} [certificatePolicy.issuerParameters.validationEmails] A
   * list of email addresses where validation emails should be sent for
   * specific DNS names.
