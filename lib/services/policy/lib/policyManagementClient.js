...
var PolicyManagementClient = ( /** @lends PolicyManagementClient */ function() {
   ...
   * @constructor
   * 
   * @param {string} tenantID Gets the tenant Id.
   * 
   ...
   * @param {Array} filters
   */
  function PolicyManagementClient(tenantID, credentials, baseUri, filters) {
...
var RoleAssignmentOperations = ( /** @lends RoleAssignmentOperations */ function() {
  ...
  RoleAssignmentOperations.prototype.createOrUpdate = function(parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + this.client.tenantID.trim() + '/roleAssignments';
  ...
  RoleAssignmentOperations.prototype.delete = function(roleAssignmentId, callback) {
    ...
    // Construct URL
    var url2 = '/' + this.client.tenantID.trim() + '/roleAssignments(guid\'' + roleAssignmentId.trim() + '\')';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  RoleAssignmentOperations.prototype.listRoleAssignmentsAtScopeAndAbove = function(parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + this.client.tenantID.trim() + '/roleAssignments/listRoleAssignmentsAtScopeAndAbove';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
...
var RoleDefinitionOperations = ( /** @lends RoleDefinitionOperations */ function() {
  ...
  RoleDefinitionOperations.prototype.get = function(roleId, callback) {
    ...
    // Construct URL
    var url2 = '/' + this.client.tenantID.trim() + '/roleDefinitions(guid\'' + roleId.trim() + '\')';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  RoleDefinitionOperations.prototype.list = function(roleDefinitionName, callback) {
    ...
    // Construct URL
    var url2 = '/' + this.client.tenantID.trim() + '/roleDefinitions()?';
    var appendFilter = true;
