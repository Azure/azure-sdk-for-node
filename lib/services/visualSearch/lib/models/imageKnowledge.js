...
/**
 * Class representing a ImageKnowledge.
 * @extends models['Response']
 */
class ImageKnowledge extends models['Response'] {
  /**
   * Create a ImageKnowledge.
  ...
  /**
   * Defines the metadata of ImageKnowledge
   *
   * @returns {object} metadata of ImageKnowledge
   *
   */
  mapper() {
    return {
