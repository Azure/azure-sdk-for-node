...
/**
 * Class representing a ImageRecipesAction.
 * @extends models['ImageAction']
 */
class ImageRecipesAction extends models['ImageAction'] {
  /**
   * Create a ImageRecipesAction.
  ...
  /**
   * Defines the metadata of ImageRecipesAction
   *
   * @returns {object} metadata of ImageRecipesAction
   *
   */
  mapper() {
    return {
...
module.exports = ImageRecipesAction;
