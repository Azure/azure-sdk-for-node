...
/**
 * Class representing a ImageModuleAction.
 * @extends models['ImageAction']
 */
class ImageModuleAction extends models['ImageAction'] {
  /**
   * Create a ImageModuleAction.
  ...
  /**
   * Defines the metadata of ImageModuleAction
   *
   * @returns {object} metadata of ImageModuleAction
   *
   */
  mapper() {
    return {
...
module.exports = ImageModuleAction;
