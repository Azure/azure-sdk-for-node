...
/** Class representing a VisualSearchClient. */
class VisualSearchClient extends ServiceClient {
  /**
   * Create a VisualSearchClient.
...
module.exports = VisualSearchClient;
module.exports['default'] = VisualSearchClient;
module.exports.VisualSearchClient = VisualSearchClient;
module.exports.VisualSearchModels = models;
