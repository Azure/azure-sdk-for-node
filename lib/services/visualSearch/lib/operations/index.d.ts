...
export interface Images {
     ...
     */
    visualSearchWithHttpOperationResponse(options?: { acceptLanguage? : string, contentType? : string, userAgent? : string, clientId? : string, clientIp? : string, location? : string, knowledgeRequest? : string, image? : stream.Readable, customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.ImageKnowledge>>;
     ...
     */
    visualSearch(options?: { acceptLanguage? : string, contentType? : string, userAgent? : string, clientId? : string, clientIp? : string, location? : string, knowledgeRequest? : string, image? : stream.Readable, customHeaders? : { [headerName: string]: string; } }): Promise<models.ImageKnowledge>;
    visualSearch(callback: ServiceCallback<models.ImageKnowledge>): void;
    visualSearch(options: { acceptLanguage? : string, contentType? : string, userAgent? : string, clientId? : string, clientIp? : string, location? : string, knowledgeRequest? : string, image? : stream.Readable, customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.ImageKnowledge>): void;
}
