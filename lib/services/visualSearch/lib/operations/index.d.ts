...
export interface Images {
     ...
     * subject to change.
     *
     * @param {string} [options.safeSearch] Filter the image results in actions
     * with type 'VisualSearch' for adult content. The following are the possible
     ...
     * the safeSearch value and uses Strict. If you use the site: filter in the
     * knowledge request, there is the chance that the response may contain adult
     ...
     * user wants the user interface strings displayed in a different language. A
     ...
     * Content-Disposition header's name parameter must be set to "image". You must
     * specify an image binary if you do not use knowledgeRequest form data to
     ...
     */
    visualSearchWithHttpOperationResponse(options?: { acceptLanguage? : string, contentType? : string, userAgent? : string, clientId? : string, clientIp? : string, location? : string, market? : string, safeSearch? : string, setLang? : string, knowledgeRequest? : string, image? : stream.Readable, customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.ImageKnowledge>>;
     ...
     *
     *                      {ImageKnowledge} [result]   - The deserialized result object if an error did not occur.
     ...
     */
    visualSearch(options?: { acceptLanguage? : string, contentType? : string, userAgent? : string, clientId? : string, clientIp? : string, location? : string, market? : string, safeSearch? : string, setLang? : string, knowledgeRequest? : string, image? : stream.Readable, customHeaders? : { [headerName: string]: string; } }): Promise<models.ImageKnowledge>;
    visualSearch(callback: ServiceCallback<models.ImageKnowledge>): void;
    visualSearch(options: { acceptLanguage? : string, contentType? : string, userAgent? : string, clientId? : string, clientIp? : string, location? : string, market? : string, safeSearch? : string, setLang? : string, knowledgeRequest? : string, image? : stream.Readable, customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.ImageKnowledge>): void;
}
