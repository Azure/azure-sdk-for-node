...
class AvailabilityStatusPropertiesRecentlyResolvedState {
   ...
   * @property {date} [resolvedTime] Timestamp when the availabilityState
   * changes to Available.
   * @property {string} [unavailabilitySummary] Brief description of cause of
   * the resource becoming unavailable.
   */
  constructor() {
  }
