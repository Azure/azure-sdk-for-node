...
class AvailabilityStatusProperties {
   ...
   * @property {string} [availabilityState] Availability status of the
   ...
   * 'Unavailable', 'Unknown'
   * @property {string} [summary] Summary description of the availability
   * status.
   ...
   * checked.
   * @property {object} [recentlyResolvedState] An annotation describing a
   * change in the availabilityState to Available from Unavailable with a
   ...
   * @property {array} [recommendedActions] Lists actions the user can take
