 ...
 */
function _getMachines(resourceGroupName, workspaceName, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/features/serviceMap/summaries/machines';
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['MachinesSummary']().mapper();
 ...
 * Initializes a new instance of the Summaries class.
 * @constructor
 *
...
class Summaries {
  constructor(client) {
    this.client = client;
    this._getMachines = _getMachines;
  }
   ...
   */
  getMachinesWithHttpOperationResponse(resourceGroupName, workspaceName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getMachines(resourceGroupName, workspaceName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getMachines(resourceGroupName, workspaceName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._getMachines(resourceGroupName, workspaceName, options, optionalCallback);
    }
  }
