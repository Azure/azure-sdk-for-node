...
class MapsAccountUpdateParameters {
  /**
   * Create a MapsAccountUpdateParameters.
  ...
  /**
   * Defines the metadata of MapsAccountUpdateParameters
   *
   * @returns {object} metadata of MapsAccountUpdateParameters
   *
   */
  mapper() {
    return {
...
module.exports = MapsAccountUpdateParameters;
