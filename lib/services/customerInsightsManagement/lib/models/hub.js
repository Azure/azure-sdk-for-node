...
class Hub extends models['Resource'] {
   ...
   * @property {number} [tenantFeatures] The bit flags for enabled hub
   * features. Bit 0 is set to 1 indicates graph is enabled, or disabled if set
   * to 0. Bit 1 is set to 1 indicates the hub is disabled, or enabled if set
   * to 0.
   ...
   * @property {number} [hubBillingInfo.maxUnits] The maximum number of units
   * can be used.  One unit is 10,000 Profiles and 100,000 Interactions.
   */
  constructor() {
    super();
  }
