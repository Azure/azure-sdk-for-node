...
class StringBeginsWithAdvancedFilter extends models['AdvancedFilter'] {
  ...
  /**
   * Defines the metadata of StringBeginsWithAdvancedFilter
   *
   * @returns {object} metadata of StringBeginsWithAdvancedFilter
   *
   */
  mapper() {
    return {
...
module.exports = StringBeginsWithAdvancedFilter;
