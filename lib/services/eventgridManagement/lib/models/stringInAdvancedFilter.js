...
class StringInAdvancedFilter extends models['AdvancedFilter'] {
  /**
   * Create a StringInAdvancedFilter.
  ...
  /**
   * Defines the metadata of StringInAdvancedFilter
   *
   * @returns {object} metadata of StringInAdvancedFilter
   *
   */
  mapper() {
    return {
...
module.exports = StringInAdvancedFilter;
