...
class StringEndsWithAdvancedFilter extends models['AdvancedFilter'] {
  /**
   * Create a StringEndsWithAdvancedFilter.
  ...
  /**
   * Defines the metadata of StringEndsWithAdvancedFilter
   *
   * @returns {object} metadata of StringEndsWithAdvancedFilter
   *
   */
  mapper() {
    return {
...
module.exports = StringEndsWithAdvancedFilter;
