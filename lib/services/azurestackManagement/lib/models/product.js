...
class Product extends models['Resource'] {
   ...
   * Extension.
   * @property {string} [galleryItemIdentity] The identifier of the gallery
   * item corresponding to the product.
   ...
   * @property {string} [productKind] The kind of the product (virtualMachine
   * or virtualMachineExtension)
