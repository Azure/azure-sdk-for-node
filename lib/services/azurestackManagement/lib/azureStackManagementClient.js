...
/** Class representing a AzureStackManagementClient. */
class AzureStackManagementClient extends ServiceClient {
  /**
   * Create a AzureStackManagementClient.
...
module.exports = AzureStackManagementClient;
module.exports['default'] = AzureStackManagementClient;
module.exports.AzureStackManagementClient = AzureStackManagementClient;
module.exports.AzureStackManagementModels = models;
