 ...
 */
function _checkNameAvailability(resourceGroupName, parameters, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EngagementFabric/checkNameAvailability';
...
/** Class representing a EngagementFabric. */
class EngagementFabric extends ServiceClient {
  /**
   * Create a EngagementFabric.
   ...
   */
  checkNameAvailabilityWithHttpOperationResponse(resourceGroupName, parameters, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._checkNameAvailability(resourceGroupName, parameters, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  checkNameAvailability(resourceGroupName, parameters, options, optionalCallback) {
    let client = this;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._checkNameAvailability(resourceGroupName, parameters, options, optionalCallback);
    }
  }

}

module.exports = EngagementFabric;
module.exports['default'] = EngagementFabric;
module.exports.EngagementFabric = EngagementFabric;
module.exports.EngagementFabricModels = models;
