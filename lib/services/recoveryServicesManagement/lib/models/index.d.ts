 ...
 * @property {string} [properties.authType] Specifies the authentication type.
 ...
 * @property {buffer} [properties.certificate] The base64 encoded certificate
 * raw data string.
 * @property {string} [properties.friendlyName] Certificate friendlyname.
 ...
 *
 * @property {object} [monitoringSummary] Summary of the replication monitoring
 * data for this vault.
 ...
 * warnings.
 * @property {number} [monitoringSummary.deprecatedProviderCount] Count of all
 ...
 * @property {number} [monitoringSummary.unsupportedProviderCount] Count of all
 ...
 * @property {number} [recoveryPlanCount] Number of replication recovery plans
 * for this vault.
 * @property {number} [registeredServersCount] Number of servers registered to
 * this vault.
 ...
 * @property {string} [blobDuration] Blobs created in customer storage account
 * per hour
 */
 ...
 * @property {date} [startTimeUtc] UTC time at which the upgrade operation has
 * started.
 ...
 * ended.
 * @property {string} [status] Status of the vault upgrade operation. Possible
 ...
 * @property {string} [triggerType] The way the vault upgradation was
 ...
 * @property {string} [previousResourceId] Resource ID of the vault before the
 * upgrade.
 */
 ...
 * operation.
 * @property {date} [upgradeDetails.startTimeUtc] UTC time at which the upgrade
 ...
 * @property {string} [upgradeDetails.triggerType] The way the vault
 ...
 * upgrade operation.
 * @property {date} [properties.upgradeDetails.startTimeUtc] UTC time at which
 * the upgrade operation has started.
 * @property {date} [properties.upgradeDetails.lastUpdatedTimeUtc] UTC time at
 ...
 * @property {string} [properties.upgradeDetails.triggerType] The way the vault
 * upgradation was triggered. Possible values include: 'UserTriggered',
 * 'ForcedUpgrade'
