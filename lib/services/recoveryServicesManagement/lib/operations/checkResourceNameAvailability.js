 ...
 */
function _post(location, input, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/providers/Microsoft.RecoveryServices/locations/{location}/checkNameAvailability';
  ...
  try {
    if (input !== null && input !== undefined) {
      let requestModelMapper = new client.models['ResourceNameAvailabilityInput']().mapper();
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['ResourceNameAvailabilityResponseResource']().mapper();
...
class CheckResourceNameAvailability {
   ...
   */
  postWithHttpOperationResponse(location, input, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._post(location, input, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  post(location, input, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._post(location, input, options, optionalCallback);
    }
  }

}

module.exports = CheckResourceNameAvailability;
