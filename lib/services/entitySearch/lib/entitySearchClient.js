...
/** Class representing a EntitySearchClient. */
class EntitySearchClient extends ServiceClient {
  /**
   * Create a EntitySearchClient.
...
module.exports = EntitySearchClient;
module.exports['default'] = EntitySearchClient;
module.exports.EntitySearchClient = EntitySearchClient;
module.exports.EntitySearchModels = models;
