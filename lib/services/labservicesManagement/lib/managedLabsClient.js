...
/** Class representing a ManagedLabsClient. */
class ManagedLabsClient extends ServiceClient {
  /**
   * Create a ManagedLabsClient.
...
module.exports = ManagedLabsClient;
module.exports['default'] = ManagedLabsClient;
module.exports.ManagedLabsClient = ManagedLabsClient;
module.exports.ManagedLabsModels = models;
