 ...
 */
function _getContainerLog(resourceGroupName, applicationName, serviceName, replicaName, codePackageName, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabricMesh/applications/{applicationName}/services/{serviceName}/replicas/{replicaName}/codePackages/{codePackageName}/logs';
  ...
  requestUrl = requestUrl.replace('{codePackageName}', codePackageName);
  let queryParameters = [];
...
class CodePackage {
  ...
  constructor(client) {
    this.client = client;
    this._getContainerLog = _getContainerLog;
  }
   ...
   */
  getContainerLogWithHttpOperationResponse(resourceGroupName, applicationName, serviceName, replicaName, codePackageName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getContainerLog(resourceGroupName, applicationName, serviceName, replicaName, codePackageName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getContainerLog(resourceGroupName, applicationName, serviceName, replicaName, codePackageName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._getContainerLog(resourceGroupName, applicationName, serviceName, replicaName, codePackageName, options, optionalCallback);
    }
  }
