...
/** Class representing a AnomalyDetectorClient. */
class AnomalyDetectorClient extends ServiceClient {
  /**
   * Create a AnomalyDetectorClient.
  ...
  constructor(credentials, endpoint, options) {
    ...
    this.baseUri = '{Endpoint}/anomalydetector/v2.0';
...
module.exports = AnomalyDetectorClient;
module.exports['default'] = AnomalyDetectorClient;
module.exports.AnomalyDetectorClient = AnomalyDetectorClient;
module.exports.AnomalyDetectorModels = models;
