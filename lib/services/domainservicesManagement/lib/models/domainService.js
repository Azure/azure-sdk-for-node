...
class DomainService extends models['Resource'] {
   ...
   * @property {string} [ldapsSettings.ldaps] A flag to determine whether or
   * not Secure LDAP is enabled or disabled. Possible values include:
   * 'Enabled', 'Disabled'
   ...
   * @property {string} [ldapsSettings.publicCertificate] Public certificate
   * used to configure secure ldap.
