...
class LdapsSettings {
   ...
   * @property {string} [ldaps] A flag to determine whether or not Secure LDAP
   * is enabled or disabled. Possible values include: 'Enabled', 'Disabled'
   ...
   * @property {string} [publicCertificate] Public certificate used to
   * configure secure ldap.
   * @property {string} [certificateThumbprint] Thumbprint of configure ldaps
   * certificate.
   * @property {date} [certificateNotAfter] NotAfter DateTime of configure
   * ldaps certificate.
