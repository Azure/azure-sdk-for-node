...
class ContainerServiceAgentPoolProfile {
   ...
   * @property {number} [count] Number of agents (VMs) to host docker
   * containers. Allowed values must be in the range of 1 to 100 (inclusive).
   * The default value is 1. . Default value: 1 .
   ...
   * specified.
   * @property {string} [dnsPrefix] DNS prefix to be used to create the FQDN
   * for the agent pool.
