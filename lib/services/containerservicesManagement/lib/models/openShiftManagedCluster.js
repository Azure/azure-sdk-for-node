...
class OpenShiftManagedCluster extends models['Resource'] {
   ...
   * @member {number} [masterPoolProfiles.count] Number of masters (VMs) to
   ...
   * @member {string} [masterPoolProfiles.osType] OsType to be used to specify
    ...
    return {
      ...
      type: {
        ...
        modelProperties: {
          ...
          masterPoolProfiles: {
            required: false,
            serializedName: 'properties.masterPoolProfiles',
            type: {
              name: 'Composite',
