 ...
 *
 */
class OpenShiftManagedClusterProfileSpec {
  /**
   * Create a OpenShiftManagedClusterProfileSpec.
  ...
  /**
   * Defines the metadata of OpenShiftManagedClusterProfileSpec
   *
  ...
  mapper() {
    return {
      required: false,
      serializedName: 'OpenShiftManagedClusterProfileSpec',
      type: {
        name: 'Composite',
        className: 'OpenShiftManagedClusterProfileSpec',
        modelProperties: {
          name: {
            required: true,
            serializedName: 'name',
...
module.exports = OpenShiftManagedClusterProfileSpec;
