 ...
 */
function _list(managedClusterName, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/providers/Microsoft.ContainerService/managedClusters/{managedClusterName}/agentPools';
...
class AgentPools {
   ...
   */
  listWithHttpOperationResponse(managedClusterName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._list(managedClusterName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  list(managedClusterName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._list(managedClusterName, options, optionalCallback);
    }
  }
