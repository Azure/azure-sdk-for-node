 ...
 */
function _imageSearch(query, options, callback) {
...
class CustomInstance {
   ...
   */
  imageSearchWithHttpOperationResponse(query, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._imageSearch(query, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  imageSearch(query, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._imageSearch(query, options, optionalCallback);
    }
  }
