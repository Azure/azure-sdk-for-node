 ...
 */
function _imageSearch(customConfig, query, options, callback) {
  ...
  try {
    ...
    if (customConfig === null || customConfig === undefined || typeof customConfig.valueOf() !== 'string') {
      throw new Error('customConfig cannot be null or undefined and it must be of type string.');
    }
  ...
  let queryParameters = [];
  queryParameters.push('customConfig=' + encodeURIComponent(customConfig));
...
class CustomInstance {
   ...
   * @param {CustomImageSearchAPIClient} client Reference to the service client.
   */
  constructor(client) {
    this.client = client;
    this._imageSearch = _imageSearch;
  }
   ...
   */
  imageSearchWithHttpOperationResponse(customConfig, query, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._imageSearch(customConfig, query, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  imageSearch(customConfig, query, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._imageSearch(customConfig, query, options, optionalCallback);
    }
  }
