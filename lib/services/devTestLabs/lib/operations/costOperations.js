 ...
 */
CostOperations.prototype.list = function (resourceGroupName, labName, options, callback) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = new client.models['ResponseWithContinuationCost']().mapper();
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
CostOperations.prototype.refreshData = function (resourceGroupName, labName, name, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Send request
  this.beginRefreshData(resourceGroupName, labName, name, options, function (err, parsedResult, httpRequest, response){
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
CostOperations.prototype.beginRefreshData = function (resourceGroupName, labName, name, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
CostOperations.prototype.listNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
