 ...
 */
VirtualNetworkOperations.prototype.list = function (resourceGroupName, labName, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/virtualnetworks';
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = new client.models['ResponseWithContinuationVirtualNetwork']().mapper();
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
VirtualNetworkOperations.prototype.getResource = function (resourceGroupName, labName, name, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/virtualnetworks/{name}';
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  requestUrl = requestUrl.replace('{resourceGroupName}', encodeURIComponent(resourceGroupName));
  requestUrl = requestUrl.replace('{labName}', encodeURIComponent(labName));
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
VirtualNetworkOperations.prototype.createOrUpdateResource = function (resourceGroupName, labName, name, virtualNetwork, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Send request
  this.beginCreateOrUpdateResource(resourceGroupName, labName, name, virtualNetwork, options, function (err, parsedResult, httpRequest, response){
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
VirtualNetworkOperations.prototype.deleteResource = function (resourceGroupName, labName, name, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
VirtualNetworkOperations.prototype.patchResource = function (resourceGroupName, labName, name, virtualNetwork, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  try {
    ...
    var serializationError = new Error(util.format('Error "%s" occurred in serializing the ' + 
        'payload - "%s"', error.message, util.inspect(virtualNetwork, {depth: null})));
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
VirtualNetworkOperations.prototype.beginCreateOrUpdateResource = function (resourceGroupName, labName, name, virtualNetwork, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
VirtualNetworkOperations.prototype.beginDeleteResource = function (resourceGroupName, labName, name, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
VirtualNetworkOperations.prototype.listNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
