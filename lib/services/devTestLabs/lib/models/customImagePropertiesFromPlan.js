...
class CustomImagePropertiesFromPlan {
  /**
   * Create a CustomImagePropertiesFromPlan.
  ...
  /**
   * Defines the metadata of CustomImagePropertiesFromPlan
   *
   * @returns {object} metadata of CustomImagePropertiesFromPlan
   *
   */
  mapper() {
    return {
...
module.exports = CustomImagePropertiesFromPlan;
