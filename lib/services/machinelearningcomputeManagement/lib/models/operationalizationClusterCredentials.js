...
class OperationalizationClusterCredentials {
   ...
   * @property {string} [containerRegistry.password2] The ACR secondary
   * password.
   ...
   * file.
   * @property {object} [containerService.servicePrincipalConfiguration]
   * Service principal configuration used by Kubernetes.
   * @property {string}
   * [containerService.servicePrincipalConfiguration.clientId] The service
   * principal client ID
   ...
   * @property {string} [containerService.imagePullSecretName] The ACR image
   * pull secret name which was created in Kubernetes.
   ...
   * @property {object} [serviceAuthConfiguration] Global authorization keys
   * for all user services deployed in cluster. These are used if the service
   * does not have auth keys.
   * @property {string} [serviceAuthConfiguration.primaryAuthKeyHash] The
   ...
   * services.
   * @property {string} [sslConfiguration.status] SSL status. Allowed values
   * are Enabled and Disabled. Possible values include: 'Enabled', 'Disabled'
   * @property {string} [sslConfiguration.cert] The SSL cert data in PEM
   * format.
