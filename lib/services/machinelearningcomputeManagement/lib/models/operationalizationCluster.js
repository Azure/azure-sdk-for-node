...
class OperationalizationCluster extends models['Resource'] {
   ...
   * @property {date} [createdOn] The date and time when the cluster was
   * created.
   ...
   * @property {array} [provisioningErrors] List of provisioning errors
   * reported by the resource provider.
   ...
   * @property {string} [storageAccount.resourceId] ARM resource ID of the
   * Azure Storage Account to store CLI specific files. If not provided one
   ...
   * @property {string} [containerService.orchestratorType] Type of
   ...
   * @property {number} [containerService.masterCount] The number of master
   * nodes in the container service.
   ...
   * @property {string} [globalServiceConfiguration.etag] The configuration
   * ETag for updates.
   ...
   * in PEM format.
   * @property {string} [globalServiceConfiguration.ssl.key] The SSL key data
   * in PEM format. This is not returned in response of GET/PUT on the
   * resource. To see this please call listKeys API.
   * @property {string} [globalServiceConfiguration.ssl.cname] The CName of the
   * certificate.
   * @property {object} [globalServiceConfiguration.serviceAuth] Optional
   ...
   * @property {number}
   * [globalServiceConfiguration.autoScale.targetUtilization] The target
   * utilization.
   * @property {number}
