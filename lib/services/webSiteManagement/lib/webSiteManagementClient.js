...
var WebSiteManagementClient = ( /** @lends WebSiteManagementClient */ function() {
  ...
  WebSiteManagementClient.prototype.getOperationStatus = function(webSpaceName, siteName, operationId, callback) {
    ...
    var url2 = '/' + this.credentials.subscriptionId + '/services/WebSpaces/' + webSpaceName + '/sites/' + siteName + '/operations/' + operationId;
  ...
  WebSiteManagementClient.prototype.registerSubscription = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.baseUri;
    var url2 = '/' + this.credentials.subscriptionId + '/services?';
...
var ServerFarmOperations = ( /** @lends ServerFarmOperations */ function() {
  ...
  ServerFarmOperations.prototype.create = function(webSpaceName, parameters, callback) {
    ...
    var url2 = '/' + this.client.credentials.subscriptionId + '/services/WebSpaces/' + webSpaceName + '/ServerFarms';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  ServerFarmOperations.prototype.delete = function(webSpaceName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId + '/services/WebSpaces/' + webSpaceName + '/ServerFarms/DefaultServerFarm';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  ServerFarmOperations.prototype.get = function(webSpaceName, serverFarmName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId + '/services/WebSpaces/' + webSpaceName + '/ServerFarms/' + serverFarmName;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var WebSiteOperations = ( /** @lends WebSiteOperations */ function() {
  ...
  WebSiteOperations.prototype.beginSwapingSlots = function(webSpaceName, webSiteName, slotName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId + '/services/WebSpaces/' + webSpaceName + '/sites/' + webSiteName + '/slots?';
  ...
  WebSiteOperations.prototype.create = function(webSpaceName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId + '/services/WebSpaces/' + webSpaceName + '/sites';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSiteOperations.prototype.createRepository = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId + '/services/WebSpaces/' + webSpaceName + '/sites/' + webSiteName + '/repository';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSiteOperations.prototype.delete = function(webSpaceName, webSiteName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId + '/services/WebSpaces/' + webSpaceName + '/sites/' + webSiteName + '?';
  ...
  WebSiteOperations.prototype.generatePassword = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId + '/services/WebSpaces/' + webSpaceName + '/sites/' + webSiteName + '/newpassword';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSiteOperations.prototype.getConfiguration = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId + '/services/WebSpaces/' + webSpaceName + '/sites/' + webSiteName + '/config';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSiteOperations.prototype.getHistoricalUsageMetrics = function(webSpaceName, webSiteName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId + '/services/WebSpaces/' + webSpaceName + '/sites/' + webSiteName + '/metrics?';
  ...
  WebSiteOperations.prototype.getPublishProfile = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId + '/services/WebSpaces/' + webSpaceName + '/sites/' + webSiteName + '/publishxml';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSiteOperations.prototype.getUsageMetrics = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId + '/services/WebSpaces/' + webSpaceName + '/sites/' + webSiteName + '/usages';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSiteOperations.prototype.isHostnameAvailable = function(webSiteName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId + '/services/WebSpaces?';
  ...
  WebSiteOperations.prototype.restart = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId + '/services/WebSpaces/' + webSpaceName + '/sites/' + webSiteName + '/restart';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSiteOperations.prototype.syncRepository = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId + '/services/WebSpaces/' + webSpaceName + '/sites/' + webSiteName + '/repository?action=sync';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var WebSpaceOperations = ( /** @lends WebSpaceOperations */ function() {
  ...
  WebSpaceOperations.prototype.createPublishingUser = function(username, password, parametersOrCallback, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId + '/services/WebSpaces?properties=publishingCredentials';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSpaceOperations.prototype.get = function(webSpaceName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId + '/services/WebSpaces/' + webSpaceName;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSpaceOperations.prototype.getDnsSuffix = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId + '/services/WebSpaces?properties=dnssuffix';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSpaceOperations.prototype.listGeoRegions = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId + '/services/WebSpaces?properties=georegions';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSpaceOperations.prototype.listPublishingUsers = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId + '/services/WebSpaces?properties=publishingUsers';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
