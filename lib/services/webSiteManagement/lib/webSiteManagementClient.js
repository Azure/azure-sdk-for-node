...
var WebSiteManagementClient = ( /** @lends WebSiteManagementClient */ function() {
  ...
  WebSiteManagementClient.prototype.getOperationStatus = function(webSpaceName, siteName, operationId, callback) {
    ...
    var url2 = '/' + this.credentials.subscriptionId.trim() + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + siteName.trim() + '/operations/' + operationId.trim();
  ...
  WebSiteManagementClient.prototype.registerSubscription = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.baseUri;
    var url2 = '/' + this.credentials.subscriptionId.trim() + '/services?';
...
var ServerFarmOperations = ( /** @lends ServerFarmOperations */ function() {
  ...
  ServerFarmOperations.prototype.create = function(webSpaceName, parameters, callback) {
    ...
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/WebSpaces/' + webSpaceName.trim() + '/ServerFarms';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  ServerFarmOperations.prototype.delete = function(webSpaceName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/WebSpaces/' + webSpaceName.trim() + '/ServerFarms/DefaultServerFarm';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  ServerFarmOperations.prototype.get = function(webSpaceName, serverFarmName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/WebSpaces/' + webSpaceName.trim() + '/ServerFarms/' + serverFarmName.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var WebSiteOperations = ( /** @lends WebSiteOperations */ function() {
  ...
  WebSiteOperations.prototype.beginSwapingSlots = function(webSpaceName, webSiteName, slotName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/slots?';
    url2 = url2 + 'Command=swap';
    url2 = url2 + '&targetSlot=' + encodeURIComponent(slotName.trim());
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSiteOperations.prototype.create = function(webSpaceName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/WebSpaces/' + webSpaceName.trim() + '/sites';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSiteOperations.prototype.createRepository = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/repository';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSiteOperations.prototype.delete = function(webSpaceName, webSiteName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '?';
  ...
  WebSiteOperations.prototype.generatePassword = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/newpassword';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSiteOperations.prototype.getConfiguration = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/config';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSiteOperations.prototype.getHistoricalUsageMetrics = function(webSpaceName, webSiteName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/metrics?';
  ...
  WebSiteOperations.prototype.getPublishProfile = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/publishxml';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSiteOperations.prototype.getUsageMetrics = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/usages';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSiteOperations.prototype.isHostnameAvailable = function(webSiteName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/WebSpaces?';
  ...
  WebSiteOperations.prototype.restart = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/restart';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSiteOperations.prototype.syncRepository = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/repository?action=sync';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var WebSpaceOperations = ( /** @lends WebSpaceOperations */ function() {
  ...
  WebSpaceOperations.prototype.createPublishingUser = function(username, password, parametersOrCallback, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/WebSpaces?properties=publishingCredentials';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSpaceOperations.prototype.get = function(webSpaceName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/WebSpaces/' + webSpaceName.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSpaceOperations.prototype.getDnsSuffix = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/WebSpaces?properties=dnssuffix';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSpaceOperations.prototype.listGeoRegions = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/WebSpaces?properties=georegions';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  WebSpaceOperations.prototype.listPublishingUsers = function(callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/WebSpaces?properties=publishingUsers';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
