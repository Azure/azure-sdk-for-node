...
var WebSiteOperations = (function() {
   ...
   * 
   * @param {List`1} parameters.hostNames Required. The fully qualified domain
   ...
   * 
   * @param {IList`1} [parametersOrCallback.propertiesToInclude] Specifies a
   * list of the names of any addtional parameters to return
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
   ...
   * 
   * @param {IList`1} [parameters.metricNames] Specifies a comma-separated list
   ...
   * the site off line).
   * 
   * @param {IList`1} [parameters.hostNameSslStates] SSL states bound to the
   * website.
   * 
   * @param {IList`1} [parameters.hostNames] An array of strings that contains
   ...
   * 
   * @param {IList`1} [parameters.sslCertificates] SSL certificates bound to
   * the web site.
   * 
   ...
   * 
   * @param {IList`1} [parameters.connectionStrings] Contains connection
   * strings for database and other external resources.
   * 
   * @param {IList`1} [parameters.defaultDocuments] Contains one or more string
   ...
   * 
   * @param {IList`1} [parameters.handlerMappings] Specifies custom executable
