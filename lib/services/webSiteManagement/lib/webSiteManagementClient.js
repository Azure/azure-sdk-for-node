...
var WebSiteOperations = ( /** @lends WebSiteOperations */ function() {
   ...
   * website. Only one hostname can be specified in the azurewebsites.net
   * domain. The hostname should match the name of the website. Custom domains
   * can only be specified for Shared or Standard websites.
   * 
   * @param {string} parameters.name The name of the website. This should match
   * the hostname in the default domain.
   * 
   ...
   * the webspace that will be created.
   * 
   * @param {string} [parameters.webSpace.name] The name of the webspace.
   * 
   * @param {string} [parameters.webSpace.plan] This value must be
