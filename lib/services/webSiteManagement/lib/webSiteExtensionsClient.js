...
var WebJobOperations = ( /** @lends WebJobOperations */ function() {
  ...
  WebJobOperations.prototype.deleteContinuous = function(jobId, recursive, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'jobs/continuous/' + jobId + '?';
    url2 = url2 + 'version=2';
    url2 = url2 + '&recursive=' + encodeURIComponent(recursive);
  ...
  WebJobOperations.prototype.deleteTriggered = function(jobId, recursive, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'jobs/triggered/' + jobId + '?';
    url2 = url2 + 'version=2';
    url2 = url2 + '&recursive=' + encodeURIComponent(recursive);
  ...
  WebJobOperations.prototype.get = function(jobId, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'jobs/' + jobId + '?';
    url2 = url2 + 'version=2';
  ...
  WebJobOperations.prototype.getRun = function(jobId, jobRunId, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'jobs/triggered/' + jobId + '/history/' + jobRunId + '?';
    url2 = url2 + 'version=2';
  ...
  WebJobOperations.prototype.runTriggered = function(jobId, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'jobs/triggered/' + jobId + '/run?';
    url2 = url2 + 'version=2';
  ...
  WebJobOperations.prototype.startContinous = function(jobId, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'jobs/continuous/' + jobId + '/start?';
    url2 = url2 + 'version=2';
  ...
  WebJobOperations.prototype.stopContinous = function(jobId, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'jobs/continuous/' + jobId + '/stop?';
    url2 = url2 + 'version=2';
