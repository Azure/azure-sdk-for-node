...
var DeploymentOperations = ( /** @lends DeploymentOperations */ function() {
  ...
  DeploymentOperations.prototype.get = function(deploymentId, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'deployments/' + deploymentId + '?version=2';
  ...
  DeploymentOperations.prototype.list = function(parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'deployments/?version=2&$top=' + parameters.top + '&$orderBy=' + parameters.orderBy;
...
var WebJobOperations = ( /** @lends WebJobOperations */ function() {
   ...
   * 
   * @param {string} recursive The recursive flag.
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
   */
  WebJobOperations.prototype.deleteContinuous = function(jobId, recursive, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'jobs/continuous/' + jobId + '?version=2&recursive=' + recursive;
   ...
   * @returns {Stream} The response stream.
   */
  WebJobOperations.prototype.deleteTriggered = function(jobId, recursive, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'jobs/triggered/' + jobId + '?version=2&recursive=' + recursive;
   ...
   * @returns {Stream} The response stream.
   */
  WebJobOperations.prototype.get = function(jobId, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'jobs/' + jobId + '?version=2';
   ...
   * TBD.
   * 
   * @param {string} jobId The deployment identifier.
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
   */
  WebJobOperations.prototype.getContinuous = function(jobId, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'jobs/continuous/' + jobId + '?version=2';
   ...
   * @returns {Stream} The response stream.
   */
  WebJobOperations.prototype.getRun = function(jobId, jobRunId, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'jobs/triggered/' + jobId + '/history/' + jobRunId + '?version=2';
   ...
   * @returns {Stream} The response stream.
   */
  WebJobOperations.prototype.getTriggered = function(jobId, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'jobs/triggered/' + jobId + '?version=2';
  ...
  WebJobOperations.prototype.list = function(parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'jobs?version=2&$top=' + parameters.top + '&$orderBy=' + parameters.orderBy;
  ...
  WebJobOperations.prototype.listContinuous = function(parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'jobs/continuous?version=2&$top=' + parameters.top + '&$orderBy=' + parameters.orderBy;
  ...
  WebJobOperations.prototype.listRuns = function(jobName, parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'jobs/triggered/' + jobName + '/history?version=2&$top=' + parameters.top + '&$orderBy=' + parameters.orderBy;
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (responseDoc) {
        var jobRunsArray = responseDoc;
        if (jobRunsArray) {
          for (var loweredIndex1 = 0; loweredIndex1 < jobRunsArray.length; loweredIndex1 = loweredIndex1 + 1) {
            var jobRunsValue = jobRunsArray[loweredIndex1];
            var webJobRunInstance = {};
            result.jobRuns.push(webJobRunInstance);
            
            var idValue = jobRunsValue['id'];
            if (idValue) {
              var idInstance = idValue;
              webJobRunInstance.id = idInstance;
            }
            
            var statusValue = jobRunsValue['status'];
            if (statusValue) {
              var statusInstance = statusValue;
              webJobRunInstance.status = statusInstance;
            }
            
            var startTimeValue = jobRunsValue['start_time'];
            if (startTimeValue) {
              var startTimeInstance = startTimeValue;
              webJobRunInstance.startTime = startTimeInstance;
            }
            
            var endTimeValue = jobRunsValue['end_time'];
            if (endTimeValue) {
              var endTimeInstance = endTimeValue;
              webJobRunInstance.endTime = endTimeInstance;
            }
            
            var durationValue = jobRunsValue['duration'];
            if (durationValue) {
              // how
              var durationInstance = durationValue;
            ...
            var outputUrlValue = jobRunsValue['output_url'];
            if (outputUrlValue) {
              // how
              var outputUrlInstance = outputUrlValue;
            ...
            var errorUrlValue = jobRunsValue['error_url'];
            if (errorUrlValue) {
              // how
              var errorUrlInstance = errorUrlValue;
  ...
  WebJobOperations.prototype.listTriggered = function(parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'jobs/triggered?version=2&$top=' + parameters.top + '&$orderBy=' + parameters.orderBy;
   ...
   * @returns {Stream} The response stream.
   */
  WebJobOperations.prototype.runTriggered = function(jobId, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'jobs/triggered/' + jobId + '/run?version=2';
   ...
   * @returns {Stream} The response stream.
   */
  WebJobOperations.prototype.startContinous = function(jobId, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'jobs/continuous/' + jobId + '/start?version=2';
   ...
   * @returns {Stream} The response stream.
   */
  WebJobOperations.prototype.stopContinous = function(jobId, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    // Construct URL
    var url2 = this.client.baseUri + 'jobs/continuous/' + jobId + '/stop?version=2';
