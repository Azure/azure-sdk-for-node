...
var DeploymentOperations = ( /** @lends DeploymentOperations */ function() {
  ...
  DeploymentOperations.prototype.listLogs = function(deploymentId, parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + '/deployments/' + deploymentId + '/log?';
    url2 = url2 + 'version=2';
    if (parameters && parameters.top) {
      url2 = url2 + '&$top=' + encodeURIComponent(parameters.top);
    }
      ...
      if (responseDoc) {
        ...
        if (logsArray) {
          for (var loweredIndex1 = 0; loweredIndex1 < logsArray.length; loweredIndex1 = loweredIndex1 + 1) {
            ...
            var hasDetailsValue = logsValue['hasDetails'];
            if (hasDetailsValue) {
              var hasDetailsInstance = hasDetailsValue;
              deploymentLogInstance.hasDetails = hasDetailsInstance;
            }
            ...
            var shortIdValue = logsValue['shortId'];
            if (shortIdValue) {
              var shortIdInstance = shortIdValue;
              deploymentLogInstance.shortId = shortIdInstance;
            }
          }
        }
      }
