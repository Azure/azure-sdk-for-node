  ...
  WebSpaceOperations.prototype.list = function(callback) {
    ...
    return request(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (webSpacesSequenceElement && webSpacesSequenceElement.WEBSPACE) {
  ...
  WebSpaceOperations.prototype.listPublishingUsers = function(callback) {
    ...
    return request(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (arrayOfstringSequenceElement && arrayOfstringSequenceElement.STRING) {
  ...
  WebSpaceOperations.prototype.listWebsites = function(webSpaceName, callback) {
    ...
    return request(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (sitesSequenceElement && sitesSequenceElement.SITE) {
          for (var loweredIndex1 = 0; loweredIndex1 < sitesSequenceElement.SITE.length; loweredIndex1 = loweredIndex1 + 1) {
            ...
            if (enabledHostNamesSequenceElement && enabledHostNamesSequenceElement.STRING) {
            ...
            if (hostNameSslStatesSequenceElement && hostNameSslStatesSequenceElement.WEBSITEHOSTNAMESSLSTATE) {
            ...
            if (hostNamesSequenceElement && hostNamesSequenceElement.STRING) {
            ...
            if (sSLCertificatesSequenceElement && sSLCertificatesSequenceElement.CERTIFICATE) {
              for (var loweredIndex5 = 0; loweredIndex5 < sSLCertificatesSequenceElement.CERTIFICATE.length; loweredIndex5 = loweredIndex5 + 1) {
                ...
                if (hostNamesSequenceElement2 && hostNamesSequenceElement2.STRING) {
            ...
            if (sitePropertiesElement) {
              ...
              if (appSettingsSequenceElement && appSettingsSequenceElement.NAMEVALUEPAIR) {
              ...
              if (appSettingsSequenceElement2 && appSettingsSequenceElement2.NAMEVALUEPAIR) {
              ...
              if (appSettingsSequenceElement3 && appSettingsSequenceElement3.NAMEVALUEPAIR) {
  ...
  WebSpaceOperations.prototype.listGeoRegions = function(callback) {
    ...
    return request(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (geoRegionsSequenceElement && geoRegionsSequenceElement.GEOREGION) {
        ...
        if (siteElement2) {
          ...
          if (sSLCertificatesSequenceElement && sSLCertificatesSequenceElement.CERTIFICATE) {
            for (var loweredIndex5 = 0; loweredIndex5 < sSLCertificatesSequenceElement.CERTIFICATE.length; loweredIndex5 = loweredIndex5 + 1) {
              ...
              if (hostNamesSequenceElement3 && hostNamesSequenceElement3.STRING) {
    ...
    return request(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (siteElement2) {
          ...
          if (hostNameSslStatesSequenceElement2 && hostNameSslStatesSequenceElement2.WEBSITEHOSTNAMESSLSTATE) {
    ...
    return request(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (publishDataElement) {
          ...
          if (publishDataElement && publishDataElement.PUBLISHPROFILE) {
            for (var loweredIndex1 = 0; loweredIndex1 < publishDataElement.PUBLISHPROFILE.length; loweredIndex1 = loweredIndex1 + 1) {
              ...
              if (databasesSequenceElement && databasesSequenceElement.ADD) {
    ...
    return request(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (siteConfigElement) {
          ...
          if (connectionStringsSequenceElement && connectionStringsSequenceElement.CONNSTRINGINFO) {
          ...
          if (defaultDocumentsSequenceElement && defaultDocumentsSequenceElement.STRING) {
          ...
          if (handlerMappingsSequenceElement && handlerMappingsSequenceElement.HANDLERMAPPING) {
          ...
          if (metadataSequenceElement && metadataSequenceElement.NAMEVALUEPAIR) {
    ...
    return request(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (siteConfigElement2) {
          ...
          if (connectionStringsSequenceElement2 && connectionStringsSequenceElement2.CONNSTRINGINFO) {
          ...
          if (defaultDocumentsSequenceElement2 && defaultDocumentsSequenceElement2.STRING) {
          ...
          if (handlerMappingsSequenceElement2 && handlerMappingsSequenceElement2.HANDLERMAPPING) {
    ...
    return request(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (usagesElement) {
          ...
          if (usagesElement && usagesElement.USAGE) {
    ...
    return request(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (metricResponsesElement) {
          ...
          if (metricResponsesElement && metricResponsesElement.METRICRESPONSE) {
            for (var loweredIndex1 = 0; loweredIndex1 < metricResponsesElement.METRICRESPONSE.length; loweredIndex1 = loweredIndex1 + 1) {
              ...
              if (dataElement) {
                ...
                if (valuesSequenceElement && valuesSequenceElement.METRICSAMPLE) {
