 ...
 */
class AzureVmWorkloadSAPHanaSystemWorkloadItem extends models['AzureVmWorkloadItem'] {
  /**
   * Create a AzureVmWorkloadSAPHanaSystemWorkloadItem.
   */
  constructor() {
    super();
  }
  ...
  /**
   * Defines the metadata of AzureVmWorkloadSAPHanaSystemWorkloadItem
   *
   * @returns {object} metadata of AzureVmWorkloadSAPHanaSystemWorkloadItem
   *
   */
  mapper() {
    return {
...
module.exports = AzureVmWorkloadSAPHanaSystemWorkloadItem;
