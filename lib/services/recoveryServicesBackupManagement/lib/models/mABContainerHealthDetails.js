...
class MABContainerHealthDetails {
  /**
   * Create a MABContainerHealthDetails.
  ...
  /**
   * Defines the metadata of MABContainerHealthDetails
   *
   * @returns {object} metadata of MABContainerHealthDetails
   *
   */
  mapper() {
    return {
...
module.exports = MABContainerHealthDetails;
