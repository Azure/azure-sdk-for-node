 ...
 */
class AzureVmWorkloadSAPAseDatabaseProtectedItem extends models['AzureVmWorkloadProtectedItem'] {
  /**
   * Create a AzureVmWorkloadSAPAseDatabaseProtectedItem.
   */
  constructor() {
    super();
  }
  ...
  /**
   * Defines the metadata of AzureVmWorkloadSAPAseDatabaseProtectedItem
   *
   * @returns {object} metadata of AzureVmWorkloadSAPAseDatabaseProtectedItem
   *
   */
  mapper() {
    return {
...
module.exports = AzureVmWorkloadSAPAseDatabaseProtectedItem;
