 ...
 */
class AzureVmWorkloadSAPHanaDatabaseProtectableItem extends models['AzureVmWorkloadProtectableItem'] {
  /**
   * Create a AzureVmWorkloadSAPHanaDatabaseProtectableItem.
   */
  constructor() {
    super();
  }
  ...
  /**
   * Defines the metadata of AzureVmWorkloadSAPHanaDatabaseProtectableItem
   *
   * @returns {object} metadata of AzureVmWorkloadSAPHanaDatabaseProtectableItem
   *
   */
  mapper() {
    return {
...
module.exports = AzureVmWorkloadSAPHanaDatabaseProtectableItem;
