 ...
 */
class AzureVmWorkloadSQLDatabaseWorkloadItem extends models['AzureVmWorkloadItem'] {
  /**
   * Create a AzureVmWorkloadSQLDatabaseWorkloadItem.
   */
  constructor() {
    super();
  }
  ...
  /**
   * Defines the metadata of AzureVmWorkloadSQLDatabaseWorkloadItem
   *
   * @returns {object} metadata of AzureVmWorkloadSQLDatabaseWorkloadItem
   *
   */
  mapper() {
    return {
...
module.exports = AzureVmWorkloadSQLDatabaseWorkloadItem;
