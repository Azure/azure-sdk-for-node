 ...
 */
class AzureVmWorkloadSAPAseDatabaseProtectableItem extends models['AzureVmWorkloadProtectableItem'] {
  /**
   * Create a AzureVmWorkloadSAPAseDatabaseProtectableItem.
   */
  constructor() {
    super();
  }
  ...
  /**
   * Defines the metadata of AzureVmWorkloadSAPAseDatabaseProtectableItem
   *
   * @returns {object} metadata of AzureVmWorkloadSAPAseDatabaseProtectableItem
   *
   */
  mapper() {
    return {
...
module.exports = AzureVmWorkloadSAPAseDatabaseProtectableItem;
