...
class AzureVmWorkloadProtectableItem extends models['WorkloadProtectableItem'] {
   ...
   * @property {string} [parentUniqueName] Parent Unique Name is added to
   ...
   * protectable objects
   * @property {string} [prebackupvalidation.status] Status of protectable
   * item, i.e. InProgress,Succeeded,Failed. Possible values include:
   * 'Invalid', 'Success', 'Failed'
   * @property {string} [prebackupvalidation.code] Error code of protectable
   * item
