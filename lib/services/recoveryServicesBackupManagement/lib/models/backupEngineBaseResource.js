...
class BackupEngineBaseResource extends models['Resource'] {
   ...
   * @property {object} [properties.extendedInfo] Extended info of the backup
   * engine
   ...
   * the backup engine.
   * @property {number} [properties.extendedInfo.usedDiskSpace] Disk space used
   * in the backup engine.
   * @property {number} [properties.extendedInfo.availableDiskSpace] Disk space
