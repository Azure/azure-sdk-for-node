...
class ContainerIdentityInfo {
   ...
   * @property {string} [aadTenantId] Protection container identity - AAD
   * Tenant
   * @property {string} [servicePrincipalClientId] Protection container
   * identity - AAD Service Principal
