...
class BackupResourceVaultConfig {
   ...
   * @property {string} [storageModelType] Storage type. Possible values
   ...
   * @property {string} [storageTypeState] Locked or Unlocked. Once a machine
   * is registered against a resource, the storageTypeState is always Locked.
