 ...
 */
class AzureVmWorkloadSQLAvailabilityGroupProtectableItem extends models['AzureVmWorkloadProtectableItem'] {
  /**
   * Create a AzureVmWorkloadSQLAvailabilityGroupProtectableItem.
   */
  constructor() {
    super();
  }
  ...
  /**
   * Defines the metadata of AzureVmWorkloadSQLAvailabilityGroupProtectableItem
   *
   * @returns {object} metadata of AzureVmWorkloadSQLAvailabilityGroupProtectableItem
   *
   */
  mapper() {
    return {
...
module.exports = AzureVmWorkloadSQLAvailabilityGroupProtectableItem;
