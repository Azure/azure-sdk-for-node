 ...
 */
class AzureVmWorkloadSAPAseSystemProtectableItem extends models['AzureVmWorkloadProtectableItem'] {
  /**
   * Create a AzureVmWorkloadSAPAseSystemProtectableItem.
   */
  constructor() {
    super();
  }
  ...
  /**
   * Defines the metadata of AzureVmWorkloadSAPAseSystemProtectableItem
   *
   * @returns {object} metadata of AzureVmWorkloadSAPAseSystemProtectableItem
   *
   */
  mapper() {
    return {
...
module.exports = AzureVmWorkloadSAPAseSystemProtectableItem;
