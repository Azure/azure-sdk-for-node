 ...
 */
class AzureVmWorkloadSAPAseSystemWorkloadItem extends models['AzureVmWorkloadItem'] {
  /**
   * Create a AzureVmWorkloadSAPAseSystemWorkloadItem.
   */
  constructor() {
    super();
  }
  ...
  /**
   * Defines the metadata of AzureVmWorkloadSAPAseSystemWorkloadItem
   *
   * @returns {object} metadata of AzureVmWorkloadSAPAseSystemWorkloadItem
   *
   */
  mapper() {
    return {
...
module.exports = AzureVmWorkloadSAPAseSystemWorkloadItem;
