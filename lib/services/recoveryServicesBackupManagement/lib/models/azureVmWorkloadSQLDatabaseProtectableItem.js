 ...
 */
class AzureVmWorkloadSQLDatabaseProtectableItem extends models['AzureVmWorkloadProtectableItem'] {
  /**
   * Create a AzureVmWorkloadSQLDatabaseProtectableItem.
   */
  constructor() {
    super();
  }
  ...
  /**
   * Defines the metadata of AzureVmWorkloadSQLDatabaseProtectableItem
   *
   * @returns {object} metadata of AzureVmWorkloadSQLDatabaseProtectableItem
   *
   */
  mapper() {
    return {
...
module.exports = AzureVmWorkloadSQLDatabaseProtectableItem;
