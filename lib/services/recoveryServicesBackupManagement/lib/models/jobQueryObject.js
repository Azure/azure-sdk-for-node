...
class JobQueryObject {
   ...
   * @property {string} [backupManagementType] Type of backup managmenent for
   * the job. Possible values include: 'Invalid', 'AzureIaasVM', 'MAB', 'DPM',
   ...
   * @property {date} [startTime] Job has started at this time. Value is in
   * UTC.
