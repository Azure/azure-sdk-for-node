 ...
 */
function _trigger(vaultName, resourceGroupName, fabricName, containerName, protectedItemName, resourceBackupRequest, options, callback) {
  ...
  try {
    ...
    if (resourceBackupRequest === null || resourceBackupRequest === undefined) {
      throw new Error('resourceBackupRequest cannot be null or undefined.');
    }
  ...
  try {
    if (resourceBackupRequest !== null && resourceBackupRequest !== undefined) {
      ...
      requestModel = client.serialize(requestModelMapper, resourceBackupRequest, 'resourceBackupRequest');
      requestContent = JSON.stringify(requestModel);
    }
  } catch (error) {
    let serializationError = new Error(`Error "${error.message}" occurred in serializing the ` +
        `payload - ${JSON.stringify(resourceBackupRequest, null, 2)}.`);
...
class Backups {
   ...
   */
  triggerWithHttpOperationResponse(vaultName, resourceGroupName, fabricName, containerName, protectedItemName, resourceBackupRequest, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._trigger(vaultName, resourceGroupName, fabricName, containerName, protectedItemName, resourceBackupRequest, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  trigger(vaultName, resourceGroupName, fabricName, containerName, protectedItemName, resourceBackupRequest, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._trigger(vaultName, resourceGroupName, fabricName, containerName, protectedItemName, resourceBackupRequest, options, optionalCallback);
    }
  }
