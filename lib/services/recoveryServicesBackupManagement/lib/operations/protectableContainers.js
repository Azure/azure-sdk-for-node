 ...
 */
function _list(vaultName, resourceGroupName, fabricName, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/protectableContainers';
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['ProtectableContainerResourceList']().mapper();
...
class ProtectableContainers {
   ...
   */
  listWithHttpOperationResponse(vaultName, resourceGroupName, fabricName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._list(vaultName, resourceGroupName, fabricName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  list(vaultName, resourceGroupName, fabricName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._list(vaultName, resourceGroupName, fabricName, options, optionalCallback);
    }
  }
...
module.exports = ProtectableContainers;
