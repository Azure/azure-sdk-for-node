 ...
 */
function _get(vaultName, resourceGroupName, fabricName, policyName, operationId, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/policies/{policyName}/operationResults/{operationId}';
...
class ScopedProtectionPolicyOperationResults {
  /**
   ...
   */
  getWithHttpOperationResponse(vaultName, resourceGroupName, fabricName, policyName, operationId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._get(vaultName, resourceGroupName, fabricName, policyName, operationId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  get(vaultName, resourceGroupName, fabricName, policyName, operationId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._get(vaultName, resourceGroupName, fabricName, policyName, operationId, options, optionalCallback);
    }
  }

}

module.exports = ScopedProtectionPolicyOperationResults;
