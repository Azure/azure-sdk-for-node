...
function _get(vaultName, resourceGroupName, fabricName, policyName, operationId, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/policies/{policyName}/operations/{operationId}';
...
class ScopedProtectionPolicyOperationStatuses {
  /**
...
module.exports = ScopedProtectionPolicyOperationStatuses;
