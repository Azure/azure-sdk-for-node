 ...
 */
function _get(vaultName, resourceGroupName, jobName, operationId, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupJobs/{jobName}/operationResults/{operationId}';
 ...
 * Initializes a new instance of the JobOperationResults class.
 * @constructor
 *
...
class JobOperationResults {
   ...
   */
  getWithHttpOperationResponse(vaultName, resourceGroupName, jobName, operationId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._get(vaultName, resourceGroupName, jobName, operationId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  get(vaultName, resourceGroupName, jobName, operationId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._get(vaultName, resourceGroupName, jobName, operationId, options, optionalCallback);
    }
  }

}

module.exports = JobOperationResults;
