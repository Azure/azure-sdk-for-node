...
function _get(vaultName, resourceGroupName, operationId, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupOperations/{operationId}';
 ...
 * Initializes a new instance of the BackupOperationStatuses class.
 * @constructor
 *
...
module.exports = BackupOperationStatuses;
