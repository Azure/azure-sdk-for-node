 ...
 */
function _validate(vaultName, resourceGroupName, parameters, options, callback) {
...
class Operation {
   ...
   */
  validateWithHttpOperationResponse(vaultName, resourceGroupName, parameters, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._validate(vaultName, resourceGroupName, parameters, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  validate(vaultName, resourceGroupName, parameters, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._validate(vaultName, resourceGroupName, parameters, options, optionalCallback);
    }
  }
