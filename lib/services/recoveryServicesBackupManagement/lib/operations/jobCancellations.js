 ...
 */
function _trigger(vaultName, resourceGroupName, jobName, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupJobs/{jobName}/cancel';
 ...
 * Initializes a new instance of the JobCancellations class.
 * @constructor
 *
...
class JobCancellations {
   ...
   */
  triggerWithHttpOperationResponse(vaultName, resourceGroupName, jobName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._trigger(vaultName, resourceGroupName, jobName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  trigger(vaultName, resourceGroupName, jobName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._trigger(vaultName, resourceGroupName, jobName, options, optionalCallback);
    }
  }

}

module.exports = JobCancellations;
