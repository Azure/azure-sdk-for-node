 ...
 */
function _operation(vaultName, resourceGroupName, parameters, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupValidateOperation';
  ...
  try {
    if (parameters !== null && parameters !== undefined) {
      let requestModelMapper = new client.models['ValidateOperationRequestResource']().mapper();
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['ValidateOperationsResponse']().mapper();
...
class Validate {
   ...
   */
  operationWithHttpOperationResponse(vaultName, resourceGroupName, parameters, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._operation(vaultName, resourceGroupName, parameters, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  operation(vaultName, resourceGroupName, parameters, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._operation(vaultName, resourceGroupName, parameters, options, optionalCallback);
    }
  }
