...
function _get(vaultName, resourceGroupName, policyName, operationId, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupPolicies/{policyName}/operationResults/{operationId}';
 ...
 * Initializes a new instance of the ProtectionPolicyOperationResults class.
 * @constructor
 *
...
module.exports = ProtectionPolicyOperationResults;
