...
class RecoveryServicesBackupClient extends ServiceClient {
  ...
  constructor(credentials, subscriptionId, baseUri, options) {
    ...
    this.protectionIntentOperations = new operations.ProtectionIntentOperations(this);
...
module.exports['default'] = RecoveryServicesBackupClient;
module.exports.RecoveryServicesBackupClient = RecoveryServicesBackupClient;
module.exports.RecoveryServicesBackupModels = models;
