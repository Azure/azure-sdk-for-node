 ...
 */
function _spellChecker(options, callback) {
...
class SpellCheckAPIClient extends ServiceClient {
   ...
   */
  spellCheckerWithHttpOperationResponse(options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._spellChecker(options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  spellChecker(options, optionalCallback) {
    let client = this;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._spellChecker(options, optionalCallback);
    }
  }
