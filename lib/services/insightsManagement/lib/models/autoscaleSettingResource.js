 ...
 * 
 */
function AutoscaleSettingResource() {
  AutoscaleSettingResource['super_'].call(this);
}

util.inherits(AutoscaleSettingResource, models['Resource']);
 ...
 *
 */
AutoscaleSettingResource.prototype.mapper = function () {
  return {
    required: false,
