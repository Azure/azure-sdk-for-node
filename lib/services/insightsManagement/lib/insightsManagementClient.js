 ...
 *
 */
function InsightsManagementClient(credentials, subscriptionId, baseUri, options) {
  ...
  InsightsManagementClient['super_'].call(this, credentials, options);
  ...
  this.serviceDiagnosticSettingsOperations = new operations.ServiceDiagnosticSettingsOperations(this);
...
util.inherits(InsightsManagementClient, ServiceClient);

module.exports = InsightsManagementClient;
