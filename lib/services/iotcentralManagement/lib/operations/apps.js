 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _checkNameAvailability(nameAvailabilityInputs, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  try {
    ...
    if (nameAvailabilityInputs === null || nameAvailabilityInputs === undefined) {
      throw new Error('nameAvailabilityInputs cannot be null or undefined.');
    }
    if (this.client.acceptLanguage !== null && this.client.acceptLanguage !== undefined && typeof this.client.acceptLanguage.valueOf() !== 'string') {
      throw new Error('this.client.acceptLanguage must be of type string.');
    }
  ...
  try {
    if (nameAvailabilityInputs !== null && nameAvailabilityInputs !== undefined) {
      let requestModelMapper = new client.models['NameAvailabilityInputs']().mapper();
      requestModel = client.serialize(requestModelMapper, nameAvailabilityInputs, 'nameAvailabilityInputs');
      requestContent = JSON.stringify(requestModel);
    }
  } catch (error) {
    let serializationError = new Error(`Error "${error.message}" occurred in serializing the ` +
        `payload - ${JSON.stringify(nameAvailabilityInputs, null, 2)}.`);
  ...
  return client.pipeline(httpRequest, (err, response, responseBody) => {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['AppAvailabilityInfo']().mapper();
          result = client.deserialize(resultMapper, parsedResponse, 'result');
        }
      } catch (error) {
        let deserializationError = new Error(`Error ${error} occurred in deserializing the responseBody - ${responseBody}`);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _checkSubdomainAvailability(subdomainAvailabilityInputs, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  try {
    ...
    if (subdomainAvailabilityInputs === null || subdomainAvailabilityInputs === undefined) {
      throw new Error('subdomainAvailabilityInputs cannot be null or undefined.');
    }
    if (this.client.acceptLanguage !== null && this.client.acceptLanguage !== undefined && typeof this.client.acceptLanguage.valueOf() !== 'string') {
      throw new Error('this.client.acceptLanguage must be of type string.');
    }
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/providers/Microsoft.IoTCentral/checkSubdomainAvailability';
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  let queryParameters = [];
  queryParameters.push('api-version=' + encodeURIComponent(this.client.apiVersion));
  if (queryParameters.length > 0) {
  ...
  try {
    if (subdomainAvailabilityInputs !== null && subdomainAvailabilityInputs !== undefined) {
      let requestModelMapper = new client.models['SubdomainAvailabilityInputs']().mapper();
      requestModel = client.serialize(requestModelMapper, subdomainAvailabilityInputs, 'subdomainAvailabilityInputs');
      requestContent = JSON.stringify(requestModel);
    }
  } catch (error) {
    let serializationError = new Error(`Error "${error.message}" occurred in serializing the ` +
        `payload - ${JSON.stringify(subdomainAvailabilityInputs, null, 2)}.`);
    return callback(serializationError);
  }
  httpRequest.body = requestContent;
  // Send Request
...
class Apps {
  ...
  constructor(client) {
    ...
    this._checkSubdomainAvailability = _checkSubdomainAvailability;
   ...
   * @reject {Error} - The error object.
   */
  checkNameAvailabilityWithHttpOperationResponse(nameAvailabilityInputs, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._checkNameAvailability(nameAvailabilityInputs, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  checkNameAvailability(nameAvailabilityInputs, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._checkNameAvailability(nameAvailabilityInputs, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  checkSubdomainAvailabilityWithHttpOperationResponse(subdomainAvailabilityInputs, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._checkSubdomainAvailability(subdomainAvailabilityInputs, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  checkSubdomainAvailability(subdomainAvailabilityInputs, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._checkSubdomainAvailability(subdomainAvailabilityInputs, options, optionalCallback);
    }
  }
