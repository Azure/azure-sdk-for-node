...
class ManagementGroup {
   ...
   * management group.
   * @property {boolean} [isGateway] Gets or sets a value indicating whether
   * the management group is a gateway.
   ...
   * created.
   * @property {date} [dataReceived] The last datetime that the management
   * group received data.
