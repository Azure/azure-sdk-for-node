...
class WorkspacePurgeResponse {
  /**
   * Create a WorkspacePurgeResponse.
  ...
  /**
   * Defines the metadata of WorkspacePurgeResponse
   *
   * @returns {object} metadata of WorkspacePurgeResponse
   *
   */
  mapper() {
    return {
...
module.exports = WorkspacePurgeResponse;
