...
export default class SqlVirtualMachineManagementClient extends AzureServiceClient {
  /**
...
export { SqlVirtualMachineManagementClient, models as SqlVirtualMachineManagementModels };
