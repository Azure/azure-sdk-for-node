 ...
 */
function _getDetails(operationId, options, callback) {
...
class Operations {
   ...
   */
  getDetailsWithHttpOperationResponse(operationId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getDetails(operationId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getDetails(operationId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._getDetails(operationId, options, optionalCallback);
    }
  }
