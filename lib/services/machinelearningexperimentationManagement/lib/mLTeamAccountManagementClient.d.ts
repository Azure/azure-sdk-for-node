...
export default class MLTeamAccountManagementClient extends AzureServiceClient {
  /**
...
export { MLTeamAccountManagementClient, models as MLTeamAccountManagementModels };
