...
class Account extends models['Resource'] {
   ...
   * This will be the workspace name in the arm id when the workspace object
   * gets created
   ...
   * for the machine learning team account.
   * @property {string} [storageAccount.storageAccountId] The fully qualified
   * arm Id of the storage account.
   * @property {string} [storageAccount.accessKey] The access key to the
   * storage account.
   * @property {string} [provisioningState] The current deployment state of
   * team account resource. The provisioningState is to indicate states for
