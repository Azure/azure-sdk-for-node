...
class AzureMLBatchExecutionActivity extends models['ExecutionActivity'] {
   ...
   * @property {object} [webServiceOutputs] Key,Value pairs, mapping the names
   ...
   * request.
   * @property {object} [webServiceInputs] Key,Value pairs, mapping the names
   * of Azure ML endpoint's Web Service Inputs to AzureMLWebServiceFile objects
