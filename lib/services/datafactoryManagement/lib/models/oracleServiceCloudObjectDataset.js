 ...
 */
class OracleServiceCloudObjectDataset extends models['Dataset'] {
  /**
   * Create a OracleServiceCloudObjectDataset.
   */
  constructor() {
    super();
  }
  ...
  /**
   * Defines the metadata of OracleServiceCloudObjectDataset
   *
...
module.exports = OracleServiceCloudObjectDataset;
