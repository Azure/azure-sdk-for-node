...
class ManagedIntegrationRuntime extends models['IntegrationRuntime'] {
   ...
   * @property {object} [computeProperties.virtualNetwork] VNet properties for
   * managed integration runtime.
   * @property {string} [computeProperties.virtualNetwork.subnetId] The ID of
   * the Subnet that this integration runtime will join.
