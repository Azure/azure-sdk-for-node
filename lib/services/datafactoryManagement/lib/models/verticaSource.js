 ...
 */
class VerticaSource extends models['CopySource'] {
  /**
   * Create a VerticaSource.
  ...
  /**
   * Defines the metadata of VerticaSource
   *
   * @returns {object} metadata of VerticaSource
   *
   */
  mapper() {
    return {
