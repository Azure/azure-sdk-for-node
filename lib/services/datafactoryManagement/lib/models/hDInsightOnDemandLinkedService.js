...
class HDInsightOnDemandLinkedService extends models['LinkedService'] {
   ...
   * @property {object} linkedServiceName Azure Storage linked service to be
   ...
   * @property {object} tenant The Tenant id/name to which the service
   * principal belongs. Type: string (or Expression with resultType string).
   * @property {object} clusterResourceGroup The resource group where the
   ...
   * @property {object} [clusterSshUserName] The username to SSH remotely
   ...
   * @property {object} [hcatalogLinkedServiceName] The name of Azure SQL
   ...
   * the HDInsight cluster.
   * @property {object} [zookeeperNodeSize] Specifies the size of the Zoo
   * Keeper node for the HDInsight cluster.
