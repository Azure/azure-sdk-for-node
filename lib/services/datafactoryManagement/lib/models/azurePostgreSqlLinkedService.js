...
class AzurePostgreSqlLinkedService extends models['LinkedService'] {
  ...
  /**
   * Defines the metadata of AzurePostgreSqlLinkedService
   *
   * @returns {object} metadata of AzurePostgreSqlLinkedService
   *
   */
  mapper() {
    return {
...
module.exports = AzurePostgreSqlLinkedService;
