 ...
 */
class MarketoLinkedService extends models['LinkedService'] {
  /**
   * Create a MarketoLinkedService.
   ...
   * @property {object} [clientSecret] The client secret of your Marketo
   * service.
  ...
  /**
   * Defines the metadata of MarketoLinkedService
   *
   * @returns {object} metadata of MarketoLinkedService
   *
   */
  mapper() {
    return {
...
module.exports = MarketoLinkedService;
