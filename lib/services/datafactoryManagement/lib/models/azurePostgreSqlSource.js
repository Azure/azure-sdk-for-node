...
class AzurePostgreSqlSource extends models['CopySource'] {
  /**
   * Create a AzurePostgreSqlSource.
  ...
  /**
   * Defines the metadata of AzurePostgreSqlSource
   *
   * @returns {object} metadata of AzurePostgreSqlSource
   *
   */
  mapper() {
    return {
...
module.exports = AzurePostgreSqlSource;
