...
class JsonFormat extends models['DatasetStorageFormat'] {
  /**
   * Create a JsonFormat.
   * @property {string} [filePattern] File pattern of JSON. To be more
   * specific, the way of separating a collection of JSON objects. The default
   * value is 'setOfObjects'. It is case-sensitive. Possible values include:
   * 'setOfObjects', 'arrayOfObjects'
   * @property {object} [nestingSeparator] The character used to separate
   * nesting levels. Default value is '.' (dot). Type: string (or Expression
