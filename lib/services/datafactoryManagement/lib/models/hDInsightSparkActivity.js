...
class HDInsightSparkActivity extends models['ExecutionActivity'] {
   ...
   * @property {object} rootPath The root path in 'sparkJobLinkedService' for
   * all the job’s files. Type: string (or Expression with resultType string).
   * @property {object} entryFilePath The relative path to the root folder of
   ...
   * @property {object} [proxyUser] The user to impersonate that will execute
