...
class AzureMLLinkedService extends models['LinkedService'] {
   ...
   * @property {object} [updateResourceEndpoint] The Update Resource REST URL
   * for an Azure ML Web Service endpoint. Type: string (or Expression with
   * resultType string).
   ...
   * Azure ML web service. Type: string (or Expression with resultType string).
