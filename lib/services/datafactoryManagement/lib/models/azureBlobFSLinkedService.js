 ...
 */
class AzureBlobFSLinkedService extends models['LinkedService'] {
  /**
   * Create a AzureBlobFSLinkedService.
   * @property {object} url Endpoint for the Azure Data Lake Storage Gen2
   * service. Type: string (or Expression with resultType string).
   * @property {object} [accountKey] Account key for the Azure Data Lake
   * Storage Gen2 service. Type: string (or Expression with resultType string).
   ...
   * to authenticate against the Azure Data Lake Storage Gen2 account.
  ...
  /**
   * Defines the metadata of AzureBlobFSLinkedService
   *
...
module.exports = AzureBlobFSLinkedService;
