 ...
 */
class DynamicsAXSource extends models['CopySource'] {
  /**
   * Create a DynamicsAXSource.
  ...
  /**
   * Defines the metadata of DynamicsAXSource
   *
   * @returns {object} metadata of DynamicsAXSource
   *
   */
  mapper() {
    return {
...
module.exports = DynamicsAXSource;
