...
class RerunTriggerResource extends models['SubResource'] {
   ...
   * @property {object} [properties.parentTrigger] The parent trigger
   * reference.
   * @property {date} [properties.requestedStartTime] The start time for the
   * time period for which restatement is initiated. Only UTC time is currently
   * supported.
