 ...
 */
class MariaDBSource extends models['CopySource'] {
  /**
   * Create a MariaDBSource.
  ...
  /**
   * Defines the metadata of MariaDBSource
   *
   * @returns {object} metadata of MariaDBSource
   *
   */
  mapper() {
    return {
