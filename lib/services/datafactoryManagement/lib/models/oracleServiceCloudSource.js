...
class OracleServiceCloudSource extends models['CopySource'] {
  /**
   * Create a OracleServiceCloudSource.
  ...
  /**
   * Defines the metadata of OracleServiceCloudSource
   *
   * @returns {object} metadata of OracleServiceCloudSource
   *
   */
  mapper() {
    return {
...
module.exports = OracleServiceCloudSource;
