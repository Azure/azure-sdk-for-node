...
class IntegrationRuntimeComputeProperties {
   ...
   * integration runtime will join.
   * @property {object} [virtualNetwork] VNet properties for managed
   * integration runtime.
   * @property {string} [virtualNetwork.subnetId] The ID of the Subnet that
   * this integration runtime will join.
   */
  constructor() {
  }
