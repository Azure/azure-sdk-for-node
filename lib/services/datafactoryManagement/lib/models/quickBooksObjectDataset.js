 ...
 */
class QuickBooksObjectDataset extends models['Dataset'] {
  /**
   * Create a QuickBooksObjectDataset.
  ...
  /**
   * Defines the metadata of QuickBooksObjectDataset
   *
   * @returns {object} metadata of QuickBooksObjectDataset
   *
   */
  mapper() {
    return {
...
module.exports = QuickBooksObjectDataset;
