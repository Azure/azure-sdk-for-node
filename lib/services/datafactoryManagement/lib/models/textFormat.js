...
class TextFormat extends models['DatasetStorageFormat'] {
  /**
   * Create a TextFormat.
   * @property {object} [columnDelimiter] The column delimiter. Type: string
   ...
   * (or Expression with resultType string).
   * @property {object} [treatEmptyAsNull] Treat empty column values in the
   * text file as null. The default value is true. Type: boolean (or Expression
