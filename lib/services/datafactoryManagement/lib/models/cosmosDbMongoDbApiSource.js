...
class CosmosDbMongoDbApiSource extends models['CopySource'] {
  /**
   * Create a CosmosDbMongoDbApiSource.
  ...
  /**
   * Defines the metadata of CosmosDbMongoDbApiSource
   *
   * @returns {object} metadata of CosmosDbMongoDbApiSource
   *
   */
  mapper() {
    return {
...
module.exports = CosmosDbMongoDbApiSource;
