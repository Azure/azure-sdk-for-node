...
class RestServiceLinkedService extends models['LinkedService'] {
   ...
   * @property {object} url The base URL of the REST service.
   * @property {object} [enableServerCertificateValidation] Whether to validate
   ...
   * @property {object} [userName] The user name used in Basic authentication
   * type.
   * @property {object} [password] The password used in Basic authentication
   * type.
   * @property {string} [password.type] Polymorphic Discriminator
   * @property {object} [servicePrincipalId] The application's client ID used
   * in AadServicePrincipal authentication type.
   * @property {object} [servicePrincipalKey] The application's key used in
   * AadServicePrincipal authentication type.
   * @property {string} [servicePrincipalKey.type] Polymorphic Discriminator
   * @property {object} [tenant] The tenant information (domain name or tenant
