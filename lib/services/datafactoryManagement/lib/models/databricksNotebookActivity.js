...
class DatabricksNotebookActivity extends models['ExecutionActivity'] {
   ...
   * @property {object} notebookPath The absolute path of the notebook to be
   * run in the Databricks Workspace. This path must begin with a slash. Type:
   * string (or Expression with resultType string).
   * @property {object} [baseParameters] Base parameters to be used for each
   * run of this job.If the notebook takes a parameter that is not specified,
   * the default value from the notebook will be used.
