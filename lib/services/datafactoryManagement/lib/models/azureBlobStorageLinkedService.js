...
class AzureBlobStorageLinkedService extends models['LinkedService'] {
   ...
   * mutually exclusive with sasUri, serviceEndpoint property. Type: string,
   ...
   * Azure Key Vault. The default value is the latest version of the secret.
   * Type: string (or Expression with resultType string).
   * @property {string} [serviceEndpoint] Blob service endpoint of the Azure
   * Blob Storage resource. It is mutually exclusive with connectionString,
   * sasUri property.
   * @property {object} [servicePrincipalId] The ID of the service principal
