...
class AzureDataLakeStoreLinkedService extends models['LinkedService'] {
   ...
   * @property {object} [servicePrincipalKey] The Key of the application used
   * to authenticate against the Azure Data Lake Store account.
   ...
   * string).
   * @property {object} [accountName] Data Lake Store account name. Type:
   * string (or Expression with resultType string).
   * @property {object} [subscriptionId] Data Lake Store account subscription
