 ...
 */
class GoogleAdWordsLinkedService extends models['LinkedService'] {
  /**
   * Create a GoogleAdWordsLinkedService.
   * @property {object} clientCustomerID The Client customer ID of the AdWords
   * account that you want to fetch report data for.
   * @property {object} developerToken The developer token associated with the
   * manager account that you use to grant access to the AdWords API.
   * @property {string} [developerToken.type] Polymorphic Discriminator
  ...
  /**
   * Defines the metadata of GoogleAdWordsLinkedService
   *
...
module.exports = GoogleAdWordsLinkedService;
