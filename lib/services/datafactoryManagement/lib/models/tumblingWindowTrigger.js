...
class TumblingWindowTrigger extends models['Trigger'] {
   ...
   * @property {object} pipelineProperty Pipeline for which runs are created
   * when an event is fired for trigger window that is ready.
   * @property {object} [pipelineProperty.pipelineReference] Pipeline
   * reference.
   * @property {string} [pipelineProperty.pipelineReference.referenceName]
   * Reference pipeline name.
   * @property {string} [pipelineProperty.pipelineReference.name] Reference
   * name.
   ...
   * @property {date} [endTime] The end time for the time period for the
   * trigger during which events are fired for windows that are ready. Only UTC
   * time is currently supported.
   ...
   * minimum: 0.
   * @property {number} [retryPolicy.intervalInSeconds] Interval between
   * retries in seconds. Default is 30.
        ...
        modelProperties: {
          ...
          dependsOn: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'DependencyReferenceElementType',
                  type: {
                    name: 'Composite',
                    polymorphicDiscriminator: {
                      serializedName: 'type',
