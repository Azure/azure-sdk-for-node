...
class AzureDataLakeAnalyticsLinkedService extends models['LinkedService'] {
   ...
   * to authenticate against the Azure Data Lake Analytics account.
   ...
   * string).
   * @property {object} [subscriptionId] Data Lake Analytics account
   * subscription ID (if different from Data Factory account). Type: string (or
   * Expression with resultType string).
   * @property {object} [resourceGroupName] Data Lake Analytics account
   * resource group name (if different from Data Factory account). Type: string
   * (or Expression with resultType string).
