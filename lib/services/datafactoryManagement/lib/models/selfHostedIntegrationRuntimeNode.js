...
class SelfHostedIntegrationRuntimeNode {
   ...
   * integration runtime.
   * @property {string} [status] Status of the integration runtime node.
   * Possible values include: 'NeedRegistration', 'Online', 'Limited',
   * 'Offline', 'Upgrading', 'Initializing', 'InitializeFailed'
   ...
   * @property {date} [expiryTime] The time at which the integration runtime
   * will expire in ISO8601 format.
   * @property {date} [lastStartTime] The time the node last started up.
   * @property {date} [lastStopTime] The integration runtime node last stop
   * time.
   ...
   * @property {boolean} [isActiveDispatcher] Indicates whether this node is
   * the active dispatcher for integration runtime requests.
