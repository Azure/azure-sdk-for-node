...
function _queryByPipelineRun(resourceGroupName, factoryName, runId, filterParameters, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/pipelineruns/{runId}/queryActivityruns';
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['ActivityRunsQueryResponse']().mapper();
...
class ActivityRuns {
  ...
  constructor(client) {
    this.client = client;
    this._queryByPipelineRun = _queryByPipelineRun;
  }
   ...
   */
  queryByPipelineRunWithHttpOperationResponse(resourceGroupName, factoryName, runId, filterParameters, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._queryByPipelineRun(resourceGroupName, factoryName, runId, filterParameters, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  queryByPipelineRun(resourceGroupName, factoryName, runId, filterParameters, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._queryByPipelineRun(resourceGroupName, factoryName, runId, filterParameters, options, optionalCallback);
    }
  }
