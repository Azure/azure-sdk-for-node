 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getGitHubAccessToken(resourceGroupName, factoryName, gitHubAccessTokenRequest, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  try {
    ...
    if (gitHubAccessTokenRequest === null || gitHubAccessTokenRequest === undefined) {
      throw new Error('gitHubAccessTokenRequest cannot be null or undefined.');
    }
    if (this.client.acceptLanguage !== null && this.client.acceptLanguage !== undefined && typeof this.client.acceptLanguage.valueOf() !== 'string') {
      throw new Error('this.client.acceptLanguage must be of type string.');
    }
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/getGitHubAccessToken';
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  requestUrl = requestUrl.replace('{resourceGroupName}', encodeURIComponent(resourceGroupName));
  requestUrl = requestUrl.replace('{factoryName}', encodeURIComponent(factoryName));
  let queryParameters = [];
  ...
  try {
    if (gitHubAccessTokenRequest !== null && gitHubAccessTokenRequest !== undefined) {
      let requestModelMapper = new client.models['GitHubAccessTokenRequest']().mapper();
      requestModel = client.serialize(requestModelMapper, gitHubAccessTokenRequest, 'gitHubAccessTokenRequest');
      requestContent = JSON.stringify(requestModel);
    }
  } catch (error) {
    let serializationError = new Error(`Error "${error.message}" occurred in serializing the ` +
        `payload - ${JSON.stringify(gitHubAccessTokenRequest, null, 2)}.`);
    return callback(serializationError);
  }
  httpRequest.body = requestContent;
  // Send Request
  return client.pipeline(httpRequest, (err, response, responseBody) => {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['GitHubAccessTokenResponse']().mapper();
          result = client.deserialize(resultMapper, parsedResponse, 'result');
        }
      } catch (error) {
        let deserializationError = new Error(`Error ${error} occurred in deserializing the responseBody - ${responseBody}`);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getDataPlaneReadOnlyToken(resourceGroupName, factoryName, dataPlaneReadOnlyTokenRequest, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  try {
    ...
    if (dataPlaneReadOnlyTokenRequest === null || dataPlaneReadOnlyTokenRequest === undefined) {
      throw new Error('dataPlaneReadOnlyTokenRequest cannot be null or undefined.');
    }
    if (this.client.acceptLanguage !== null && this.client.acceptLanguage !== undefined && typeof this.client.acceptLanguage.valueOf() !== 'string') {
      throw new Error('this.client.acceptLanguage must be of type string.');
    }
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/getDataPlaneReadOnlyToken';
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  requestUrl = requestUrl.replace('{resourceGroupName}', encodeURIComponent(resourceGroupName));
  requestUrl = requestUrl.replace('{factoryName}', encodeURIComponent(factoryName));
  let queryParameters = [];
  ...
  try {
    if (dataPlaneReadOnlyTokenRequest !== null && dataPlaneReadOnlyTokenRequest !== undefined) {
      let requestModelMapper = new client.models['DataPlaneReadOnlyTokenRequest']().mapper();
      requestModel = client.serialize(requestModelMapper, dataPlaneReadOnlyTokenRequest, 'dataPlaneReadOnlyTokenRequest');
      requestContent = JSON.stringify(requestModel);
    }
  } catch (error) {
    let serializationError = new Error(`Error "${error.message}" occurred in serializing the ` +
        `payload - ${JSON.stringify(dataPlaneReadOnlyTokenRequest, null, 2)}.`);
    return callback(serializationError);
  }
  httpRequest.body = requestContent;
  // Send Request
  return client.pipeline(httpRequest, (err, response, responseBody) => {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['DataPlaneReadOnlyTokenResponse']().mapper();
          result = client.deserialize(resultMapper, parsedResponse, 'result');
        }
      } catch (error) {
        let deserializationError = new Error(`Error ${error} occurred in deserializing the responseBody - ${responseBody}`);
...
class Factories {
  ...
  constructor(client) {
    ...
    this._getDataPlaneReadOnlyToken = _getDataPlaneReadOnlyToken;
   ...
   * @reject {Error} - The error object.
   */
  getGitHubAccessTokenWithHttpOperationResponse(resourceGroupName, factoryName, gitHubAccessTokenRequest, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getGitHubAccessToken(resourceGroupName, factoryName, gitHubAccessTokenRequest, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getGitHubAccessToken(resourceGroupName, factoryName, gitHubAccessTokenRequest, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getGitHubAccessToken(resourceGroupName, factoryName, gitHubAccessTokenRequest, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getDataPlaneReadOnlyTokenWithHttpOperationResponse(resourceGroupName, factoryName, dataPlaneReadOnlyTokenRequest, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getDataPlaneReadOnlyToken(resourceGroupName, factoryName, dataPlaneReadOnlyTokenRequest, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getDataPlaneReadOnlyToken(resourceGroupName, factoryName, dataPlaneReadOnlyTokenRequest, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getDataPlaneReadOnlyToken(resourceGroupName, factoryName, dataPlaneReadOnlyTokenRequest, options, optionalCallback);
    }
  }
