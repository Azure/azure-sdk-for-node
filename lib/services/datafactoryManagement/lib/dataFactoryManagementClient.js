...
class DataFactoryManagementClient extends ServiceClient {
   ...
   */
  constructor(credentials, subscriptionId, locationId, baseUri, options) {
    ...
    if (locationId === null || locationId === undefined) {
      throw new Error('\'locationId\' cannot be null.');
    }
    ...
    this.configureFactoryRepo = new operations.ConfigureFactoryRepo(this);
