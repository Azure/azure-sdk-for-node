 ...
 */
class SquareLinkedService extends models['LinkedService'] {
  /**
   * Create a SquareLinkedService.
  ...
  /**
   * Defines the metadata of SquareLinkedService
   *
   * @returns {object} metadata of SquareLinkedService
   *
   */
  mapper() {
    return {
...
module.exports = SquareLinkedService;
