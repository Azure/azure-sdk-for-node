 ...
 */
class GoogleBigQueryObjectDataset extends models['Dataset'] {
  /**
   * Create a GoogleBigQueryObjectDataset.
   */
  constructor() {
    super();
  }
  ...
  /**
   * Defines the metadata of GoogleBigQueryObjectDataset
   *
...
module.exports = GoogleBigQueryObjectDataset;
