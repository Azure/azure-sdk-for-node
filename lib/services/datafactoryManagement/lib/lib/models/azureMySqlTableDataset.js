 ...
 */
class AzureMySqlTableDataset extends models['Dataset'] {
  /**
   * Create a AzureMySqlTableDataset.
  ...
  /**
   * Defines the metadata of AzureMySqlTableDataset
   *
...
module.exports = AzureMySqlTableDataset;
