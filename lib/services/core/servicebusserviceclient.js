...
ServiceBusServiceClient.prototype._buildRequestOptions = function (webResource, options, callback) {
  ...
  // Set API version
  if (webResource.queryString[Constants.ServiceBusConstants.API_VERSION_QUERY_KEY] === undefined && this.apiVersion) {
    webResource.addOptionalQueryParam(Constants.ServiceBusConstants.API_VERSION_QUERY_KEY, this.apiVersion);
  }
