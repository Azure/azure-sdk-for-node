...
StorageServiceClient.getStorageSettings = function (storageAccountOrConnectionString, storageAccessKey, host) {
  ...
  if (typeof storageAccountOrConnectionString === 'string' && !storageAccessKey) {
  ...
  } else if (typeof storageAccountOrConnectionString === 'function') {
    ...
    storageServiceSettings = StorageServiceSettings.createExplicitlyOrFromEnvironment(
