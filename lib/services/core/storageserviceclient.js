  ...
  if (storageAccountOrConnectionString && !storageAccessKey) {
    ...
    if (!(storageAccountOrConnectionString && storageAccessKey) && ServiceClient.isEmulated()) {
      ...
      if (host) {
        ...
        blobendpoint = url.format({ protocol: parsedHost.protocol, port: parsedHost.port, hostname: storageAccountOrConnectionString + '.' + parsedHost.host });
        tableendpoint = url.format({ protocol: parsedHost.protocol, port: parsedHost.port, hostname: storageAccountOrConnectionString + '.' + parsedHost.host });
        queueendpoint = url.format({ protocol: parsedHost.protocol, port: parsedHost.port, hostname: storageAccountOrConnectionString + '.' + parsedHost.host });
      }
