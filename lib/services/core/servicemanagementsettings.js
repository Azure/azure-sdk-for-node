...
var configKeys = {
  ...
  HOST: 'service management host name',
  PORT: 'service management host port'
};

ServiceManagementSettings.customiseConfig = function (config) {
  ...
  _.extend(config, {
    ...
    serviceManagementHost: setValue('HOST'),
    serviceManagementPort: setValue('PORT'),
