...
class ProvisioningServiceDescription extends models['Resource'] {
   ...
   * @property {object} properties Service specific properties for a
   ...
   * @property {string} [properties.provisioningState] The ARM provisioning
   * state of the provisioning service.
   * @property {array} [properties.iotHubs] List of IoT hubs associated with
   ...
   * @property {string} [sku.tier] Pricing tier name of the provisioning
   * service.
