...
export interface Face {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    detectWithUrlWithHttpOperationResponse(url: string, options?: { returnFaceId? : boolean, returnFaceLandmarks? : boolean, returnFaceAttributes? : string[], recognitionModel? : string, customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.DetectedFace[]>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    detectWithUrl(url: string, options?: { returnFaceId? : boolean, returnFaceLandmarks? : boolean, returnFaceAttributes? : string[], recognitionModel? : string, customHeaders? : { [headerName: string]: string; } }): Promise<models.DetectedFace[]>;
    detectWithUrl(url: string, callback: ServiceCallback<models.DetectedFace[]>): void;
    detectWithUrl(url: string, options: { returnFaceId? : boolean, returnFaceLandmarks? : boolean, returnFaceAttributes? : string[], recognitionModel? : string, customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.DetectedFace[]>): void;
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    detectWithStreamWithHttpOperationResponse(image: stream.Readable, options?: { returnFaceId? : boolean, returnFaceLandmarks? : boolean, returnFaceAttributes? : string[], recognitionModel? : string, customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.DetectedFace[]>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    detectWithStream(image: stream.Readable, options?: { returnFaceId? : boolean, returnFaceLandmarks? : boolean, returnFaceAttributes? : string[], recognitionModel? : string, customHeaders? : { [headerName: string]: string; } }): Promise<models.DetectedFace[]>;
    detectWithStream(image: stream.Readable, callback: ServiceCallback<models.DetectedFace[]>): void;
    detectWithStream(image: stream.Readable, options: { returnFaceId? : boolean, returnFaceLandmarks? : boolean, returnFaceAttributes? : string[], recognitionModel? : string, customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.DetectedFace[]>): void;
}
