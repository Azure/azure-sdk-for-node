...
/** Class representing a AutoSuggestClient. */
class AutoSuggestClient extends ServiceClient {
  /**
   * Create a AutoSuggestClient.
...
module.exports = AutoSuggestClient;
module.exports['default'] = AutoSuggestClient;
module.exports.AutoSuggestClient = AutoSuggestClient;
module.exports.AutoSuggestModels = models;
