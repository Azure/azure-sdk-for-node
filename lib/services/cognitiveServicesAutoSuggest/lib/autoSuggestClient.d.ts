...
/**
 * AutoSuggestClientOptions for AutoSuggestClient.
 */
declare interface AutoSuggestClientOptions extends ServiceClientOptions {
  /**
...
export default class AutoSuggestClient extends ServiceClient {
  /**
   * @class
   ...
   *
   */
  constructor(credentials: ServiceClientCredentials, options?: AutoSuggestClientOptions);
...
export { AutoSuggestClient, models as AutoSuggestModels };
