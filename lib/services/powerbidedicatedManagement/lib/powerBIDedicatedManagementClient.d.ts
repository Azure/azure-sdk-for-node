...
export default class PowerBIDedicatedManagementClient extends AzureServiceClient {
  /**
...
export { PowerBIDedicatedManagementClient, models as PowerBIDedicatedManagementModels };
