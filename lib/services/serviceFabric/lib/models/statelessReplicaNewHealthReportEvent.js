...
class StatelessReplicaNewHealthReportEvent extends models['ReplicaEvent'] {
  ...
  /**
   * Defines the metadata of StatelessReplicaNewHealthReportEvent
   *
   * @returns {object} metadata of StatelessReplicaNewHealthReportEvent
   *
   */
  mapper() {
    return {
...
module.exports = StatelessReplicaNewHealthReportEvent;
