...
class StatelessServiceTypeDescription extends models['ServiceTypeDescription'] {
   ...
   * @property {boolean} [useImplicitHost] A flag indicating if this type is
   * not implemented and hosted by a user service process, but is implicitly
   * hosted by a system created process. This value is true for services using
