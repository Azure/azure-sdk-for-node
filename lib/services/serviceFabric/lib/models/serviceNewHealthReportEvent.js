 ...
 */
class ServiceNewHealthReportEvent extends models['ServiceEvent'] {
  /**
   * Create a ServiceNewHealthReportEvent.
  ...
  /**
   * Defines the metadata of ServiceNewHealthReportEvent
   *
   * @returns {object} metadata of ServiceNewHealthReportEvent
   *
   */
  mapper() {
    return {
...
module.exports = ServiceNewHealthReportEvent;
