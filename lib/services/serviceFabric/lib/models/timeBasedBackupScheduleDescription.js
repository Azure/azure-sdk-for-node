...
class TimeBasedBackupScheduleDescription extends models['BackupScheduleDescription'] {
   ...
   * to run the time based backup schedule.
   ...
   * Date specified along with time will be ignored.In the examples, date is
   * also specified with time but the date will always be ignored.
   */
  constructor() {
    super();
  }
