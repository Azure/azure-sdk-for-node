...
class UpdateClusterUpgrade {
   ...
   * restart
   * @member {string} [updateDescription.failureAction] The action of the
   * failure
   * @member {number}
   * [updateDescription.upgradeReplicaSetCheckTimeoutInSeconds] The seconds of
