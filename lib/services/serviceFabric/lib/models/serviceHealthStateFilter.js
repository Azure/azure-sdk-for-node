...
class ServiceHealthStateFilter {
   ...
   * @property {string} [serviceNameFilter] The name of the service that
   * matches the filter. The filter is applied only to the specified service,
   * if it exists.
   ...
   * @property {array} [partitionFilters] Defines a list of filters that
   * specify which partitions to be included in the returned cluster health
   * chunk as children of the service. The partitions are returned only if the
   * parent service matches a filter.
