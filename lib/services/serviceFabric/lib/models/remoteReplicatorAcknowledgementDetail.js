...
class RemoteReplicatorAcknowledgementDetail {
   ...
   * @property {string} [averageReceiveDuration] Represents the average
   * duration it takes for the remote replicator to receive an operation.
   * @property {string} [averageApplyDuration] Represents the average duration
   * it takes for the remote replicator to apply an operation. This usually
