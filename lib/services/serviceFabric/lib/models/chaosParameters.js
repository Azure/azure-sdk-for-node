...
class ChaosParameters {
   ...
   * @property {number} [maxConcurrentFaults] MaxConcurrentFaults is the
   ...
   * @property {number} [waitTimeBetweenIterationsInSeconds] Time-separation
   ...
   * 30 .
   * @property {object} [clusterHealthPolicy] Passed-in cluster health policy
   * is used to validate health of the cluster in between Chaos iterations. If
   * the cluster health is in error or if an unexpected exception happens
   * during fault execution--to provide the cluster with some time to
   ...
   * @property {object} [context.map] Describes a map that contains a
