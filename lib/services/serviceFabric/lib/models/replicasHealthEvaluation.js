 ...
 * 
 */
function ReplicasHealthEvaluation() {
  ReplicasHealthEvaluation['super_'].call(this);
}
 ...
 *
 */
ReplicasHealthEvaluation.prototype.mapper = function () {
  return {
    required: false,
    serializedName: 'ReplicasHealthEvaluation',
    type: {
      name: 'Composite',
