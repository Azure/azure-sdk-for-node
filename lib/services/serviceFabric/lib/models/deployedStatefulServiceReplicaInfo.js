...
class DeployedStatefulServiceReplicaInfo extends models['DeployedServiceReplicaInfo'] {
   ...
   * @property {string} [reconfigurationInformation.reconfigurationPhase]
   ...
   * @property {string} [reconfigurationInformation.reconfigurationType] Type
   * of current ongoing reconfiguration. If no reconfiguration is taking place
