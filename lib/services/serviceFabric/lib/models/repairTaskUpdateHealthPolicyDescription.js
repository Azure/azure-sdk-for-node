...
class RepairTaskUpdateHealthPolicyDescription {
   ...
   * @property {string} [version] The current version number of the repair
   * task. If non-zero, then the request will only succeed if this value
   * matches the actual current value of the repair task. If zero, then no
