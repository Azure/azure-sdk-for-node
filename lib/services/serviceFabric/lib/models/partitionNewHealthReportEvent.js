 ...
 */
class PartitionNewHealthReportEvent extends models['PartitionEvent'] {
  /**
   * Create a PartitionNewHealthReportEvent.
  ...
  /**
   * Defines the metadata of PartitionNewHealthReportEvent
   *
   * @returns {object} metadata of PartitionNewHealthReportEvent
   *
   */
  mapper() {
    return {
...
module.exports = PartitionNewHealthReportEvent;
