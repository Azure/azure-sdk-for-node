 ...
 * 
 */
function PartitionsHealthEvaluation() {
  PartitionsHealthEvaluation['super_'].call(this);
}

util.inherits(PartitionsHealthEvaluation, models['HealthEvaluation']);
 ...
 *
 */
PartitionsHealthEvaluation.prototype.mapper = function () {
  return {
    required: false,
    serializedName: 'PartitionsHealthEvaluation',
    type: {
      name: 'Composite',
