...
function _get(nodeName, applicationName, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Nodes/{nodeName}/$/GetApplications/{applicationName}/$/GetCodePackages';
...
/** Class representing a DeployedCodePackages. */
class DeployedCodePackages {
  /**
   * Create a DeployedCodePackages.
