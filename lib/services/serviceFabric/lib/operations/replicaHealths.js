...
ReplicaHealths.prototype.get = function (partitionId, replicaId, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Partitions/{partitionId}/$/GetReplicas/{replicaId}/$/GetHealth';
...
ReplicaHealths.prototype.send = function (partitionId, replicaId, replicaHealthReport, options, callback) {
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Partitions/{partitionId}/$/GetReplicas/{replicaId}/$/ReportHealth';
  requestUrl = requestUrl.replace('{partitionId}', encodeURIComponent(partitionId));
  requestUrl = requestUrl.replace('{replicaId}', encodeURIComponent(replicaId));
  var queryParameters = [];
  if (this.client.timeout !== null && this.client.timeout !== undefined) {
