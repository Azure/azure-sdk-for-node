...
ServiceGroups.prototype.create = function (applicationName, createServiceGroupDescription, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Applications/{applicationName}/$/GetServices/$/CreateServiceGroup';
...
ServiceGroups.prototype.update = function (applicationName, serviceName, updateServiceGroupDescription, options, callback) {
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Applications/{applicationName}/$/GetServices/{serviceName}/$/UpdateServiceGroup';
  requestUrl = requestUrl.replace('{applicationName}', applicationName);
...
ServiceGroups.prototype.remove = function (applicationName, serviceName, options, callback) {
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Applications/{applicationName}/$/GetServiceGroups/{serviceName}/$/Delete';
  requestUrl = requestUrl.replace('{applicationName}', applicationName);
  requestUrl = requestUrl.replace('{serviceName}', serviceName);
  var queryParameters = [];
  queryParameters.push('api-version=' + encodeURIComponent(this.client.apiVersion));
