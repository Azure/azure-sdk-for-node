 ...
 */
function _start(applicationName, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Applications/{applicationName}/$/RollbackUpgrade';
...
/** Class representing a ApplicationUpgradeRollbacks. */
class ApplicationUpgradeRollbacks {
  /**
   * Create a ApplicationUpgradeRollbacks.
   ...
   */
  startWithHttpOperationResponse(applicationName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._start(applicationName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  start(applicationName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._start(applicationName, options, optionalCallback);
    }
  }

}

module.exports = ApplicationUpgradeRollbacks;
