 ...
 */
function ApplicationUpgradeRollbacks(client) {
  this.client = client;
}
 ...
 */
ApplicationUpgradeRollbacks.prototype.start = function (applicationName, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Applications/{applicationName}/$/RollbackUpgrade';
