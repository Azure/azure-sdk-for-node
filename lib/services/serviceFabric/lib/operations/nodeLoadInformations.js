 ...
 */
function NodeLoadInformations(client) {
  this.client = client;
}
 ...
 */
NodeLoadInformations.prototype.get = function (nodeName, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Nodes/{nodeName}/$/GetLoadInformation';
