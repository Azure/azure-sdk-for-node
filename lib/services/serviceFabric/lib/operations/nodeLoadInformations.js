    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['NodeLoadInformation']().mapper();
...
/** Class representing a NodeLoadInformations. */
class NodeLoadInformations {
  /**
   * Create a NodeLoadInformations.
...
module.exports = NodeLoadInformations;
