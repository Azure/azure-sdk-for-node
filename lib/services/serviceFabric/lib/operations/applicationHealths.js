 ...
 */
function ApplicationHealths(client) {
  this.client = client;
}
 ...
 */
ApplicationHealths.prototype.get = function (applicationName, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Applications/{applicationName}/$/GetHealth';
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ApplicationHealths.prototype.send = function (applicationName, applicationHealthReport, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Applications/{applicationName}/$/ReportHealth';
  requestUrl = requestUrl.replace('{applicationName}', applicationName);
  var queryParameters = [];
  if (this.client.timeout !== null && this.client.timeout !== undefined) {
    queryParameters.push('timeout=' + encodeURIComponent(this.client.timeout.toString()));
