...
Replicas.prototype.list = function (partitionId, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Partitions/{partitionId}/$/GetReplicas';
...
Replicas.prototype.get = function (partitionId, replicaId, options, callback) {
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Partitions/{partitionId}/$/GetReplicas/{replicaId}';
  requestUrl = requestUrl.replace('{partitionId}', encodeURIComponent(partitionId));
