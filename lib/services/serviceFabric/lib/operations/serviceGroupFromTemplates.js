...
function _create(applicationName, serviceDescriptionTemplate, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Applications/{applicationName}/$/GetServiceGroups/$/CreateServiceGroupFromTemplate';
...
/** Class representing a ServiceGroupFromTemplates. */
class ServiceGroupFromTemplates {
  /**
   * Create a ServiceGroupFromTemplates.
