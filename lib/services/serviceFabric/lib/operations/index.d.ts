...
export interface Nodes {
     ...
     * doc in ms-rest index.d.ts for details
     */
    disable(nodeName: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<string>): void;
    disable(nodeName: string, callback: ServiceCallback<string>): void;
}
