 ...
 */
function DeployedServicePackages(client) {
  this.client = client;
}
 ...
 */
DeployedServicePackages.prototype.get = function (nodeName, applicationName, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Nodes/{nodeName}/$/GetApplications/{applicationName}/$/GetServicePackages';
