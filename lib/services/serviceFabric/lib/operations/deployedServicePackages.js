...
function _get(nodeName, applicationName, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Nodes/{nodeName}/$/GetApplications/{applicationName}/$/GetServicePackages';
...
/** Class representing a DeployedServicePackages. */
class DeployedServicePackages {
  /**
   * Create a DeployedServicePackages.
...
module.exports = DeployedServicePackages;
