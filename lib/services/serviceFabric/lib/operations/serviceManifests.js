 ...
 */
function ServiceManifests(client) {
  this.client = client;
}
 ...
 */
ServiceManifests.prototype.get = function (applicationTypeName, applicationTypeVersion, serviceManifestName, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'ApplicationTypes/{applicationTypeName}/$/GetServiceManifest';
