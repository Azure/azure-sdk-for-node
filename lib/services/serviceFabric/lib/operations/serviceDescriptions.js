 ...
 */
function ServiceDescriptions(client) {
  this.client = client;
}
 ...
 */
ServiceDescriptions.prototype.get = function (serviceName, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Services/{serviceName}/$/GetDescription';
