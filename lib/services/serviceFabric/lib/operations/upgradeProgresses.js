    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['ClusterUpgradeProgress']().mapper();
...
/** Class representing a UpgradeProgresses. */
class UpgradeProgresses {
  /**
   * Create a UpgradeProgresses.
