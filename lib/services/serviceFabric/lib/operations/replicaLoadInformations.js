 ...
 */
function ReplicaLoadInformations(client) {
  this.client = client;
}
 ...
 */
ReplicaLoadInformations.prototype.get = function (partitionId, replicaId, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Partitions/{partitionId}/$/GetReplicas/{replicaId}/$/GetLoadInformation';
