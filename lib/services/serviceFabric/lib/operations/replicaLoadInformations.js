...
function _get(partitionId, replicaId, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Partitions/{partitionId}/$/GetReplicas/{replicaId}/$/GetLoadInformation';
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['ReplicaLoadInformation']().mapper();
...
/** Class representing a ReplicaLoadInformations. */
class ReplicaLoadInformations {
  /**
   * Create a ReplicaLoadInformations.
...
module.exports = ReplicaLoadInformations;
