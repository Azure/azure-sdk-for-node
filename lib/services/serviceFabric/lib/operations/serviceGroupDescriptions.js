...
function _get(applicationName, serviceName, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Applications/{applicationName}/$/GetServices/{serviceName}/$/GetServiceGroupDescription';
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['ServiceGroupDescription']().mapper();
...
/** Class representing a ServiceGroupDescriptions. */
class ServiceGroupDescriptions {
  /**
   * Create a ServiceGroupDescriptions.
