...
Partitions.prototype.list = function (serviceName, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Services/{serviceName}/$/GetPartitions';
...
Partitions.prototype.get = function (serviceName, partitionId, options, callback) {
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Services/{serviceName}/$/GetPartitions/{partitionId}';
  requestUrl = requestUrl.replace('{serviceName}', serviceName);
...
Partitions.prototype.repair = function (partitionId, options, callback) {
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Partitions/{partitionId}/$/Recover';
