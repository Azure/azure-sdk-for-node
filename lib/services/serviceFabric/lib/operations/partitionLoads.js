 ...
 */
function _reset(partitionId, options, callback) {
...
/** Class representing a PartitionLoads. */
class PartitionLoads {
  /**
   * Create a PartitionLoads.
   ...
   */
  resetWithHttpOperationResponse(partitionId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._reset(partitionId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  reset(partitionId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._reset(partitionId, options, optionalCallback);
    }
  }

}

module.exports = PartitionLoads;
