 ...
 */
function PartitionLoads(client) {
  this.client = client;
}
 ...
 */
PartitionLoads.prototype.reset = function (partitionId, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Partitions/{partitionId}/$/ResetLoad';
