...
function _get(nodeName, applicationName, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Nodes/{nodeName}/$/GetApplications/{applicationName}/$/GetServiceTypes';
...
/** Class representing a DeployedServiceTypes. */
class DeployedServiceTypes {
  /**
   * Create a DeployedServiceTypes.
...
module.exports = DeployedServiceTypes;
