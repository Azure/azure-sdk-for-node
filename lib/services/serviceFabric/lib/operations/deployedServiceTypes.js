 ...
 */
function DeployedServiceTypes(client) {
  this.client = client;
}
 ...
 */
DeployedServiceTypes.prototype.get = function (nodeName, applicationName, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Nodes/{nodeName}/$/GetApplications/{applicationName}/$/GetServiceTypes';
