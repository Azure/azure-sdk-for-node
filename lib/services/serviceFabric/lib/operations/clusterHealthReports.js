 ...
 * Initializes a new instance of the ClusterHealthReports class.
 * @constructor
 *
 * @param {ServiceFabricClient} client Reference to the service client.
 */
function ClusterHealthReports(client) {
  this.client = client;
}
 ...
 */
ClusterHealthReports.prototype.send = function (clusterHealthReport, options, callback) {
...
module.exports = ClusterHealthReports;
