 ...
 */
function _get(applicationTypeName, applicationTypeVersion, options, callback) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['ApplicationManifest']().mapper();
...
/** Class representing a ApplicationManifests. */
class ApplicationManifests {
  /**
   * Create a ApplicationManifests.
   ...
   */
  getWithHttpOperationResponse(applicationTypeName, applicationTypeVersion, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._get(applicationTypeName, applicationTypeVersion, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  get(applicationTypeName, applicationTypeVersion, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._get(applicationTypeName, applicationTypeVersion, options, optionalCallback);
    }
  }
