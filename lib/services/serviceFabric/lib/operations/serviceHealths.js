 ...
 */
function ServiceHealths(client) {
  this.client = client;
}
 ...
 */
ServiceHealths.prototype.get = function (serviceName, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Services/{serviceName}/$/GetHealth';
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ServiceHealths.prototype.send = function (serviceName, serviceHealthReport, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Services/{serviceName}/$/ReportHealth';
  requestUrl = requestUrl.replace('{serviceName}', serviceName);
  var queryParameters = [];
  queryParameters.push('api-version=' + encodeURIComponent(this.client.apiVersion));
  if (queryParameters.length > 0) {
