 ...
 * Initializes a new instance of the NodeHealthReports class.
 * @constructor
 *
 * @param {ServiceFabricClient} client Reference to the service client.
 */
function NodeHealthReports(client) {
  this.client = client;
}
 ...
 */
NodeHealthReports.prototype.send = function (nodeName, nodeHealthReport, options, callback) {
...
module.exports = NodeHealthReports;
