...
function _get(options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + '$/GetLoadInformation';
  let queryParameters = [];
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['ClusterLoadInformation']().mapper();
...
/** Class representing a ClusterLoadInformations. */
class ClusterLoadInformations {
  /**
   * Create a ClusterLoadInformations.
