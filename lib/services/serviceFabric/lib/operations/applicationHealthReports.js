 ...
 * Initializes a new instance of the ApplicationHealthReports class.
 * @constructor
 *
 * @param {ServiceFabricClient} client Reference to the service client.
 */
function ApplicationHealthReports(client) {
  this.client = client;
}
 ...
 */
ApplicationHealthReports.prototype.send = function (applicationName, applicationHealthReport, options, callback) {
...
module.exports = ApplicationHealthReports;
