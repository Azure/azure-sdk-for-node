 ...
 */
function DeployedApplications(client) {
  this.client = client;
}
 ...
 */
DeployedApplications.prototype.list = function (nodeName, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Nodes/{nodeName}/$/GetApplications';
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
DeployedApplications.prototype.get = function (nodeName, applicationName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Nodes/{nodeName}/$/GetApplications/{applicationName}';
  requestUrl = requestUrl.replace('{nodeName}', encodeURIComponent(nodeName));
