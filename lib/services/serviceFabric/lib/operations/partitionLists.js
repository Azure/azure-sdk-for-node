 ...
 */
function PartitionLists(client) {
  this.client = client;
}
 ...
 */
PartitionLists.prototype.repair = function (serviceName, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Services/{serviceName}/$/GetPartitions/$/Recover';
