 ...
 */
function _repair(serviceName, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Services/{serviceName}/$/GetPartitions/$/Recover';
...
/** Class representing a PartitionLists. */
class PartitionLists {
  /**
   * Create a PartitionLists.
   ...
   */
  repairWithHttpOperationResponse(serviceName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._repair(serviceName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  repair(serviceName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._repair(serviceName, options, optionalCallback);
    }
  }

}

module.exports = PartitionLists;
