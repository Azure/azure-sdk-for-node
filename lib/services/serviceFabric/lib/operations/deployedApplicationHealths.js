...
DeployedApplicationHealths.prototype.get = function (nodeName, applicationName, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Nodes/{nodeName}/$/GetApplications/{applicationName}/$/GetHealth';
...
DeployedApplicationHealths.prototype.send = function (nodeName, applicationName, deployedApplicationHealthReport, options, callback) {
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Nodes/{nodeName}/$/GetApplications/{applicationName}/$/ReportHealth';
  requestUrl = requestUrl.replace('{nodeName}', encodeURIComponent(nodeName));
  requestUrl = requestUrl.replace('{applicationName}', applicationName);
  var queryParameters = [];
  if (this.client.timeout !== null && this.client.timeout !== undefined) {
