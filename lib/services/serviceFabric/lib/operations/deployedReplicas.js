...
function _get(nodeName, applicationName, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Nodes/{nodeName}/$/GetApplications/{applicationName}/$/GetReplicas';
...
/** Class representing a DeployedReplicas. */
class DeployedReplicas {
  /**
   * Create a DeployedReplicas.
...
module.exports = DeployedReplicas;
