 ...
 */
function DeployedReplicas(client) {
  this.client = client;
}
 ...
 */
DeployedReplicas.prototype.get = function (nodeName, applicationName, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Nodes/{nodeName}/$/GetApplications/{applicationName}/$/GetReplicas';
