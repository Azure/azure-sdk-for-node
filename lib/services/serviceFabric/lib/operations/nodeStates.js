 ...
 */
function _remove(nodeName, options, callback) {
...
/** Class representing a NodeStates. */
class NodeStates {
  /**
   * Create a NodeStates.
   ...
   */
  removeWithHttpOperationResponse(nodeName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._remove(nodeName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  remove(nodeName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._remove(nodeName, options, optionalCallback);
    }
  }
