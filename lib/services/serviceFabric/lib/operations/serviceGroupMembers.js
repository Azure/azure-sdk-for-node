 ...
 * Initializes a new instance of the ServiceGroupMembers class.
 * @constructor
 *
 * @param {ServiceFabricClient} client Reference to the service client.
 */
function ServiceGroupMembers(client) {
  this.client = client;
}
 ...
 */
ServiceGroupMembers.prototype.get = function (applicationName, serviceName, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Applications/{applicationName}/$/GetServices/{serviceName}/$/GetServiceGroupMembers';
...
module.exports = ServiceGroupMembers;
