...
function _get(applicationName, serviceName, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Applications/{applicationName}/$/GetServices/{serviceName}/$/GetServiceGroupMembers';
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['ServiceGroupMember']().mapper();
...
/** Class representing a ServiceGroupMembers. */
class ServiceGroupMembers {
  /**
   * Create a ServiceGroupMembers.
