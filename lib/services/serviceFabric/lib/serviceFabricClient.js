...
class ServiceFabricClient extends ServiceClient {
  constructor(apiVersion, baseUri, options) {
    ...
    this.clusterUpgrades = new operations.ClusterUpgrades(this);
    this.clusterPackages = new operations.ClusterPackages(this);
