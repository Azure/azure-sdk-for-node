...
function ServiceFabricClient(apiVersion, baseUri, options) {
  ...
  this.clusterHealthReports = new operations.ClusterHealthReports(this);
  ...
  this.nodeHealthReports = new operations.NodeHealthReports(this);
  this.deployedApplicationHealthReports = new operations.DeployedApplicationHealthReports(this);
  this.deployedServicePackageHealthReports = new operations.DeployedServicePackageHealthReports(this);
  ...
  this.applicationHealthReports = new operations.ApplicationHealthReports(this);
  ...
  this.partitionHealthReports = new operations.PartitionHealthReports(this);
