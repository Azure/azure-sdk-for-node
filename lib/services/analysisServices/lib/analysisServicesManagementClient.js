 ...
 *
 */
function AnalysisServicesManagementClient(credentials, subscriptionId, baseUri, options) {
  ...
  AnalysisServicesManagementClient['super_'].call(this, credentials, options);
...
util.inherits(AnalysisServicesManagementClient, ServiceClient);
