...
KeyVaultClient.prototype.setCertificateIssuer = function (vaultBaseUrl, issuerName, issuer, options, callback) {
  ...
  try {
    ...
    if (issuer === null || issuer === undefined) {
      throw new Error('issuer cannot be null or undefined.');
    }
    if (this.apiVersion === null || this.apiVersion === undefined || typeof this.apiVersion.valueOf() !== 'string') {
      throw new Error('this.apiVersion cannot be null or undefined and it must be of type string.');
    }
  ...
  try {
    if (issuer !== null && issuer !== undefined) {
      var requestModelMapper = new client.models['IssuerBundle']().mapper();
      requestModel = client.serialize(requestModelMapper, issuer, 'issuer');
      requestContent = JSON.stringify(requestModel);
    }
  } catch (error) {
    var serializationError = new Error(util.format('Error "%s" occurred in serializing the ' + 
        'payload - "%s"', error.message, util.inspect(issuer, {depth: null})));
    return callback(serializationError);
  }
  httpRequest.body = requestContent;
  // Send Request
...
KeyVaultClient.prototype.updateCertificate = function (vaultBaseUrl, certificateName, certificateVersion, options, callback) {
  ...
  var parameters;
  if ((certificateAttributes !== null && certificateAttributes !== undefined) || (tags !== null && tags !== undefined)) {
...
KeyVaultClient.prototype.updateCertificateOperation = function (vaultBaseUrl, certificateName, certificateOperation, options, callback) {
  ...
  try {
    ...
    if (certificateOperation === null || certificateOperation === undefined) {
      throw new Error('certificateOperation cannot be null or undefined.');
    }
    if (this.apiVersion === null || this.apiVersion === undefined || typeof this.apiVersion.valueOf() !== 'string') {
      throw new Error('this.apiVersion cannot be null or undefined and it must be of type string.');
    }
  ...
  try {
    if (certificateOperation !== null && certificateOperation !== undefined) {
      var requestModelMapper = new client.models['CertificateOperation']().mapper();
