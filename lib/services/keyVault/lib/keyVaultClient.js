 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getKeyVersionsNext(vaultBaseUrl, nextPageLink, options, callback) {
   /* jshint validthis: true */
  let client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getKeysNext(vaultBaseUrl, nextPageLink, options, callback) {
   /* jshint validthis: true */
  let client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getDeletedKeysNext(vaultBaseUrl, nextPageLink, options, callback) {
   /* jshint validthis: true */
  let client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getSecretsNext(vaultBaseUrl, nextPageLink, options, callback) {
   /* jshint validthis: true */
  let client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getSecretVersionsNext(vaultBaseUrl, nextPageLink, options, callback) {
   /* jshint validthis: true */
  let client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getDeletedSecretsNext(vaultBaseUrl, nextPageLink, options, callback) {
   /* jshint validthis: true */
  let client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getCertificatesNext(vaultBaseUrl, nextPageLink, options, callback) {
   /* jshint validthis: true */
  let client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getCertificateIssuersNext(vaultBaseUrl, nextPageLink, options, callback) {
   /* jshint validthis: true */
  let client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getCertificateVersionsNext(vaultBaseUrl, nextPageLink, options, callback) {
   /* jshint validthis: true */
  let client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getDeletedCertificatesNext(vaultBaseUrl, nextPageLink, options, callback) {
   /* jshint validthis: true */
  let client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getStorageAccountsNext(vaultBaseUrl, nextPageLink, options, callback) {
   /* jshint validthis: true */
  let client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getSasDefinitionsNext(vaultBaseUrl, nextPageLink, options, callback) {
   /* jshint validthis: true */
  let client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
...
class KeyVaultClient extends ServiceClient {
   ...
   * @reject {Error} - The error object.
   */
  getKeyVersionsNextWithHttpOperationResponse(vaultBaseUrl, nextPageLink, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getKeyVersionsNext(vaultBaseUrl, nextPageLink, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getKeyVersionsNext(vaultBaseUrl, nextPageLink, options, optionalCallback) {
    let client = this;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getKeyVersionsNext(vaultBaseUrl, nextPageLink, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getKeysNextWithHttpOperationResponse(vaultBaseUrl, nextPageLink, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getKeysNext(vaultBaseUrl, nextPageLink, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getKeysNext(vaultBaseUrl, nextPageLink, options, optionalCallback) {
    let client = this;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getKeysNext(vaultBaseUrl, nextPageLink, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getDeletedKeysNextWithHttpOperationResponse(vaultBaseUrl, nextPageLink, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getDeletedKeysNext(vaultBaseUrl, nextPageLink, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getDeletedKeysNext(vaultBaseUrl, nextPageLink, options, optionalCallback) {
    let client = this;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getDeletedKeysNext(vaultBaseUrl, nextPageLink, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getSecretsNextWithHttpOperationResponse(vaultBaseUrl, nextPageLink, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getSecretsNext(vaultBaseUrl, nextPageLink, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getSecretsNext(vaultBaseUrl, nextPageLink, options, optionalCallback) {
    let client = this;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getSecretsNext(vaultBaseUrl, nextPageLink, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getSecretVersionsNextWithHttpOperationResponse(vaultBaseUrl, nextPageLink, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getSecretVersionsNext(vaultBaseUrl, nextPageLink, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getSecretVersionsNext(vaultBaseUrl, nextPageLink, options, optionalCallback) {
    let client = this;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getSecretVersionsNext(vaultBaseUrl, nextPageLink, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getDeletedSecretsNextWithHttpOperationResponse(vaultBaseUrl, nextPageLink, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getDeletedSecretsNext(vaultBaseUrl, nextPageLink, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getDeletedSecretsNext(vaultBaseUrl, nextPageLink, options, optionalCallback) {
    let client = this;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getDeletedSecretsNext(vaultBaseUrl, nextPageLink, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getCertificatesNextWithHttpOperationResponse(vaultBaseUrl, nextPageLink, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getCertificatesNext(vaultBaseUrl, nextPageLink, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getCertificatesNext(vaultBaseUrl, nextPageLink, options, optionalCallback) {
    let client = this;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getCertificatesNext(vaultBaseUrl, nextPageLink, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getCertificateIssuersNextWithHttpOperationResponse(vaultBaseUrl, nextPageLink, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getCertificateIssuersNext(vaultBaseUrl, nextPageLink, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getCertificateIssuersNext(vaultBaseUrl, nextPageLink, options, optionalCallback) {
    let client = this;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getCertificateIssuersNext(vaultBaseUrl, nextPageLink, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getCertificateVersionsNextWithHttpOperationResponse(vaultBaseUrl, nextPageLink, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getCertificateVersionsNext(vaultBaseUrl, nextPageLink, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getCertificateVersionsNext(vaultBaseUrl, nextPageLink, options, optionalCallback) {
    let client = this;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getCertificateVersionsNext(vaultBaseUrl, nextPageLink, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getDeletedCertificatesNextWithHttpOperationResponse(vaultBaseUrl, nextPageLink, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getDeletedCertificatesNext(vaultBaseUrl, nextPageLink, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getDeletedCertificatesNext(vaultBaseUrl, nextPageLink, options, optionalCallback) {
    let client = this;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getDeletedCertificatesNext(vaultBaseUrl, nextPageLink, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getStorageAccountsNextWithHttpOperationResponse(vaultBaseUrl, nextPageLink, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getStorageAccountsNext(vaultBaseUrl, nextPageLink, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getStorageAccountsNext(vaultBaseUrl, nextPageLink, options, optionalCallback) {
    let client = this;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getStorageAccountsNext(vaultBaseUrl, nextPageLink, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getSasDefinitionsNextWithHttpOperationResponse(vaultBaseUrl, nextPageLink, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getSasDefinitionsNext(vaultBaseUrl, nextPageLink, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getSasDefinitionsNext(vaultBaseUrl, nextPageLink, options, optionalCallback) {
    let client = this;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getSasDefinitionsNext(vaultBaseUrl, nextPageLink, options, optionalCallback);
    }
  }
