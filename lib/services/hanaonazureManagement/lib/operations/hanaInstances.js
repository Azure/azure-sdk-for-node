 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _restart(resourceGroupName, hanaInstanceName, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 * @param {string} hanaInstanceName Name of the SAP HANA on Azure instance.
 *
 * @param {object} monitoringParameter Request body that only contains the new
 * Tags field
 *
 ...
 *
 * @param {boolean} [monitoringParameter.hanaMdc] Flag to specify the use of
 * MDC(Multi Database Containers).
 *
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _monitoring(resourceGroupName, hanaInstanceName, monitoringParameter, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Send request
  this.beginMonitoring(resourceGroupName, hanaInstanceName, monitoringParameter, options, (err, parsedResult, httpRequest, response) => {
    if (err) return callback(err);
...
function _beginRestart(resourceGroupName, hanaInstanceName, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HanaOnAzure/hanaInstances/{hanaInstanceName}/restart';
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  requestUrl = requestUrl.replace('{resourceGroupName}', encodeURIComponent(resourceGroupName));
  requestUrl = requestUrl.replace('{hanaInstanceName}', encodeURIComponent(hanaInstanceName));
  let queryParameters = [];
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _beginMonitoring(resourceGroupName, hanaInstanceName, monitoringParameter, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
...
class HanaInstances {
  ...
  constructor(client) {
    ...
    this._beginMonitoring = _beginMonitoring;
   ...
   * @reject {Error} - The error object.
   */
  restartWithHttpOperationResponse(resourceGroupName, hanaInstanceName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._restart(resourceGroupName, hanaInstanceName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  restart(resourceGroupName, hanaInstanceName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._restart(resourceGroupName, hanaInstanceName, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  monitoringWithHttpOperationResponse(resourceGroupName, hanaInstanceName, monitoringParameter, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._monitoring(resourceGroupName, hanaInstanceName, monitoringParameter, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  monitoring(resourceGroupName, hanaInstanceName, monitoringParameter, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._monitoring(resourceGroupName, hanaInstanceName, monitoringParameter, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  beginMonitoringWithHttpOperationResponse(resourceGroupName, hanaInstanceName, monitoringParameter, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginMonitoring(resourceGroupName, hanaInstanceName, monitoringParameter, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  beginMonitoring(resourceGroupName, hanaInstanceName, monitoringParameter, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._beginMonitoring(resourceGroupName, hanaInstanceName, monitoringParameter, options, optionalCallback);
    }
  }
