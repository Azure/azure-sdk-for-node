...
*/
exports.createSqlManagementClient = function (credentials, baseUri, filters) {
  return new exports.SqlManagementClient.SqlManagementClient(credentials, baseUri, filters);
};
