...
var DacOperations = ( /** @lends DacOperations */ function() {
  ...
  DacOperations.prototype.export = function(serverName, parametersOrCallback, callback) {
    ...
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/sqlservers/servers/' + serverName.trim() + '/DacOperations/Export';
  ...
  DacOperations.prototype.getStatus = function(serverName, fullyQualifiedServerName, username, password, requestId, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/sqlservers/servers/' + serverName.trim() + '/DacOperations/Status?';
  ...
  DacOperations.prototype.import = function(serverName, parametersOrCallback, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/sqlservers/servers/' + serverName.trim() + '/DacOperations/Import';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var DatabaseOperationOperations = ( /** @lends DatabaseOperationOperations */ function() {
  ...
  DatabaseOperationOperations.prototype.get = function(serverName, operationGuid, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = this.client.credentials.subscriptionId.trim() + '/services/sqlservers/servers/' + serverName.trim() + '/databaseoperations/' + operationGuid.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  DatabaseOperationOperations.prototype.listByDatabase = function(serverName, databaseName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = this.client.credentials.subscriptionId.trim() + '/services/sqlservers/servers/' + serverName.trim() + '/databaseoperations?';
  ...
  DatabaseOperationOperations.prototype.listByServer = function(serverName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = this.client.credentials.subscriptionId.trim() + '/services/sqlservers/servers/' + serverName.trim() + '/databaseoperations?contentview=generic';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var DatabaseOperations = ( /** @lends DatabaseOperations */ function() {
  ...
  DatabaseOperations.prototype.create = function(serverName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/sqlservers/servers/' + serverName.trim() + '/databases';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  DatabaseOperations.prototype.delete = function(serverName, databaseName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/sqlservers/servers/' + serverName.trim() + '/databases/' + databaseName.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  DatabaseOperations.prototype.getEventLogs = function(serverName, databaseName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/sqlservers/servers/' + serverName.trim() + '/databases/' + databaseName.trim() + '/events?';
  ...
  DatabaseOperations.prototype.list = function(serverName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/sqlservers/servers/' + serverName.trim() + '/databases?contentview=generic';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var FirewallRuleOperations = ( /** @lends FirewallRuleOperations */ function() {
  ...
  FirewallRuleOperations.prototype.create = function(serverName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/sqlservers/servers/' + serverName.trim() + '/firewallrules';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  FirewallRuleOperations.prototype.delete = function(serverName, ruleName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/sqlservers/servers/' + serverName.trim() + '/firewallrules/' + ruleName.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var ServerOperations = ( /** @lends ServerOperations */ function() {
  ...
  ServerOperations.prototype.changeAdministratorPassword = function(serverName, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/sqlservers/servers/' + serverName.trim() + '?op=ResetPassword';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  ServerOperations.prototype.create = function(parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/sqlservers/servers';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  ServerOperations.prototype.delete = function(serverName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = '/' + this.client.credentials.subscriptionId.trim() + '/services/sqlservers/servers/' + serverName.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
...
var ServiceObjectiveOperations = ( /** @lends ServiceObjectiveOperations */ function() {
  ...
  ServiceObjectiveOperations.prototype.get = function(serverName, serviceObjectiveId, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = this.client.credentials.subscriptionId.trim() + '/services/sqlservers/servers/' + serverName.trim() + '/serviceobjectives/' + serviceObjectiveId.trim();
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
  ...
  ServiceObjectiveOperations.prototype.list = function(serverName, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = this.client.credentials.subscriptionId.trim() + '/services/sqlservers/servers/' + serverName.trim() + '/serviceobjectives';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    }
