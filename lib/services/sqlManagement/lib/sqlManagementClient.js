...
var DacOperations = (function() {
   ...
   * 
   * @param {string} [parametersOrCallback.blobCredentials.uri] The URI of the
   * DAC file in stored in Windows Azure Blob Storage.
   * 
   ...
   * 
   * @param {string} [parametersOrCallback.connectionInfo.databaseName] The
   * name of the database.
   * 
   * @param {string} [parametersOrCallback.connectionInfo.password] The
   * password for the database user.
   * 
   * @param {string} [parametersOrCallback.connectionInfo.serverName] The SQL
   * server name.
   * 
   * @param {string} [parametersOrCallback.connectionInfo.userName] The
   ...
   * Credentials for getting the DAC.
   * 
   * @param {string} [parametersOrCallback.blobCredentials.uri]
   * 
   * @param {string} [parametersOrCallback.blobCredentials.storageAccessKey]
   * The key for the Windows Azure Storage account.
   * 
   ...
   * username of the database user.
   * 
   * @param {number} [parametersOrCallback.databaseSizeInGB] The size of this
   * database.
   * 
   * @param {function} callback
   * 
 ...
 * @class
 */
var DatabaseOperationOperations = (function() {
  /**
...
var DatabaseOperations = (function() {
   ...
   * database operation
   * 
   * @param {string} parameters.name The name for the new database.
   * 
   * @param {string} parameters.edition The edition for the new database.
   * 
   * @param {number} parameters.maximumDatabaseSizeInGB Maximum size of this
   * database, in Gigabytes.
   * 
   * @param {string} parameters.collationName The collation name for the new
   * database.
   * 
   * @param {string} [parameters.serviceObjectiveId] The id of this service
   * objective.
   * 
   * @param {function} callback
   * 
   ...
   * database operation.
   * 
   * @param {string} [parameters.name] The name of the database.
   * 
   * @param {number} parameters.id The id of the database.
   * 
   * @param {string} parameters.edition The edition for the new database.
   * 
   * @param {number} parameters.maximumDatabaseSizeInGB Maximum size of this
...
var FirewallRuleOperations = (function() {
   ...
   * 
   * @param {string} parameters.name The name of this firewall rule.
   * 
   * @param {string} parameters.startIPAddress The beginning IP address applied
   * to this firewall rule.
   * 
   * @param {string} parameters.endIPAddress The ending IP address applied to
   * this firewall rule.
   * 
   * @param {function} callback
   * 
...
var ServerOperations = (function() {
   ...
   * 
   * @param {string} parameters.newPassword The new password for the
   * administrator
   * 
   * @param {function} callback
   * 
   ...
   * 
   * @param {string} parameters.administratorUserName The administrator username
   * 
   * @param {string} parameters.administratorPassword The administrator password
   * 
   * @param {string} parameters.location The region in which this server will
   * be created.
   * 
   * @param {function} callback
   * 
 ...
 * @class
 */
var ServiceObjectiveOperations = (function() {
  /**
