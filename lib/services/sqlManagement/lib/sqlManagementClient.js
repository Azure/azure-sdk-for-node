...
var DacOperations = ( /** @lends DacOperations */ function() {
  ...
  DacOperations.prototype.export = function(serverName, parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/DacOperations/Export';
  ...
  DacOperations.prototype.getStatus = function(serverName, fullyQualifiedServerName, username, password, requestId, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/DacOperations/Status?';
        ...
        if (arrayOfStatusInfoElement !== null && arrayOfStatusInfoElement !== undefined) {
          if (arrayOfStatusInfoElement !== null && arrayOfStatusInfoElement !== undefined) {
            for (var loweredIndex1 = 0; loweredIndex1 < js2xml.getElements(responseDoc, arrayOfStatusInfoElement, 'STATUSINFO', 'HTTP://SCHEMAS.DATACONTRACT.ORG/2004/07/MICROSOFT.SQLSERVER.MANAGEMENT.DAC.SERVICETYPES').length; loweredIndex1 = loweredIndex1 + 1) {
              ...
              if (queuedTimeElement !== null && queuedTimeElement !== undefined) {
  ...
  DacOperations.prototype.import = function(serverName, parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/DacOperations/Import';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
...
var DatabaseCopyOperations = ( /** @lends DatabaseCopyOperations */ function() {
   ...
   * 
   * @param {boolean} parameters.isOfflineSecondary Gets a value that indicates
   * whether it is an offline secondary copy.
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
  ...
  DatabaseCopyOperations.prototype.create = function(serverName, databaseName, parameters, callback) {
    ...
    if (parameters.isOfflineSecondary === null || parameters.isOfflineSecondary === undefined) {
      return callback(new Error('parameters.isOfflineSecondary cannot be null.'));
    }
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/databases/' + databaseName.trim() + '/databasecopies';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (serviceResourceElement2 !== null && serviceResourceElement2 !== undefined) {
          ...
          if (isContinuousElement2 !== null && isContinuousElement2 !== undefined) {
          ...
          if (replicationStateElement !== null && replicationStateElement !== undefined) {
          ...
          if (localDatabaseIdElement !== null && localDatabaseIdElement !== undefined) {
          ...
          if (isLocalDatabaseReplicationTargetElement !== null && isLocalDatabaseReplicationTargetElement !== undefined) {
          ...
          if (isInterlinkConnectedElement !== null && isInterlinkConnectedElement !== undefined) {
          ...
          if (percentCompleteElement !== null && percentCompleteElement !== undefined) {
          ...
          if (isOfflineSecondaryElement2 !== null && isOfflineSecondaryElement2 !== undefined) {
          ...
          if (isTerminationAllowedElement !== null && isTerminationAllowedElement !== undefined) {
  ...
  DatabaseCopyOperations.prototype.delete = function(serverName, databaseName, databaseCopyName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/databases/' + databaseName.trim() + '/databasecopies/' + databaseCopyName;
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  DatabaseCopyOperations.prototype.get = function(serverName, databaseName, databaseCopyName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/databases/' + databaseName.trim() + '/databasecopies/' + databaseCopyName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (serviceResourceElement !== null && serviceResourceElement !== undefined) {
          ...
          if (isContinuousElement !== null && isContinuousElement !== undefined) {
          ...
          if (isOfflineSecondaryElement !== null && isOfflineSecondaryElement !== undefined) {
...
var DatabaseOperationOperations = ( /** @lends DatabaseOperationOperations */ function() {
  ...
  DatabaseOperationOperations.prototype.get = function(serverName, operationGuid, callback) {
    ...
    // Construct URL
    var url2 = (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/databaseoperations/' + operationGuid.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (serviceResourceElement !== null && serviceResourceElement !== undefined) {
          ...
          if (stateIdElement !== null && stateIdElement !== undefined) {
          ...
          if (errorCodeElement !== null && errorCodeElement !== undefined) {
          ...
          if (errorSeverityElement !== null && errorSeverityElement !== undefined) {
          ...
          if (errorStateElement !== null && errorStateElement !== undefined) {
          ...
          if (startTimeElement !== null && startTimeElement !== undefined) {
          ...
          if (lastModifyTimeElement !== null && lastModifyTimeElement !== undefined) {
  ...
  DatabaseOperationOperations.prototype.listByDatabase = function(serverName, databaseName, callback) {
    ...
    // Construct URL
    var url2 = (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/databaseoperations?';
  ...
  DatabaseOperationOperations.prototype.listByServer = function(serverName, callback) {
    ...
    // Construct URL
    var url2 = (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/databaseoperations?contentview=generic';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
...
var DatabaseOperations = ( /** @lends DatabaseOperations */ function() {
  ...
  DatabaseOperations.prototype.create = function(serverName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/databases';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (serviceResourceElement2 !== null && serviceResourceElement2 !== undefined) {
          ...
          if (maxSizeGBElement2 !== null && maxSizeGBElement2 !== undefined) {
          ...
          if (maxSizeBytesElement2 !== null && maxSizeBytesElement2 !== undefined) {
          ...
          if (creationDateElement !== null && creationDateElement !== undefined) {
          ...
          if (isFederationRootElement !== null && isFederationRootElement !== undefined) {
          ...
          if (isSystemObjectElement !== null && isSystemObjectElement !== undefined) {
          ...
          if (recoveryPeriodStartDateElement !== null && recoveryPeriodStartDateElement !== undefined && (recoveryPeriodStartDateElement === null || recoveryPeriodStartDateElement === undefined || recoveryPeriodStartDateElement.length === 0) === false) {
  ...
  DatabaseOperations.prototype.delete = function(serverName, databaseName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/databases/' + databaseName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (serviceResourceElement !== null && serviceResourceElement !== undefined) {
          ...
          if (maxSizeGBElement !== null && maxSizeGBElement !== undefined) {
          ...
          if (maxSizeBytesElement !== null && maxSizeBytesElement !== undefined) {
  ...
  DatabaseOperations.prototype.getEventLogs = function(serverName, databaseName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/databases/' + databaseName.trim() + '/events?';
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (serviceResourcesSequenceElement !== null && serviceResourcesSequenceElement !== undefined) {
          for (var loweredIndex1 = 0; loweredIndex1 < js2xml.getElements(responseDoc, serviceResourcesSequenceElement, 'SERVICERESOURCE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex1 = loweredIndex1 + 1) {
            ...
            if (startTimeUtcElement !== null && startTimeUtcElement !== undefined) {
            ...
            if (intervalSizeInMinutesElement !== null && intervalSizeInMinutesElement !== undefined) {
            ...
            if (numberOfEventsElement !== null && numberOfEventsElement !== undefined) {
            ...
            if (severityElement !== null && severityElement !== undefined) {
  ...
  DatabaseOperations.prototype.list = function(serverName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/databases?contentview=generic';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
...
var FirewallRuleOperations = ( /** @lends FirewallRuleOperations */ function() {
  ...
  FirewallRuleOperations.prototype.create = function(serverName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/firewallrules';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  FirewallRuleOperations.prototype.delete = function(serverName, ruleName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/firewallrules/' + ruleName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
...
var QuotaOperations = ( /** @lends QuotaOperations */ function() {
  ...
  QuotaOperations.prototype.get = function(serverName, quotaName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/serverquotas/' + quotaName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  QuotaOperations.prototype.list = function(serverName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/serverquotas';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
...
var RecoverableDatabaseOperations = ( /** @lends RecoverableDatabaseOperations */ function() {
  ...
  RecoverableDatabaseOperations.prototype.get = function(serverName, databaseName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/recoverabledatabases/' + databaseName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (serviceResourceElement !== null && serviceResourceElement !== undefined) {
          ...
          if (lastAvailableBackupDateElement !== null && lastAvailableBackupDateElement !== undefined) {
  ...
  RecoverableDatabaseOperations.prototype.list = function(serverName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/recoverabledatabases?contentview=generic';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
...
var RecoverDatabaseOperations = ( /** @lends RecoverDatabaseOperations */ function() {
  ...
  RecoverDatabaseOperations.prototype.create = function(sourceServerName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + sourceServerName.trim() + '/recoverdatabaseoperations';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
...
var RestorableDroppedDatabaseOperations = ( /** @lends RestorableDroppedDatabaseOperations */ function() {
  ...
  RestorableDroppedDatabaseOperations.prototype.get = function(serverName, entityId, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/restorabledroppeddatabases/' + entityId.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (serviceResourceElement !== null && serviceResourceElement !== undefined) {
          ...
          if (deletionDateElement !== null && deletionDateElement !== undefined) {
  ...
  RestorableDroppedDatabaseOperations.prototype.list = function(serverName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/restorabledroppeddatabases?contentview=generic';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
...
var RestoreDatabaseOperations = ( /** @lends RestoreDatabaseOperations */ function() {
  ...
  RestoreDatabaseOperations.prototype.create = function(sourceServerName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + sourceServerName.trim() + '/restoredatabaseoperations';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (serviceResourceElement2 !== null && serviceResourceElement2 !== undefined) {
          ...
          if (sourceDatabaseDeletionDateElement2 !== null && sourceDatabaseDeletionDateElement2 !== undefined && (sourceDatabaseDeletionDateElement2 === null || sourceDatabaseDeletionDateElement2 === undefined || sourceDatabaseDeletionDateElement2.length === 0) === false) {
          ...
          if (targetUtcPointInTimeElement2 !== null && targetUtcPointInTimeElement2 !== undefined) {
...
var ServerOperations = ( /** @lends ServerOperations */ function() {
  ...
  ServerOperations.prototype.changeAdministratorPassword = function(serverName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '?op=ResetPassword';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  ServerOperations.prototype.create = function(parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  ServerOperations.prototype.delete = function(serverName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
...
var ServiceObjectiveOperations = ( /** @lends ServiceObjectiveOperations */ function() {
  ...
  ServiceObjectiveOperations.prototype.get = function(serverName, serviceObjectiveId, callback) {
    ...
    // Construct URL
    var url2 = (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/serviceobjectives/' + serviceObjectiveId.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (serviceResourceElement !== null && serviceResourceElement !== undefined) {
          ...
          if (isDefaultElement !== null && isDefaultElement !== undefined) {
          ...
          if (isSystemElement !== null && isSystemElement !== undefined) {
          ...
          if (enabledElement !== null && enabledElement !== undefined) {
          ...
          if (dimensionSettingsSequenceElement !== null && dimensionSettingsSequenceElement !== undefined) {
            for (var loweredIndex1 = 0; loweredIndex1 < js2xml.getElements(responseDoc, dimensionSettingsSequenceElement, 'SERVICERESOURCE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex1 = loweredIndex1 + 1) {
              ...
              if (ordinalElement !== null && ordinalElement !== undefined) {
              ...
              if (isDefaultElement2 !== null && isDefaultElement2 !== undefined) {
  ...
  ServiceObjectiveOperations.prototype.list = function(serverName, callback) {
    ...
    // Construct URL
    var url2 = (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/sqlservers/servers/' + serverName.trim() + '/serviceobjectives';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
