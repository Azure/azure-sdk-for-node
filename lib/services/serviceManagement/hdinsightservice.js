...
HDInsightService.prototype.validateCreationObject = function (clusterCreationObject) {
  if (!clusterCreationObject.name || typeof(clusterCreationObject.name) != 'string') {
    throw new Error('The [name] field is required when creating a cluster and must be a string');
  }
  if (!clusterCreationObject.location || typeof(clusterCreationObject.location) != 'string') {
    throw new Error('The [location] field is required when creating a cluster and must be a string');
  }
  if (!clusterCreationObject.defaultStorageAccountName || typeof(clusterCreationObject.defaultStorageAccountName) != 'string') {
    throw new Error('The [defaultStorageAccountName] field is required when creating a cluster and must be a string');
  }
  if (!clusterCreationObject.defaultStorageAccountKey || typeof(clusterCreationObject.defaultStorageAccountKey) != 'string') {
    throw new Error('The [defaultStorageAccountKey] field is required when creating a cluster and must be a string');
  }
  if (!clusterCreationObject.defaultStorageContainer || typeof(clusterCreationObject.defaultStorageContainer) != 'string') {
    throw new Error('The [defaultStorageContainer] field is required when creating a cluster and must be a string');
  }
  if (!clusterCreationObject.user || typeof(clusterCreationObject.user) != 'string') {
    throw new Error('The [user] field is required when creating a cluster and must be a string');
  }
  if (!clusterCreationObject.password || typeof(clusterCreationObject.password) != 'string') {
    throw new Error('The [password] field is required when creating a cluster and must be a string');
  }
  if (!clusterCreationObject.nodes || typeof(clusterCreationObject.nodes) != 'number' || !isInt(clusterCreationObject.nodes)) {
  ...
  if (clusterCreationObject.oozieMetastore) {
    ...
    if (!clusterCreationObject.oozieMetastore.server || typeof(clusterCreationObject.oozieMetastore.server) != 'string') {
      throw new Error('If the [oozieMetastore] field is supplied it must contain a [server] field which must be a string');
    }
    if (!clusterCreationObject.oozieMetastore.database || typeof(clusterCreationObject.oozieMetastore.database) != 'string') {
      throw new Error('If the [oozieMetastore] field is supplied it must contain a [database] field which must be a string');
    }
    if (!clusterCreationObject.oozieMetastore.user || typeof(clusterCreationObject.oozieMetastore.user) != 'string') {
      throw new Error('If the [oozieMetastore] field is supplied it must contain a [user] field which must be a string');
    }
    if (!clusterCreationObject.oozieMetastore.password || typeof(clusterCreationObject.oozieMetastore.password) != 'string') {
  ...
  if (clusterCreationObject.hiveMetastore) {
    ...
    if (!clusterCreationObject.hiveMetastore.server || typeof(clusterCreationObject.hiveMetastore.server) != 'string') {
      throw new Error('If the [hiveMetastore] field is supplied it must contain a [server] field which must be a string');
    }
    if (!clusterCreationObject.hiveMetastore.database || typeof(clusterCreationObject.hiveMetastore.database) != 'string') {
      throw new Error('If the [hiveMetastore] field is supplied it must contain a [database] field which must be a string');
    }
    if (!clusterCreationObject.hiveMetastore.user || typeof(clusterCreationObject.hiveMetastore.user) != 'string') {
      throw new Error('If the [hiveMetastore] field is supplied it must contain a [user] field which must be a string');
    }
    if (!clusterCreationObject.hiveMetastore.password || typeof(clusterCreationObject.hiveMetastore.password) != 'string') {
