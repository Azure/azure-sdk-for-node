...
//
// create an azure sdk configuration setup based on the
// individual parameters passed.
//
function configFromParameters(subscriptionId, auth, hostOptions) {
...
function ServiceManagementService(configOrSubscriptionId, authentication, hostOptions) {
  ...
  if (!config) {
    ...
    config = configFromParameters(configOrSubscriptionId, authentication, hostOptions);
  }

  var settings = ServiceManagementSettings.createFromConfig(config);
