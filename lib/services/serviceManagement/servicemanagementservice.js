...
ServiceManagementService.prototype.listStorageAccounts = function (callback) {
  validateObjectArgument(callback, 'callback', 'listStorageAccounts');
...
ServiceManagementService.prototype.regenerateStorageAccountKeys = function (serviceName, keyType, callback) {
  validateStringArgument(serviceName, 'serviceName', 'regenerateStorageAccountKeys');
  validateObjectArgument(callback, 'callback', 'regenerateStorageAccountKeys');
...
ServiceManagementService.prototype.deleteStorageAccount = function (serviceName, callback) {
  validateStringArgument(serviceName, 'serviceName', 'deleteStorageAccount');
  validateObjectArgument(callback, 'callback', 'deleteStorageAccount');
...
*
* @param {string} serviceName           The name of the hosted service. Required.
* @param {string} deploymentSlot        The deployment slot. Required.
* @param {object} deploymentOptions     Options for deployment creation
*                                       {
*                                         Name: The deployment name.
*                                         PackageUrl: required. The url to the package to deploy.
*                                         Label: required. Defaults to deploymentName
*                                         Configuration: required. The configuration.
*                                         StartDeployment: required: Wether to start deployment or not.
*                                       }
* @param {function} callback            The callback function called on completion. Required.
*/
...
*                                       {
*                                         Mode: required. The deployment mode.
*                                         PackageUrl: required. The url to the package to deploy.
*                                         Label: required. Defaults to deploymentName
*                                         Configuration: required. The configuration.
*                                         Force: required: Wether to force the deployment or not.
*                                       }
* @param {function} callback            The callback function called on completion. Required.
*/
...
ServiceManagementService.prototype.listVirtualNetworkSites = function (callback) {
  validateObjectArgument(callback, 'callback', 'listVirtualNetworkSites');
...
ServiceManagementService.prototype.getNetworkConfig = function (callback) {
  validateObjectArgument(callback, 'callback', 'getNetworkConfig');
...
ServiceManagementService.prototype.setNetworkConfig = function (networkConfiguration, callback) {
  validateObjectArgument(networkConfiguration, 'networkConfiguration', 'setNetworkConfig');
  validateObjectArgument(callback, 'callback', 'setNetworkConfig');
