 ...
 *                                        - edition: 'Web' or 'Business', defaults to 'Web'
 *                                        - maxSize: in GB, defaults to 1 for web, 10 for business, only certain
 *                                                   values are valid
 *                                        - collation: sql collation name, defaults to 'SQL_Latin1_General_CP1_CI_AS'
* @param {function} callback            function (err, database, response) The callback function called on completion. Required.
 */
SqlManagementService.prototype.createDatabase = function(serverName, databaseName, options, callback) {
