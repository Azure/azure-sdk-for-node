...
ServiceManagementSerialize.prototype.buildNetworkConfiguration = function(networkConfig, client)
{
  var doc = xmlbuilder.create();
  ...
  // Dns section
  if (vNetConfig.Dns != null && vNetConfig.Dns.DnsServers instanceof Array) {
  ...
  if (vNetConfig.VirtualNetworkSites instanceof Array) {
    if (vNetConfig.VirtualNetworkSites.length > 0) {
      ...
      if (virtualNetworkSite.Gateway != null) {
        ...
        if (virtualNetworkSite.Gateway.Profile != null) {
        ...
        if (virtualNetworkSite.Gateway.ConnectionsToLocalNetwork instanceof Array) {
          if (virtualNetworkSite.Gateway.ConnectionsToLocalNetwork.length > 0) {
            ...
            virtualNetworkSite.Gateway.ConnectionsToLocalNetwork.forEach(function(localNetworkRef) {
              if (localNetworkRef.Name != null) {
                virtualNetworkSiteGatewayVPNClientAdressPoolElement.
