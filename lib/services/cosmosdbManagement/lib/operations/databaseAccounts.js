 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _offlineRegion(resourceGroupName, accountName, region, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Send request
  this.beginOfflineRegion(resourceGroupName, accountName, region, options, (err, parsedResult, httpRequest, response) => {
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _onlineRegion(resourceGroupName, accountName, region, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Send request
  this.beginOnlineRegion(resourceGroupName, accountName, region, options, (err, parsedResult, httpRequest, response) => {
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _beginOfflineRegion(resourceGroupName, accountName, region, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  requestUrl = requestUrl.replace('{resourceGroupName}', encodeURIComponent(resourceGroupName));
  requestUrl = requestUrl.replace('{accountName}', encodeURIComponent(accountName));
  requestUrl = requestUrl.replace('{region}', encodeURIComponent(region));
  let queryParameters = [];
  queryParameters.push('api-version=' + encodeURIComponent(this.client.apiVersion));
  if (queryParameters.length > 0) {
    requestUrl += '?' + queryParameters.join('&');
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _beginOnlineRegion(resourceGroupName, accountName, region, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
...
class DatabaseAccounts {
   ...
   * @reject {Error} - The error object.
   */
  offlineRegionWithHttpOperationResponse(resourceGroupName, accountName, region, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._offlineRegion(resourceGroupName, accountName, region, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  offlineRegion(resourceGroupName, accountName, region, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._offlineRegion(resourceGroupName, accountName, region, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  onlineRegionWithHttpOperationResponse(resourceGroupName, accountName, region, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._onlineRegion(resourceGroupName, accountName, region, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  onlineRegion(resourceGroupName, accountName, region, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._onlineRegion(resourceGroupName, accountName, region, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  beginOfflineRegionWithHttpOperationResponse(resourceGroupName, accountName, region, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginOfflineRegion(resourceGroupName, accountName, region, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  beginOfflineRegion(resourceGroupName, accountName, region, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._beginOfflineRegion(resourceGroupName, accountName, region, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  beginOnlineRegionWithHttpOperationResponse(resourceGroupName, accountName, region, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginOnlineRegion(resourceGroupName, accountName, region, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  beginOnlineRegion(resourceGroupName, accountName, region, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._beginOnlineRegion(resourceGroupName, accountName, region, options, optionalCallback);
    }
  }
