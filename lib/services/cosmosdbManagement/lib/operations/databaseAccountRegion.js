 ...
 */
function _listMetrics(resourceGroupName, accountName, region, filter, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/region/{region}/metrics';
...
class DatabaseAccountRegion {
   ...
   */
  listMetricsWithHttpOperationResponse(resourceGroupName, accountName, region, filter, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listMetrics(resourceGroupName, accountName, region, filter, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listMetrics(resourceGroupName, accountName, region, filter, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._listMetrics(resourceGroupName, accountName, region, filter, options, optionalCallback);
    }
  }

}

module.exports = DatabaseAccountRegion;
