...
export interface GlobalDomainRegistration {
     ...
     *
     * @param {object} identifier Name of the domain
     * 
     * @param {string} [identifier.name] Name of the object
     * 
     * @param {object} [options] Optional Parameters.
     * 
     * @param {object} [options.customHeaders] Headers that will be added to the
     ...
     * doc in ms-rest index.d.ts for details
     */
    checkDomainAvailability(identifier: models.NameIdentifier, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.DomainAvailablilityCheckResult>): void;
    checkDomainAvailability(identifier: models.NameIdentifier, callback: ServiceCallback<models.DomainAvailablilityCheckResult>): void;
...
export interface Sites {
     ...
     * @param {string} name Name of web app
     * 
     * @param {object} options Specifies options for publishing profile. Pass
     ...
     * doc in ms-rest index.d.ts for details
     */
    listSitePublishingProfileXml(resourceGroupName: string, name: string, options: models.CsmPublishingProfileOptions, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<stream.Readable>): void;
    listSitePublishingProfileXml(resourceGroupName: string, name: string, options: models.CsmPublishingProfileOptions, callback: ServiceCallback<stream.Readable>): void;
     ...
     * doc in ms-rest index.d.ts for details
     */
    listSitePublishingProfileXmlSlot(resourceGroupName: string, name: string, options: models.CsmPublishingProfileOptions, slot: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<stream.Readable>): void;
    listSitePublishingProfileXmlSlot(resourceGroupName: string, name: string, options: models.CsmPublishingProfileOptions, slot: string, callback: ServiceCallback<stream.Readable>): void;
...
export interface TopLevelDomains {
     ...
     * 
     * @param {boolean} [agreementOption.includePrivacy] If true then the list of
     ...
     * doc in ms-rest index.d.ts for details
     */
    listTopLevelDomainAgreements(name: string, agreementOption: models.TopLevelDomainAgreementOption, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.TldLegalAgreementCollection>): void;
    listTopLevelDomainAgreements(name: string, agreementOption: models.TopLevelDomainAgreementOption, callback: ServiceCallback<models.TldLegalAgreementCollection>): void;
}
