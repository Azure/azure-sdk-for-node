 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
GlobalDomainRegistration.prototype.listDomainRecommendations = function (options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  var keywords = (options && options.keywords !== undefined) ? options.keywords : undefined;
  var maxDomainRecommendations = (options && options.maxDomainRecommendations !== undefined) ? options.maxDomainRecommendations : undefined;
  // Validate
  try {
    if (this.client.subscriptionId === null || this.client.subscriptionId === undefined || typeof this.client.subscriptionId.valueOf() !== 'string') {
      throw new Error('this.client.subscriptionId cannot be null or undefined and it must be of type string.');
    ...
    if (keywords !== null && keywords !== undefined && typeof keywords.valueOf() !== 'string') {
      throw new Error('keywords must be of type string.');
    }
    if (maxDomainRecommendations !== null && maxDomainRecommendations !== undefined && typeof maxDomainRecommendations !== 'number') {
      throw new Error('maxDomainRecommendations must be of type number.');
    }
    if (this.client.acceptLanguage !== null && this.client.acceptLanguage !== undefined && typeof this.client.acceptLanguage.valueOf() !== 'string') {
      throw new Error('this.client.acceptLanguage must be of type string.');
    }
  ...
  var parameters;
  if ((keywords !== null && keywords !== undefined) || (maxDomainRecommendations !== null && maxDomainRecommendations !== undefined)) {
      parameters = new client.models['DomainRecommendationSearchParameters']();
      parameters.keywords = keywords;
      parameters.maxDomainRecommendations = maxDomainRecommendations;
  }
