 ...
 * values for this property include: 'Active', 'Awaiting', 'Cancelled',
 ...
 * values for this property include: 'Succeeded', 'Failed', 'Canceled',
 * 'InProgress'.
 * 
 ...
 * hostname is assigned to. Possible values for this property include:
 * 'Website', 'TrafficManager'.
 * 
 * @member {string} [customHostNameDnsRecordType] Type of the Dns record.
 * Possible values for this property include: 'CName', 'A'.
 * 
 * @member {string} [hostNameType] Type of the hostname. Possible values for
 * this property include: 'Verified', 'Managed'.
 * 
 */
 ...
 * 
 * @member {string} [status] App Service Plan Status. Possible values for this
 * property include: 'Ready', 'Pending'.
 * 
 ...
 * its quota usage. Possible values for this property include: 'Normal',
 * 'Exceeded'.
 * 
 ...
 * Possible values for this property include: 'Normal', 'Limited',
 ...
 * 
 * @member {string} sslState SSL type. Possible values for this property
 ...
 * values for this property include: 'Integrated', 'Classic'.
 * 
 * @member {array} [virtualApplications] Virtual applications
 * 
 * @member {string} [loadBalancing] Site load balancing. Possible values for
 * this property include: 'WeightedRoundRobin', 'LeastRequests',
 * 'LeastResponseTime', 'WeightedTotalTraffic', 'RequestHash'.
 * 
 ...
 * action to be taken. Possible values for this property include: 'Recycle',
 ...
 * 
 * @member {string} type Type of database. Possible values for this property
 ...
 * taken. Possible values for this property include: 'Recycle', 'LogEvent',
 * 'CustomAction'.
 * 
 ...
 * Possible values for this property include: 'Recycle', 'LogEvent',
 * 'CustomAction'.
 * 
 ...
 * values for this property include: 'RedirectToLoginPage', 'AllowAnonymous'.
 * 
 ...
 * Service Environment). Possible values for this property include:
 ...
 * VNET. Possible values for this property include: 'None', 'Web',
 * 'Publishing'.
 * 
 ...
 * Possible values for this property include: 'Shared', 'Dedicated'.
 * 
 ...
 * @constructor
 * @member {string} [action] Possible values for this property include:
 * 'Permit', 'Deny'.
 * 
 ...
 * environment. Possible values for this property include: 'Preparing',
 * 'Ready', 'Deleting'.
 * 
 ...
 * CreateDomain Api
 * 
 * @member {string} [domainType] Domain type. Possible values for this
 * property include: 'Regular', 'SoftDeleted'.
 * 
 */
 ...
 * values for this property include: 'Shared', 'Dedicated'.
 * 
 ...
 * for this property include: 'Website', 'TrafficManager'.
 * 
 * @member {string} [customHostNameDnsRecordType] Custom DNS record type.
 * Possible values for this property include: 'CName', 'A'.
 * 
 * @member {string} [hostNameType] Host name type. Possible values for this
 * property include: 'Verified', 'Managed'.
 * 
 */
 ...
 * values for this property include: 'Off', 'Verbose', 'Information',
 * 'Warning', 'Error'.
 * 
 ...
 * Possible values for this property include: 'Off', 'Verbose',
 ...
 * 
 * @member {string} [fileSystem.level] Log level. Possible values for this
 * property include: 'Off', 'Verbose', 'Information', 'Warning', 'Error'.
 * 
 * @member {object} [azureTableStorage] Application logs to azure table
 * storage configuration
 * 
 * @member {string} [azureTableStorage.level] Log level. Possible values for
 * this property include: 'Off', 'Verbose', 'Information', 'Warning', 'Error'.
 * 
 ...
 * configuration
 * 
 * @member {string} [azureBlobStorage.level] Log level. Possible values for
 * this property include: 'Off', 'Verbose', 'Information', 'Warning', 'Error'.
 * 
 ...
 * @member {string} [level] Log level. Possible values for this property
 ...
 * for this property include: 'Default', 'Clone', 'Relocation'.
 * 
 */
 ...
 * should be set to 7). Possible values for this property include: 'Day',
 * 'Hour'.
 * 
 ...
 * 
 * @member {string} [status] Backup status. Possible values for this property
 ...
 * 
 * @member {string} [operationType] Operation type. Possible values for this
 * property include: 'Default', 'Clone', 'Relocation'.
 * 
