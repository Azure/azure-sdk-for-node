...
var WebSiteManagementClient = ( /** @lends WebSiteManagementClient */ function() {
  ...
  WebSiteManagementClient.prototype.beginDeletingResourceGroup = function(resourceGroupName, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.credentials.subscriptionId !== null && this.credentials.subscriptionId !== undefined ? this.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '?';
    url2 = url2 + 'api-version=2014-06-01';
  ...
  WebSiteManagementClient.prototype.getResourceGroups = function(callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.credentials.subscriptionId !== null && this.credentials.subscriptionId !== undefined ? this.credentials.subscriptionId.trim() : '') + '/resourcegroups?';
    url2 = url2 + 'api-version=2014-06-01';
    var baseUrl = this.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
  ...
  WebSiteManagementClient.prototype.registerResourceProvider = function(callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.credentials.subscriptionId !== null && this.credentials.subscriptionId !== undefined ? this.credentials.subscriptionId.trim() : '') + '/providers/Microsoft.Web/register?';
    url2 = url2 + 'api-version=2014-06-01';
    var baseUrl = this.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
  ...
  WebSiteManagementClient.prototype.unregisterResourceProvider = function(callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.credentials.subscriptionId !== null && this.credentials.subscriptionId !== undefined ? this.credentials.subscriptionId.trim() : '') + '/providers/Microsoft.Web/unregister?';
    url2 = url2 + 'api-version=2014-06-01';
    var baseUrl = this.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
...
var WebHostingPlanOperations = ( /** @lends WebHostingPlanOperations */ function() {
  ...
  WebHostingPlanOperations.prototype.createOrUpdate = function(resourceGroupName, parameters, callback) {
    ...
    if (parameters.webHostingPlan.properties !== null && parameters.webHostingPlan.properties !== undefined) {
      if (parameters.webHostingPlan.properties.numberOfWorkers === null || parameters.webHostingPlan.properties.numberOfWorkers === undefined) {
        return callback(new Error('parameters.webHostingPlan.properties.numberOfWorkers cannot be null.'));
      }
    }
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourceGroups/' + resourceGroupName.trim() + '/providers/Microsoft.Web/serverFarms/' + parameters.webHostingPlan.name.trim() + '?';
    url2 = url2 + 'api-version=2014-06-01';
   ...
   * @returns {Stream} The response stream.
   */
  WebHostingPlanOperations.prototype.delete = function(resourceGroupName, webHostingPlanName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourceGroups/' + resourceGroupName.trim() + '/providers/Microsoft.Web/serverFarms/' + webHostingPlanName.trim() + '?';
    url2 = url2 + 'api-version=2014-06-01';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
   ...
   * 
   * @param {boolean} parameters.includeInstanceBreakdown Flag which specifies
   * if the metrics for each machine instance should be included. For sites
   * that run on more than one machine this could be useful to identify a bad
   * machine.
   * 
   * @param {function} callback
   * 
  ...
  WebHostingPlanOperations.prototype.getHistoricalUsageMetrics = function(resourceGroupName, webHostingPlanName, parameters, callback) {
    ...
    if (parameters.includeInstanceBreakdown === null || parameters.includeInstanceBreakdown === undefined) {
      return callback(new Error('parameters.includeInstanceBreakdown cannot be null.'));
    }
    
    // Tracing
    
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourceGroups/' + resourceGroupName.trim() + '/providers/Microsoft.Web/serverFarms/' + webHostingPlanName.trim() + '/metrics?';
    url2 = url2 + 'api-version=2014-06-01';
    ...
    if (parameters.timeGrain !== null && parameters.timeGrain !== undefined) {
      url2 = url2 + '&timeGrain=' + encodeURIComponent(parameters.timeGrain !== null && parameters.timeGrain !== undefined ? parameters.timeGrain.trim() : '');
    }
    url2 = url2 + '&details=' + encodeURIComponent(parameters.includeInstanceBreakdown.toString());
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebHostingPlanOperations.prototype.list = function(resourceGroupName, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourceGroups/' + resourceGroupName.trim() + '/providers/Microsoft.Web/serverFarms?';
    url2 = url2 + 'api-version=2014-06-01';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
...
var WebSiteOperations = ( /** @lends WebSiteOperations */ function() {
   ...
   * immediately.
   * 
   * @param {IEnumerable`1} [backupRequestEnvelope.request.databases] Database
   * settings for backup.
   * 
  ...
  WebSiteOperations.prototype.backup = function(resourceGroupName, webSiteName, slotName, backupRequestEnvelope, callback) {
    ...
    if (backupRequestEnvelope.request !== null && backupRequestEnvelope.request !== undefined) {
      if (backupRequestEnvelope.request.backupSchedule !== null && backupRequestEnvelope.request.backupSchedule !== undefined) {
        if (backupRequestEnvelope.request.backupSchedule.frequencyInterval === null || backupRequestEnvelope.request.backupSchedule.frequencyInterval === undefined) {
          return callback(new Error('backupRequestEnvelope.request.backupSchedule.frequencyInterval cannot be null.'));
        }
        if (backupRequestEnvelope.request.backupSchedule.keepAtLeastOneBackup === null || backupRequestEnvelope.request.backupSchedule.keepAtLeastOneBackup === undefined) {
          return callback(new Error('backupRequestEnvelope.request.backupSchedule.keepAtLeastOneBackup cannot be null.'));
        }
        if (backupRequestEnvelope.request.backupSchedule.retentionPeriodInDays === null || backupRequestEnvelope.request.backupSchedule.retentionPeriodInDays === undefined) {
          return callback(new Error('backupRequestEnvelope.request.backupSchedule.retentionPeriodInDays cannot be null.'));
        }
      }
    }
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourceGroups/' + resourceGroupName.trim() + '/providers/Microsoft.Web/sites/' + webSiteName.trim();
    if (slotName !== null && slotName !== undefined) {
      url2 = url2 + '/slots/' + encodeURIComponent(slotName !== null && slotName !== undefined ? slotName.trim() : '');
    }
    url2 = url2 + '/backup?';
    url2 = url2 + 'api-version=2014-06-01';
    var baseUrl = this.client.baseUri;
   ...
   * @returns {Stream} The response stream.
   */
  WebSiteOperations.prototype.delete = function(resourceGroupName, webSiteName, slotName, parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
   ...
   * 
   * @param {IEnumerable`1} [restoreRequestEnvelope.request.databases] Database
   * settings for backup.
   * 
   * @param {boolean}
  ...
  WebSiteOperations.prototype.discover = function(resourceGroupName, webSiteName, slotName, restoreRequestEnvelope, callback) {
    ...
    if (restoreRequestEnvelope.request !== null && restoreRequestEnvelope.request !== undefined) {
      if (restoreRequestEnvelope.request.adjustConnectionStrings === null || restoreRequestEnvelope.request.adjustConnectionStrings === undefined) {
        return callback(new Error('restoreRequestEnvelope.request.adjustConnectionStrings cannot be null.'));
      }
      if (restoreRequestEnvelope.request.ignoreConflictingHostNames === null || restoreRequestEnvelope.request.ignoreConflictingHostNames === undefined) {
        return callback(new Error('restoreRequestEnvelope.request.ignoreConflictingHostNames cannot be null.'));
      }
      if (restoreRequestEnvelope.request.overwrite === null || restoreRequestEnvelope.request.overwrite === undefined) {
        return callback(new Error('restoreRequestEnvelope.request.overwrite cannot be null.'));
      }
    }
  ...
  WebSiteOperations.prototype.getHistoricalUsageMetrics = function(resourceGroupName, webSiteName, slotName, parameters, callback) {
    ...
    if (parameters.slotView === null || parameters.slotView === undefined) {
      return callback(new Error('parameters.slotView cannot be null.'));
    }
    ...
    url2 = url2 + '&details=' + encodeURIComponent(parameters.includeInstanceBreakdown.toString());
    url2 = url2 + '&slotView=' + encodeURIComponent(parameters.slotView.toString());
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (publishDataSequenceElement !== null && publishDataSequenceElement !== undefined) {
          for (var loweredIndex1 = 0; loweredIndex1 < js2xml.getElements(responseDoc, publishDataSequenceElement, 'PUBLISHPROFILE', '').length; loweredIndex1 = loweredIndex1 + 1) {
            ...
            if (ftpPassiveModeAttribute !== null && ftpPassiveModeAttribute !== undefined) {
  ...
  WebSiteOperations.prototype.getSlotConfigNames = function(resourceGroupName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourceGroups/' + resourceGroupName.trim() + '/providers/Microsoft.Web/sites/' + webSiteName.trim() + '/slotConfigNames?';
    url2 = url2 + 'api-version=2014-06-01';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
  ...
  WebSiteOperations.prototype.list = function(resourceGroupName, webSiteName, parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourceGroups/' + resourceGroupName.trim() + '/providers/Microsoft.Web/sites';
    if (webSiteName !== null && webSiteName !== undefined) {
      url2 = url2 + '/' + encodeURIComponent(webSiteName !== null && webSiteName !== undefined ? webSiteName.trim() : '') + '/slots/';
    }
    url2 = url2 + '?';
    url2 = url2 + 'api-version=2014-06-01';
    if (parameters !== null && parameters !== undefined && parameters.propertiesToInclude !== null && parameters.propertiesToInclude !== undefined && parameters.propertiesToInclude.length > 0) {
