...
function _create(personGroupId, options, callback) {
  ...
  try {
    if (this.client.azureRegion) {
      ...
      if (!allowedValues.some( function(item) { return item === client..azureRegion; })) {
        throw new Error(this.client.azureRegion + ' is not a valid value. The valid values are: ' + allowedValues);
      }
    } else {
