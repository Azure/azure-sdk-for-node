...
/** Class representing a DataLakeStorageClient. */
class DataLakeStorageClient extends ServiceClient {
  /**
   * Create a DataLakeStorageClient.
   ...
   */
  constructor(credentials, accountName, options) {
    ...
    this.filesystemOperations = new operations.FilesystemOperations(this);
    this.pathOperations = new operations.PathOperations(this);
    this.models = models;
...
module.exports = DataLakeStorageClient;
module.exports['default'] = DataLakeStorageClient;
module.exports.DataLakeStorageClient = DataLakeStorageClient;
module.exports.DataLakeStorageModels = models;
