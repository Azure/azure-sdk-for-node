...
var SchedulerClient = ( /** @lends SchedulerClient */ function() {
   ...
   * @param {Array} filters
   */
  function SchedulerClient(credentials, cloudServiceName, jobCollectionName, baseUri, filters) {
...
var JobOperations = ( /** @lends JobOperations */ function() {
  ...
  JobOperations.prototype.create = function(parameters, callback) {
    ...
    var url2 = this.client.credentials.subscriptionId.trim() + '/cloudservices/' + this.client.cloudServiceName.trim() + '/resources/scheduler/~/JobCollections/' + this.client.jobCollectionName.trim() + '/jobs?';
  ...
  JobOperations.prototype.createOrUpdate = function(jobId, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = this.client.credentials.subscriptionId.trim() + '/cloudservices/' + this.client.cloudServiceName.trim() + '/resources/scheduler/~/JobCollections/' + this.client.jobCollectionName.trim() + '/jobs/' + jobId.trim() + '?';
    url2 = url2 + 'api-version=2014-04-01';
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  JobOperations.prototype.getHistory = function(jobId, parameters, callback) {
    ...
    // Construct URL
    var baseUrl = this.client.baseUri;
    var url2 = this.client.credentials.subscriptionId.trim() + '/cloudservices/' + this.client.cloudServiceName.trim() + '/resources/scheduler/~/JobCollections/' + this.client.jobCollectionName.trim() + '/jobs/' + jobId.trim() + '/history?';
    url2 = url2 + 'api-version=2014-04-01';
