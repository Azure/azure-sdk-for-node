    ...
    if (parameters.action.request !== null && parameters.action.request !== undefined) {
      ...
      if (parameters.action.request.authentication !== null && parameters.action.request.authentication !== undefined) {
        ...
        if (parameters.action.request.authentication.type === 'ClientCertificate') {
          ...
          var derived2 = parameters.action.request.authentication;
          
          if (derived2.password !== null && derived2.password !== undefined) {
            authenticationValue2['password'] = derived2.password;
          }
          
          if (derived2.pfx !== null && derived2.pfx !== undefined) {
            authenticationValue2['pfx'] = derived2.pfx;
          }
          
          if (derived2.certificateThumbprint !== null && derived2.certificateThumbprint !== undefined) {
            authenticationValue2['certificateThumbprint'] = derived2.certificateThumbprint;
          }
          
          if (derived2.certificateExpiration !== null && derived2.certificateExpiration !== undefined) {
            authenticationValue2['certificateExpiration'] = derived2.certificateExpiration;
          }
          
          if (derived2.certificateSubjectName !== null && derived2.certificateSubjectName !== undefined) {
            authenticationValue2['certificateSubjectName'] = derived2.certificateSubjectName;
          }
          
          authenticationValue2['type'] = derived2.type !== null && derived2.type !== undefined ? derived2.type.toString() : 'NotSpecified';
        }
      }
    }
          ...
          if (requestValue4 !== null && requestValue4 !== undefined) {
            ...
            if (authenticationValue4 !== null && authenticationValue4 !== undefined) {
              ...
              if (typeName2 === 'ClientCertificate') {
                ...
                var passwordValue2 = authenticationValue4['password'];
                ...
                var typeValue4 = authenticationValue4['type'];
          ...
          if (requestValue2 !== null && requestValue2 !== undefined) {
            ...
            if (authenticationValue2 !== null && authenticationValue2 !== undefined) {
              ...
              if (typeName2 === 'ClientCertificate') {
                ...
                var passwordValue2 = authenticationValue2['password'];
                if (passwordValue2 !== null && passwordValue2 !== undefined) {
                  var passwordInstance2 = passwordValue2;
                  clientCertAuthenticationInstance2.password = passwordInstance2;
                }
                ...
                var typeValue4 = authenticationValue2['type'];
                if (typeValue4 !== null && typeValue4 !== undefined) {
                  var typeInstance4 = typeValue4;
                  clientCertAuthenticationInstance2.type = typeInstance4;
                }
