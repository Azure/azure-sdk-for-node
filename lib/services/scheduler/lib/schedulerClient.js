...
var JobOperations = ( /** @lends JobOperations */ function() {
  ...
  JobOperations.prototype.create = function(parameters, callback) {
    ...
    url2 = url2 + 'api-version=2013-10-31_Preview';
  ...
  JobOperations.prototype.createOrUpdate = function(jobId, parameters, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + this.client.credentials.subscriptionId + '/cloudservices/' + this.client.cloudServiceName + '/resources/scheduler/~/JobCollections/' + this.client.jobCollectionName + '/jobs/' + jobId + '?';
    url2 = url2 + 'api-version=2013-10-31_Preview';
  ...
  JobOperations.prototype.getHistory = function(jobId, parameters, callback) {
    ...
    // Construct URL
    var url2 = this.client.baseUri + this.client.credentials.subscriptionId + '/cloudservices/' + this.client.cloudServiceName + '/resources/scheduler/~/JobCollections/' + this.client.jobCollectionName + '/jobs/' + jobId + '/history?';
    url2 = url2 + 'api-version=2013-10-31_Preview';
