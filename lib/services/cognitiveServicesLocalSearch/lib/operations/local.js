...
/**
 * @summary The Local Search API lets you send a search query to Bing and get
 ...
 *
 * @param {string} [options.localCategories] comma-delimited list of business
 * categories to search for. Supported categories can be high-level such as
 * EatDrink, Shop, SeeDo.
 *
 * @param {string} [options.localCircularView] Preferred location to search
 * around, expressed as Latitude, longitude and radius in meters. For example
 ...
 *
 * @param {string} [options.localMapView] Preferred bounding box for results,
 * specified in NW_latitude, NW_Longitude, SE_Latitude, SE_Longitude format.
 * For example 47.64,-122.13,47.63,-122.12. These values are lat, long pairs
 * for the Northwest corner and the Southeast corner of a rectangle.
 *
 * @param {string} [options.count] Preferred number of results to return. If
 * not specified, then Bing returns 1-20 of the most relevant results.
 *
 * @param {string} [options.first] First result to return. zero-based. default
 * is 0.
 *
...
function _search(query, options, callback) {
  ...
  let localCategories = (options && options.localCategories !== undefined) ? options.localCategories : undefined;
  let localCircularView = (options && options.localCircularView !== undefined) ? options.localCircularView : undefined;
  let localMapView = (options && options.localMapView !== undefined) ? options.localMapView : undefined;
  let count = (options && options.count !== undefined) ? options.count : undefined;
  let first = (options && options.first !== undefined) ? options.first : undefined;
  ...
  try {
    ...
    if (localCategories !== null && localCategories !== undefined && typeof localCategories.valueOf() !== 'string') {
      throw new Error('localCategories must be of type string.');
    }
    if (localCircularView !== null && localCircularView !== undefined && typeof localCircularView.valueOf() !== 'string') {
      throw new Error('localCircularView must be of type string.');
    }
    if (localMapView !== null && localMapView !== undefined && typeof localMapView.valueOf() !== 'string') {
      throw new Error('localMapView must be of type string.');
    }
    if (count !== null && count !== undefined && typeof count.valueOf() !== 'string') {
      throw new Error('count must be of type string.');
    }
    if (first !== null && first !== undefined && typeof first.valueOf() !== 'string') {
      throw new Error('first must be of type string.');
    }
    if (Array.isArray(responseFormat)) {
      for (let i = 0; i < responseFormat.length; i++) {
        if (responseFormat[i] !== null && responseFormat[i] !== undefined && typeof responseFormat[i].valueOf() !== 'string') {
          throw new Error('responseFormat[i] must be of type string.');
        }
      }
    }
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'localbusinesses/v7.0/search';
  let queryParameters = [];
  ...
  if (localCategories !== null && localCategories !== undefined) {
    queryParameters.push('localcategories=' + encodeURIComponent(localCategories));
  }
  if (localCircularView !== null && localCircularView !== undefined) {
    queryParameters.push('localcircularview=' + encodeURIComponent(localCircularView));
  }
  if (localMapView !== null && localMapView !== undefined) {
    queryParameters.push('localmapview=' + encodeURIComponent(localMapView));
  }
  if (count !== null && count !== undefined) {
    queryParameters.push('count=' + encodeURIComponent(count));
  }
  if (first !== null && first !== undefined) {
    queryParameters.push('first=' + encodeURIComponent(first));
  }
...
class Local {
  /**
   * Create a Local.
   * @param {LocalSearchClient} client Reference to the service client.
   */
  constructor(client) {
    this.client = client;
