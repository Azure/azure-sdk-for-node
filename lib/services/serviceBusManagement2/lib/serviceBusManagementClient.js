...
/** Class representing a ServiceBusManagementClient. */
class ServiceBusManagementClient extends ServiceClient {
  /**
   * Create a ServiceBusManagementClient.
  ...
  constructor(credentials, subscriptionId, baseUri, options) {
    ...
    this.migrationConfigurations = new operations.MigrationConfigurations(this);
    this.migrationConfig = new operations.MigrationConfig(this);
    ...
    this.premiumMessagingRegionsOperations = new operations.PremiumMessagingRegionsOperations(this);
