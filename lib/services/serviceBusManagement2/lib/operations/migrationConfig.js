 ...
 */
function _upgrade(resourceGroupName, namespaceName, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/migrationConfigurations/$default/upgrade';
...
/** Class representing a MigrationConfig. */
class MigrationConfig {
   ...
   */
  upgradeWithHttpOperationResponse(resourceGroupName, namespaceName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._upgrade(resourceGroupName, namespaceName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  upgrade(resourceGroupName, namespaceName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._upgrade(resourceGroupName, namespaceName, options, optionalCallback);
    }
  }
