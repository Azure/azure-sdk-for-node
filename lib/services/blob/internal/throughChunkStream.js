...
*/
function ThroughChunkStream(options) {
...
util.inherits(ThroughChunkStream, EventEmitter);

/**
* Internl stream ended
*/
ThroughChunkStream.prototype.end = function() {
...
* Add event listener
*/
ThroughChunkStream.prototype.write = function(data) {
...
*/
ThroughChunkStream.prototype._buildChunk = function(data) {
  if(this._md5hash) {
...
* Emit the buffer
*/
ThroughChunkStream.prototype._emitBufferData = function(buffer) {
...
*/
ThroughChunkStream.prototype._copyToInternalBuffer = function(data, start, end) {
...
*/
ThroughChunkStream.prototype._flushInternalBuffer = function() {
...
* Pop internal buffer
*/
ThroughChunkStream.prototype._popInternalBuffer = function () {
  var buf = null;
...
* Allocate a buffer
*/
ThroughChunkStream.prototype._allocateNewBuffer = function() {
...
*/
ThroughChunkStream.prototype.getContentMd5 = function(encoding) {
...
* Pause chunk stream
*/
ThroughChunkStream.prototype.pause = function() {
  this._paused = true;
};
...
* Resume read stream
*/
ThroughChunkStream.prototype.resume = function() {
  if (this._paused) {
    this._paused = false;
    this.emit('resume');
  }
...
module.exports = ThroughChunkStream;
