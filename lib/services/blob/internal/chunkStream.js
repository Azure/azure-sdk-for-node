...
function ChunkStream(stream, options) {
  ...
  this._stream = stream;
  this._stream.on('end', this._onInternalStreamEnd.bind(this)); //Should catch the end event for node v0.6 and v0.8
...
*/
ChunkStream.prototype._onInternalStreamEnd = function() {
