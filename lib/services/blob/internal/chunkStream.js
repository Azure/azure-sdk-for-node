...
var ThroughChunkStream = require('./throughChunkStream');
...
*/
function ChunkStream(stream, options) {
  ThroughChunkStream.call(this, options);
...
util.inherits(ChunkStream, ThroughChunkStream);

/**
* Add event listener
*/
ChunkStream.prototype.on = function(event, listener) {
...
ChunkStream.prototype.pause = function () {
  ThroughChunkStream.prototype.pause.call(this);
...
ChunkStream.prototype.resume = function() {
  ThroughChunkStream.prototype.resume.call(this);
