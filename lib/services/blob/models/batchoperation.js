...
var os = require('os');
var DEFAULT_OPERATION_MEMORY_USAGE = require('../../../util/constants').BlobConstants.DEFAULT_WRITE_BLOCK_SIZE_IN_BYTES;
...
BatchOperation.prototype._fireOperationUserCallback = function (operation) {
  ...
  if(index != -1 && !this._paused) {
    ...
    if(operation._userCallback) {
      ...
      //Please make sure UserCallback is a sync operation
      //Otherwise BatchOperatioin can't know whether we should call the next callback.
