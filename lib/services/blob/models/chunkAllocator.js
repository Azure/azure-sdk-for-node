...
ChunkAllocator.prototype.releaseBuffer = function(buffer) {
  if(buffer.length === this._chunkSize) {
    //Directly delete the buffer if bufferSize is weird and wait for GC.
    buffer = null;
    return;
  }
