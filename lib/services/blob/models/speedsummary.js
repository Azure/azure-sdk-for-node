...
SpeedSummary.prototype.getAverageSpeed = function(humanReadable) {
  return this._getInternalSpeed(this.completeSize, humanReadable);
};
...
SpeedSummary.prototype.getSpeed = function(humanReadable) {
  ...
  return this._getInternalSpeed(this._totalWindowSize, humanReadable);
};

/**
* Get internal speed
*/
SpeedSummary.prototype._getInternalSpeed = function(totalSize, humanReadable) {
