...
BlobResult.prototype.getPropertiesFromHeaders = function (headers) {
  ...
  setBlobPropertyFromHeaders('leaseDuration', HeaderConstants.LEASE_DURATION);
  setBlobPropertyFromHeaders('leaseState', HeaderConstants.LEASE_STATE);
  ...
  setBlobPropertyFromHeaders('copyCompletionTime', HeaderConstants.COPY_COMPLETION_TIME);
  setBlobPropertyFromHeaders('copyStatusDescription', HeaderConstants.COPY_STATUS_DESCRIPTION);
  setBlobPropertyFromHeaders('copyId', HeaderConstants.COPY_ID);
  setBlobPropertyFromHeaders('copyProgress', HeaderConstants.COPY_PROGRESS);

  setBlobPropertyFromHeaders('requestId', HeaderConstants.REQUEST_ID_HEADER);
};
