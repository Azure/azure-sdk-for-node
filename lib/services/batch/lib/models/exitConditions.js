...
class ExitConditions {
   ...
   * error. The add task request fails with an invalid property value error;;
   ...
   * @member {string} [schedulingError.dependencyAction] The default is
   ...
   * the dependencyAction property returns an error. The add task request fails
   ...
   * properties - that is, any nonzero exit code not listed in the exitCodes or
   * exitCodeRanges collection, or a scheduling error if the schedulingError
   * property is not present. Note that the default condition does not include
   * exit code 0. If you want non-default behaviour on exit code 0, you must
   * list it explicitly using the exitCodes or exitCodeRanges collection.
