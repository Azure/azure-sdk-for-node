 ...
 *
 */
class AccountListSupportedImagesNextOptions {
  /**
   * Create a AccountListSupportedImagesNextOptions.
  ...
  /**
   * Defines the metadata of AccountListSupportedImagesNextOptions
   *
   * @returns {object} metadata of AccountListSupportedImagesNextOptions
   *
   */
  mapper() {
    return {
...
module.exports = AccountListSupportedImagesNextOptions;
