...
class JobPreparationTask {
   ...
   * any other tasks of the job on the compute node. If true and the Job
   ...
   * task runs as the common auto user account which is created on every node
   * in a pool. task - specifies that the service should create a new user for
   * the task. The default value is task. Possible values include: 'task',
   * 'pool'
