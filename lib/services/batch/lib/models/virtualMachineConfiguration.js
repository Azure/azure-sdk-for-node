...
class VirtualMachineConfiguration {
   ...
   * @member {object} [imageReference] A reference to the Azure Virtual
   * Machines Marketplace image to use. This property and osDisk are mutually
   ...
   * you do not supply enough VHD URIs, the pool will partially allocate
