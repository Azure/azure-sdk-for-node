...
class NodeAgentSku {
   ...
   * @member {array} [verifiedImageReferences] The list of images verified to
   * be compatible with this node agent SKU. This collection is not exhaustive
