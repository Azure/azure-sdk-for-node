 ...
 * @description Multi-instance tasks are commonly used to support MPI tasks. In MPI scenario, if
 * any of the subtasks fail, for example, exiting with a non-zero return code, the entire
