...
class AutoPoolSpecification {
   ...
   * @member {object} [pool.virtualMachineConfiguration.osDisk] This property
   ...
   * specified.
   * @member {array} [pool.virtualMachineConfiguration.osDisk.imageUris] All
   * the VHDs must be identical and must reside in an Azure Storage account
   ...
   * for the disk is read only. readWrite - The caching mode for the disk is
   * read and write. The default value for caching is none. For information
   ...
   * @member {number} [pool.targetDedicated] This property must not be
   ...
   * element is required. If true, the autoScaleFormula element is required.
   * The pool automatically resizes according to the formula. The default value
   * is false.
