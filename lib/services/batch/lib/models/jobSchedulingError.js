...
class JobSchedulingError {
   ...
   * @property {string} category The category of the job scheduling error.
   * Possible values include: 'userError', 'serverError'
   * @property {string} [code] An identifier for the job scheduling error.
   ...
   * @property {array} [details] A list of additional error details related to
