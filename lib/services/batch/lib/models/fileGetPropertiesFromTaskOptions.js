 ...
 *
 */
function FileGetPropertiesFromTaskOptions() {
}

/**
 * Defines the metadata of FileGetPropertiesFromTaskOptions
 *
 * @returns {object} metadata of FileGetPropertiesFromTaskOptions
 *
 */
FileGetPropertiesFromTaskOptions.prototype.mapper = function () {
  return {
    required: false,
    type: {
      name: 'Composite',
...
module.exports = FileGetPropertiesFromTaskOptions;
