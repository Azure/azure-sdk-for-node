...
class CloudTask {
   ...
   * does not include exit code 0. If you want non-default behaviour on exit
   * code 0, you must list it explicitly using the exitCodes or exitCodeRanges
   * collection.
   ...
   * a compute node or task to indicate that this task needs to be placed close
   * to the node or task.
   ...
   * @member {number} [executionInfo.retryCount] The task is retried if it
