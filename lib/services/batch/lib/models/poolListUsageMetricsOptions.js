...
class PoolListUsageMetricsOptions {
  /**
   * Create a PoolListUsageMetricsOptions.
   * @property {date} [startTime] The earliest time from which to include
   ...
   * @property {date} [endTime] The latest time from which to include metrics.
  ...
  /**
   * Defines the metadata of PoolListUsageMetricsOptions
   *
   * @returns {object} metadata of PoolListUsageMetricsOptions
   *
   */
  mapper() {
    return {
...
module.exports = PoolListUsageMetricsOptions;
