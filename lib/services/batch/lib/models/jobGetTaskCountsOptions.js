 ...
 *
 */
class JobGetTaskCountsOptions {
  /**
   * Create a JobGetTaskCountsOptions.
  ...
  /**
   * Defines the metadata of JobGetTaskCountsOptions
   *
   * @returns {object} metadata of JobGetTaskCountsOptions
   *
   */
  mapper() {
    return {
...
module.exports = JobGetTaskCountsOptions;
