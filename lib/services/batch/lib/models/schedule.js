...
class Schedule {
  /**
   * Create a Schedule.
   * @property {date} [doNotRunUntil] The earliest time at which any job may be
   ...
   * @property {date} [doNotRunAfter] A time after which no job will be created
   ...
   * @property {moment.duration} [startWindow] The time interval, starting from
   ...
   * @property {moment.duration} [recurrenceInterval] The time interval between
