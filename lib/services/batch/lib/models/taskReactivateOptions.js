 ...
 * 
 */
function TaskReactivateOptions() {
}

/**
 * Defines the metadata of TaskReactivateOptions
 *
 * @returns {object} metadata of TaskReactivateOptions
 *
 */
TaskReactivateOptions.prototype.mapper = function () {
  return {
    required: false,
    type: {
      name: 'Composite',
...
module.exports = TaskReactivateOptions;
