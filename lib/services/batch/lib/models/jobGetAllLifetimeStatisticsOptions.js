 ...
 *
 */
function JobGetAllLifetimeStatisticsOptions() {
}

/**
 * Defines the metadata of JobGetAllLifetimeStatisticsOptions
 *
 * @returns {object} metadata of JobGetAllLifetimeStatisticsOptions
 *
 */
JobGetAllLifetimeStatisticsOptions.prototype.mapper = function () {
  return {
    required: false,
    type: {
      name: 'Composite',
...
module.exports = JobGetAllLifetimeStatisticsOptions;
