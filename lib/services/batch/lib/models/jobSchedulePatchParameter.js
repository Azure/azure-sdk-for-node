...
class JobSchedulePatchParameter {
   ...
   * MyCommand" in Linux. The command line had better use relativate path of
   * task execution directory, or use the Batch provided environment
   ...
   * executable due to nonzero exit code. The Batch service will try the task
