 ...
 *
 */
function PoolGetAllLifetimeStatisticsOptions() {
}

/**
 * Defines the metadata of PoolGetAllLifetimeStatisticsOptions
 *
 * @returns {object} metadata of PoolGetAllLifetimeStatisticsOptions
 *
 */
PoolGetAllLifetimeStatisticsOptions.prototype.mapper = function () {
  return {
    required: false,
    type: {
      name: 'Composite',
...
module.exports = PoolGetAllLifetimeStatisticsOptions;
