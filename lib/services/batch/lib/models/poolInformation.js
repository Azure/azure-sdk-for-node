...
class PoolInformation {
   ...
   * @property {number} [autoPoolSpecification.pool.taskSlotsPerNode] The
   * default value is 1. The maximum value is the smaller of 4 times the number
   * of cores of the vmSize of the pool or 256.
   * @property {object} [autoPoolSpecification.pool.taskSchedulingPolicy] If
   * not specified, the default is spread.
   * @property {string}
   * [autoPoolSpecification.pool.taskSchedulingPolicy.nodeFillType] If not
   ...
   * @property {string}
   * [autoPoolSpecification.pool.startTask.containerSettings.workingDirectory]
   ...
   * directory.
   * @property {array}
   * [autoPoolSpecification.pool.applicationPackageReferences] Changes to
   * Package references affect all new Nodes joining the Pool, but do not
   ...
   * code.
   * @property {array} [autoPoolSpecification.pool.mountConfiguration] This
