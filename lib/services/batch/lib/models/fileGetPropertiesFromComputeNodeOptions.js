 ...
 *
 */
function FileGetPropertiesFromComputeNodeOptions() {
}

/**
 * Defines the metadata of FileGetPropertiesFromComputeNodeOptions
 *
 * @returns {object} metadata of FileGetPropertiesFromComputeNodeOptions
 *
 */
FileGetPropertiesFromComputeNodeOptions.prototype.mapper = function () {
  return {
    required: false,
    type: {
      name: 'Composite',
...
module.exports = FileGetPropertiesFromComputeNodeOptions;
