...
class OutputFileBlobContainerDestination {
  /**
   * Create a OutputFileBlobContainerDestination.
  ...
  /**
   * Defines the metadata of OutputFileBlobContainerDestination
   *
   * @returns {object} metadata of OutputFileBlobContainerDestination
   *
   */
  mapper() {
    return {
...
module.exports = OutputFileBlobContainerDestination;
