...
class TaskConstraints {
   ...
   * ResourceFiles and AppplicationPackages are only downloaded again if the
   * task is retried on a new compute node. Batch will also retry tasks when a
   ...
   * failure. Retries due to recovery operation are independent of and are not
   * counted against maxTaskRetryCount. All tasks should be idempotent, it
   * means they need to tolerate being interrupted and restarted, without
