...
class CloudPool {
   ...
   * @member {string} [cloudServiceConfiguration.osVersion] The default value
   ...
   * pool.
   * @member {string} [networkConfiguration.subnetId] This is of the form
   ...
   * @member {string} [networkConfiguration.dynamicVNetAssignmentScope]
