...
class JobDisableParameter {
   ...
   * the job. requeue - Terminate running tasks and requeue them. The tasks
   * will run again when the job is enabled. terminate - Terminate running
   * tasks. The tasks will not run again. wait - Allow currently running tasks
   * to complete. Possible values include: 'requeue', 'terminate', 'wait'
   */
  constructor() {
  }
