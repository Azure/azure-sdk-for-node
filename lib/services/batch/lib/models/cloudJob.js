...
class CloudJob {
   ...
   * @member {object} [jobReleaseTask] The Job Release task. The Job Release
   ...
   * @member {object} [executionInfo.schedulingError] This property is not set
   ...
   * @member {number} [stats.numSucceededTasks] A task completes successfully
