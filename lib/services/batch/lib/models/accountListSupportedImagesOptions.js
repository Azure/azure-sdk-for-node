...
class AccountListSupportedImagesOptions {
  /**
   * Create a AccountListSupportedImagesOptions.
  ...
  /**
   * Defines the metadata of AccountListSupportedImagesOptions
   *
   * @returns {object} metadata of AccountListSupportedImagesOptions
   *
   */
  mapper() {
    return {
...
module.exports = AccountListSupportedImagesOptions;
