...
class EnvironmentListResponse {
  /**
   * Create a EnvironmentListResponse.
  ...
  /**
   * Defines the metadata of EnvironmentListResponse
   *
        ...
        modelProperties: {
          value: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'EnvironmentResourceElementType',
                  type: {
                    name: 'Composite',
...
module.exports = EnvironmentListResponse;
