 ...
 * Initializes a new instance of the EventCategories class.
 * @constructor
 *
...
EventCategories.prototype.list = function (options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/microsoft.insights/eventcategories';
  var queryParameters = [];
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = new client.models['EventCategoryCollection']().mapper();
