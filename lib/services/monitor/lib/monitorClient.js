 ...
 *
 */
function MonitorClient(credentials, subscriptionId, baseUri, options) {
  ...
  MonitorClient['super_'].call(this, credentials, options);
...
util.inherits(MonitorClient, ServiceClient);
