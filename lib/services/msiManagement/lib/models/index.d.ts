...
export interface Identity extends BaseResource {
   ...
   * credentials. If identity is user assigned identity, the value of clientSecretUrl is null. If
   * identity is system assigned or proxy resource, the clientSecretUrl is not null.
   */
