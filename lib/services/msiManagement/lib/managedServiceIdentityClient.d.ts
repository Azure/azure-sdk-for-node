...
export default class ManagedServiceIdentityClient extends AzureServiceClient {
  /**
...
export { ManagedServiceIdentityClient, models as ManagedServiceIdentityModels };
