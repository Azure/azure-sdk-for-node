 ...
 *
 */
function DataLakeStoreFileSystemManagementClient(credentials, adlsFileSystemDnsSuffix, options) {
  ...
  if (adlsFileSystemDnsSuffix === null || adlsFileSystemDnsSuffix === undefined) {
    throw new Error('\'adlsFileSystemDnsSuffix\' cannot be null.');
  }
