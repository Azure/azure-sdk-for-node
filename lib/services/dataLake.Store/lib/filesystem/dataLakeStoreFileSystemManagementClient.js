 ...
 */
function DataLakeStoreFileSystemManagementClient(credentials, subscriptionId, datalakeserviceuri, baseUri, options) {
  ...
  if (datalakeserviceuri === null || datalakeserviceuri === undefined) {
    throw new Error('\'datalakeserviceuri\' cannot be null.');
  }
  ...
  if (!this.baseUri) {
    this.baseUri = 'https://accountname.datalakeserviceuri';
  }
