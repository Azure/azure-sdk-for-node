...
declare class DataLakeStoreFileSystemManagementClient {
     ...
     *
     * @param {String} datalakeserviceuri Gets the URI used as the base for all cloud service requests.
     *
     ...
     */
    constructor(credentials: ServiceClientCredentials, subscriptionId: string, datalakeserviceuri: string, baseUri: string, options: ServiceClientOptions);
