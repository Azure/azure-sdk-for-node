  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse) {
          result = new client._models['FileOperationResult'](parsedResponse);
        }
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
FileSystem.prototype.concat = function (destinationPath, accountname, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  var sources = (options && options.sources !== undefined) ? options.sources : undefined;
  ...
  try {
    ...
    if (sources !== null && sources !== undefined && typeof sources.valueOf() !== 'string') {
      throw new Error('sources must be of type string.');
    }
    if (op !== null && op !== undefined && typeof op.valueOf() !== 'string') {
      throw new Error('op must be of type string.');
    }
  ...
  if (sources !== null && sources !== undefined) {
    queryParameters.push('sources=' + encodeURIComponent(sources));
  }
  if (op !== null && op !== undefined) {
    queryParameters.push('op=' + encodeURIComponent(op));
  }
...
FileSystem.prototype.listFileStatus = function (listFilePath, accountname, options, callback) {
  ...
  var op = (options && options.op !== undefined) ? options.op : 'LISTSTATUS';
  // Validate
  try {
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['FileStatusesResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['ContentSummaryResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['FileStatusResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
FileSystem.prototype.directAppend = function (directFilePath, accountname, streamContents, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
FileSystem.prototype.directCreate = function (directFilePath, accountname, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
FileSystem.prototype.directOpen = function (directFilePath, accountname, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['AclStatusResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
FileSystem.prototype.beginAppend = function (filePath, accountname, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
FileSystem.prototype.beginCreate = function (filePath, accountname, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
FileSystem.prototype.beginOpen = function (filePath, accountname, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
FileSystem.prototype.append = function (fileAppendRequestLink, streamContents, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Validate
  try {
    if (fileAppendRequestLink === null || fileAppendRequestLink === undefined || typeof fileAppendRequestLink.valueOf() !== 'string') {
      throw new Error('fileAppendRequestLink cannot be null or undefined and it must be of type string.');
    }
    if (streamContents === null || streamContents === undefined) {
      throw new Error('streamContents cannot be null or undefined and it must be of type object.');
    }
  ...
  // Construct URL
  var requestUrl = fileAppendRequestLink;
  var queryParameters = [];
  if (queryParameters.length > 0) {
    requestUrl += '?' + queryParameters.join('&');
  }
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['HomeDirectoryResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
FileSystem.prototype.create = function (fileCreateRequestLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Validate
  try {
    if (fileCreateRequestLink === null || fileCreateRequestLink === undefined || typeof fileCreateRequestLink.valueOf() !== 'string') {
      throw new Error('fileCreateRequestLink cannot be null or undefined and it must be of type string.');
    }
    if (streamContents !== null && streamContents !== undefined && typeof streamContents.valueOf() !== 'object') {
      throw new Error('streamContents must be of type object.');
    }
  ...
  // Construct URL
  var requestUrl = fileCreateRequestLink;
  var queryParameters = [];
  if (queryParameters.length > 0) {
    requestUrl += '?' + queryParameters.join('&');
  }
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
FileSystem.prototype.open = function (fileOpenRequestLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Validate
  try {
    if (fileOpenRequestLink === null || fileOpenRequestLink === undefined || typeof fileOpenRequestLink.valueOf() !== 'string') {
      throw new Error('fileOpenRequestLink cannot be null or undefined and it must be of type string.');
    }
    if (this.client.acceptLanguage !== null && this.client.acceptLanguage !== undefined && typeof this.client.acceptLanguage.valueOf() !== 'string') {
      throw new Error('this.client.acceptLanguage must be of type string.');
    }
  ...
  // Construct URL
  var requestUrl = fileOpenRequestLink;
  var queryParameters = [];
  if (queryParameters.length > 0) {
    requestUrl += '?' + queryParameters.join('&');
  }
