...
var FileSystemOperations = ( /** @lends FileSystemOperations */ function() {
  ...
  FileSystemOperations.prototype.append = function(fileAppendRequestLink, streamContents, callback) {
    ...
    if ('Azure SDK - Microsoft.Azure.Management.DataLake.StoreFileSystem 0.9.0-preview ' + this.client.userAgentSuffix !== null && 'Azure SDK - Microsoft.Azure.Management.DataLake.StoreFileSystem 0.9.0-preview ' + this.client.userAgentSuffix !== undefined) {
      httpRequest.headers['useragent'] = 'Azure SDK - Microsoft.Azure.Management.DataLake.StoreFileSystem 0.9.0-preview ' + this.client.userAgentSuffix;
    }
    if ('Azure SDK - Microsoft.Azure.Management.DataLake.StoreFileSystem 0.9.0-preview ' + this.client.userAgentSuffix !== null && 'Azure SDK - Microsoft.Azure.Management.DataLake.StoreFileSystem 0.9.0-preview ' + this.client.userAgentSuffix !== undefined) {
      httpRequest.headers['User-Agent'] = 'Azure SDK - Microsoft.Azure.Management.DataLake.StoreFileSystem 0.9.0-preview ' + this.client.userAgentSuffix;
    }
  ...
  FileSystemOperations.prototype.checkAccess = function(path, accountName, fsAction, callback) {
    ...
    queryParameters.push('api-version=2014-10-01');
  ...
  FileSystemOperations.prototype.internalBeginOpen = function(filePath, accountName, parametersOrCallback, callback) {
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      // Required due to the node HTTP handler always following redirects for GET operations.
      if (statusCode === 200) {
        var responseContent = body;
   ...
   * @param {string} accountName The name of the account to use
   * 
   * @param {DataLakeFileSystemListParameters} [parametersOrCallback] Query
   * parameters. If null is passed returns all file status items.
   * 
   ...
   * @returns {Stream} The response stream.
   */
  FileSystemOperations.prototype.msConcat = function(destinationPath, accountName, streamContents, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
