...
var FileSystemOperations = ( /** @lends FileSystemOperations */ function() {
  ...
  FileSystemOperations.prototype.append = function(fileAppendRequestLink, streamContents, callback) {
    ...
    if ('Azure SDK - Microsoft.Azure.Management.DataLake.StoreFileSystem 0.9.3-preview ' + this.client.userAgentSuffix !== null && 'Azure SDK - Microsoft.Azure.Management.DataLake.StoreFileSystem 0.9.3-preview ' + this.client.userAgentSuffix !== undefined) {
      httpRequest.headers['useragent'] = 'Azure SDK - Microsoft.Azure.Management.DataLake.StoreFileSystem 0.9.3-preview ' + this.client.userAgentSuffix;
    }
    if ('Azure SDK - Microsoft.Azure.Management.DataLake.StoreFileSystem 0.9.3-preview ' + this.client.userAgentSuffix !== null && 'Azure SDK - Microsoft.Azure.Management.DataLake.StoreFileSystem 0.9.3-preview ' + this.client.userAgentSuffix !== undefined) {
      httpRequest.headers['User-Agent'] = 'Azure SDK - Microsoft.Azure.Management.DataLake.StoreFileSystem 0.9.3-preview ' + this.client.userAgentSuffix;
    }
