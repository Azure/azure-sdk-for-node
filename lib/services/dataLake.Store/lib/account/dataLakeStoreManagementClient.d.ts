...
declare class DataLakeStoreManagementClient {
    /**
     * @class
    ...
    // Operation groups
    dataLakeStoreAccountOperations: operations.DataLakeStoreAccountOperations;
    }

export = DataLakeStoreManagementClient;
