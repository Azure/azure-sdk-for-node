...
/**
 * Deserialize the instance to DataLakeStoreFirewallRuleListResult schema
 *
 * @param {JSON} instance
 *
 */
DataLakeStoreFirewallRuleListResult.prototype.deserialize = function (instance) {
  if (instance) {
    if (instance['value']) {
      var deserializedInstancevalue = [];
        instance['value'].forEach(function(element) {
        if (element) {
          element = new models['FirewallRule']().deserialize(element);
        }
