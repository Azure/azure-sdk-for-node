...
export default class DataLakeStoreAccountManagementClient extends AzureServiceClient {
  /**
...
export { DataLakeStoreAccountManagementClient, models as DataLakeStoreAccountManagementModels };
