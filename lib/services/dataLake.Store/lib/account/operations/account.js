 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Account.prototype.firewallRulesListNext = function (nextLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Account.prototype.firewallRulesListNextNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
