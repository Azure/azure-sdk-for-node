 ...
 */
function _list(largeFaceListId, options, callback) {
...
/** Class representing a LargeFaceListFace. */
class LargeFaceListFace {
  /**
   * Create a LargeFaceListFace.
   ...
   */
  listWithHttpOperationResponse(largeFaceListId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._list(largeFaceListId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  list(largeFaceListId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._list(largeFaceListId, options, optionalCallback);
    }
  }

}

module.exports = LargeFaceListFace;
