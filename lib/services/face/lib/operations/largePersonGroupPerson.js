 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _addPersonFaceFromUrl(largePersonGroupId, personId, url, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _addPersonFaceFromStream(largePersonGroupId, personId, image, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
...
class LargePersonGroupPerson {
  ...
  constructor(client) {
    ...
    this._addPersonFaceFromUrl = _addPersonFaceFromUrl;
   ...
   * @reject {Error} - The error object.
   */
  addPersonFaceFromUrlWithHttpOperationResponse(largePersonGroupId, personId, url, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._addPersonFaceFromUrl(largePersonGroupId, personId, url, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  addPersonFaceFromUrl(largePersonGroupId, personId, url, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._addPersonFaceFromUrl(largePersonGroupId, personId, url, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  addPersonFaceFromStreamWithHttpOperationResponse(largePersonGroupId, personId, image, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._addPersonFaceFromStream(largePersonGroupId, personId, image, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  addPersonFaceFromStream(largePersonGroupId, personId, image, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._addPersonFaceFromStream(largePersonGroupId, personId, image, options, optionalCallback);
    }
  }
