 ...
 */
function _getBalancesByBillingAccount(billingAccountId, options, callback) {
...
class ConsumptionManagementClient extends ServiceClient {
   ...
   */
  getBalancesByBillingAccountWithHttpOperationResponse(billingAccountId, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getBalancesByBillingAccount(billingAccountId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getBalancesByBillingAccount(billingAccountId, options, optionalCallback) {
    let client = this;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._getBalancesByBillingAccount(billingAccountId, options, optionalCallback);
    }
  }
