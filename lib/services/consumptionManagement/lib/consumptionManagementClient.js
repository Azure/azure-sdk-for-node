 ...
 */
function _balancesByBillingAccount(options, callback) {
...
class ConsumptionManagementClient extends ServiceClient {
  ...
  constructor(credentials, billingAccountId, departmentId, enrollmentAccountId, subscriptionId, baseUri, options) {
    ...
    this.models = models;
    this._balancesByBillingAccount = _balancesByBillingAccount;
   ...
   */
  balancesByBillingAccountWithHttpOperationResponse(options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._balancesByBillingAccount(options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  balancesByBillingAccount(options, optionalCallback) {
    let client = this;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._balancesByBillingAccount(options, optionalCallback);
    }
  }
