...
class ConsumptionManagementClient extends ServiceClient {
   ...
   */
  constructor(credentials, subscriptionId, resourceGroupName, budgetName, baseUri, options) {
    ...
    if (budgetName === null || budgetName === undefined) {
      throw new Error('\'budgetName\' cannot be null.');
    }
