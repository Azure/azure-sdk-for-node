...
class BillingAccount extends models['Resource'] {
   ...
   * @property {string} [address.phoneNumber] Phone Number.
   * @property {string} [defaultCurrency] The ISO currency, for example, USD.
   * @property {string} [country] The country associated with billing account.
   * @property {string} [agreements] Agreements associated with billing account
   * @property {array} [invoiceSections] The invoiceSections associated to the
   * billing account.
