...
class ReportConfig extends models['Resource'] {
   ...
   * being delivered.
   * @member {string} [deliveryInfo.destination.subscriptionId] The
   * subscription id of the storage account where reports will be delivered.
   * @member {string} [deliveryInfo.destination.resourceGroup] The resource
   * group of the storage account here reports will be delivered.
