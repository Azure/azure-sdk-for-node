 ...
 */
function _listByBillingPeriod(billingAccountId, departmentId, billingPeriodName, options, callback) {
...
/** Class representing a ChargesForDepartment. */
class ChargesForDepartment {
  /**
   * Create a ChargesForDepartment.
   ...
   */
  listByBillingPeriodWithHttpOperationResponse(billingAccountId, departmentId, billingPeriodName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listByBillingPeriod(billingAccountId, departmentId, billingPeriodName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listByBillingPeriod(billingAccountId, departmentId, billingPeriodName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._listByBillingPeriod(billingAccountId, departmentId, billingPeriodName, options, optionalCallback);
    }
  }

}

module.exports = ChargesForDepartment;
