...
function _list(billingAccountId, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/providers/Microsoft.Consumption/dimensions';
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['DimensionsListResult']().mapper();
...
/** Class representing a BillingAccountDimensions. */
class BillingAccountDimensions {
  /**
   * Create a BillingAccountDimensions.
...
module.exports = BillingAccountDimensions;
