...
function _list(options, callback) {
  ...
  // Validate
  try {
    if (this.client.enrollmentAccountId === null || this.client.enrollmentAccountId === undefined || typeof this.client.enrollmentAccountId.valueOf() !== 'string') {
      throw new Error('this.client.enrollmentAccountId cannot be null or undefined and it must be of type string.');
    }
  ...
  requestUrl = requestUrl.replace('{enrollmentAccountId}', encodeURIComponent(this.client.enrollmentAccountId));
  let queryParameters = [];
