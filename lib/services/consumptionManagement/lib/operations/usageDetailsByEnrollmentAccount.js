 ...
 */
function _list(enrollmentAccountId, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.CostManagement/enrollmentAccounts/{enrollmentAccountId}/providers/Microsoft.Consumption/usageDetails';
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _listByBillingPeriod(enrollmentAccountId, billingPeriodName, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.CostManagement/enrollmentAccounts/{enrollmentAccountId}/providers/Microsoft.Billing/billingPeriods/{billingPeriodName}/providers/Microsoft.Consumption/usageDetails';
  requestUrl = requestUrl.replace('{enrollmentAccountId}', encodeURIComponent(enrollmentAccountId));
...
/** Class representing a UsageDetailsByEnrollmentAccount. */
class UsageDetailsByEnrollmentAccount {
  /**
   * Create a UsageDetailsByEnrollmentAccount.
   ...
   */
  listWithHttpOperationResponse(enrollmentAccountId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._list(enrollmentAccountId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  list(enrollmentAccountId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._list(enrollmentAccountId, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  listByBillingPeriodWithHttpOperationResponse(enrollmentAccountId, billingPeriodName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listByBillingPeriod(enrollmentAccountId, billingPeriodName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listByBillingPeriod(enrollmentAccountId, billingPeriodName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._listByBillingPeriod(enrollmentAccountId, billingPeriodName, options, optionalCallback);
    }
  }
...
module.exports = UsageDetailsByEnrollmentAccount;
