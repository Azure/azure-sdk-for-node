 ...
 */
function _list(billingAccountId, departmentId, options, callback) {
...
/** Class representing a ChargesByDepartment. */
class ChargesByDepartment {
  /**
   * Create a ChargesByDepartment.
   ...
   */
  listWithHttpOperationResponse(billingAccountId, departmentId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._list(billingAccountId, departmentId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  list(billingAccountId, departmentId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._list(billingAccountId, departmentId, options, optionalCallback);
    }
  }

}

module.exports = ChargesByDepartment;
