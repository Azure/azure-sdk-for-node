...
function _list(billingAccountId, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.CostManagement/billingAccounts/{billingAccountId}/providers/Microsoft.Consumption/usageDetails';
...
function _listByBillingPeriod(billingAccountId, billingPeriodName, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.CostManagement/billingAccounts/{billingAccountId}/providers/Microsoft.Billing/billingPeriods/{billingPeriodName}/providers/Microsoft.Consumption/usageDetails';
  requestUrl = requestUrl.replace('{billingAccountId}', encodeURIComponent(billingAccountId));
...
/** Class representing a UsageDetailsByBillingAccount. */
class UsageDetailsByBillingAccount {
  /**
   * Create a UsageDetailsByBillingAccount.
...
module.exports = UsageDetailsByBillingAccount;
