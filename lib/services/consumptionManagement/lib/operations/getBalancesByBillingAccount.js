 ...
 */
function _byBillingPeriod(billingAccountId, billingPeriodName, options, callback) {
...
class GetBalancesByBillingAccount {
   ...
   */
  byBillingPeriodWithHttpOperationResponse(billingAccountId, billingPeriodName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._byBillingPeriod(billingAccountId, billingPeriodName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  byBillingPeriod(billingAccountId, billingPeriodName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._byBillingPeriod(billingAccountId, billingPeriodName, options, optionalCallback);
    }
  }
