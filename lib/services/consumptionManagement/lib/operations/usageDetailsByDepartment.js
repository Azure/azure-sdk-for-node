...
function _list(departmentId, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.CostManagement/departments/{departmentId}/providers/Microsoft.Consumption/usageDetails';
...
function _listByBillingPeriod(departmentId, billingPeriodName, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.CostManagement/departments/{departmentId}/providers/Microsoft.Billing/billingPeriods/{billingPeriodName}/providers/Microsoft.Consumption/usageDetails';
  requestUrl = requestUrl.replace('{departmentId}', encodeURIComponent(departmentId));
...
/** Class representing a UsageDetailsByDepartment. */
class UsageDetailsByDepartment {
  /**
   * Create a UsageDetailsByDepartment.
...
module.exports = UsageDetailsByDepartment;
