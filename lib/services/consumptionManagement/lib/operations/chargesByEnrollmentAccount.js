 ...
 */
function _list(billingAccountId, enrollmentAccountId, options, callback) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['ChargesListResultByEnrollmentAccount']().mapper();
...
/** Class representing a ChargesByEnrollmentAccount. */
class ChargesByEnrollmentAccount {
  /**
   * Create a ChargesByEnrollmentAccount.
   ...
   */
  listWithHttpOperationResponse(billingAccountId, enrollmentAccountId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._list(billingAccountId, enrollmentAccountId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  list(billingAccountId, enrollmentAccountId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._list(billingAccountId, enrollmentAccountId, options, optionalCallback);
    }
  }

}

module.exports = ChargesByEnrollmentAccount;
