...
function _list(options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/providers/Microsoft.Consumption/dimensions';
...
/** Class representing a SubscriptionDimensions. */
class SubscriptionDimensions {
  /**
   * Create a SubscriptionDimensions.
...
module.exports = SubscriptionDimensions;
