...
function _list(options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.CostManagement/enrollmentAccounts/{enrollmentAccountId}/providers/Microsoft.Consumption/marketplaces';
...
function _listByBillingPeriod(billingPeriodName, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.CostManagement/enrollmentAccounts/{enrollmentAccountId}/providers/Microsoft.Billing/billingPeriods/{billingPeriodName}/providers/Microsoft.Consumption/marketplaces';
  requestUrl = requestUrl.replace('{enrollmentAccountId}', encodeURIComponent(this.client.enrollmentAccountId));
...
/** Class representing a MarketplacesByEnrollmentAccounts. */
class MarketplacesByEnrollmentAccounts {
  /**
   * Create a MarketplacesByEnrollmentAccounts.
...
module.exports = MarketplacesByEnrollmentAccounts;
