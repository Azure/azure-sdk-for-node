...
function _list(billingAccountId, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/providers/Microsoft.Consumption/paymentMethods';
...
/** Class representing a PaymentMethodsByBillingAccount. */
class PaymentMethodsByBillingAccount {
  /**
   * Create a PaymentMethodsByBillingAccount.
...
module.exports = PaymentMethodsByBillingAccount;
