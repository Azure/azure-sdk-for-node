 ...
 */
function _post(parameters, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/providers/Microsoft.Consumption/Insights';
...
/** Class representing a SubscriptionInsights. */
class SubscriptionInsights {
  /**
   * Create a SubscriptionInsights.
   ...
   */
  postWithHttpOperationResponse(parameters, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._post(parameters, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  post(parameters, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._post(parameters, options, optionalCallback);
    }
  }

}

module.exports = SubscriptionInsights;
