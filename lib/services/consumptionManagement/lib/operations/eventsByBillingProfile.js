...
function _list(billingAccountId, billingProfileId, startDate, endDate, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}/providers/Microsoft.Consumption/events';
...
module.exports = EventsByBillingProfile;
