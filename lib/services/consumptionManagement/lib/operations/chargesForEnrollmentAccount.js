 ...
 */
function _listByBillingPeriod(billingAccountId, enrollmentAccountId, billingPeriodName, options, callback) {
...
/** Class representing a ChargesForEnrollmentAccount. */
class ChargesForEnrollmentAccount {
  /**
   * Create a ChargesForEnrollmentAccount.
   ...
   */
  listByBillingPeriodWithHttpOperationResponse(billingAccountId, enrollmentAccountId, billingPeriodName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listByBillingPeriod(billingAccountId, enrollmentAccountId, billingPeriodName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listByBillingPeriod(billingAccountId, enrollmentAccountId, billingPeriodName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._listByBillingPeriod(billingAccountId, enrollmentAccountId, billingPeriodName, options, optionalCallback);
    }
  }

}

module.exports = ChargesForEnrollmentAccount;
