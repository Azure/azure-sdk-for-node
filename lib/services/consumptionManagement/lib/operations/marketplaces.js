 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _listByEnrollmentAccounts(enrollmentAccountId, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _listForBillingPeriodByEnrollmentAccounts(enrollmentAccountId, billingPeriodName, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _listByEnrollmentAccountsNext(nextPageLink, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _listForBillingPeriodByEnrollmentAccountsNext(nextPageLink, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
...
class Marketplaces {
  ...
  constructor(client) {
    ...
    this._listByEnrollmentAccounts = _listByEnrollmentAccounts;
    this._listForBillingPeriodByEnrollmentAccounts = _listForBillingPeriodByEnrollmentAccounts;
    ...
    this._listByEnrollmentAccountsNext = _listByEnrollmentAccountsNext;
    this._listForBillingPeriodByEnrollmentAccountsNext = _listForBillingPeriodByEnrollmentAccountsNext;
  }
   ...
   * @reject {Error} - The error object.
   */
  listByEnrollmentAccountsWithHttpOperationResponse(enrollmentAccountId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listByEnrollmentAccounts(enrollmentAccountId, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listByEnrollmentAccounts(enrollmentAccountId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._listByEnrollmentAccounts(enrollmentAccountId, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  listForBillingPeriodByEnrollmentAccountsWithHttpOperationResponse(enrollmentAccountId, billingPeriodName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listForBillingPeriodByEnrollmentAccounts(enrollmentAccountId, billingPeriodName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listForBillingPeriodByEnrollmentAccounts(enrollmentAccountId, billingPeriodName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._listForBillingPeriodByEnrollmentAccounts(enrollmentAccountId, billingPeriodName, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  listByEnrollmentAccountsNextWithHttpOperationResponse(nextPageLink, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listByEnrollmentAccountsNext(nextPageLink, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listByEnrollmentAccountsNext(nextPageLink, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._listByEnrollmentAccountsNext(nextPageLink, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  listForBillingPeriodByEnrollmentAccountsNextWithHttpOperationResponse(nextPageLink, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listForBillingPeriodByEnrollmentAccountsNext(nextPageLink, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listForBillingPeriodByEnrollmentAccountsNext(nextPageLink, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._listForBillingPeriodByEnrollmentAccountsNext(nextPageLink, options, optionalCallback);
    }
  }
