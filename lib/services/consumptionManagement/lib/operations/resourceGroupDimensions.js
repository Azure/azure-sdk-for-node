...
function _list(resourceGroupName, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Consumption/dimensions';
...
/** Class representing a ResourceGroupDimensions. */
class ResourceGroupDimensions {
  /**
   * Create a ResourceGroupDimensions.
...
module.exports = ResourceGroupDimensions;
