 ...
 */
function _post(billingAccountId, parameters, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/providers/Microsoft.Consumption/insights';
...
/** Class representing a BillingAccountInsights. */
class BillingAccountInsights {
  /**
   * Create a BillingAccountInsights.
   ...
   */
  postWithHttpOperationResponse(billingAccountId, parameters, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._post(billingAccountId, parameters, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  post(billingAccountId, parameters, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._post(billingAccountId, parameters, options, optionalCallback);
    }
  }

}

module.exports = BillingAccountInsights;
