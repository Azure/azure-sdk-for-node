 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _listByManagementGroup(options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Validate
  try {
    if (this.client.managementGroupId === null || this.client.managementGroupId === undefined || typeof this.client.managementGroupId.valueOf() !== 'string') {
      throw new Error('this.client.managementGroupId cannot be null or undefined and it must be of type string.');
    }
    if (expand !== null && expand !== undefined && typeof expand.valueOf() !== 'string') {
      throw new Error('expand must be of type string.');
    }
  ...
  requestUrl = requestUrl.replace('{managementGroupId}', encodeURIComponent(this.client.managementGroupId));
  let queryParameters = [];
  if (expand !== null && expand !== undefined) {
    queryParameters.push('$expand=' + encodeURIComponent(expand));
  }
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _listForBillingPeriodByManagementGroup(billingPeriodName, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
...
class UsageDetails {
   ...
   * @reject {Error} - The error object.
   */
  listByManagementGroupWithHttpOperationResponse(options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listByManagementGroup(options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listByManagementGroup(options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._listByManagementGroup(options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  listForBillingPeriodByManagementGroupWithHttpOperationResponse(billingPeriodName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listForBillingPeriodByManagementGroup(billingPeriodName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listForBillingPeriodByManagementGroup(billingPeriodName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._listForBillingPeriodByManagementGroup(billingPeriodName, options, optionalCallback);
    }
  }
