...
function _list(options, callback) {
  ...
  try {
    ...
    if (this.client.departmentId === null || this.client.departmentId === undefined || typeof this.client.departmentId.valueOf() !== 'string') {
      throw new Error('this.client.departmentId cannot be null or undefined and it must be of type string.');
    }
  ...
  requestUrl = requestUrl.replace('{departmentId}', encodeURIComponent(this.client.departmentId));
  let queryParameters = [];
