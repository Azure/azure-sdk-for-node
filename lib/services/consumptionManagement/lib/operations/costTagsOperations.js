...
function _get(billingAccountId, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'providers/Microsoft.CostManagement/billingAccounts/{billingAccountId}/providers/Microsoft.Consumption/costTags';
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['CostTags']().mapper();
...
function _createOrUpdate(billingAccountId, parameters, options, callback) {
  ...
  try {
    if (parameters !== null && parameters !== undefined) {
      let requestModelMapper = new client.models['CostTags']().mapper();
...
/** Class representing a CostTagsOperations. */
class CostTagsOperations {
  /**
   * Create a CostTagsOperations.
...
module.exports = CostTagsOperations;
