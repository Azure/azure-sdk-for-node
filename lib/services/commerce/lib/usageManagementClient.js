...
/** Class representing a UsageManagementClient. */
class UsageManagementClient extends ServiceClient {
  /**
   * Create a UsageManagementClient.
...
module.exports = UsageManagementClient;
module.exports['default'] = UsageManagementClient;
module.exports.UsageManagementClient = UsageManagementClient;
module.exports.UsageManagementModels = models;
