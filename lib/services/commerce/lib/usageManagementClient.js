 ...
 *
 */
function UsageManagementClient(credentials, subscriptionId, baseUri, options) {
  ...
  UsageManagementClient['super_'].call(this, credentials, options);
...
util.inherits(UsageManagementClient, ServiceClient);
