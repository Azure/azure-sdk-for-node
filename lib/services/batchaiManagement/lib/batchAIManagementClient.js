...
/** Class representing a BatchAIManagementClient. */
class BatchAIManagementClient extends ServiceClient {
  /**
   * Create a BatchAIManagementClient.
...
module.exports = BatchAIManagementClient;
module.exports['default'] = BatchAIManagementClient;
module.exports.BatchAIManagementClient = BatchAIManagementClient;
module.exports.BatchAIManagementModels = models;
