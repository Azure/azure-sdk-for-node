...
class JobCreateParameters {
   ...
   * arguments that needs to be passed to the python script for the master
   * task.
   * @member {string} [tensorFlowSettings.workerCommandLineArgs] Command line
   * arguments that needs to be passed to the python script for the worker
   * task. Optional for single process jobs.
   * @member {string} [tensorFlowSettings.parameterServerCommandLineArgs]
   * Command line arguments that needs to be passed to the python script for
