...
class WorkspacesListOptions {
  /**
   * Create a WorkspacesListOptions.
  ...
  /**
   * Defines the metadata of WorkspacesListOptions
   *
   * @returns {object} metadata of WorkspacesListOptions
   *
   */
  mapper() {
    return {
...
module.exports = WorkspacesListOptions;
