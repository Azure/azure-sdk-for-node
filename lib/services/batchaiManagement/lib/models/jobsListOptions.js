...
class JobsListOptions {
  ...
  /**
   * Defines the metadata of JobsListOptions
   *
   * @returns {object} metadata of JobsListOptions
   *
   */
  mapper() {
    return {
...
module.exports = JobsListOptions;
