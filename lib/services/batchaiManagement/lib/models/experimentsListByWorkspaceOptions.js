...
class ExperimentsListByWorkspaceOptions {
  /**
   * Create a ExperimentsListByWorkspaceOptions.
  ...
  /**
   * Defines the metadata of ExperimentsListByWorkspaceOptions
   *
   * @returns {object} metadata of ExperimentsListByWorkspaceOptions
   *
   */
  mapper() {
    return {
...
module.exports = ExperimentsListByWorkspaceOptions;
