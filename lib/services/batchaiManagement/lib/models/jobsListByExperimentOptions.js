 ...
 *
 */
class JobsListByExperimentOptions {
  /**
   * Create a JobsListByExperimentOptions.
  ...
  /**
   * Defines the metadata of JobsListByExperimentOptions
   *
   * @returns {object} metadata of JobsListByExperimentOptions
   *
   */
  mapper() {
    return {
...
module.exports = JobsListByExperimentOptions;
