...
class WorkspacesListByResourceGroupOptions {
  /**
   * Create a WorkspacesListByResourceGroupOptions.
  ...
  /**
   * Defines the metadata of WorkspacesListByResourceGroupOptions
   *
   * @returns {object} metadata of WorkspacesListByResourceGroupOptions
   *
   */
  mapper() {
    return {
...
module.exports = WorkspacesListByResourceGroupOptions;
