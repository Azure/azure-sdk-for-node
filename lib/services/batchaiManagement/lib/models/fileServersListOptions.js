...
class FileServersListOptions {
  /**
   * Create a FileServersListOptions.
  ...
  /**
   * Defines the metadata of FileServersListOptions
   *
   * @returns {object} metadata of FileServersListOptions
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'FileServersListOptions',
        modelProperties: {
          filter: {
            required: false,
            type: {
...
module.exports = FileServersListOptions;
