...
class ClustersListOptions {
  ...
  /**
   * Defines the metadata of ClustersListOptions
   *
   * @returns {object} metadata of ClustersListOptions
   *
   */
  mapper() {
    return {
...
module.exports = ClustersListOptions;
