...
class NetworkManagementClient extends ServiceClient {
   ...
   */
  constructor(credentials, subscriptionId, predefinedPolicyName, baseUri, options) {
    ...
    if (predefinedPolicyName === null || predefinedPolicyName === undefined) {
      throw new Error('\'predefinedPolicyName\' cannot be null.');
    }
    ...
    this.predefinedPolicyName = predefinedPolicyName;
