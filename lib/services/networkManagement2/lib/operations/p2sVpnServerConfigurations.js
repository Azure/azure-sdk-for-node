...
function _createOrUpdate(virtualWanName, p2SVpnServerConfigurationName, p2SVpnServerConfigurationParameters, options, callback) {
  ...
  // Send request
  this.beginCreateOrUpdate(virtualWanName, p2SVpnServerConfigurationName, p2SVpnServerConfigurationParameters, options, (err, parsedResult, httpRequest, response) => {
...
function _deleteMethod(virtualWanName, p2SVpnServerConfigurationName, options, callback) {
  ...
  // Send request
  this.beginDeleteMethod(virtualWanName, p2SVpnServerConfigurationName, options, (err, parsedResult, httpRequest, response) => {
    if (err) return callback(err);
...
class P2sVpnServerConfigurations {
   ...
   */
  getWithHttpOperationResponse(virtualWanName, p2SVpnServerConfigurationName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._get(virtualWanName, p2SVpnServerConfigurationName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  get(virtualWanName, p2SVpnServerConfigurationName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._get(virtualWanName, p2SVpnServerConfigurationName, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  createOrUpdateWithHttpOperationResponse(virtualWanName, p2SVpnServerConfigurationName, p2SVpnServerConfigurationParameters, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._createOrUpdate(virtualWanName, p2SVpnServerConfigurationName, p2SVpnServerConfigurationParameters, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  createOrUpdate(virtualWanName, p2SVpnServerConfigurationName, p2SVpnServerConfigurationParameters, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._createOrUpdate(virtualWanName, p2SVpnServerConfigurationName, p2SVpnServerConfigurationParameters, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  deleteMethodWithHttpOperationResponse(virtualWanName, p2SVpnServerConfigurationName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._deleteMethod(virtualWanName, p2SVpnServerConfigurationName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  deleteMethod(virtualWanName, p2SVpnServerConfigurationName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._deleteMethod(virtualWanName, p2SVpnServerConfigurationName, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  listByVirtualWanWithHttpOperationResponse(virtualWanName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listByVirtualWan(virtualWanName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listByVirtualWan(virtualWanName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._listByVirtualWan(virtualWanName, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  beginCreateOrUpdateWithHttpOperationResponse(virtualWanName, p2SVpnServerConfigurationName, p2SVpnServerConfigurationParameters, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginCreateOrUpdate(virtualWanName, p2SVpnServerConfigurationName, p2SVpnServerConfigurationParameters, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  beginCreateOrUpdate(virtualWanName, p2SVpnServerConfigurationName, p2SVpnServerConfigurationParameters, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._beginCreateOrUpdate(virtualWanName, p2SVpnServerConfigurationName, p2SVpnServerConfigurationParameters, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  beginDeleteMethodWithHttpOperationResponse(virtualWanName, p2SVpnServerConfigurationName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginDeleteMethod(virtualWanName, p2SVpnServerConfigurationName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  beginDeleteMethod(virtualWanName, p2SVpnServerConfigurationName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._beginDeleteMethod(virtualWanName, p2SVpnServerConfigurationName, options, optionalCallback);
    }
  }
