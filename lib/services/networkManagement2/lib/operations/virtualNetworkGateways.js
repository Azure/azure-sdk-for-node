 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getVpnProfilePacakgeUrl(resourceGroupName, virtualNetworkGatewayName, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Send request
  this.beginGetVpnProfilePacakgeUrl(resourceGroupName, virtualNetworkGatewayName, options, (err, parsedResult, httpRequest, response) => {
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _beginGetVpnProfilePacakgeUrl(resourceGroupName, virtualNetworkGatewayName, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
...
class VirtualNetworkGateways {
  ...
  constructor(client) {
    ...
    this._getVpnProfilePacakgeUrl = _getVpnProfilePacakgeUrl;
    ...
    this._beginGetVpnProfilePacakgeUrl = _beginGetVpnProfilePacakgeUrl;
   ...
   * @reject {Error} - The error object.
   */
  getVpnProfilePacakgeUrlWithHttpOperationResponse(resourceGroupName, virtualNetworkGatewayName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getVpnProfilePacakgeUrl(resourceGroupName, virtualNetworkGatewayName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getVpnProfilePacakgeUrl(resourceGroupName, virtualNetworkGatewayName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getVpnProfilePacakgeUrl(resourceGroupName, virtualNetworkGatewayName, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  beginGetVpnProfilePacakgeUrlWithHttpOperationResponse(resourceGroupName, virtualNetworkGatewayName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginGetVpnProfilePacakgeUrl(resourceGroupName, virtualNetworkGatewayName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  beginGetVpnProfilePacakgeUrl(resourceGroupName, virtualNetworkGatewayName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._beginGetVpnProfilePacakgeUrl(resourceGroupName, virtualNetworkGatewayName, options, optionalCallback);
    }
  }
