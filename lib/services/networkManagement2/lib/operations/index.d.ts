...
export interface SecurityRules {
     ...
     * Possible values for this property include: 'Allow', 'Deny'.
     * 
...
export interface VirtualNetworkGatewayConnections {
     ...
     * name -Basic/HighPerformance/Standard. Possible values for this property
     * include: 'Basic', 'HighPerformance', 'Standard'.
     * 
     * @param {string} [parameters.virtualNetworkGateway2.sku.tier] Gateway sku
     * tier -Basic/HighPerformance/Standard. Possible values for this property
     * include: 'Basic', 'HighPerformance', 'Standard'.
     * 
