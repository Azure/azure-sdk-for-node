...
export interface VirtualNetworkGateways {
     ...
     *
     * @param {string} [parameters.radiusServer] The radius server address property
     * of the VirtualNetworkGateway resource for vpn client connection.
     *
     * @param {string} [parameters.radiusSecret] The radius secret property of the
...
export interface VirtualNetworkGatewayConnections {
     ...
     *
     * @param {string} [parameters.virtualNetworkGateway2.radiusServer] The radius
     * server address property of the VirtualNetworkGateway resource for vpn client
     * connection.
     *
     * @param {string} [parameters.virtualNetworkGateway2.radiusSecret] The radius
