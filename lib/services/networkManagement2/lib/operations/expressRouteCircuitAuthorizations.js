 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ExpressRouteCircuitAuthorizations.prototype.beginDelete = function (resourceGroupName, circuitName, authorizationName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse) {
          result = new client._models['ExpressRouteCircuitAuthorization'](parsedResponse);
        }
...
ExpressRouteCircuitAuthorizations.prototype.beginCreateOrUpdate = function (resourceGroupName, circuitName, authorizationName, authorizationParameters, options, callback) {
  ...
  try {
    if (authorizationParameters) {
      requestModel = new client._models['ExpressRouteCircuitAuthorization'](authorizationParameters);
    }
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['AuthorizationListResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
