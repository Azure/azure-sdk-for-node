 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ApplicationGateways.prototype.beginDelete = function (resourceGroupName, applicationGatewayName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse) {
          result = new client._models['ApplicationGateway'](parsedResponse);
        }
...
ApplicationGateways.prototype.beginCreateOrUpdate = function (resourceGroupName, applicationGatewayName, parameters, options, callback) {
  ...
  try {
    if (parameters) {
      requestModel = new client._models['ApplicationGateway'](parameters);
    }
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['ApplicationGatewayListResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
