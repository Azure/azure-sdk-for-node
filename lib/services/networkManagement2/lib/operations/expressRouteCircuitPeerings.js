 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ExpressRouteCircuitPeerings.prototype.beginDelete = function (resourceGroupName, circuitName, peeringName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse) {
          result = new client._models['ExpressRouteCircuitPeering'](parsedResponse);
        }
...
ExpressRouteCircuitPeerings.prototype.beginCreateOrUpdate = function (resourceGroupName, circuitName, peeringName, peeringParameters, options, callback) {
  ...
  try {
    if (peeringParameters) {
      requestModel = new client._models['ExpressRouteCircuitPeering'](peeringParameters);
    }
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['ExpressRouteCircuitPeeringListResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
