 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ExpressRouteCircuits.prototype.listPeeringStats = function (resourceGroupName, circuitName, peeringName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
ExpressRouteCircuits.prototype.listPeeringStatsNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
