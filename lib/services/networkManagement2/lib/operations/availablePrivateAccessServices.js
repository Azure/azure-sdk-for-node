...
function _list(location, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/providers/Microsoft.Network/locations/{location}/privateAccessServices';
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['PrivateAccessServicesListResult']().mapper();
 ...
 * Initializes a new instance of the AvailablePrivateAccessServices class.
 * @constructor
 *
...
module.exports = AvailablePrivateAccessServices;
