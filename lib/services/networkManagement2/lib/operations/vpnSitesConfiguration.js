...
function _download(virtualWANName, request, options, callback) {
  ...
  // Send request
  this.beginDownload(virtualWANName, request, options, (err, parsedResult, httpRequest, response) => {
...
class VpnSitesConfiguration {
   ...
   */
  downloadWithHttpOperationResponse(virtualWANName, request, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._download(virtualWANName, request, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  download(virtualWANName, request, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._download(virtualWANName, request, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  beginDownloadWithHttpOperationResponse(virtualWANName, request, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginDownload(virtualWANName, request, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  beginDownload(virtualWANName, request, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._beginDownload(virtualWANName, request, options, optionalCallback);
    }
  }
