 ...
 * Initializes a new instance of the ExpressRouteServiceProviders class.
 * @constructor
 *
...
ExpressRouteServiceProviders.prototype.list = function (options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/providers/Microsoft.Network/expressRouteServiceProviders';
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = new client.models['ExpressRouteServiceProviderListResult']().mapper();
