 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
LoadBalancers.prototype.beginDelete = function (resourceGroupName, loadBalancerName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
LoadBalancers.prototype.get = function (resourceGroupName, loadBalancerName, expand, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse) {
          result = new client._models['LoadBalancer'](parsedResponse);
        }
...
LoadBalancers.prototype.beginCreateOrUpdate = function (resourceGroupName, loadBalancerName, parameters, options, callback) {
  ...
  try {
    if (parameters) {
      requestModel = new client._models['LoadBalancer'](parameters);
    }
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['LoadBalancerListResult'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
