 ...
 * this property include: 'Basic', 'PathBasedRouting'.
 * 
...
function ApplicationGatewayRequestRoutingRule(parameters) {
  ...
  if (parameters !== null && parameters !== undefined) {
    ...
    if (parameters.urlPathMap) {
      this.urlPathMap = new models['SubResource'](parameters.urlPathMap);
    }
...
ApplicationGatewayRequestRoutingRule.prototype.serialize = function () {
  ...
  if (this['urlPathMap']) {
    ...
    payload['properties']['urlPathMap'] = this['urlPathMap'].serialize();
  }
...
ApplicationGatewayRequestRoutingRule.prototype.deserialize = function (instance) {
  ...
  if (instance) {
    ...
    if (instance['properties'] !== null && instance['properties'] !== undefined) {
      if (instance['properties']['urlPathMap']) {
        this['urlPathMap'] = new models['SubResource']().deserialize(instance['properties']['urlPathMap']);
      }
    }
