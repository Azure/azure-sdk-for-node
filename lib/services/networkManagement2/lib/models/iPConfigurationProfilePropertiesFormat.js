 ...
 *
 */
class IPConfigurationProfilePropertiesFormat {
  /**
   * Create a IPConfigurationProfilePropertiesFormat.
  ...
  /**
   * Defines the metadata of IPConfigurationProfilePropertiesFormat
   *
   * @returns {object} metadata of IPConfigurationProfilePropertiesFormat
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'IPConfigurationProfilePropertiesFormat',
      type: {
        name: 'Composite',
...
module.exports = IPConfigurationProfilePropertiesFormat;
