...
class VpnGateway extends models['Resource'] {
   ...
   * 'Failed'
   * @property {object} [policies] The policies applied to this vpn gateway.
   * @property {boolean} [policies.allowBranchToBranchTraffic] True if branch
   * to branch traffic is allowed.
   * @property {boolean} [policies.allowVnetToVnetTraffic] True if Vnet to Vnet
   * traffic is allowed.
