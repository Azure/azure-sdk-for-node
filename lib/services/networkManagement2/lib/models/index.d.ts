 ...
 * @property {object} [rewriteRuleSet] Rewrite Rule Set resource in Basic rule
 ...
 * the Action Set
 * @property {array} [responseHeaderConfigurations] Response Header Actions in
 * the Action Set
 */
 ...
 *
 * @property {string} [name] Name of the rewrite rule that is unique within an
 * Application Gateway.
 ...
 * 'Failed'.
 * @property {string} [name] Name of the rewrite rule set that is unique within
 * an Application Gateway.
 * @property {string} [etag] A unique read-only string that changes whenever
 * the resource is updated.
 */
 ...
 * @property {object} [defaultRewriteRuleSet] Default Rewrite rule set resource
 * of URL path map.
 ...
 * identity.
 * @property {string} [tenantId] The tenant id of the system assigned identity.
 ...
 * identity.
 * @property {string} [identity.tenantId] The tenant id of the system assigned
 * identity. This property will only be provided for a system assigned
 * identity.
 ...
 * include: 'JSON'
 * @property {number} [version] The version (revision) of the flow log. Default
 * value: 0 .
 */
 ...
 * @property {number} [trafficAnalyticsInterval] The interval in minutes which
 ...
 * @property {string} [format.type] The file type of flow log. Possible values
 * include: 'JSON'
 * @property {number} [format.version] The version (revision) of the flow log.
...
/**
 * @class
 * Initializes a new instance of the ExpressRouteCircuitConnectionListResult class.
 * @constructor
