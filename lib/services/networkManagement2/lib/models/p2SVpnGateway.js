...
class P2SVpnGateway extends models['Resource'] {
   ...
   * @member {string}
   * [p2SVpnServerConfiguration.p2SVpnServerConfigurationPropertiesName] The
   * name of the P2SVpnServerConfiguration that is unique within a VirtualWan
   * in a resource group. This name can be used to access the resource along
   * with Paren VirtualWan resource name.
   ...
   * @member {string}
   * [p2SVpnServerConfiguration.p2SVpnServerConfigurationPropertiesEtag] A
   ...
   * @member {object} [vpnClientConnectionHealth] All P2S vpnclients'
