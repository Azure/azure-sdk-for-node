...
/**
 * Deserialize the instance to ExpressRouteCircuitPeeringListResult schema
 *
 * @param {JSON} instance
 *
 */
ExpressRouteCircuitPeeringListResult.prototype.deserialize = function (instance) {
  if (instance) {
    if (instance['value']) {
      var deserializedInstancevalue = [];
        instance['value'].forEach(function(element) {
        if (element) {
          element = new models['ExpressRouteCircuitPeering']().deserialize(element);
        }
