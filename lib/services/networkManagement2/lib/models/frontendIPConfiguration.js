...
class FrontendIPConfiguration extends models['SubResource'] {
   ...
   * @member {object} [publicIPAddress.ddosSettings] The DDoS protection custom
   * policy associated with the public IP address.
   * @member {string} [publicIPAddress.ddosSettings.ddosCustomPolicy] The DDoS
   * custom policy associated with the public IP.
   * @member {string} [publicIPAddress.ddosSettings.protectionCoverage] The
   * type of the DDoS protection plan associated with the public IP. Possible
   * values include: 'Basic', 'Standard'
   * @member {string} [publicIPAddress.ddosSettings.domainNameLabel] Gets or
   * sets the Domain name label.The concatenation of the domain name label and
   * the regionalized DNS zone make up the fully qualified domain name
   * associated with the public IP address. If a domain name label is
   * specified, an A DNS record is created for the public IP in the Microsoft
   * Azure DNS system.
   * @member {string} [publicIPAddress.ddosSettings.fqdn] Gets the FQDN, Fully
   * qualified domain name of the A DNS record associated with the public IP.
   * This is the concatenation of the domainNameLabel and the regionalized DNS
   * zone.
   * @member {string} [publicIPAddress.ddosSettings.reverseFqdn] Gets or Sets
   * the Reverse FQDN. A user-visible, fully qualified domain name that
   * resolves to this public IP address. If the reverseFqdn is specified, then
   * a PTR DNS record is created pointing from the IP address in the
   * in-addr.arpa domain to the reverse FQDN.
