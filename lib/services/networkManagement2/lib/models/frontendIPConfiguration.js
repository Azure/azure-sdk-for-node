...
class FrontendIPConfiguration extends models['SubResource'] {
   ...
   * of the nat gateway.
   * @member {array} [subnet.natGateway.publicIpAddresses] An array of public
   * ip addresses associated with the nat gateway resource.
   ...
   * @member {string} [subnet.natGateway.resourceGuid] The resource GUID
   ...
   * @member {object} [publicIPAddress.ipConfiguration.subnet.natGateway.sku]
   * The nat gateway SKU.
   * @member {string}
   * [publicIPAddress.ipConfiguration.subnet.natGateway.sku.name] Name of Nat
   * Gateway SKU. Possible values include: 'Basic', 'Standard'
   * @member {number}
   * [publicIPAddress.ipConfiguration.subnet.natGateway.idleTimeoutInMinutes]
   ...
   * @member {array}
   * [publicIPAddress.ipConfiguration.subnet.natGateway.subnets] Gets an array
   ...
   * 'Updating', 'Deleting', and 'Failed'.
   * @member {string} [publicIPAddress.ipConfiguration.subnet.natGateway.etag]
   ...
   * SKU. Possible values include: 'Basic', 'Standard'
   * @member {number} [publicIPAddress.natGateway.idleTimeoutInMinutes] The
   ...
   * @member {string} [publicIPAddress.natGateway.resourceGuid] The resource
   * GUID property of the nat gateway resource.
   * @member {string} [publicIPAddress.natGateway.provisioningState] The
   * provisioning state of the NatGateway resource. Possible values are:
   * 'Updating', 'Deleting', and 'Failed'.
   * @member {string} [publicIPAddress.natGateway.etag] A unique read-only
   * string that changes whenever the resource is updated.
