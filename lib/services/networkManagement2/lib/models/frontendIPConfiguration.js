...
class FrontendIPConfiguration extends models['SubResource'] {
   ...
   * @property {object} [subnet.natGateway] Nat gateway associated with this
   * subnet.
   * @property {string} [subnet.natGateway.id] Resource ID.
   ...
   * address version. Possible values include: 'IPv4', 'IPv6'
   ...
   * address allocation method. Possible values include: 'Static', 'Dynamic'
   ...
   * @property {object} [publicIPAddress.ipConfiguration.subnet.natGateway] Nat
   * gateway associated with this subnet.
   * @property {string} [publicIPAddress.ipConfiguration.subnet.natGateway.id]
   * Resource ID.
   * @property {array}
