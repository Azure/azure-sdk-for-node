...
/**
 * Deserialize the instance to VirtualNetworkGatewayConnectionListResult schema
 *
 * @param {JSON} instance
 *
 */
VirtualNetworkGatewayConnectionListResult.prototype.deserialize = function (instance) {
  if (instance) {
    if (instance['value']) {
      var deserializedInstancevalue = [];
        instance['value'].forEach(function(element) {
        if (element) {
          element = new models['VirtualNetworkGatewayConnection']().deserialize(element);
        }
