 ...
 * 
 */
function InboundNatRule(parameters) {
  InboundNatRule['super_'].call(this, parameters);
  if (parameters !== null && parameters !== undefined) {
    ...
    if (parameters.backendIPConfiguration) {
      this.backendIPConfiguration = new models['NetworkInterfaceIPConfiguration'](parameters.backendIPConfiguration);
    }
...
/**
 * Validate the payload against the InboundNatRule schema
 *
 * @param {JSON} payload
 *
 */
InboundNatRule.prototype.serialize = function () {
  var payload = InboundNatRule['super_'].prototype.serialize.call(this);
  ...
  if (this['backendIPConfiguration']) {
    if (payload['properties'] === null || payload['properties'] === undefined) {
      payload['properties'] = {};
    }
    payload['properties']['backendIPConfiguration'] = this['backendIPConfiguration'].serialize();
  }
  ...
  if (this['frontendPort'] !== null && this['frontendPort'] !== undefined) {
    if (typeof this['frontendPort'] !== 'number') {
      throw new Error('this[\'frontendPort\'] must be of type number.');
    }
    if (payload['properties'] === null || payload['properties'] === undefined) {
      payload['properties'] = {};
    }
  ...
  if (this['enableFloatingIP'] !== null && this['enableFloatingIP'] !== undefined) {
    if (typeof this['enableFloatingIP'] !== 'boolean') {
      throw new Error('this[\'enableFloatingIP\'] must be of type boolean.');
    }
    if (payload['properties'] === null || payload['properties'] === undefined) {
      payload['properties'] = {};
    }
...
/**
 * Deserialize the instance to InboundNatRule schema
 *
 * @param {JSON} instance
 *
 */
InboundNatRule.prototype.deserialize = function (instance) {
  InboundNatRule['super_'].prototype.deserialize.call(this, instance);
  if (instance) {
    ...
    if (instance['properties'] !== null && instance['properties'] !== undefined) {
      if (instance['properties']['backendIPConfiguration']) {
        this['backendIPConfiguration'] = new models['NetworkInterfaceIPConfiguration']().deserialize(instance['properties']['backendIPConfiguration']);
      }
    }
