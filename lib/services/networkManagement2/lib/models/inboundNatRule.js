...
class InboundNatRule extends models['SubResource'] {
   ...
   * gateway SKU.
   * @member {string} [backendIPConfiguration.subnet.natGateway.sku.name] Name
   ...
   * @member {array}
   * [backendIPConfiguration.subnet.natGateway.publicIpAddresses] An array of
   * public ip addresses associated with the nat gateway resource.
   * @member {array}
   * [backendIPConfiguration.subnet.natGateway.publicIpPrefixes] An array of
   ...
   * @member {string} [backendIPConfiguration.subnet.natGateway.resourceGuid]
   ...
   * @member {object} [backendIPConfiguration.publicIPAddress.natGateway.sku]
   * The nat gateway SKU.
   * @member {string}
   * [backendIPConfiguration.publicIPAddress.natGateway.sku.name] Name of Nat
   * Gateway SKU. Possible values include: 'Basic', 'Standard'
   * @member {number}
   * [backendIPConfiguration.publicIPAddress.natGateway.idleTimeoutInMinutes]
   * The idle timeout of the nat gateway.
   * @member {array}
   ...
   * @member {array}
   * [backendIPConfiguration.publicIPAddress.natGateway.subnets] Gets an array
   ...
   * provisioning state of the NatGateway resource. Possible values are:
   * 'Updating', 'Deleting', and 'Failed'.
   * @member {string} [backendIPConfiguration.publicIPAddress.natGateway.etag]
   * A unique read-only string that changes whenever the resource is updated.
