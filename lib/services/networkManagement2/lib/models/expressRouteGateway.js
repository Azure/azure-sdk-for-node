...
class ExpressRouteGateway extends models['Resource'] {
   ...
   * @member {object} [autoScaleConfiguration.bounds] Minimum and maximum
   * number of scale units to deploy.
   * @member {number} [autoScaleConfiguration.bounds.min] Minimum number of
   * scale units deployed for ExpressRoute gateway.
   * @member {number} [autoScaleConfiguration.bounds.max] Maximum number of
   * scale units deployed for ExpressRoute gateway.
   ...
   * @member {string} [virtualHub.id] The resource URI for the Virtual Hub
