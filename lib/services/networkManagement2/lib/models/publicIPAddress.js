...
class PublicIPAddress extends models['Resource'] {
   ...
   * include: 'IPv4', 'IPv6'
   * @member {array} [publicIPPrefix.ipTags] The list of tags associated with
   ...
   * the public IP prefix.
   * @member {string} [publicIPPrefix.resourceGuid] The resource GUID property
   * of the public IP prefix resource.
   ...
   * changes whenever the resource is updated.
   * @member {array} [publicIPPrefix.zones] A list of availability zones
