 ...
 * 
 */
function ApplicationGatewayFrontendIPConfiguration(parameters) {
  ApplicationGatewayFrontendIPConfiguration['super_'].call(this, parameters);
...
/**
 * Validate the payload against the ApplicationGatewayFrontendIPConfiguration schema
 *
 * @param {JSON} payload
 *
 */
ApplicationGatewayFrontendIPConfiguration.prototype.serialize = function () {
  var payload = ApplicationGatewayFrontendIPConfiguration['super_'].prototype.serialize.call(this);
...
/**
 * Deserialize the instance to ApplicationGatewayFrontendIPConfiguration schema
 *
 * @param {JSON} instance
 *
 */
ApplicationGatewayFrontendIPConfiguration.prototype.deserialize = function (instance) {
  ApplicationGatewayFrontendIPConfiguration['super_'].prototype.deserialize.call(this, instance);
  if (instance) {
