...
class VirtualNetworkTap extends models['Resource'] {
   ...
   * gateway SKU.
   * @member {string}
   * [destinationNetworkInterfaceIPConfiguration.subnet.natGateway.sku.name]
   ...
   * @member {array}
   * [destinationNetworkInterfaceIPConfiguration.subnet.natGateway.subnets]
   ...
   * 'Updating', 'Deleting', and 'Failed'.
   * @member {string}
   * [destinationNetworkInterfaceIPConfiguration.subnet.natGateway.etag] A
   * unique read-only string that changes whenever the resource is updated.
   * @member {array}
   ...
   * @member {object}
   * [destinationNetworkInterfaceIPConfiguration.publicIPAddress.natGateway]
   * Nat gateway associated with this subnet.
   * @member {object}
