...
OutboundNatRule.prototype.serialize = function () {
  ...
  if (this['allocatedOutboundPorts'] !== null && this['allocatedOutboundPorts'] !== undefined) {
    if (typeof this['allocatedOutboundPorts'] !== 'number') {
      throw new Error('this[\'allocatedOutboundPorts\'] must be of type number.');
    }
