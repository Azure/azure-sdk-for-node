...
function OutboundNatRule(parameters) {
  ...
  if (parameters !== null && parameters !== undefined) {
    ...
    if (parameters.allocatedOutboundPorts !== undefined) {
      this.allocatedOutboundPorts = parameters.allocatedOutboundPorts;
    }
...
OutboundNatRule.prototype.serialize = function () {
  ...
  if (this['allocatedOutboundPorts'] === null || this['allocatedOutboundPorts'] === undefined || typeof this['allocatedOutboundPorts'] !== 'number') {
    throw new Error('this[\'allocatedOutboundPorts\'] cannot be null or undefined and it must be of type number.');
  }
  if (payload['properties'] === null || payload['properties'] === undefined) {
    payload['properties'] = {};
  }
  payload['properties']['allocatedOutboundPorts'] = this['allocatedOutboundPorts'];
...
OutboundNatRule.prototype.deserialize = function (instance) {
  ...
  if (instance) {
    ...
    if (instance['properties'] !== null && instance['properties'] !== undefined) {
      if (instance['properties']['allocatedOutboundPorts'] !== undefined) {
        this['allocatedOutboundPorts'] = instance['properties']['allocatedOutboundPorts'];
      }
    }
