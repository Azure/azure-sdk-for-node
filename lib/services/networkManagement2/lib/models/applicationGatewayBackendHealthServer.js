 ...
 *
 * @member {string} [health] Health of backend server. Possible values are:
 * 'Unknown', 'Up', 'Down', and 'Partial'. Possible values include: 'Unknown',
 * 'Up', 'Down', 'Partial'
 *
 */
 ...
 *
 */
ApplicationGatewayBackendHealthServer.prototype.mapper = function () {
  return {
    required: false,
