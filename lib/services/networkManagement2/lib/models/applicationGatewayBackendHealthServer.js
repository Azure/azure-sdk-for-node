...
class ApplicationGatewayBackendHealthServer {
   ...
   * @member {object} [ipConfiguration.subnet.natGateway] Nat gateway
   ...
   * @member {array} [ipConfiguration.subnet.natGateway.subnets] Gets an array
   ...
   * 'Updating', 'Deleting', and 'Failed'.
   * @member {string} [ipConfiguration.subnet.natGateway.etag] A unique
   * read-only string that changes whenever the resource is updated.
   ...
   * @member {object}
   * [ipConfiguration.publicIPAddress.ipConfiguration.subnet.natGateway.sku]
   * The nat gateway SKU.
   * @member {string}
   ...
   * gateway SKU.
   * @member {string} [ipConfiguration.publicIPAddress.natGateway.sku.name]
   * Name of Nat Gateway SKU. Possible values include: 'Basic', 'Standard'
   * @member {number}
   ...
   * @member {array} [ipConfiguration.publicIPAddress.natGateway.subnets] Gets
   ...
   * provisioning state of the NatGateway resource. Possible values are:
   * 'Updating', 'Deleting', and 'Failed'.
   * @member {string} [ipConfiguration.publicIPAddress.natGateway.etag] A
   * unique read-only string that changes whenever the resource is updated.
