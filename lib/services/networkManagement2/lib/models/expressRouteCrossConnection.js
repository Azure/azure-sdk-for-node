...
class ExpressRouteCrossConnection extends models['Resource'] {
   ...
   * Circuit Id.
   * @property {string} [serviceProviderProvisioningState] The provisioning
   * state of the circuit in the connectivity provider system. Possible values
   * are 'NotProvisioned', 'Provisioning', 'Provisioned'. Possible values
   * include: 'NotProvisioned', 'Provisioning', 'Provisioned', 'Deprovisioning'
   * @property {string} [serviceProviderNotes] Additional read only notes set
   * by the connectivity provider.
