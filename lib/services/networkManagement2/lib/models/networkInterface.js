...
class NetworkInterface extends models['Resource'] {
   ...
   * SKU.
   * @member {string} [interfaceEndpoint.subnet.natGateway.sku.name] Name of
   * Nat Gateway SKU. Possible values include: 'Basic', 'Standard'
   * @member {number}
   * [interfaceEndpoint.subnet.natGateway.idleTimeoutInMinutes] The idle
   ...
   * @member {array} [interfaceEndpoint.subnet.natGateway.subnets] Gets an
   ...
   * @member {string} [interfaceEndpoint.subnet.natGateway.provisioningState]
