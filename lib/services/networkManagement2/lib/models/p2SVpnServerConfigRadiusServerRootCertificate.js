 ...
 */
class P2SVpnServerConfigRadiusServerRootCertificate extends models['SubResource'] {
  /**
   * Create a P2SVpnServerConfigRadiusServerRootCertificate.
  ...
  /**
   * Defines the metadata of P2SVpnServerConfigRadiusServerRootCertificate
   *
   * @returns {object} metadata of P2SVpnServerConfigRadiusServerRootCertificate
   *
   */
  mapper() {
    return {
...
module.exports = P2SVpnServerConfigRadiusServerRootCertificate;
