...
util.inherits(ExpressRouteCircuitsArpTableListResult, Array);

/**
 * Deserialize the instance to ExpressRouteCircuitsArpTableListResult schema
 *
 * @param {JSON} instance
 *
 */
ExpressRouteCircuitsArpTableListResult.prototype.deserialize = function (instance) {
  if (instance) {
    if (instance['value']) {
      var deserializedInstancevalue = [];
        instance['value'].forEach(function(element) {
        if (element) {
          element = new models['ExpressRouteCircuitArpTable']().deserialize(element);
        }
