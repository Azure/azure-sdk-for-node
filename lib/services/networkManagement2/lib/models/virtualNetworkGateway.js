...
function VirtualNetworkGateway(parameters) {
  ...
  if (parameters !== null && parameters !== undefined) {
    ...
    if (parameters.sku) {
      this.sku = new models['VirtualNetworkGatewaySku'](parameters.sku);
    }
    if (parameters.vpnClientConfiguration) {
      this.vpnClientConfiguration = new models['VpnClientConfiguration'](parameters.vpnClientConfiguration);
    }
...
VirtualNetworkGateway.prototype.serialize = function () {
  ...
  if (this['vpnClientConfiguration']) {
    if (payload['properties'] === null || payload['properties'] === undefined) {
      payload['properties'] = {};
    }
    payload['properties']['vpnClientConfiguration'] = this['vpnClientConfiguration'].serialize();
  }
  ...
  if (instance) {
    ...
    if (instance['properties'] !== null && instance['properties'] !== undefined) {
      if (instance['properties']['sku']) {
        this['sku'] = new models['VirtualNetworkGatewaySku']().deserialize(instance['properties']['sku']);
      }
    }

    if (instance['properties'] !== null && instance['properties'] !== undefined) {
      if (instance['properties']['vpnClientConfiguration']) {
        this['vpnClientConfiguration'] = new models['VpnClientConfiguration']().deserialize(instance['properties']['vpnClientConfiguration']);
      }
    }
