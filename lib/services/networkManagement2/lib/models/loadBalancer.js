...
class LoadBalancer extends models['Resource'] {
   ...
   * @property {array} [backendAddressPools] Collection of backend address
   ...
   * balancer
   * @property {array} [inboundNatRules] Collection of inbound NAT Rules used
   ...
   * @property {array} [outboundNatRules] The outbound NAT rules.
