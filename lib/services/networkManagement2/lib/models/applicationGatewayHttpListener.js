...
function ApplicationGatewayHttpListener(parameters) {
  ...
  if (parameters !== null && parameters !== undefined) {
    ...
    if (parameters.requireServerNameIndication !== undefined) {
      this.requireServerNameIndication = parameters.requireServerNameIndication;
    }
...
ApplicationGatewayHttpListener.prototype.serialize = function () {
  ...
  if (this['requireServerNameIndication'] !== null && this['requireServerNameIndication'] !== undefined) {
    if (typeof this['requireServerNameIndication'].valueOf() !== 'string') {
      throw new Error('this[\'requireServerNameIndication\'] must be of type string.');
    }
    if (payload['properties'] === null || payload['properties'] === undefined) {
      payload['properties'] = {};
    }
    payload['properties']['requireServerNameIndication'] = this['requireServerNameIndication'];
  }
...
ApplicationGatewayHttpListener.prototype.deserialize = function (instance) {
  ...
  if (instance) {
    ...
    if (instance['properties'] !== null && instance['properties'] !== undefined) {
      if (instance['properties']['requireServerNameIndication'] !== undefined) {
        this['requireServerNameIndication'] = instance['properties']['requireServerNameIndication'];
      }
    }
