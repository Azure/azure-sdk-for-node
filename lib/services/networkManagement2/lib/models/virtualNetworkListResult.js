...
/**
 * Deserialize the instance to VirtualNetworkListResult schema
 *
 * @param {JSON} instance
 *
 */
VirtualNetworkListResult.prototype.deserialize = function (instance) {
  if (instance) {
    if (instance['value']) {
      var deserializedInstancevalue = [];
        instance['value'].forEach(function(element) {
        if (element) {
          element = new models['VirtualNetwork']().deserialize(element);
        }
