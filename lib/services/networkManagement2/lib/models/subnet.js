...
class Subnet extends models['SubResource'] {
   ...
   * @member {array} [addressPrefixes] List of  address prefixes for the
   * subnet.
   ...
   * @member {array} [natGateway.publicIpPrefixes] An array of public ip
   ...
   * @member {string} [natGateway.resourceGuid] The resource GUID property of
   ...
   * @member {array} [ipConfigurationProfiles] Array of IP configuration
   ...
   * @member {array} [delegations] Gets an array of references to the
