...
class DscNode extends models['ProxyResource'] {
   ...
   * @member {date} [registrationTime1] Gets or sets the registration time of
   * the node.
   * @member {string} [ip1] Gets or sets the ip of the node.
   * @member {string} [accountId1] Gets or sets the account id of the node.
   * @member {object} [nodeConfiguration1] Gets or sets the configuration of
   * the node.
   * @member {string} [nodeConfiguration1.name] Gets or sets the name of the
   * dsc nodeconfiguration.
