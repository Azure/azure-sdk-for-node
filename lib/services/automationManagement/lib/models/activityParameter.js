...
class ActivityParameter {
   ...
   * @property {boolean} [isDynamic] Gets or sets a Boolean value that
   * indicates true if the parameter is dynamic.
   ...
   * @property {boolean} [valueFromPipelineByPropertyName] Gets or sets a
   * Boolean value that indicates true if the parameter can be filled from a
   * property of the incoming pipeline object that has the same name as this
   * parameter. false indicates that the parameter cannot be filled from the
