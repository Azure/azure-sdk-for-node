...
class SourceControlSyncJobOperations {
   ...
   */
  createWithHttpOperationResponse(automationAccountName, sourceControlName, sourceControlSyncJobId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._create(automationAccountName, sourceControlName, sourceControlSyncJobId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  create(automationAccountName, sourceControlName, sourceControlSyncJobId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._create(automationAccountName, sourceControlName, sourceControlSyncJobId, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getWithHttpOperationResponse(automationAccountName, sourceControlName, sourceControlSyncJobId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._get(automationAccountName, sourceControlName, sourceControlSyncJobId, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  get(automationAccountName, sourceControlName, sourceControlSyncJobId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._get(automationAccountName, sourceControlName, sourceControlSyncJobId, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  listByAutomationAccountWithHttpOperationResponse(automationAccountName, sourceControlName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listByAutomationAccount(automationAccountName, sourceControlName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listByAutomationAccount(automationAccountName, sourceControlName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._listByAutomationAccount(automationAccountName, sourceControlName, options, optionalCallback);
    }
  }
