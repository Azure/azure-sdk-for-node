 ...
 */
function _getById(resourceGroupName, softwareUpdateConfigurationMachineRunId, options, callback) {
...
class SoftwareUpdateConfigurationMachineRuns {
   ...
   */
  getByIdWithHttpOperationResponse(resourceGroupName, softwareUpdateConfigurationMachineRunId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getById(resourceGroupName, softwareUpdateConfigurationMachineRunId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getById(resourceGroupName, softwareUpdateConfigurationMachineRunId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._getById(resourceGroupName, softwareUpdateConfigurationMachineRunId, options, optionalCallback);
    }
  }
