...
class TestJobStreams {
   ...
   */
  getWithHttpOperationResponse(automationAccountName, runbookName, jobStreamId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._get(automationAccountName, runbookName, jobStreamId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  get(automationAccountName, runbookName, jobStreamId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._get(automationAccountName, runbookName, jobStreamId, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  listByTestJobWithHttpOperationResponse(automationAccountName, runbookName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listByTestJob(automationAccountName, runbookName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listByTestJob(automationAccountName, runbookName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._listByTestJob(automationAccountName, runbookName, options, optionalCallback);
    }
  }
