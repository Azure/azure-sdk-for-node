...
class DscCompilationJobStream {
   ...
   */
  listByJobWithHttpOperationResponse(automationAccountName, jobId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listByJob(automationAccountName, jobId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listByJob(automationAccountName, jobId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._listByJob(automationAccountName, jobId, options, optionalCallback);
    }
  }
