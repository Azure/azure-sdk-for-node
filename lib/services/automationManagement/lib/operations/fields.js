...
class Fields {
   ...
   */
  listByTypeWithHttpOperationResponse(resourceGroupName, automationAccountName, moduleName, typeName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listByType(resourceGroupName, automationAccountName, moduleName, typeName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listByType(resourceGroupName, automationAccountName, moduleName, typeName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._listByType(resourceGroupName, automationAccountName, moduleName, typeName, options, optionalCallback);
    }
  }
