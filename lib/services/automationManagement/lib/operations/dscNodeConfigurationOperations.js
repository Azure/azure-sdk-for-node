 ...
 */
function _deleteMethod(automationAccountName, nodeConfigurationName, options, callback) {
...
function _createOrUpdate(automationAccountName, nodeConfigurationName, parameters, options, callback) {
  ...
  // Send request
  this.beginCreateOrUpdate(automationAccountName, nodeConfigurationName, parameters, options, (err, parsedResult, httpRequest, response) => {
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _beginCreateOrUpdate(automationAccountName, nodeConfigurationName, parameters, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  try {
    if (parameters !== null && parameters !== undefined) {
      let requestModelMapper = new client.models['DscNodeConfigurationCreateOrUpdateParametersProperties']().mapper();
...
class DscNodeConfigurationOperations {
   ...
   */
  deleteMethodWithHttpOperationResponse(automationAccountName, nodeConfigurationName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._deleteMethod(automationAccountName, nodeConfigurationName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  deleteMethod(automationAccountName, nodeConfigurationName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._deleteMethod(automationAccountName, nodeConfigurationName, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getWithHttpOperationResponse(automationAccountName, nodeConfigurationName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._get(automationAccountName, nodeConfigurationName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  get(automationAccountName, nodeConfigurationName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._get(automationAccountName, nodeConfigurationName, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  createOrUpdateWithHttpOperationResponse(automationAccountName, nodeConfigurationName, parameters, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._createOrUpdate(automationAccountName, nodeConfigurationName, parameters, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  createOrUpdate(automationAccountName, nodeConfigurationName, parameters, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._createOrUpdate(automationAccountName, nodeConfigurationName, parameters, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  beginCreateOrUpdateWithHttpOperationResponse(automationAccountName, nodeConfigurationName, parameters, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginCreateOrUpdate(automationAccountName, nodeConfigurationName, parameters, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  beginCreateOrUpdate(automationAccountName, nodeConfigurationName, parameters, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._beginCreateOrUpdate(automationAccountName, nodeConfigurationName, parameters, options, optionalCallback);
    }
  }
