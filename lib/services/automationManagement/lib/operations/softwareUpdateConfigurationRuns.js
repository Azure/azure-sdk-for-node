 ...
 */
function _getById(automationAccountName, softwareUpdateConfigurationRunId, options, callback) {
...
class SoftwareUpdateConfigurationRuns {
   ...
   */
  getByIdWithHttpOperationResponse(automationAccountName, softwareUpdateConfigurationRunId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getById(automationAccountName, softwareUpdateConfigurationRunId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getById(automationAccountName, softwareUpdateConfigurationRunId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._getById(automationAccountName, softwareUpdateConfigurationRunId, options, optionalCallback);
    }
  }
