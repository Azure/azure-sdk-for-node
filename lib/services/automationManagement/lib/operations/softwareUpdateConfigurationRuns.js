...
class SoftwareUpdateConfigurationRuns {
   ...
   */
  getByIdWithHttpOperationResponse(softwareUpdateConfigurationRunId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getById(softwareUpdateConfigurationRunId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getById(softwareUpdateConfigurationRunId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._getById(softwareUpdateConfigurationRunId, options, optionalCallback);
    }
  }
