 ...
 */
function _get(automationAccountName, options, callback) {
...
class LinkedWorkspaceOperations {
   ...
   */
  getWithHttpOperationResponse(automationAccountName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._get(automationAccountName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  get(automationAccountName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._get(automationAccountName, options, optionalCallback);
    }
  }
