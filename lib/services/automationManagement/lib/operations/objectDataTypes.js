...
class ObjectDataTypes {
   ...
   */
  listFieldsByModuleAndTypeWithHttpOperationResponse(automationAccountName, moduleName, typeName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listFieldsByModuleAndType(automationAccountName, moduleName, typeName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listFieldsByModuleAndType(automationAccountName, moduleName, typeName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._listFieldsByModuleAndType(automationAccountName, moduleName, typeName, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  listFieldsByTypeWithHttpOperationResponse(automationAccountName, typeName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listFieldsByType(automationAccountName, typeName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listFieldsByType(automationAccountName, typeName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._listFieldsByType(automationAccountName, typeName, options, optionalCallback);
    }
  }
