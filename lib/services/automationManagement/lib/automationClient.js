...
class AutomationClient extends ServiceClient {
   ...
   */
  constructor(credentials, subscriptionId, automationAccountName, automationAccountName1, baseUri, options) {
    ...
    if (automationAccountName1 === null || automationAccountName1 === undefined) {
      throw new Error('\'automationAccountName1\' cannot be null.');
    }
    ...
    this.automationAccountName1 = automationAccountName1;
