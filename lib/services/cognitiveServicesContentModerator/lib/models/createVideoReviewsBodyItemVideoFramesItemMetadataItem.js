...
/**
 * Class representing a CreateVideoReviewsBodyItemVideoFramesItemMetadataItem.
 */
class CreateVideoReviewsBodyItemVideoFramesItemMetadataItem {
  ...
  /**
   * Defines the metadata of CreateVideoReviewsBodyItemVideoFramesItemMetadataItem
   *
   * @returns {object} metadata of CreateVideoReviewsBodyItemVideoFramesItemMetadataItem
   *
   */
  mapper() {
    return {
...
module.exports = CreateVideoReviewsBodyItemVideoFramesItemMetadataItem;
