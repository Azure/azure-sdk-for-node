 ...
 */
class EventsTraceResult extends models['EventsResultData'] {
  /**
   * Create a EventsTraceResult.
   * @member {object} [trace]
  ...
  /**
   * Defines the metadata of EventsTraceResult
   *
...
module.exports = EventsTraceResult;
