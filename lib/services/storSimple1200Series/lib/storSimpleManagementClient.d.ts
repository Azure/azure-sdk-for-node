...
export default class StorSimpleManagementClient extends AzureServiceClient {
  /**
  ...
  availableProviderOperationsOperations: operations.AvailableProviderOperationsOperations;
  ...
  chapSettingsOperations: operations.ChapSettingsOperations;
...
export { StorSimpleManagementClient, models as StorSimpleManagementModels };
