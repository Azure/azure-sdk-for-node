...
export interface Managers {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    regenerateRegistrationCertificateWithHttpOperationResponse(resourceGroupName: string, managerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.RegistrationCertificate>>;
     ...
     *                      {Error|ServiceError}  err        - The Error object if an error occurred, null otherwise.
     *
     *                      {RegistrationCertificate} [result]   - The deserialized result object if an error did not occur.
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    regenerateRegistrationCertificate(resourceGroupName: string, managerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<models.RegistrationCertificate>;
    regenerateRegistrationCertificate(resourceGroupName: string, managerName: string, callback: ServiceCallback<models.RegistrationCertificate>): void;
    regenerateRegistrationCertificate(resourceGroupName: string, managerName: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.RegistrationCertificate>): void;
...
export interface AvailableProviderOperationsOperations {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    createOrUpdateWithHttpOperationResponse(options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.Manager>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    createOrUpdate(options?: { customHeaders? : { [headerName: string]: string; } }): Promise<models.Manager>;
    createOrUpdate(callback: ServiceCallback<models.Manager>): void;
    createOrUpdate(options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.Manager>): void;
...
export interface Devices {
     ...
     * @param {string} deviceName The device name.
     *
     * @param {object} supportPackageRequest The publish support package request.
     *
     * @param {string} supportPackageRequest.sdpPassKey The SDPPassKey
     *
     * @param {string} [supportPackageRequest.packageType] The support package
     * type. Possible values include: 'None', 'IncludeDefault', 'IncludeAll',
     * 'Mini', 'Custom'
     *
     * @param {date} [supportPackageRequest.endTime] The maximum time stamp of the
     * logs.
     *
     * @param {date} [supportPackageRequest.startTime] The minimum time stamp of
     * the logs.
     *
     * @param {boolean} [supportPackageRequest.includeArchived] The bool which
     * determines whether the archived logs are included or not.
     *
     * @param {string} [supportPackageRequest.sourceType] The support package
     * source type. Possible values include: 'None', 'OpsTriggered',
     * 'ClientTriggered'
     *
     * @param {array} [supportPackageRequest.customIncludeList] The list of log
     * categories
     *
     * @param {string} resourceGroupName The resource group name
     *
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    publishSupportPackageWithHttpOperationResponse(deviceName: string, supportPackageRequest: models.SupportPackageRequest, resourceGroupName: string, managerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    publishSupportPackage(deviceName: string, supportPackageRequest: models.SupportPackageRequest, resourceGroupName: string, managerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<void>;
    publishSupportPackage(deviceName: string, supportPackageRequest: models.SupportPackageRequest, resourceGroupName: string, managerName: string, callback: ServiceCallback<void>): void;
    publishSupportPackage(deviceName: string, supportPackageRequest: models.SupportPackageRequest, resourceGroupName: string, managerName: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    beginPublishSupportPackageWithHttpOperationResponse(deviceName: string, supportPackageRequest: models.SupportPackageRequest, resourceGroupName: string, managerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    beginPublishSupportPackage(deviceName: string, supportPackageRequest: models.SupportPackageRequest, resourceGroupName: string, managerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<void>;
    beginPublishSupportPackage(deviceName: string, supportPackageRequest: models.SupportPackageRequest, resourceGroupName: string, managerName: string, callback: ServiceCallback<void>): void;
    beginPublishSupportPackage(deviceName: string, supportPackageRequest: models.SupportPackageRequest, resourceGroupName: string, managerName: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
