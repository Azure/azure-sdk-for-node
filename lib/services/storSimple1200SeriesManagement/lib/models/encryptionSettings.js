...
class EncryptionSettings extends models['BaseModel'] {
   ...
   * @property {string} encryptionStatus The encryption status which indicates
   * if encryption is enabled or not. Possible values include: 'Enabled',
   * 'Disabled'
   * @property {string} keyRolloverStatus The key rollover status which
   * indicates if key rollover is required or not. If secrets encryption has
