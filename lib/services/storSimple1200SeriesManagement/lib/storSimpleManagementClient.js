...
/** Class representing a StorSimpleManagementClient. */
class StorSimpleManagementClient extends ServiceClient {
  /**
   * Create a StorSimpleManagementClient.
  ...
  constructor(credentials, subscriptionId, baseUri, options) {
    ...
    this.availableProviderOperationsOperations = new operations.AvailableProviderOperationsOperations(this);
    ...
    this.chapSettingsOperations = new operations.ChapSettingsOperations(this);
...
module.exports = StorSimpleManagementClient;
module.exports['default'] = StorSimpleManagementClient;
module.exports.StorSimpleManagementClient = StorSimpleManagementClient;
module.exports.StorSimpleManagementModels = models;
