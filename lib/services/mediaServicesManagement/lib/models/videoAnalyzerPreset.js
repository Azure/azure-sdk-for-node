...
class VideoAnalyzerPreset extends models['AudioAnalyzerPreset'] {
   ...
   * If not set then based on the content the type will selected.  If the
   * content is audi only then only audio insights are extraced and if it is
      ...
      type: {
        ...
        modelProperties: {
          ...
          insightsToExtract: {
            ...
            type: {
              name: 'Enum',
              allowedValues: [ 'AudioInsightsOnly', 'VideoInsightsOnly', 'AllInsights' ]
            }
          }
        }
      }
