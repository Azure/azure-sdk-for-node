...
class Image extends models['Video'] {
   ...
   * @property {string} [range] The position in the input video at which to
   * stop generating thumbnails. The value can be in absolute timestamp (ISO
   * 8601, e.g: PT5M30S to stop at 5 minutes and 30 seconds), or a frame count
   * (For example, 300 to stop at the 300th frame), or a relative value (For
   * example, 100%).
   */
  constructor() {
    super();
