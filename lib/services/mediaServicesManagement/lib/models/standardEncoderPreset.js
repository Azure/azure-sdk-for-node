...
class StandardEncoderPreset extends models['Preset'] {
   ...
   * 'AutoPixelAdaptive'
   * @property {string} [filters.rotation] The rotation, if any, to be applied
   * to the input video, before it is encoded. Default is Auto. Possible values
   * include: 'Auto', 'None', 'Rotate0', 'Rotate90', 'Rotate180', 'Rotate270'
   * @property {object} [filters.crop] The parameters for the rectangular
   ...
   * @property {string} [filters.crop.width] The width of the rectangular
