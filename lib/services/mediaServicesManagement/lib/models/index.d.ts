...
*/
export interface ContentKeyPolicyPlayReadyContentEncryptionKeyFromHeader extends
...
*/
export interface ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier extends
ContentKeyPolicyPlayReadyContentKeyLocation {
  /**
   * The content key ID.
  */
...
*/
export interface ContentKeyPolicyX509CertificateTokenKey extends
