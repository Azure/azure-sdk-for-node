...
class Volume extends models['BaseModel'] {
   ...
   * @property {string} volumeStatus The volume status. Possible values
   ...
   * @property {string} [backupStatus] The backup status of the volume.
   * Possible values include: 'Enabled', 'Disabled'
   * @property {string} monitoringStatus The monitoring status of the volume.
   * Possible values include: 'Enabled', 'Disabled'
   * @property {array} [backupPolicyIds] The IDs of the backup policies, in
