...
class MetricFilter {
   ...
   * @property {string} [name.value] Specifies the metric name to be filtered
   * on. E.g., CloudStorageUsed. Valid values are the ones returned in the
   * field "name" in the ListMetricDefinitions call. Only 'Equality' operator
   ...
   * property.
   * @property {string} [timeGrain] Specifies the time granularity of the
   * metrics to be returned. E.g., "P1D". Valid values are the ones returned as
   * the field "timeGrain" in the ListMetricDefinitions call. Only 'Equality'
   ...
   * is supported for this property.
   * @property {string} [dimensions.values] Specifies the dimension value.
   * E.g., Data0. Valid values are the ones returned in the field "dimensions"
   * in the ListMetricDefinitions call. Only 'Equality' operator is supported
   * for this property.
   */
  constructor() {
  }
