...
class BackupPolicy extends models['BaseModel'] {
   ...
   * the backup policy.
   * @property {date} [nextBackupTime] The time of the next backup for the
   * backup policy.
   * @property {date} [lastBackupTime] The time of the last backup for the
   * backup policy.
   * @property {number} [schedulesCount] The count of schedules the backup
   * policy contains.
   * @property {string} [scheduledBackupStatus] Indicates whether at least one
   * of the schedules in the backup policy is active or not. Possible values
