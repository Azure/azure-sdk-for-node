...
class NetworkAdapters {
   ...
   * network adapter.
   * @property {string} [nicIpv4Settings.controller0Ipv4Address] The IPv4
   * address of Controller0.
   * @property {string} [nicIpv4Settings.controller1Ipv4Address] The IPv4
   * address of Controller1.
   ...
   * network adapter.
   * @property {string} [nicIpv6Settings.controller0Ipv6Address] The IPv6
   * address of Controller0.
   * @property {string} [nicIpv6Settings.controller1Ipv6Address] The IPv6
   * address of Controller1.
   */
  constructor() {
  }
