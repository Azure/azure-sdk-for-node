...
class VolumeContainer extends models['BaseModel'] {
   ...
   * it will be null.
   * @property {string} [encryptionKey.encryptionAlgorithm] The algorithm used
   * to encrypt "Value". Possible values include: 'None', 'AES256',
   * 'RSAES_PKCS1_v_1_5'
   * @property {string} [encryptionStatus] The flag to denote whether
   ...
   * Container.
   * @property {string} storageAccountCredentialId The path ID of storage
