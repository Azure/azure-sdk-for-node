...
class TargetEligibilityErrorMessage {
   ...
   * @property {string} [message] The localized error message stating the
   * reason why the device is not eligible as a target device.
   * @property {string} [resolution] The localized resolution message for the
   * error.
   * @property {string} [resultCode] The result code for the error, due to
   * which the device does not qualify as a failover target device. Possible
   * values include: 'TargetAndSourceCannotBeSameError',
