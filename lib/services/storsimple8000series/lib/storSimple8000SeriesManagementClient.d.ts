...
export default class StorSimple8000SeriesManagementClient extends AzureServiceClient {
  /**
...
export { StorSimple8000SeriesManagementClient, models as StorSimple8000SeriesManagementModels };
