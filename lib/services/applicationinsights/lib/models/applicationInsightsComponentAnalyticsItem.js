...
class ApplicationInsightsComponentAnalyticsItem {
   ...
   * @property {string} [version] This instance's version of the data model.
   * This can change as new features are added.
   * @property {string} [scope] Enum indicating if this item definition is
