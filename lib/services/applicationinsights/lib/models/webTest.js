 ...
 *
 * @extends models['WebtestsResource']
 */
class WebTest extends models['WebtestsResource'] {
  /**
   * Create a WebTest.
   ...
   * fail.
   * @property {array} locations A list of where to physically run the tests
   * from to give global coverage for accessibility of your application.
   * @property {object} [configuration] An XML configuration specification for
   * a WebTest.
