...
class ApplicationInsightsComponent extends models['ComponentsResource'] {
   ...
   * 'rest' .
   * @property {string} [instrumentationKey] Application Insights
   * Instrumentation key. A read-only value that applications can use to
   * identify the destination for all telemetry sent to Azure Application
   * Insights. This value will be supplied upon construction of each new
