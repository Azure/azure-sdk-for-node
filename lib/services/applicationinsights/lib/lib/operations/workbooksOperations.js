    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['Workbooks']().mapper();
...
/** Class representing a WorkbooksOperations. */
class WorkbooksOperations {
  /**
   * Create a WorkbooksOperations.
...
module.exports = WorkbooksOperations;
