...
class EventsExceptionResult extends models['EventsResultData'] {
   ...
   * @property {string} [exception.outerMethod] The outer method of the
   * exception
   * @property {string} [exception.outerAssembly] The outer assembly of the
   * exception
   ...
   * the exception
   * @property {string} [exception.innermostMethod] The inner most method of
   * the exception
   * @property {string} [exception.innermostAssembly] The inner most assembly
   * of the exception
