 ...
 *
 * @param {string} [options.safeSearch] Filter suggestions for adult content.
 ...
 */
function _autoSuggestMethod(query, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'Suggestions';
  let queryParameters = [];
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['AutoSuggest']().mapper();
...
/** Class representing a AutoSuggestAPIClient. */
class AutoSuggestAPIClient extends ServiceClient {
  /**
   * Create a AutoSuggestAPIClient.
  ...
  constructor(credentials, baseUri, options) {
    ...
    this.models = models;
    this._autoSuggestMethod = _autoSuggestMethod;
   ...
   */
  autoSuggestMethodWithHttpOperationResponse(query, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._autoSuggestMethod(query, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  autoSuggestMethod(query, options, optionalCallback) {
    let client = this;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._autoSuggestMethod(query, options, optionalCallback);
    }
  }

}

module.exports = AutoSuggestAPIClient;
module.exports['default'] = AutoSuggestAPIClient;
module.exports.AutoSuggestAPIClient = AutoSuggestAPIClient;
module.exports.AutoSuggestAPIModels = models;
