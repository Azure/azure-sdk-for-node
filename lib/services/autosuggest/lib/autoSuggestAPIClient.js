 ...
 */
function _autoSuggest(query, options, callback) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['Suggestions']().mapper();
...
class AutoSuggestAPIClient extends ServiceClient {
  ...
  constructor(credentials, baseUri, options) {
    ...
    this.models = models;
    this._autoSuggest = _autoSuggest;
   ...
   */
  autoSuggestWithHttpOperationResponse(query, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._autoSuggest(query, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  autoSuggest(query, options, optionalCallback) {
    let client = this;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._autoSuggest(query, options, optionalCallback);
    }
  }
