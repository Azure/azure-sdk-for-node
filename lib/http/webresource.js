...
WebResource.put = function (path) {
  ...
  webResource.path = path ? path : null;
...
WebResource.prototype.addOptionalAccessContitionHeader = function (accessConditionHeaders) {
...
WebResource.prototype.addOptionalSourceAccessContitionHeader = function (accessConditionHeaders) {
  if (accessConditionHeaders) {
