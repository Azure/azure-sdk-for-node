...
*/
exports.writeZeroToStream = function(stream, length, callback) {
  var defaultBufferSize = Constants.BlobConstants.DEFAULT_MINIMUM_PAGE_STREAM_WRITE_IN_BYTES;
  ...
  stream.write(buffer, function() {
    buffer = null;
    if (remaining > 0) {
      exports.writeZeroToStream(stream, remaining, callback);
