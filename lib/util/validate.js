...
* @return {undefined}
*/
exports.containerNameIsValidForOpen = function (containerName, callback) {
  ...
  return exports.containerNameIsValid(containerName, callback);
}
...
_.extend(ArgumentValidator.prototype, {
  ...
  containerNameIsValidForOpen: exports.containerNameIsValidForOpen,
