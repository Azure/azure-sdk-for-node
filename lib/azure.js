...
var WebsiteManagementService = require('./services/webSiteManagement/websitemanagementservice');
...
* @ignore
*/
var WebSiteManagementClient = require('./services/webSiteManagement/webSiteManagementClient');
...
* @return {WebsiteManagementService}                A new WebsitemanagementService object.
*/
exports._createWebsiteManagementService = function (credentials, baseUri) {
  return new WebSiteManagementClient.WebSiteManagementClient(credentials, baseUri);
};
