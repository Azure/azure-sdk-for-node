...
*/
exports.createARMInsightsManagementClient = function (credentials, subscriptionId, options) {
  return new InsightsManagementClient(credentials, subscriptionId, null, options);
};
...
exports.createInsightsClient = function (credentials, subscriptionId, options) {
  return new InsightsClient(credentials, subscriptionId, null, options);
};
