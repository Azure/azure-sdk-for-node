...
/**
* ApiApp management client exports.
* @ignore
*/
var apiAppManagement = require('azure-arm-apiapp');
/**
 * Creates a new {@link ApiAppManagementClient} object.
 * @param {object} credentials The credentials object (typically, a TokenCloudCredentials instance).
 * @param {string} [baseUri] The Azure management URI. If not informed, the value "https://management.azure.com" is used.
 * @param {object[]} [filters] Extra filters to attach to the client.
 * @return {ApiAppManagementClient} A new ApiAppManagementClient object.
 */
exports.ApiAppManagementClient = apiAppManagement.ApiAppManagementClient;
...
* @return {ApiAppManagementClient}                  A new ApiAppManagementClient object.
*/
exports.createApiAppManagementClient = apiAppManagement.createApiAppManagementClient;
