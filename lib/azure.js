...
if (nodeVersion.major === 0 && nodeVersion.minor > 8 && !(nodeVersion.minor === 10 && nodeVersion.patch >= 3)) {
  throw new Error('The Windows Azure node SDK does not work with node versions > 0.8.0 and < 0.10.3. Please upgrade to node >= 0.10.3');
}
