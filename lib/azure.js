 ...
 *
 */
exports.createDataLakeStoreFileSystemManagementClient = function (credentials, subscriptionId, adlsFileSystemDnsSuffix, options) {
  let AzureARMDatalakeStore = require('azure-arm-datalake-store');
...
exports.createServiceBusManagementClient = function (credentials, subscriptionId, options) {
  const SearchManagServiceBusManagementClientementClient = require('azure-arm-sb');
