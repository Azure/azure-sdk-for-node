...
exports.ARMLockManagementClient = resourceManagement.LockManagementClient;
/**
 * Creates a new instance of the ARM Resource LockManagementClient.
 *
 * @param {credentials} credentials - Gets Azure subscription credentials.
 *
 * @param {string} subscriptionId - Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
 ...
 *
 */
exports.createResourceLockManagementClient = function (credentials, subscriptionId, options) {
  return new resourceManagement.LockManagementClient(credentials, subscriptionId, null, options)
};
...
exports.createARMNetworkManagementClient = function (credentials, subscriptionId, options) {
  return new azureARMNetwork(credentials, subcriptionId, null, options);
};
...
exports.createARMComputeManagementClient = function (credentials, subscriptionId, options) {
  return new azureARMCompute(credentials, subcriptionId, null, options);
};
...
exports.createARMRedisCacheManagementClient = function (credentials, subscriptionId, options) {
  return new azureARMRedis(credentials, subcriptionId, null, options);
};
...
exports.createARMWebsiteManagementClient = function (credentials, subscriptionId, options) {
  return new azureARMWebSite(credentials, subcriptionId, null, options);
};
...
exports.createARMCdnManagementClient = function (credentials, subscriptionId, options) {
  return new azureARMCdn(credentials, subcriptionId, null, options);
};
...
exports.createARMAuthorizationManagementClient = function (credentials, subscriptionId, options) {
  return new azureARMAuthorization(credentials, subcriptionId, null, options);
};
 ...
 *
 */
function createDataLakeAnalyticsJobManagementClient(credentials, subscriptionId, adlaJobDnsSuffix, options) {
 ...
 *
 */
function createDataLakeAnalyticsCatalogManagementClient(credentials, subscriptionId, adlaCatalogDnsSuffix, options) {
 ...
 *
 */
function createDataLakeAnalyticsAccountManagementClient(credentials, subscriptionId, baseUri, options) {
  return new azureARMDatalakeAnalytics.DataLakeAnalyticsAccountClient(credentials, subscriptionId, baseUri, options);
};
 ...
 *
 */
function createDataLakeStoreAccountManagementClient(credentials, subscriptionId, baseUri, options) {
  return new azureARMDatalakeStore.DataLakeStoreAccountClient(credentials, subscriptionId, baseUri, options);
};
 ...
 *
 */
function DataLakeStoreFileSystemManagementClient(credentials, subscriptionId, adlsFileSystemDnsSuffix, options) {
