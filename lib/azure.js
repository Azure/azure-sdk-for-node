...
* @param {string} [authentication.keyfile]          The path to a .pem file that contains the private key
* @param {string} [authentication.certFile]         The path to a .pem file that contains the certificate
* @param {string} [authentication.keyvalue]         A string that contains the private key
* @param {string} [authentication.certvalue]        A string that contains the certificate
* @param {object} [hostOptions]                     The host options to override defaults.
* @param {string} [hostOptions.host]                The management endpoint.
* @param {string} [hostOptions.apiversion]          The API vesion to be used.
* @param {string} [hostOptions.serializetype]       The serialization to be used. Either JSON or XML.
