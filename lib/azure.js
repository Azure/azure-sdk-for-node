...
/**
 * Creates a new instance of the InsightsManagementClient.
 *
 * @param {credentials} credentials - Credentials needed for the client to connect to Azure.
 *
...
exports.createInsightsManagementClient = function (credentials, subscriptionId, options) {
  const AzureARMInsights = require('azure-arm-insights');
  return new AzureARMInsights(credentials, subscriptionId, null, options);
};

var azureARMMonitor = require('azure-arm-monitor');
exports.ARMMonitorManagementClient = azureARMMonitor.MonitorManagementClient;
/**
 * @class
 ...
 * @param {boolean} [options.generateClientRequestId] - When set to true a unique x-ms-client-request-id value is generated and included in each request. Default is true.
 *
 * @return {MonitorManagementClient}                A new MonitorManagementClient object.
*/
exports.createMonitorManagementClient = function (credentials, subscriptionId, options) {
  return new azureARMMonitor.MonitorManagementClient(credentials, subscriptionId, null, options);
};

var azureMonitor = require('azure-monitor');
exports.MonitorClient = azureMonitor.MonitorClient;
/**
 * @class
...
*/
exports.createMonitorClient = function (credentials, subscriptionId, options) {
  return new azureMonitor.MonitorClient(credentials, subscriptionId, null, options);
};
...
/**
 * Creates a new instance of the InsightsClient.
 *
 * @param {credentials} credentials - Credentials needed for the client to connect to Azure.
 *
 * @param {string} subscriptionId - The Azure subscription Id.
...
exports.createInsightsClient = function (credentials, subscriptionId, options) {
  ...
  return new AzureInsights(credentials, subscriptionId, null, options);
};
...
exports.createIntuneManagementClient = function (credentials, subscriptionId, options) {
  const IntuneManagementClient = require('azure-arm-intune');
