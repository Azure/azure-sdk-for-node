...
function validateNodeVersion() {
  ...
  if (parseInt(version[0], 10) === 0 && (parseInt(version[1], 10) < 6 || (parseInt(version[1], 10) === 6 && version.length > 2 && parseInt(version[2], 10) < 11))) {
    throw new Error('Service runtime need node version >= 0.6.11 to run');
  }
}