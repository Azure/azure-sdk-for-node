# Windows Azure SDK for Node.js [![Build Status](https://travis-ci.org/WindowsAzure/azure-sdk-for-node.png?branch=dev)](https://travis-ci.org/WindowsAzure/azure-sdk-for-node)
