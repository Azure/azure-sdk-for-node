...
describe('RP RegistrationFilter', () => {
  it('should correctly parse the error message from service for new subscription', (done) => {
      let msg = "{\"error\":{\"code\":\"MissingSubscriptionRegistration\",\"message\":\"The subscription is not registered to use namespace 'Microsoft.Devices'. See https://aka.ms/rps-not-found for how to register subscriptions.\"}}";
      let rpName = RPRegistrationFilter.checkRPNotRegisteredError(msg);
