...
class Subscriptions {
  ...
  listLocations(subscriptionId, options, optionalCallback) {
    ...
    if (!optionalCallback) {
      return new Promise((resolve, reject) => {
        self._listLocations(subscriptionId, options, (err, result) => {
          if (err) { reject(err); }
          else { resolve(result); }
          return;
        });
  ...
  get(subscriptionId, options, optionalCallback) {
    ...
    if (!optionalCallback) {
      return new Promise((resolve, reject) => {
        self._get(subscriptionId, options, (err, result) => {
          if (err) { reject(err); }
          else { resolve(result); }
          return;
        });
  ...
  listNext(nextPageLink, options, optionalCallback) {
    ...
    if (!optionalCallback) {
      return new Promise((resolve, reject) => {
        self._listNext(nextPageLink, options, (err, result) => {
          if (err) { reject(err); }
          else { resolve(result); }
          return;
        });
