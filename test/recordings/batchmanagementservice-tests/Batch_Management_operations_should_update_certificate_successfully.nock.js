...
.patch('/subscriptions/f30ef677-64a9-4768-934f-5fbbc0e1ad27/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.Batch/batchAccounts/batchtestnodesdk/certificates/SHA1-cff2ab63c8c955aaf71989efa641b906558d9fb7?api-version=2019-08-01', '*')
  ...
  'x-ms-correlation-request-id': 'db4582f3-abf3-4ff7-8755-cb069361386d',
  'x-ms-request-id': '20de6c3a-4690-4fb1-b9d7-64a710f3662e',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-content-type-options': 'nosniff',
  'x-ms-ratelimit-remaining-subscription-writes': '1199',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-routing-request-id':
   'WESTUS:20190805T190605Z:db4582f3-abf3-4ff7-8755-cb069361386d',
  date: 'Mon, 05 Aug 2019 19:06:04 GMT',
  connection: 'close' });
 return result; }]];