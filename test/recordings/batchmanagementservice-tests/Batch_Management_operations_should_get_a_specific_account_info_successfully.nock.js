...
nock('https://management.azure.com:443')
  .get('/subscriptions/f30ef677-64a9-4768-934f-5fbbc0e1ad27/resourceGroups/default-azurebatch-westus2/providers/Microsoft.Batch/batchAccounts/batchtestnodesdk?api-version=2020-09-01')
  ...
  expires: '-1',
  'last-modified': 'Mon, 28 Sep 2020 18:45:09 GMT',
  etag: '"0x8D863DEA03B2C00"',
  'x-ms-correlation-request-id': '90444ca9-11c0-4f80-a556-b9102098b0b3',
  'x-ms-request-id': '35889156-9b22-4514-a726-dd33aaf9b1c3',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-content-type-options': 'nosniff',
  'x-ms-ratelimit-remaining-subscription-reads': '11998',
  server: 'Microsoft-HTTPAPI/2.0',
  'x-ms-routing-request-id':
   'WESTUS:20200928T184624Z:90444ca9-11c0-4f80-a556-b9102098b0b3',
  date: 'Mon, 28 Sep 2020 18:46:24 GMT',
  connection: 'close' });
 return result; }]];