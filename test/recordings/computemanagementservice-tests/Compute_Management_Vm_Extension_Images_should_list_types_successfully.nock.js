...
nock('http://management.azure.com:443')
  ...
  'x-ms-request-id': 'a165d6dd-c8d1-4410-8208-b3b4e3ef368d',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14998',
  'x-ms-correlation-request-id': '02fd0bce-81b4-433b-899d-3bd4dd67a581',
  'x-ms-routing-request-id': 'WESTUS:20151208T230205Z:02fd0bce-81b4-433b-899d-3bd4dd67a581',
  date: 'Tue, 08 Dec 2015 23:02:05 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
