...
.post('/pools/nodesdktestpool1/updateproperties?api-version=2016-07-01.3.1', '*')
  .reply(204, "", { 'content-length': '0',
  'last-modified': 'Fri, 29 Jul 2016 16:39:04 GMT',
  etag: '0x8D3B7CEDA7E182F',
  server: 'Microsoft-HTTPAPI/2.0',
  'request-id': 'e3a46581-4133-4b55-8e18-3cc9d3e6b141',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  dataserviceversion: '3.0',
  dataserviceid: 'https://matthchreastus2.eastus2.batch.azure.com/pools/nodesdktestpool1/updateproperties',
  date: 'Fri, 29 Jul 2016 16:39:04 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
