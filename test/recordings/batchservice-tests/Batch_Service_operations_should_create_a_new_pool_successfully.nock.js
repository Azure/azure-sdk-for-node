...
.post('/pools?api-version=2017-01-01.4.0', '*')
  ...
  'last-modified': 'Fri, 03 Feb 2017 21:45:49 GMT',
  etag: '0x8D44C7E04D3A4FF',
  location: 'https://jstesteastus2.eastus2.batch.azure.com/pools/nodesdktestpool1',
  server: 'Microsoft-HTTPAPI/2.0',
  'request-id': 'd2a25ffd-0c33-4cf6-8734-567894867c70',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-content-type-options': 'nosniff',
  dataserviceversion: '3.0',
  dataserviceid: 'https://jstesteastus2.eastus2.batch.azure.com/pools/nodesdktestpool1',
  date: 'Fri, 03 Feb 2017 21:45:50 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
...
var result = 
nock('http://jstesteastus2.eastus2.batch.azure.com:443')
  .get('/nodeagentskus?api-version=2017-01-01.4.0')
  ...
  server: 'Microsoft-HTTPAPI/2.0',
  'request-id': '44512f00-6908-42cf-9d79-731b22c831a2',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  'x-content-type-options': 'nosniff',
  dataserviceversion: '3.0',
  date: 'Fri, 03 Feb 2017 21:45:49 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
