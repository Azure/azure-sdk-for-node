...
var PostgreSQLManagementClient = require('../../../lib/services/postgresqlManagement/lib/postgreSQLManagementClient');

const testPrefix = 'postgresqlmanagementservice-tests';
const groupPrefix = 'nodeTestGroup';
const serverPrefix = 'testserver';
const databasePrefix = 'testdb';
const serverType = 'Microsoft.DBforPostgreSQL/servers';
const databaseType = 'Microsoft.DBforPostgreSQL/servers/databases';
const databaseCharset = 'UTF8';
const postgresAdmin = 'postgres';
const postgresAdminPassword = 'F00Bar!!';
...
describe('PostgreSQL Management', function () {

  before(function (done) {
    suite = new SuiteBase(this, testPrefix, requiredEnvironment);
    suite.setupSuite(function () {
      groupName = suite.generateId(groupPrefix, createdGroups, suite.isMocked);
      client = new PostgreSQLManagementClient(suite.credentials, suite.subscriptionId);
  ...
  describe('servers', function () {
    ...
    it('should create a server correctly', function () {
      return client.servers.create(groupName, serverName1, {
        ...
        server.administratorLogin.should.equal(postgresAdmin);
  ...
  describe('databases', function () {
    ...
    before(function (done) {
      ...
      client.servers.createOrUpdate(groupName, serverName2, {
        location: location,
        properties: {
          createMode: 'Default',
          administratorLogin: postgresAdmin,
    ...
    it('should list all the databases in the server', function () {
      return client.databases.listByServer(
        ...
        // This includes the default database as well as the one we created
